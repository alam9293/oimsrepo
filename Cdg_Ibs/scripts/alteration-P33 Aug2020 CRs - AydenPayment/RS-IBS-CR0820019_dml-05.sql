...
select  'RS-IBS-CR0820019_dml-05.sql_' || sys_context('userenv','instance_name') || '_' || to_char(sysdate,'YYYYMMDD_HH24MISS') dt,'.txt' ext from dual;
...
SET URI = '/report/ayden_payment_matching_report.zul?rsrcId=1550' where rsrc_Id = 1550;
