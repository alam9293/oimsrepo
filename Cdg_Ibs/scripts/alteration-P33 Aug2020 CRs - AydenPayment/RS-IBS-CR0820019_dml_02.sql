...
select  'RS-IBS-CR0820019_dml_02_' || sys_context('userenv','instance_name') || '_' || to_char(sysdate,'YYYYMMDD_HH24MISS') dt,'.txt' ext from dual;
...
UPDATE MSTB_MASTER_TABLE SET MASTER_VALUE = 'Dear Receiver,\n Adyen Settlement Job Completed (#title)' where master_type = 'ETASC' and MASTER_CODE = 'CONT';
UPDATE MSTB_MASTER_TABLE SET MASTER_VALUE = '#status Ayden Settlement For #settlementDate and #acq' where master_type = 'ETASC' and MASTER_CODE = 'SUBJ';
