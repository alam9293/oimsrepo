...
select  'RS-IBS-CR1220017_ddl_4.sql_' || sys_context('userenv','instance_name') || '_' || to_char(sysdate,'YYYYMMDD_HH24MISS') dt,'.txt' ext from dual;
...
MODIFY FILE_NAME VARCHAR2(500);

ALTER TABLE TMTB_NON_BILLABLE_BATCH
MODIFY UPLOAD_DT_STRING VARCHAR2(500);
