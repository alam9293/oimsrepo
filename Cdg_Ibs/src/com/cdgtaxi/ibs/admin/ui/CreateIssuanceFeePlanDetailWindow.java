...
public class CreateIssuanceFeePlanDetailWindow extends CommonWindow {
	private static final Logger logger = Logger.getLogger(CreateIssuanceFeePlanDetailWindow.class);
	...
	public CreateIssuanceFeePlanDetailWindow() {
		logger.info("New Issuance Fee Plan Detail");
		...
		detail = new MstbIssuanceFeeDetail();
		detail.setMstbIssuanceFeeMaster(plan);
	}
	...
	public void saveDetail() throws InterruptedException {
		...
		try {
			businessHelper.getAdminBusiness().saveIssuanceFeePlanDetail(detail, getUserLoginIdAndDomain());
