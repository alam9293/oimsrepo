...
public class EditLatePaymentPlanDetailWindow extends CommonWindow implements AfterCompose{
	private static final Logger logger = Logger.getLogger(EditLatePaymentPlanDetailWindow.class);
	...
	public EditLatePaymentPlanDetailWindow() {
		Map params = Executions.getCurrent().getArg();
		Integer planDetailNo =  (Integer) params.get("planDetailNo");
		logger.info("Plan Detail No = " + planDetailNo);
		detail = businessHelper.getAdminBusiness().getLatePaymentPlanDetail(planDetailNo);
		plan = detail.getMstbLatePaymentMaster();
	}
	...
	public void afterCompose() {
		...
		latePaymentDB.setValue(detail.getLatePayment());
	...
	public void updateDetail() throws InterruptedException {
		...
		try {
			businessHelper.getAdminBusiness().updateLatePaymentPlanDetail(detail, getUserLoginIdAndDomain());
