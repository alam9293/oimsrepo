...
public class ViewAdminFeePlanDetailWindow extends CommonWindow implements AfterCompose{

	private MstbAdminFeeMaster plan;
	private MstbAdminFeeDetail detail;
	
	private Label planNameLabel, startDateDBLabel, adminFeeDBLabel;
	...
	public void afterCompose() {
		...
		adminFeeDBLabel.setValue(StringUtil.bigDecimalToString(detail.getAdminFee(), StringUtil.GLOBAL_DECIMAL_FORMAT));
