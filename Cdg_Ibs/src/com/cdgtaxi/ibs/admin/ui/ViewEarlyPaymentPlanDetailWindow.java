...
public class ViewEarlyPaymentPlanDetailWindow extends CommonWindow implements AfterCompose{

	private MstbEarlyPaymentMaster plan;
	private MstbEarlyPaymentDetail detail;
	private Label planNameLabel,startDateDBLabel,earlyPaymentDB;
	...
	public void afterCompose() {
		...
		earlyPaymentDB.setValue(StringUtil.bigDecimalToString(detail.getEarlyPayment(), StringUtil.GLOBAL_DECIMAL_FORMAT));
