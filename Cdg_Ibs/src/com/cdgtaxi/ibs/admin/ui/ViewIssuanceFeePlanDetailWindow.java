...
public class ViewIssuanceFeePlanDetailWindow extends CommonWindow implements AfterCompose{

	private MstbIssuanceFeeMaster plan;
	private MstbIssuanceFeeDetail detail;
	
	private Label planNameLabel,startDateDBLabel,issuanceFeeDBLabel;
	...
	public void afterCompose() {
		...
		issuanceFeeDBLabel.setValue(StringUtil.bigDecimalToString(detail.getIssuanceFee(), StringUtil.GLOBAL_DECIMAL_FORMAT));
