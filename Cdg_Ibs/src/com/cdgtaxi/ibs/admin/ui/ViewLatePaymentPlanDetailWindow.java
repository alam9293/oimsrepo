...
public class ViewLatePaymentPlanDetailWindow extends CommonWindow implements AfterCompose{

	private MstbLatePaymentMaster plan;
	private MstbLatePaymentDetail detail;
	
	private Label planNameLabel,startDateDBLabel,latePaymentDBLabel;
	...
	public void afterCompose() {
		...
		latePaymentDBLabel.setValue(StringUtil.bigDecimalToString(detail.getLatePayment(), StringUtil.GLOBAL_DECIMAL_FORMAT));
