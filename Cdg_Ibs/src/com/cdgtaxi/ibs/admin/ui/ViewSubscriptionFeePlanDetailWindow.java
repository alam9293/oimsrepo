...
public class ViewSubscriptionFeePlanDetailWindow extends CommonWindow implements AfterCompose{

	private MstbSubscFeeMaster plan;
	private MstbSubscFeeDetail detail;
	
	private Label planNameLabel,startDateDBLabel,subscriptionFeeDBLabel,recurringPeriodIBLabel;
	...
	public void afterCompose() {
		...
		subscriptionFeeDBLabel.setValue(StringUtil.bigDecimalToString(detail.getSubscriptionFee(), StringUtil.GLOBAL_DECIMAL_FORMAT));
		recurringPeriodIBLabel.setValue(StringUtil.numberToString(detail.getRecurringPeriod(), StringUtil.GLOBAL_INTEGER_FORMAT));
