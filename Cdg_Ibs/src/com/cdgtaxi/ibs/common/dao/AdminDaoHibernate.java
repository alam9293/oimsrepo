...
public class AdminDaoHibernate extends GenericDaoHibernate implements AdminDao {
	...
	public MstbVolDiscMaster getVolumeDiscountPlanWithDetails(Integer planNo) {
		...
		DetachedCriteria planDetailCriteria = planCriteria.createCriteria("mstbVolDiscDetails", DetachedCriteria.LEFT_JOIN);
		planDetailCriteria.createCriteria("mstbVolDiscTiers", DetachedCriteria.LEFT_JOIN);
	...
	public MstbVolDiscDetail getVolumeDiscountPlanDetailWithTiers(
		...
		planCriteria.createCriteria("mstbVolDiscTiers", DetachedCriteria.LEFT_JOIN);
		planCriteria.createCriteria("mstbVolDiscMaster", DetachedCriteria.LEFT_JOIN);
	...
	public MstbProdDiscMaster getProductDiscountPlanWithDetails(Integer planNo) {
		...
		planCriteria.createCriteria("mstbProdDiscDetails", DetachedCriteria.LEFT_JOIN);
		planCriteria.add(Restrictions.idEq(planNo));
	...
	public MstbAdminFeeMaster getAdminFeePlanWithDetails(Integer planNo) {
		...
		planCriteria.createCriteria("mstbAdminFeeDetails", DetachedCriteria.LEFT_JOIN);
		planCriteria.add(Restrictions.idEq(planNo));
	...
	public MstbBankMaster getBankWithBranches(Integer bankNo) {
		...
		DetachedCriteria branchCriteria = criteria.createCriteria("mstbBranchMasters", DetachedCriteria.LEFT_JOIN);
		branchCriteria.createCriteria("bmtbPaymentReceipts", DetachedCriteria.LEFT_JOIN);
		branchCriteria.createCriteria("amtbBillReqs", DetachedCriteria.LEFT_JOIN);
		branchCriteria.createCriteria("amtbAccounts", DetachedCriteria.LEFT_JOIN);
	...
	public MstbCreditTermMaster getCreditTermPlanWithDetails(
		...
		planCriteria.createCriteria("mstbCreditTermDetails", DetachedCriteria.LEFT_JOIN);
	...
	public MstbEarlyPaymentMaster getEarlyPaymentPlanWithDetails(
		...
		planCriteria.createCriteria("mstbEarlyPaymentDetails", DetachedCriteria.LEFT_JOIN);
	...
	public FmtbArContCodeMaster getGLControlCodeWithDetails(Integer codeNo) {
		...
		planCriteria.createCriteria("fmtbArContCodeDetails", DetachedCriteria.LEFT_JOIN);
		planCriteria.createCriteria("fmtbEntityMaster", DetachedCriteria.LEFT_JOIN);
	...
	public MstbLatePaymentMaster getLatePaymentPlanWithDetails(
		...
		planCriteria.createCriteria("mstbLatePaymentDetails", DetachedCriteria.LEFT_JOIN);
	...
	public MstbSubscFeeMaster getSubscriptionFeePlanWithDetails(
		...
		planCriteria.createCriteria("mstbSubscFeeDetails", DetachedCriteria.LEFT_JOIN);
	...
	public MstbIssuanceFeeMaster getIssuanceFeePlanWithDetails(
		...
		planCriteria.createCriteria("mstbIssuanceFeeDetails", DetachedCriteria.LEFT_JOIN);
	...
	public List<Object[]> getGLBankCodes(SearchGLBankForm form) {
		...
		try{
			...
			if(form.entityNo!=null) query.setParameter("entityNo", form.entityNo, Hibernate.INTEGER);
			else query.setParameter("entityNo", null, Hibernate.INTEGER);
			if(form.bankCode!=null) query.setParameter("bankCode", form.bankCode, Hibernate.STRING);
			else query.setParameter("bankCode", null, Hibernate.STRING);
			if(form.branchCode!=null) query.setParameter("branchCode", form.branchCode, Hibernate.STRING);
			else query.setParameter("branchCode", null, Hibernate.STRING);
			if(form.effDateFromDate!=null & form.effDateToDate!=null){
				query.setParameter("effectiveDateFrom", form.effDateFromDate, Hibernate.DATE);
				query.setParameter("effectiveDateTo", form.effDateToDate, Hibernate.DATE);
			}
			else{
				query.setParameter("effectiveDateFrom", null, Hibernate.DATE);
				query.setParameter("effectiveDateTo", null, Hibernate.DATE);
			}
	...
	public List<FmtbArContCodeMaster> getGLControlCodes(Integer entityNo) {
		...
		codeCriteria.createCriteria("fmtbEntityMaster", "e", DetachedCriteria.LEFT_JOIN);
		if (entityNo != null) {
	...
	public List<FmtbTaxCode> getGLTaxCodes(Integer entityNo, String taxType) {
		...
		codeCriteria.createCriteria("fmtbEntityMaster", "e", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria taxTypeMasterCriteria = codeCriteria.createCriteria("mstbMasterTable", DetachedCriteria.LEFT_JOIN);
	...
	public List<Object[]> getTransactionCodes(SearchTransactionCodeForm form) {
		...
		try{
			...
			if(form.txnType!=null) query.setParameter("txnType", form.txnType, Hibernate.STRING);
			else query.setParameter("txnType", null, Hibernate.STRING);
			if(form.taxType!=null) query.setParameter("taxType", form.taxType, Hibernate.STRING);
			else query.setParameter("taxType", null, Hibernate.STRING);
			if(form.txnCode!=null) query.setParameter("txnCode", form.txnCode, Hibernate.STRING);
			else query.setParameter("txnCode", null, Hibernate.STRING);
			if(form.effDateFromDate!=null & form.effDateToDate!=null){
				query.setParameter("effectiveDateFrom", form.effDateFromDate, Hibernate.DATE);
				query.setParameter("effectiveDateTo", form.effDateToDate, Hibernate.DATE);
			}
	...
	public List<MstbProdDiscMaster> getProductDiscountPlans() {
		...
		criteria.createCriteria("mstbProdDiscDetails", DetachedCriteria.LEFT_JOIN);
	...
	public List<MstbSubscFeeMaster> getSubscriptionFeePlans() {
		...
		criteria.createCriteria("mstbSubscFeeDetails", DetachedCriteria.LEFT_JOIN);
	...
	public List<MstbIssuanceFeeMaster> getIssuanceFeePlans() {
		...
		criteria.createCriteria("mstbIssuanceFeeDetails", DetachedCriteria.LEFT_JOIN);
	...
	public List<MstbVolDiscMaster> getVolumeDiscountPlans() {
		...
		criteria.createCriteria("mstbVolDiscDetails", DetachedCriteria.LEFT_JOIN);
	...
	public boolean hasDuplicateEffectiveDate(FmtbTaxCode tax) {
		...
		criteria.createCriteria("fmtbEntityMaster", "entity", DetachedCriteria.LEFT_JOIN);
		criteria.createCriteria("mstbMasterTable", "taxType", DetachedCriteria.LEFT_JOIN);
	...
	public boolean hasDuplicateEffectiveDate(MstbVolDiscDetail detail) {
		...
		criteria.createCriteria("mstbVolDiscMaster", "m", DetachedCriteria.LEFT_JOIN);
	...
	public boolean hasDuplicateEffectiveDate(MstbProdDiscDetail detail) {
		...
		criteria.createCriteria("mstbProdDiscMaster", "m", DetachedCriteria.LEFT_JOIN);
	...
	public boolean hasDuplicateEffectiveDate(MstbAdminFeeDetail detail) {
		...
		criteria.createCriteria("mstbAdminFeeMaster", "m", DetachedCriteria.LEFT_JOIN);
	...
	public boolean hasDuplicateEffectiveDate(MstbCreditTermDetail detail) {
		...
		criteria.createCriteria("mstbCreditTermMaster", "m", DetachedCriteria.LEFT_JOIN);
	...
	public boolean hasDuplicateEffectiveDate(MstbSubscFeeDetail detail) {
		...
		criteria.createCriteria("mstbSubscFeeMaster", "m", DetachedCriteria.LEFT_JOIN);
	...
	public boolean hasDuplicateEffectiveDate(MstbIssuanceFeeDetail detail) {
		...
		criteria.createCriteria("mstbIssuanceFeeMaster", "m", DetachedCriteria.LEFT_JOIN);
	...
	public boolean hasDuplicateEffectiveDate(MstbLatePaymentDetail detail) {
		...
		criteria.createCriteria("mstbLatePaymentMaster", "m", DetachedCriteria.LEFT_JOIN);
	...
	public boolean hasDuplicateEffectiveDate(MstbEarlyPaymentDetail detail) {
		...
		criteria.createCriteria("mstbEarlyPaymentMaster", "m", DetachedCriteria.LEFT_JOIN);
	...
	public boolean hasDuplicateCode(MstbBranchMaster branch) {
		...
		DetachedCriteria bankMasterCriteria = criteria.createCriteria("mstbBankMaster", DetachedCriteria.LEFT_JOIN);
	...
	public List<FmtbBankPaymentMaster> searchBankPayment(SearchBankPaymentForm form){
		...
		criteria.createCriteria("mstbAcquirer", DetachedCriteria.LEFT_JOIN);
		criteria.createCriteria("fmtbBankPaymentDetails", DetachedCriteria.LEFT_JOIN);
	...
	public List<FmtbNonBillableMaster> searchNonBillable(SearchNonBillableForm form){
		...
		DetachedCriteria masterSPCriteria = criteria.createCriteria("mstbMasterTableByServiceProvider", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria masterPTCriteria = criteria.createCriteria("mstbMasterTableByPymtTypeMasterNo", DetachedCriteria.LEFT_JOIN);
		criteria.createCriteria("fmtbNonBillableDetails", DetachedCriteria.LEFT_JOIN);
	...
	public List<FmtbArContCodeMaster> getARControlCode(Integer entity_no){
		DetachedCriteria criteria = DetachedCriteria.forClass(FmtbArContCodeMaster.class);
		DetachedCriteria entityCriteria = criteria.createCriteria("fmtbEntityMaster", DetachedCriteria.LEFT_JOIN);
	...
	public List<MstbAcquirerPymtType> searchAcquirerPaymentType(SearchAcquirerPaymentTypeForm form){
		...
		criteria.createCriteria("mstbMasterTable", "mmt", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria acquirerCriteria = criteria.createCriteria("mstbAcquirer", "mstbacq", DetachedCriteria.LEFT_JOIN);
		...
		if(form.effDateFromDate!=null || form.effDateToDate!=null){
			...
			disjunction.add(Restrictions.sqlRestriction("? between effective_Dt_From and effective_Dt_To", DateUtil.convertDateToTimestamp(form.effDateFromDate), Hibernate.TIMESTAMP));
			
			disjunction.add(Restrictions.sqlRestriction("? between effective_Dt_From and effective_Dt_To", DateUtil.convertDateToTimestamp(form.effDateToDate), Hibernate.TIMESTAMP));
...
//		criteria.createCriteria("mstbAcquirer", "a", DetachedCriteria.LEFT_JOIN);
//		
...
//		return this.findDefaultMaxResultByCriteria(criteria);
		...
		try{
			...
			if(form.acquirer!=null) query.setParameter("acquirerNo", form.acquirer.getAcquirerNo(), Hibernate.INTEGER);
			else query.setParameter("acquirerNo", null, Hibernate.INTEGER);
			if(form.rate!=null) query.setParameter("rate", form.rate, Hibernate.BIG_DECIMAL);
			else query.setParameter("rate", null, Hibernate.BIG_DECIMAL);
			if(form.effDateFromDate!=null & form.effDateToDate!=null){
				query.setParameter("effectiveDateFrom", form.effDateFromDate, Hibernate.DATE);
				query.setParameter("effectiveDateTo", form.effDateToDate, Hibernate.DATE);
			}
	...
	public MstbAcquirerPymtType getAcquirerPaymentType(Integer pymtTypeNo){
		DetachedCriteria criteria = DetachedCriteria.forClass(MstbAcquirerPymtType.class);
		criteria.createCriteria("mstbMasterTable", DetachedCriteria.LEFT_JOIN);
		criteria.createCriteria("mstbAcquirer", "mstbacq", DetachedCriteria.LEFT_JOIN);
		criteria.createCriteria("mstbAcquirerPymtComm", DetachedCriteria.LEFT_JOIN);
	...
	public FmtbNonBillableMaster getNonBillableMaster(Integer masterNo){
		DetachedCriteria criteria = DetachedCriteria.forClass(FmtbNonBillableMaster.class);
		DetachedCriteria detailCriteria = criteria.createCriteria("fmtbNonBillableDetails", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria arContCodeCriteria = detailCriteria.createCriteria("fmtbArContCodeMaster", DetachedCriteria.LEFT_JOIN);
		arContCodeCriteria.createCriteria("fmtbEntityMaster", DetachedCriteria.LEFT_JOIN);
		criteria.createCriteria("mstbMasterTableByServiceProvider", DetachedCriteria.LEFT_JOIN);
		criteria.createCriteria("mstbMasterTableByPymtTypeMasterNo", DetachedCriteria.LEFT_JOIN);
	...
	public FmtbBankPaymentMaster getBankPaymentMaster(Integer masterNo){
		DetachedCriteria criteria = DetachedCriteria.forClass(FmtbBankPaymentMaster.class);
		DetachedCriteria detail = criteria.createCriteria("fmtbBankPaymentDetails", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria arCont = detail.createCriteria("fmtbArContCodeMaster", DetachedCriteria.LEFT_JOIN);
		arCont.createCriteria("fmtbEntityMaster", DetachedCriteria.LEFT_JOIN);
		criteria.createCriteria("mstbAcquirer", DetachedCriteria.LEFT_JOIN);
	...
	public FmtbBankPaymentDetail getBankPaymentDetail(Integer detailNo){
		DetachedCriteria criteria = DetachedCriteria.forClass(FmtbBankPaymentDetail.class);
		criteria.createCriteria("fmtbBankPaymentMaster", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria arContCodecriteria = criteria.createCriteria("fmtbArContCodeMaster", DetachedCriteria.LEFT_JOIN);
		arContCodecriteria.createCriteria("fmtbEntityMaster", DetachedCriteria.LEFT_JOIN);
	...
	public FmtbNonBillableDetail getNonBillableDetail(Integer detailNo){
		...
		criteria.createCriteria("fmtbNonBillableMaster", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria arContCodecriteria = criteria.createCriteria("fmtbArContCodeMaster", DetachedCriteria.LEFT_JOIN);
		arContCodecriteria.createCriteria("fmtbEntityMaster", DetachedCriteria.LEFT_JOIN);
	...
	public boolean hasDuplicateRecord(FmtbNonBillableMaster master, FmtbNonBillableDetail detail){
		DetachedCriteria criteria = DetachedCriteria.forClass(FmtbNonBillableDetail.class);
		DetachedCriteria mastercriteria = criteria.createCriteria("fmtbNonBillableMaster", DetachedCriteria.LEFT_JOIN);
		criteria.add(Restrictions.eq("effectiveDate", detail.getEffectiveDate()));
		if(detail.getDetailNo()!=null)
			criteria.add(Restrictions.ne("detailNo", detail.getDetailNo()));
	...
	public boolean hasDuplicateRecord(MstbAcquirerPymtType acquirerPymtType) {
		DetachedCriteria criteria = DetachedCriteria.forClass(MstbAcquirerPymtType.class);
		criteria.createCriteria("mstbAcquirer", "mstbacq", DetachedCriteria.LEFT_JOIN);
		criteria.createCriteria("mstbMasterTable", "mstbmt", DetachedCriteria.LEFT_JOIN);
...
//		criteria.add(Restrictions.eq("mstbacq.acquirerNo", acquirerPymtType.getMstbAcquirer().getAcquirerNo()));
		...
		conjunction.add(Restrictions.sqlRestriction("? between effective_Dt_From and effective_Dt_To", acquirerPymtType.getEffectiveDtFrom(), Hibernate.TIMESTAMP));
		
		if(acquirerPymtType.getEffectiveDtTo()!=null){
			conjunction.add(Restrictions.sqlRestriction("? between effective_Dt_From and effective_Dt_To", acquirerPymtType.getEffectiveDtTo(), Hibernate.TIMESTAMP));
			disjunction2.add(conjunction);
		}
		
		if(acquirerPymtType.getEffectiveDtTo()!=null){
			Conjunction conjunction2 = Restrictions.conjunction();
			conjunction2.add(Restrictions.sqlRestriction("? between effective_Dt_From and effective_Dt_To", acquirerPymtType.getEffectiveDtFrom(), Hibernate.TIMESTAMP));
			conjunction2.add(Restrictions.sqlRestriction("? >= effective_Dt_To", acquirerPymtType.getEffectiveDtTo(), Hibernate.TIMESTAMP));
			disjunction2.add(conjunction2);
			
			Conjunction conjunction3 = Restrictions.conjunction();
			conjunction3.add(Restrictions.sqlRestriction("? <= effective_Dt_From", acquirerPymtType.getEffectiveDtFrom(), Hibernate.TIMESTAMP));
			conjunction3.add(Restrictions.sqlRestriction("? >= effective_Dt_From", acquirerPymtType.getEffectiveDtTo(), Hibernate.TIMESTAMP));
			disjunction2.add(conjunction3);
			
			Conjunction conjunction4 = Restrictions.conjunction();
			conjunction4.add(Restrictions.sqlRestriction("? >= effective_Dt_From", acquirerPymtType.getEffectiveDtFrom(), Hibernate.TIMESTAMP));
	...
	public List<MstbMasterTable> getPaymentType(MstbAcquirer acquirer){
		...
		DetachedCriteria acquirerPymtTypeCriteria = criteria.createCriteria("mstbAcquirerPymtTypes","mapy", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria acquirerCriteria = acquirerPymtTypeCriteria.createCriteria("mstbAcquirer", "ma",  DetachedCriteria.LEFT_JOIN);
	...
	public boolean isAcquirerDeletable(int acquirer_no){
		DetachedCriteria criteria = DetachedCriteria.forClass(MstbAcquirer.class);
		criteria.createCriteria("mstbAcquirerMdrs", "mdr", DetachedCriteria.LEFT_JOIN);
		criteria.createCriteria("mstbAcquirerPymtTypes", "pymtType", DetachedCriteria.LEFT_JOIN);
	...
	public boolean hasDuplicateName(Integer promoNo, String name){
		...
		DetachedCriteria promoDetailCriteria = criteria.createCriteria("currentPromoDetail", DetachedCriteria.LEFT_JOIN);
	...
	public List<MstbPromotion> searchCurrentPromotion(SearchPromotionForm form){
		DetachedCriteria criteria = DetachedCriteria.forClass(MstbPromotion.class);
		DetachedCriteria promoDetailCriteria = criteria.createCriteria("currentPromoDetail", "promoDetail", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria prodTypeCriteria = promoDetailCriteria.createCriteria("pmtbProductType", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria jobTypeCriteria = promoDetailCriteria.createCriteria("mstbMasterTableByJobType", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria vehicleModelCriteria = promoDetailCriteria.createCriteria("mstbMasterTableByVehicleModel", DetachedCriteria.LEFT_JOIN);
		...
		if(form.effDateFrom!=null && form.effDateTo!=null){
			...
			disjunction.add(Restrictions.sqlRestriction("? between {alias}.effective_Dt_From and {alias}.effective_Dt_To", DateUtil.convertDateToTimestamp(form.effDateFrom), Hibernate.TIMESTAMP));
			
			disjunction.add(Restrictions.sqlRestriction("? between {alias}.effective_Dt_From and {alias}.effective_Dt_To", DateUtil.convertDateToTimestamp(form.effDateTo), Hibernate.TIMESTAMP));
	...
	public List<MstbPromotion> searchLastPromoReq(SearchPromotionForm form){
		...
		DetachedCriteria criteria = DetachedCriteria.forClass(MstbPromotion.class);
		DetachedCriteria lastPromoReqCriteria = criteria.createCriteria("lastPromoReq", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria fromPromoDetailCriteria = lastPromoReqCriteria.createCriteria("fromPromoDetail", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria lastPromoReqFlowCriteria  = lastPromoReqCriteria.createCriteria("lastPromoReqFlow", DetachedCriteria.LEFT_JOIN);
		
		DetachedCriteria toPromoDetailCriteria = lastPromoReqFlowCriteria.createCriteria("toPromoDetail", "toPromoDetail", DetachedCriteria.LEFT_JOIN);

		DetachedCriteria prodTypeCriteria = toPromoDetailCriteria.createCriteria("pmtbProductType", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria jobTypeCriteria = toPromoDetailCriteria.createCriteria("mstbMasterTableByJobType", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria vehicleModelCriteria = toPromoDetailCriteria.createCriteria("mstbMasterTableByVehicleModel", DetachedCriteria.LEFT_JOIN);
	...
	public List<MstbPromoReq> searchPromoPlanHistory(SearchPromoPlanHistoryForm form){
		...
		criteria.createCriteria("mstbPromotion", DetachedCriteria.LEFT_JOIN);
		criteria.createCriteria("fromPromoDetail", DetachedCriteria.LEFT_JOIN);
		
		DetachedCriteria promoReqFlowCriteria  = criteria.createCriteria("mstbPromoReqFlows", DetachedCriteria.LEFT_JOIN);
		promoReqFlowCriteria.add(Restrictions.eq("reqFromStatus", NonConfigurableConstants.PROMOTION_REQUEST_STATUS_NEW));
		
		DetachedCriteria toPromoDetailCriteria = promoReqFlowCriteria.createCriteria("toPromoDetail", DetachedCriteria.LEFT_JOIN);
		...
		DetachedCriteria lastPromoReqFlowCriteria  = criteria.createCriteria("lastPromoReqFlow", DetachedCriteria.LEFT_JOIN);
	...
	public List<MstbPromoReq> getPendingPromoReq(){
		DetachedCriteria criteria = DetachedCriteria.forClass(MstbPromoReq.class);
		DetachedCriteria promotionCriteria = criteria.createCriteria("mstbPromotion", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria currentPromoDetailCriteria =promotionCriteria.createCriteria("currentPromoDetail", DetachedCriteria.LEFT_JOIN);
		currentPromoDetailCriteria.createCriteria("pmtbProductType", DetachedCriteria.LEFT_JOIN);
		currentPromoDetailCriteria.createCriteria("mstbMasterTableByJobType", DetachedCriteria.LEFT_JOIN);
		currentPromoDetailCriteria.createCriteria("mstbMasterTableByVehicleModel", DetachedCriteria.LEFT_JOIN);
		
		DetachedCriteria fromPromoDetailCriteria = criteria.createCriteria("fromPromoDetail", DetachedCriteria.LEFT_JOIN);
		
		fromPromoDetailCriteria.createCriteria("pmtbProductType", DetachedCriteria.LEFT_JOIN);
		fromPromoDetailCriteria.createCriteria("mstbMasterTableByJobType", DetachedCriteria.LEFT_JOIN);
		fromPromoDetailCriteria.createCriteria("mstbMasterTableByVehicleModel", DetachedCriteria.LEFT_JOIN);
		
		DetachedCriteria lastPromoReqFlowCriteria  = criteria.createCriteria("lastPromoReqFlow", DetachedCriteria.LEFT_JOIN);
		lastPromoReqFlowCriteria.add(Restrictions.eq("reqToStatus", NonConfigurableConstants.PROMOTION_REQUEST_STATUS_PENDING));
		
		DetachedCriteria toPromoDetailCriteria = lastPromoReqFlowCriteria.createCriteria("toPromoDetail", DetachedCriteria.LEFT_JOIN);
		toPromoDetailCriteria.createCriteria("pmtbProductType", DetachedCriteria.LEFT_JOIN);
		toPromoDetailCriteria.createCriteria("mstbMasterTableByJobType", DetachedCriteria.LEFT_JOIN);
		toPromoDetailCriteria.createCriteria("mstbMasterTableByVehicleModel", DetachedCriteria.LEFT_JOIN);
	...
	public MstbPromotion getPromotion(Integer promoNo){
		...
		DetachedCriteria promoDetailCriteria =criteria.createCriteria("currentPromoDetail", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria cpdProdTypeCriteria = promoDetailCriteria.createCriteria("pmtbProductType", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria cpdJobTypeCriteria = promoDetailCriteria.createCriteria("mstbMasterTableByJobType", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria cpdVehicleModelCriteria = promoDetailCriteria.createCriteria("mstbMasterTableByVehicleModel", DetachedCriteria.LEFT_JOIN);
		
		DetachedCriteria lastPromoReqCriteria =criteria.createCriteria("lastPromoReq", DetachedCriteria.LEFT_JOIN);
		
		DetachedCriteria fromPromoDetailCriteria =lastPromoReqCriteria.createCriteria("fromPromoDetail", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria fpdProdTypeCriteria = fromPromoDetailCriteria.createCriteria("pmtbProductType", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria fpdJobTypeCriteria = fromPromoDetailCriteria.createCriteria("mstbMasterTableByJobType", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria fpdVehicleModelCriteria = fromPromoDetailCriteria.createCriteria("mstbMasterTableByVehicleModel", DetachedCriteria.LEFT_JOIN);
		
		DetachedCriteria lastPromoReqFlowCriteria =lastPromoReqCriteria.createCriteria("lastPromoReqFlow", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria toPromoDetailCriteria =lastPromoReqFlowCriteria.createCriteria("toPromoDetail", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria tpdProdTypeCriteria = toPromoDetailCriteria.createCriteria("pmtbProductType", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria tpdJobTypeCriteria = toPromoDetailCriteria.createCriteria("mstbMasterTableByJobType", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria tpdVehicleModelCriteria = toPromoDetailCriteria.createCriteria("mstbMasterTableByVehicleModel", DetachedCriteria.LEFT_JOIN);
...
//		this.logger.info("updated "+recordsUpdated+" records...");
	...
	public FmtbBankCode checkDefaultCollectionBankExist(Integer entityNo, Date effectiveDate, Integer bankCodeNo){
		DetachedCriteria criteria = DetachedCriteria.forClass(FmtbBankCode.class);
		DetachedCriteria entity = criteria.createCriteria("fmtbEntityMaster", DetachedCriteria.LEFT_JOIN);
	...
	public List<IttbGiroReq> searchGiroRequest(SearchGiroRequestForm form) {
		...
		DetachedCriteria criteria = DetachedCriteria.forClass(IttbGiroReq.class);
		DetachedCriteria setupCriteria = criteria.createCriteria("ittbGiroSetup", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria entityCriteria = setupCriteria.createCriteria("fmtbEntityMaster", DetachedCriteria.LEFT_JOIN);
	...
	public IttbGiroReq searchGiroRequest(Long requestNo) {
		...
		DetachedCriteria criteria = DetachedCriteria.forClass(IttbGiroReq.class);
		DetachedCriteria setupCriteria = criteria.createCriteria("ittbGiroSetup", DetachedCriteria.LEFT_JOIN);
		setupCriteria.createCriteria("fmtbEntityMaster", DetachedCriteria.LEFT_JOIN);
	...
	public IttbGiroUobHeader getCorrespondingGiroOutgoingFile(String returnFileName){
		DetachedCriteria criteria = DetachedCriteria.forClass(IttbGiroUobHeader.class);
		criteria.createCriteria("ittbGiroUobDetails", DetachedCriteria.LEFT_JOIN);
		criteria.setResultTransformer(DetachedCriteria.DISTINCT_ROOT_ENTITY);
		
		//Left join data
		DetachedCriteria request = criteria.createCriteria("ittbGiroReq", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria setup = request.createCriteria("ittbGiroSetup", DetachedCriteria.LEFT_JOIN);
		setup.createCriteria("fmtbEntityMaster", DetachedCriteria.LEFT_JOIN);
	...
	public List<IttbGiroReturnReq> searchGiroReturnRequest(SearchGiroReturnRequestForm form) {
		...
		criteria.createCriteria("ittbGiroUobHeader", DetachedCriteria.LEFT_JOIN);
	...
	public List<IttbGovtEinvoiceReq> searchGovtEInvRequest(SearchGovtEInvRequestForm form) {
		...
		DetachedCriteria govtEInvHdrDtlsCrit = govtEInvRequestCrit.createCriteria("ittbGovtEinvoiceHdrDtls", DetachedCriteria.LEFT_JOIN);
		govtEInvHdrDtlsCrit.createCriteria("ittbGovtEinvoiceLineDtls", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria billGenReqCrit = govtEInvRequestCrit.createCriteria("bmtbBillGenReq", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria accountCrit = govtEInvRequestCrit.createCriteria("amtbAccount", DetachedCriteria.LEFT_JOIN);
	...
	public IttbGovtEinvoiceReq searchGovtEInvRequest(Integer requestNo) {
		DetachedCriteria govtEInvRequestCrit = DetachedCriteria.forClass(IttbGovtEinvoiceReq.class);
		DetachedCriteria govtEInvHdrDtls = govtEInvRequestCrit.createCriteria("ittbGovtEinvoiceHdrDtls", DetachedCriteria.LEFT_JOIN);
		govtEInvHdrDtls.createCriteria("ittbGovtEinvoiceLineDtls", DetachedCriteria.LEFT_JOIN);
	...
	public List<IttbPubbsReq> searchPubbsRequest(SearchPubbsRequestForm form) {
		...
		DetachedCriteria pubbsDtlsCrit = pubbsRequestCrit.createCriteria("ittbPubbsDtls", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria billGenReqCrit = pubbsRequestCrit.createCriteria("bmtbBillGenReq", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria accountCrit = pubbsRequestCrit.createCriteria("amtbAccount", DetachedCriteria.LEFT_JOIN);
	...
	public IttbPubbsReq searchPubbsRequest(Integer requestNo) {
		DetachedCriteria pubbsRequestCrit = DetachedCriteria.forClass(IttbPubbsReq.class);
		DetachedCriteria pubbsHdrDtls = pubbsRequestCrit.createCriteria("ittbPubbsDtls", DetachedCriteria.LEFT_JOIN);
	...
	public List<IttbRecurringReq> searchIttbRecurringRequest(SearchRecurringRequestForm form) {
		...
		DetachedCriteria recurringDtlsCrit = recurringRequestCrit.createCriteria("ittbRecurringDtls", DetachedCriteria.LEFT_JOIN);
	...
	public IttbRecurringReq searchIttbRecurringRequest(Integer requestNo) {
		DetachedCriteria recurringRequestCrit = DetachedCriteria.forClass(IttbRecurringReq.class);
		DetachedCriteria recurringHdrDtls = recurringRequestCrit.createCriteria("ittbRecurringDtls", DetachedCriteria.LEFT_JOIN);
	...
	public IttbRecurringDtl getRecurringDtlwInvoice(String referenceId, String invoiceNo, String tokenId) {
		...
		DetachedCriteria recurringReq = recurringRequestCrit.createCriteria("ittbRecurringReq", DetachedCriteria.LEFT_JOIN);
