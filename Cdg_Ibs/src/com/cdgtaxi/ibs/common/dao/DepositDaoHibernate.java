...
public class DepositDaoHibernate extends GenericDaoHibernate implements DepositDao{
	...
	public BigDecimal getTotalRefundTxnAmount(AmtbAccount account){
		...
		{
			DetachedCriteria acctCriteria = depositCriteria.createCriteria("amtbAccount", DetachedCriteria.LEFT_JOIN);
			DetachedCriteria parentAcctCriteria = acctCriteria.createCriteria("amtbAccount", DetachedCriteria.LEFT_JOIN);
			DetachedCriteria grandparentAcctCriteria = parentAcctCriteria.createCriteria("amtbAccount", DetachedCriteria.LEFT_JOIN);
