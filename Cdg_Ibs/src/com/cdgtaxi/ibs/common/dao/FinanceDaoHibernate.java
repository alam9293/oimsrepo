...
public class FinanceDaoHibernate extends GenericDaoHibernate implements FinanceDao {
	...
	public List<FmtbTransactionCode> getEffectiveManualTxnCodes(int entityNo) {
		...
		DetachedCriteria subQueryFmtbQuery = subQuery.createCriteria("fmtbEntityMaster", DetachedCriteria.LEFT_JOIN);
		...
		DetachedCriteria fmtbQuery = mainQuery.createCriteria("fmtbEntityMaster", DetachedCriteria.LEFT_JOIN);
		fmtbQuery.createCriteria("mstbMasterTable", DetachedCriteria.LEFT_JOIN);
		mainQuery.createCriteria("mstbMasterTable", DetachedCriteria.LEFT_JOIN);
		mainQuery.createCriteria("pmtbProductType", DetachedCriteria.LEFT_JOIN);
	...
	public FmtbTaxCode getEffectiveTxnCode(int entityNo, Integer taxType) {
		...
		DetachedCriteria txnTypeCriteria = criteria.createCriteria("mstbMasterTable", DetachedCriteria.LEFT_JOIN);
