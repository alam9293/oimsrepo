...
public class ProductDaoHibernate extends GenericDaoHibernate implements ProductDao{
	...
	public List<PmtbProductRenew> getRenewProducts(BigDecimal productId) {
		 ...
		 DetachedCriteria productCriteria= productRenewCriteria.createCriteria("pmtbProduct", DetachedCriteria.LEFT_JOIN);
	...
	public List<PmtbProductCreditLimit> getUpdatedCreditLimtProducts(BigDecimal productId){
		 ...
		 logger.info("ProductNo :"+ productId.toString());
		 DetachedCriteria productCriteria= productCreditLimitCriteria.createCriteria("pmtbProduct", DetachedCriteria.LEFT_JOIN);
		 productCriteria.add(Restrictions.eq("productNo", productId));
	...
	public List<PmtbProductRetag> getRetagProducts(BigDecimal productId){
		 ...
		 logger.info("ProductNo :"+ productId.toString());
		 DetachedCriteria productCriteria= productRetagCriteria.createCriteria("pmtbProduct", DetachedCriteria.LEFT_JOIN);
		 productCriteria.add(Restrictions.eq("productNo", productId));
		 DetachedCriteria accountCriteriaCurrentAccountNo= productRetagCriteria.createCriteria("amtbAccountByCurrentAccountNo", DetachedCriteria.LEFT_JOIN);
		 DetachedCriteria accountCriteriaNewAccountNo= productRetagCriteria.createCriteria("amtbAccountByNewAccountNo", DetachedCriteria.LEFT_JOIN);
	...
	public List<PmtbProductReplacement> getReplaceProducts(BigDecimal productId) {
		 ...
		 logger.info("ProductNo :"+ productId.toString());
		 DetachedCriteria productCriteria= productReplacementCriteria.createCriteria("pmtbProduct", DetachedCriteria.LEFT_JOIN);
		 productCriteria.add(Restrictions.eq("productNo", productId));
	...
	public List<PmtbProductStatus> getProductStatus(BigDecimal productId) {
		 ...
		 logger.info("ProductNo :"+ productId.toString());
		 DetachedCriteria productCriteria= productStatusCriteria.createCriteria("pmtbProduct", DetachedCriteria.LEFT_JOIN);
		 productStatusCriteria.createCriteria("mstbMasterTable", DetachedCriteria.LEFT_JOIN);
		 productCriteria.add(Restrictions.eq("productNo", productId));
	...
	public AmtbContactPerson getcontactPersonCountry(AmtbContactPerson contactPerson){
		...
		DetachedCriteria masterCountryCriteria= contactPersonCriteria.createCriteria("mstbMasterTableByAddressCountry", DetachedCriteria.LEFT_JOIN);
...
/////////////
	...
	public PmtbProductType getProductTypebyProductId(BigDecimal productId){
		...
		DetachedCriteria productCriteria= productTypeCriteria.createCriteria("pmtbProducts", DetachedCriteria.LEFT_JOIN);
		productCriteria.add(Restrictions.eq("productNo",productId));
...
//////////////	
	...
	public List<PmtbProduct>getProducts(ProductSearchCriteria productSearchCriteria,PmtbProductType productType, HashSet<Integer> accountIdSet){
		...
		DetachedCriteria productCriteria = DetachedCriteria.forClass(PmtbProduct.class);
		DetachedCriteria productStatusCriteria= productCriteria.createCriteria("pmtbProductStatuses", DetachedCriteria.LEFT_JOIN);
		logger.debug("Retriving Products by product search Criteria ");
		logger.info("Account No : "+productSearchCriteria.getAccNo());
		
		DetachedCriteria accountCriteria= productCriteria.createCriteria("amtbAccount", DetachedCriteria.LEFT_JOIN);
		...
		//	DetachedCriteria productStatus= productCriteria.createCriteria("pmtbProductStatuses", DetachedCriteria.LEFT_JOIN);
		//	DetachedCriteria productTypeCriteria= productCriteria.createCriteria("pmtbProductType", DetachedCriteria.LEFT_JOIN);
		//	}
		//if(productType!=null )
		//productCriteria.add(Restrictions.eq("pmtbProductType",productType));
	...
	public List<PmtbProduct>getProducts(ProductSearchCriteria productSearchCriteria,PmtbProductType productType){
		...
		//DetachedCriteria productStatusCriteria= productCriteria.createCriteria("pmtbProductStatuses", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria accountCriteria= productCriteria.createCriteria("amtbAccount", DetachedCriteria.LEFT_JOIN);
		accountCriteria	.createCriteria("amtbAccount", DetachedCriteria.LEFT_JOIN).createCriteria("amtbAccount", DetachedCriteria.LEFT_JOIN);
		...
		//For Product Suspension
		if(productSearchCriteria.getSuspensionDateFrom()!=null || productSearchCriteria.getSuspensionDateTo()!=null){
			DetachedCriteria productStatusCriteria= productCriteria.createCriteria("pmtbProductStatuses","prod_status", DetachedCriteria.LEFT_JOIN);;
		...
		public List<PmtbProduct> getProductsbyIdSet(Collection<BigDecimal> productIdSet){
			...
			DetachedCriteria productType= productCriteria.createCriteria("pmtbProductType", DetachedCriteria.LEFT_JOIN);
			DetachedCriteria productStatusCriteria= productCriteria.createCriteria("pmtbProductStatuses","prod_status", DetachedCriteria.LEFT_JOIN);
...
//	
			...
			DetachedCriteria  secondLevelaccountCriteria=accountCriteria.createCriteria("amtbAccount", DetachedCriteria.LEFT_JOIN);
			//secondLevelaccountCriteria.createCriteria("amtbAcctStatuses", DetachedCriteria.LEFT_JOIN);
			DetachedCriteria  thirdLevelaccountCriteria=secondLevelaccountCriteria.createCriteria("amtbAccount", DetachedCriteria.LEFT_JOIN);
			//thirdLevelaccountCriteria.createCriteria("amtbAcctStatuses", DetachedCriteria.LEFT_JOIN);
			productCriteria.setResultTransformer(Criteria.DISTINCT_ROOT_ENTITY);
			List<PmtbProduct> results = this.findAllByCriteria(productCriteria);
			if(results.isEmpty()) return null;
			else return results;
		...
		public List<PmtbProduct> getProductsAssignCardbyIdSet(Collection<BigDecimal> productIdSet){
			...
			DetachedCriteria productType= productCriteria.createCriteria("pmtbProductType", DetachedCriteria.LEFT_JOIN);
			DetachedCriteria productStatusCriteria= productCriteria.createCriteria("pmtbProductStatuses","prod_status", DetachedCriteria.LEFT_JOIN);
			DetachedCriteria ittbCpCustCardIssuances = productCriteria.createCriteria("ittbCpCustCardIssuances", "ittb", DetachedCriteria.LEFT_JOIN);
	...
	public PmtbProduct getProduct(BigDecimal productId){
		logger.debug("Retriving Products by product search Criteria ");
		DetachedCriteria productCriteria = DetachedCriteria.forClass(PmtbProduct.class);
		DetachedCriteria amtbAccount = productCriteria.createCriteria("amtbAccount", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria amtbAccount2 = amtbAccount.createCriteria("amtbAccount", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria amtbAccount3 = amtbAccount2.createCriteria("amtbAccount", DetachedCriteria.LEFT_JOIN);
//		productCriteria.createCriteria("amtbAccount", DetachedCriteria.LEFT_JOIN);
		productCriteria.add(Restrictions.eq("productNo", productId));
		productCriteria.createCriteria("pmtbProductType", DetachedCriteria.LEFT_JOIN);
		List<PmtbProduct> results = this.findAllByCriteria(productCriteria);
		if(results.isEmpty()) return null;
		else return results.get(0);
		//return (List<PmtbProduct>)this.findAllByCriteria(productCriteria);
...
//		return  this.findAllByCriteria(productCriteria);
	...
	public List<PmtbProduct> getProductsCreditLimit (HashSet<BigDecimal> productIdSet){
		...
		DetachedCriteria productType= productCriteria.createCriteria("pmtbProductType", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria productStatus= productCriteria.createCriteria("pmtbProductStatuses", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria account= productCriteria.createCriteria("amtbAccount", DetachedCriteria.LEFT_JOIN);
		List<PmtbProduct> results = this.findAllByCriteria(productCriteria);
		if(results.isEmpty()) return null;
		else return results;
		//return (List<PmtbProduct>)this.findAllByCriteria(productCriteria);
	...
	public AmtbAcctStatus getAccountStatus(Integer accNo) {
		...
		DetachedCriteria accountCriteria= amtbAccountStatusCriteria.createCriteria("amtbAccount", DetachedCriteria.LEFT_JOIN);
	...
	public MstbAdminFeeDetail getAdminFee(Integer topAcctNo, Timestamp tripDt)
	{
		...
		try{
			...
			query.setParameter("topAcctNo", topAcctNo, Hibernate.INTEGER);
			query.setParameter("runDate", tripDt, Hibernate.DATE);
			list = query.list();
		}
		catch(Exception e){
			e.printStackTrace();
	...
	public List<PmtbProduct> getProductsWithStatus(AmtbAccount acct){
		...
		productCriteria.createCriteria("pmtbProductStatuses", DetachedCriteria.LEFT_JOIN);
		productCriteria.createCriteria("pmtbProductType", DetachedCriteria.LEFT_JOIN);
		productCriteria.setResultTransformer(Criteria.DISTINCT_ROOT_ENTITY);
		return this.findAllByCriteria(productCriteria);
	}
...
//			DetachedCriteria replaceCriteria = productCriteria.createCriteria("pmtbProductReplacements", DetachedCriteria.LEFT_JOIN);
//			if(replaceEnd!=null){
...
//			}
		...
		// renew
		if(renewStart!=null){
//			DetachedCriteria renewCriteria = productCriteria.createCriteria("pmtbProductRenews", DetachedCriteria.LEFT_JOIN);
//			if(renewEnd!=null){
...
//			}
		...
		DetachedCriteria acctCriteria = productCriteria.createCriteria("amtbAccount", DetachedCriteria.LEFT_JOIN);
...
//	
	...
	public List<PmtbProduct> getProducts(Collection<BigDecimal> productIds){
		...
		productCriteria
			.createCriteria("amtbAccount", DetachedCriteria.LEFT_JOIN)
			.createCriteria("amtbAcctStatuses", DetachedCriteria.LEFT_JOIN);
		productCriteria.setResultTransformer(DetachedCriteria.DISTINCT_ROOT_ENTITY);
		return this.findAllByCriteria(productCriteria);
	}
	...
	public List<Object[]> getNegativeExternalProduct(String cardNoStart, String cardNoEnd, PmtbProductType productType){
		...
		try{
			...
			query.setParameter("cardNoStart", cardNoStart, Hibernate.STRING);
			query.setParameter("cardNoEnd", cardNoEnd, Hibernate.STRING);
			query.setParameter("productTypeId", productType==null ? null : productType.getProductTypeId(), Hibernate.STRING);
	...
	public List<String> getProducts(String custNo, String cardHolderName) {
		...
		try{
			...
			query.setParameter("name", cardHolderName, Hibernate.STRING);
			return query.list();
		}
		catch(Exception e){
			e.printStackTrace();
	...
	public List<String> getDistinctNameOnCards(String custNo, String nameOnCard) {
		...
		try{
			...
			query.setParameter("custNo", custNo, Hibernate.STRING);
			query.setParameter("name", nameOnCard, Hibernate.STRING);
			return query.list();
		}
		catch(Exception e){
			e.printStackTrace();
	...
	public boolean hasFutureTermination(Collection<BigDecimal> productNos){
		...
		DetachedCriteria statusCriteria = productCriteria.createCriteria("pmtbProductStatuses", DetachedCriteria.LEFT_JOIN);
	...
	public boolean containPrepaidProducts(Set<BigDecimal> productIdSet){
		...
		DetachedCriteria dc = DetachedCriteria.forClass(PmtbProduct.class);
		DetachedCriteria typeDc = dc.createCriteria("pmtbProductType", DetachedCriteria.LEFT_JOIN);
	...
	public String getIndustry(AmtbAccount acct) {
		...
		DetachedCriteria corpCriteria = accountCriteria.createCriteria("amtbCorporateDetails", DetachedCriteria.LEFT_JOIN);
		corpCriteria.createCriteria("mstbMasterTableByIndustry", DetachedCriteria.LEFT_JOIN);
