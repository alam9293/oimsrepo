...
public class ReportDaoHibernate extends GenericDaoHibernate implements ReportDao {
	...
	public Map<String, String> getRevenueHeaderForMisc(){
		List<Object[]> results = this.getHibernateTemplate().findByNamedQueryAndNamedParam("revenueHeaderForMisc", new String[]{}, new String[]{});
	...
	public Map<String, Object[]> getRevenueProductTypeTripInfos(String invoiceHeaderNo, String invoiceStart, String invoiceEnd){
		...
		List<Object[]> results = this.getHibernateTemplate().findByNamedQueryAndNamedParam("revenueProductTypeTripInfos", paramNames, values);
	...
	public Map<String, Object[]> getRevenueProductTypePrepaidInfos(String invoiceHeaderNo, String invoiceStart, String invoiceEnd){
		String[] paramNames = new String[]{"invoiceHeaderNo", "invoiceStart", "invoiceEnd"};
		String[] values = new String[]{invoiceHeaderNo, invoiceStart, invoiceEnd};
		List<Object[]> results = this.getHibernateTemplate().findByNamedQueryAndNamedParam("revenueProductTypePrepaidInfos", paramNames, values);
...
//		List results = this.getHibernateTemplate().findByNamedQueryAndNamedParam("cashlessBankCollectionSummary", paramNames, values);
	...
	public List<ImtbItem> getUnredeemedVoucher(Date issuedDateFrom, Date issuedDateTo, Date expiryDateFrom,
		...
		DetachedCriteria issueReqCrit = issueCrit.createCriteria("imtbIssueReq",
				DetachedCriteria.LEFT_JOIN);
		DetachedCriteria account3Crit = issueReqCrit.createCriteria("amtbAccount", "acct3", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria account2Crit = account3Crit.createCriteria("amtbAccount", "acct2", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria account1Crit = account2Crit.createCriteria("amtbAccount", "acct1", DetachedCriteria.LEFT_JOIN);

		DetachedCriteria fmtbArCont1Crit = account1Crit.createCriteria("fmtbArContCodeMaster", "fmtbArCont1", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria fmtbEntity1Crit = fmtbArCont1Crit.createCriteria("fmtbEntityMaster", "fmtbEntity1", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria fmtbArCont2Crit = account2Crit.createCriteria("fmtbArContCodeMaster", "fmtbArCont2", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria fmtbEntity2Crit = fmtbArCont2Crit.createCriteria("fmtbEntityMaster", "fmtbEntity2", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria fmtbArCont3Crit = account3Crit.createCriteria("fmtbArContCodeMaster", "fmtbArCont3", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria fmtbEntity3Crit = fmtbArCont3Crit.createCriteria("fmtbEntityMaster", "fmtbEntity3", DetachedCriteria.LEFT_JOIN);
	...
	public List<ImtbItem> getRedeemedVoucher(BigDecimal serialNoStart, BigDecimal serialNoEnd,
		...
		DetachedCriteria itemIssue = itemCrit.createCriteria("imtbIssue", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria itemIssueReq = itemIssue.createCriteria("imtbIssueReq", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria amtbAccount = itemIssueReq.createCriteria("amtbAccount", "account", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria parentAccountCriteria = amtbAccount.createCriteria("amtbAccount", "parentAccount", DetachedCriteria.LEFT_JOIN);
		...
		DetachedCriteria fmtbArCont1Crit = amtbAccount.createCriteria("fmtbArContCodeMaster", "fmtbArCont1", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria fmtbEntity1Crit = fmtbArCont1Crit.createCriteria("fmtbEntityMaster", "fmtbEntity1", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria fmtbArCont2Crit = parentAccountCriteria.createCriteria("fmtbArContCodeMaster", "fmtbArCont2", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria fmtbEntity2Crit = fmtbArCont2Crit.createCriteria("fmtbEntityMaster", "fmtbEntity2", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria fmtbArCont3Crit = grandParentAccountCriteria.createCriteria("fmtbArContCodeMaster", "fmtbArCont3", DetachedCriteria.LEFT_JOIN);
		DetachedCriteria fmtbEntity3Crit = fmtbArCont3Crit.createCriteria("fmtbEntityMaster", "fmtbEntity3", DetachedCriteria.LEFT_JOIN);
