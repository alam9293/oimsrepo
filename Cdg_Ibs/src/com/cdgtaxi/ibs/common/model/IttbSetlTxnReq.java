...
/**
 * IttbSetlTxnReq generated by hbm2java
 */

public class IttbSetlTxnReq  implements java.io.Serializable, Creatable, Updatable {
    ...
    /** default constructor */
    public IttbSetlTxnReq() {
    }

	/** minimal constructor */
    public IttbSetlTxnReq(String status, Date requestDate) {
        this.status = status;
        this.requestDate = requestDate;
    }
    
    /** full constructor */
    public IttbSetlTxnReq(String status, Date requestDate, String createdBy, Timestamp createdDt, String updatedBy, Timestamp updatedDt, Integer version) {
        this.status = status;
        this.requestDate = requestDate;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof IttbSetlTxnReq) ) return false;
		 IttbSetlTxnReq castOther = ( IttbSetlTxnReq ) other; 
