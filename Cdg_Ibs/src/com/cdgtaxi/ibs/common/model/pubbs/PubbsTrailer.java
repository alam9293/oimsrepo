...
public class PubbsTrailer {
	public static final int expectedLength = 216;
	...
	public Field filler2 = new Field("filler2", Field.VARCHAR, 155);
	
	public PubbsTrailer(String rawStrData) throws FieldException {
...
//		System.out.println("filler2 > '"+rawStrData.substring(61, 216)+"'");
		...
		filler2.setData(rawStrData.substring(61, 216));
	}
...
//			PubbsTrailer test = new PubbsTrailer("TRL" + StringUtil.appendRight("RCTV", 15, " ") + StringUtil.appendRight("11", 9, " "));
			PubbsTrailer test = new PubbsTrailer("TRL"		//rowIdentifier
					+ "  "									//filler1
					...
					+ StringUtil.appendLeft(" ", 155, " "));	//Filler2
