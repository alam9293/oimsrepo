...
/**
 * IttbAsUpdBillProdReq generated by hbm2java
 */

public class IttbAsUpdBillProdReq  implements java.io.Serializable {
    ...
    /** default constructor */
    public IttbAsUpdBillProdReq() {
    }

	/** minimal constructor */
    public IttbAsUpdBillProdReq(IttbAsMasterReq ittbAsMasterReq) {
        this.ittbAsMasterReq = ittbAsMasterReq;
    }
    
    /** full constructor */
    public IttbAsUpdBillProdReq(String cardNo, String newCreditLimit, String totalTxnAmtBilled, String acctId, String updateBy, IttbAsMasterReq ittbAsMasterReq) {
        this.cardNo = cardNo;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof IttbAsUpdBillProdReq) ) return false;
		 IttbAsUpdBillProdReq castOther = ( IttbAsUpdBillProdReq ) other; 
