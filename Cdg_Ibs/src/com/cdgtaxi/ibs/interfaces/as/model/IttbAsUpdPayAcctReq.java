...
/**
 * IttbAsUpdPayAcctReq generated by hbm2java
 */

public class IttbAsUpdPayAcctReq  implements java.io.Serializable {
    ...
    /** default constructor */
    public IttbAsUpdPayAcctReq() {
    }

	/** minimal constructor */
    public IttbAsUpdPayAcctReq(IttbAsMasterReq ittbAsMasterReq) {
        this.ittbAsMasterReq = ittbAsMasterReq;
    }
    
    /** full constructor */
    public IttbAsUpdPayAcctReq(String acctId, String newCreditLimit, String parentId, String updateBy, IttbAsMasterReq ittbAsMasterReq) {
        this.acctId = acctId;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof IttbAsUpdPayAcctReq) ) return false;
		 IttbAsUpdPayAcctReq castOther = ( IttbAsUpdPayAcctReq ) other; 
