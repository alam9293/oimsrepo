...
public class CashlessAgingReportSummary extends ReportWindow implements CSVFormat {
	private static final long serialVersionUID = 1L;
	private static final Logger logger = Logger.getLogger(CashlessAgingReportSummary.class);
	public CashlessAgingReportSummary() throws IOException {
		super("Cashless Aging Report Summary", "Non Billable");
	}
	@Override
	...
	public StringBuffer generateCSVData(Properties reportParamsProperties) throws FormatNotSupportedException {
		...
		buffer.append("\n");
		buffer.append(Constants.TEXT_QUALIFIER+"Cashless Aging Report Summary"+Constants.TEXT_QUALIFIER+",");
		buffer.append("\n");
		...
		buffer.append("\n");
		//Data
		List<Object[]> results = this.businessHelper.getReportBusiness().getCashlessAgingReportSummary(
				agingDate,
				...
				entityNo, providerNo, acquirerNo
		);
