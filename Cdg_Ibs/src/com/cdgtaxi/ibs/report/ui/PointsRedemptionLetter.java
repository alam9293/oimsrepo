...
public class PointsRedemptionLetter extends ReportWindow{
	private static final long serialVersionUID = 1L;
	private static final Logger logger = Logger.getLogger(PointsRedemptionLetter.class);
	public PointsRedemptionLetter() throws IOException {
		super("Points Redemption Letter", "Rewards");
	}
	@Override
