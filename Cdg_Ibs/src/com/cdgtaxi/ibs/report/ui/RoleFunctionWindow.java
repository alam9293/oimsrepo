...
/**
 * This class is for Role Function (UAM) Report
 * 
 * @author vani
 * @version 28/10/2010
 *
...
public class RoleFunctionWindow extends ReportWindow {
	private static final long serialVersionUID = 1L;
	private static final Logger logger = Logger.getLogger(RoleFunctionWindow.class);
	public RoleFunctionWindow() throws IOException {
		super("RoleFunction", "UAM");		
	}
