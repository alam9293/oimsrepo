...
public class SuspensionReactivationVoucherWindow extends CommonWindow implements AfterCompose {

	private static final long serialVersionUID = 1L;
	private static final Logger logger = Logger.getLogger(SuspensionReactivationVoucherWindow.class);

	private String report = "Suspension Reactivation Voucher";
	...
	public SuspensionReactivationVoucherWindow() throws IOException {
		reportRsrcId = new Long(this.getHttpServletRequest().getParameter("rsrcId"));
		actionTypeMap.put(NonConfigurableConstants.INVENTORY_ITEM_STATUS_PENDING_REACTIVATION, "REACTIVATE");
		actionTypeMap.put(NonConfigurableConstants.INVENTORY_ITEM_STATUS_PENDING_SUSPENSION, "SUSPEND");
	}
	...
	public void afterCompose() {
		...
		actionTypeLB.appendChild(new Listitem(actionTypeMap.get(NonConfigurableConstants.INVENTORY_ITEM_STATUS_PENDING_SUSPENSION), NonConfigurableConstants.INVENTORY_ITEM_STATUS_PENDING_SUSPENSION));
		actionTypeLB.appendChild(new Listitem(actionTypeMap.get(NonConfigurableConstants.INVENTORY_ITEM_STATUS_PENDING_REACTIVATION), NonConfigurableConstants.INVENTORY_ITEM_STATUS_PENDING_REACTIVATION));
	...
	public void generate() throws HttpException, IOException, InterruptedException, NetException,
		...
		if (actionStartDate == null && actionEndDate == null && approvalStartDate == null
				&& approvalEndDate == null && serialNoStart == null && serialNoEnd == null)
			throw new WrongValueException(
					"Either Action Date Range or Approval Date Range or Voucher No Range is mandatory");
		...
		StringBuffer dataInCSV = this.generateCSVData(
				...
				approvalStatus, getUserLoginIdAndDomain(), entity);
		AMedia media = new AMedia(report.replaceAll(" ", "_") + "." + extension, extension, format,
				dataInCSV.toString());
		Filedownload.save(media);
	}

	private StringBuffer generateCSVData(String actionStartDate, String actionEndDate,
			String approvalStartDate, String approvalEndDate, String serialNoStart, String serialNoEnd,
			ImtbItemType itemType, String actionType, String approvalStatus, String printedBy, FmtbEntityMaster entity) {
		...
		sb.append(Constants.TEXT_QUALIFIER + "Integrated Billing System" + Constants.TEXT_QUALIFIER
				+ ",");
		sb.append("\n");
		sb.append(Constants.TEXT_QUALIFIER + "Suspension Reactivation Voucher"
		...
		sb.append(Constants.TEXT_QUALIFIER + "Issued Date" + Constants.TEXT_QUALIFIER + ",");
		...
		sb.append(Constants.TEXT_QUALIFIER + "Action Date" + Constants.TEXT_QUALIFIER + ",");
		sb.append(Constants.TEXT_QUALIFIER + "Action By" + Constants.TEXT_QUALIFIER + ",");
		...
		List<Object[]> rowsOfData = this.businessHelper.getReportBusiness()
				.suspensionReactivationVoucher(actionStartDate, actionEndDate, approvalStartDate,
						approvalEndDate, serialNoStart, serialNoEnd,
