...
public class TransactionSummaryWindow extends ReportWindow implements CSVFormat {
	private static final long serialVersionUID = 1L;
	private static final Logger logger = Logger.getLogger(TransactionSummaryWindow.class);
	public TransactionSummaryWindow() throws IOException {
		super("Transaction Summary", "Trips");
	}
