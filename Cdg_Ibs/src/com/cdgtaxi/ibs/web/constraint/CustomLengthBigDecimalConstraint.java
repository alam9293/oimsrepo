...
public class CustomLengthBigDecimalConstraint extends ZeroOrGreaterConstraint{
	 ...
	 * @param maxLength
	 */
	public CustomLengthBigDecimalConstraint(int maxLength){
		if(maxLength <=0)
	 ...
	 */
	public CustomLengthBigDecimalConstraint(String limit){
