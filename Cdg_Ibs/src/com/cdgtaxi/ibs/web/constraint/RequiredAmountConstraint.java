...
public class RequiredAmountConstraint extends RequiredConstraint implements Constraint{
	public void validate(Component arg0, Object arg1) throws WrongValueException {
		...
		if(amount.compareTo(new BigDecimal(99999999.99).setScale(2, BigDecimal.ROUND_HALF_UP))>0){
