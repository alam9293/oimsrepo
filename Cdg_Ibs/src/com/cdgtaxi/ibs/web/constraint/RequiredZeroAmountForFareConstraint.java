...
public class RequiredZeroAmountForFareConstraint extends RequiredConstraint implements Constraint{
	public void validate(Component arg0, Object arg1) throws WrongValueException {
		...
		if(amount.compareTo(new BigDecimal(10000))>0){
			throw new WrongValueException(arg0, "* Must be lesser or equal to 9999.99");
