...
public class ResourceDaoHibernate extends GenericDaoHibernate implements ResourceDao{
	protected ResourceDaoHibernate() {
		super();
	...
	public List retrieveMenu(Long parentRsrcId, List<String> grantedAuthorities){
		...
		DetachedCriteria roleCriteria = resourceCriteria.createCriteria("satbRoles", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		//		DetachedCriteria parentResourceCriteria = resourceCriteria.createCriteria("satbResource", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public List<SatbResource> get(Long parentRsrcId){
		DetachedCriteria resourceCriteria = DetachedCriteria.forClass(SatbResource.class);
		DetachedCriteria parentResourceCriteria = resourceCriteria.createCriteria("satbResource", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria childrenResourceCriteria1 = resourceCriteria.createCriteria("satbResources", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria childrenResourceCriteria2 = childrenResourceCriteria1.createCriteria("satbResources", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria childrenResourceCriteria3 = childrenResourceCriteria2.createCriteria("satbResources", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria childrenResourceCriteria4 = childrenResourceCriteria3.createCriteria("satbResources", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria childrenResourceCriteria5 = childrenResourceCriteria4.createCriteria("satbResources", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public SatbResource get(String rsrcName){
		DetachedCriteria resourceCriteria = DetachedCriteria.forClass(SatbResource.class);
		DetachedCriteria parentResourceCriteria = resourceCriteria.createCriteria("satbResource", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria childrenResourceCriteria = resourceCriteria.createCriteria("satbResources", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public List<SatbResource> getReportCategories(SatbRole role){
		...
		DetachedCriteria parentResourceCriteria = resourceCriteria.createCriteria("satbResource", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria childrenResourceCriteria = resourceCriteria.createCriteria("satbResources", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria roleCriteria = childrenResourceCriteria.createCriteria("satbRoles", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
