...
public class EditAdminFeePlanDetailWindow extends CommonWindow implements AfterCompose{
	private static final Logger logger = Logger.getLogger(EditAdminFeePlanDetailWindow.class);
	...
	public void updateDetail() throws InterruptedException {
		...
		try {
			businessHelper.getAdminBusiness().updateAdminFeePlanDetail(detail, getUserLoginIdAndDomain());
