...
public class EditProductDiscountPlanDetailWindow extends CommonWindow implements AfterCompose{
	private static final Logger logger = Logger.getLogger(EditProductDiscountPlanDetailWindow.class);
	...
	public EditProductDiscountPlanDetailWindow() {
	...
	public void afterCompose() {
		...
		discountDB.setValue(detail.getProductDiscount());
	...
	public void updateDetail() throws InterruptedException {
		...
		try {
			businessHelper.getAdminBusiness().updateProductDiscountPlanDetail(detail, getUserLoginIdAndDomain());
