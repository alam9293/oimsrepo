...
public class AccountDaoHibernate extends GenericDaoHibernate implements AccountDao{
	...
	public AmtbAccount getAccount(String accountNo){
		...
		DetachedCriteria parentAccountCriteria = accountCriteria.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN); //join division
		DetachedCriteria grandParentAccountCriteria = parentAccountCriteria.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN); //join corporation

		//Assuming pulled out account is corporation level
		DetachedCriteria childrenAccountCriteria = accountCriteria.createCriteria("amtbAccounts", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN); //join division
		DetachedCriteria grandChildrenAccountCriteria = childrenAccountCriteria.createCriteria("amtbAccounts", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN); //join dept
	...
	public List<IttbRecurringChargeTagAcct> getRecurringChargeTagAcct(String tokenId){
		...
		recurringCriteria.createCriteria("recurringChargeId", "rc", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		recurringCriteria.createCriteria("amtbAccount", "acct", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		recurringCriteria.createCriteria("acct.amtbAccount", "acct2", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		recurringCriteria.createCriteria("acct2.amtbAccount", "acct3", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
...
//		recurringCriteria.add(Restrictions.eq("to", rc.getAmtbAccount()));
		recurringCriteria.createCriteria("pmtbProduct","prod", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		recurringCriteria.createCriteria("prod.pmtbProductType","prodtype", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		recurringCriteria.createCriteria("recurringChargeId", "rc", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		recurringCriteria.add(Restrictions.eq("rc.tokenId", tokenId));
	...
	public List<IttbRecurringCharge> searchRC(ProductSearchCriteria productSearchCriteria){
		DetachedCriteria recurringCriteria = DetachedCriteria.forClass(IttbRecurringCharge.class);
		recurringCriteria.createCriteria("ittbRecurringChargeTagAcct","tagAcct", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		recurringCriteria.createCriteria("ittbRecurringChargeTagCard","tagCard", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		recurringCriteria.createCriteria("tagCard.pmtbProduct","prod", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		
		DetachedCriteria parentAccountCriteria2 = recurringCriteria.createCriteria("prod.amtbAccount", "acct1a", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		parentAccountCriteria2.createCriteria("amtbAccount", "acct2a", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		parentAccountCriteria2.createCriteria("acct2a.amtbAccount", "acct3a", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		
		DetachedCriteria parentAccountCriteria = recurringCriteria.createCriteria("tagAcct.amtbAccount","acct", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		parentAccountCriteria.createCriteria("amtbAccount", "acct2", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		parentAccountCriteria.createCriteria("acct2.amtbAccount", "acct3", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	
		
//		recurringCriteria.add(Restrictions.eq("to", rc.getAmtbAccount()));
	//	
	//	recurringCriteria.createCriteria("amtbAccount", "am", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public List<IttbRecurringCharge> searchRC2(ProductSearchCriteria productSearchCriteria){
		...
		recurringCriteria.createCriteria("ittbRecurringChargeTagCard","tagCard", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		recurringCriteria.createCriteria("tagCard.pmtbProduct","prod", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		recurringCriteria.createCriteria("tagAcct.amtbAccount","acct", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
//		recurringCriteria.add(Restrictions.eq("to", rc.getAmtbAccount()));
	//	
	//	recurringCriteria.createCriteria("amtbAccount", "am", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		if(!productSearchCriteria.getTokenId().isEmpty()) {
...
//			detachedCriteria.add(Restrictions.eq("accountCategory", type));
	...
	public AmtbAccount getAccountWithParentandContact(String accountNo){
		...
		DetachedCriteria accountMainContactCriteria = accountCriteria.createCriteria("amtbAcctMainContacts", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		accountMainContactCriteria.createCriteria("amtbContactPerson", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
//		accountMainContactCriteria.add(Restrictions.eq("comp_id.mainContactType", NonConfigurableConstants.MAIN_CONTACT_TYPE_SHIPPING));
		...
		//Assuming pulled out account is dept level
		DetachedCriteria parentAccountCriteria = accountCriteria.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN); //join division
		DetachedCriteria parentAcctMainContactCriteria = parentAccountCriteria.createCriteria("amtbAcctMainContacts", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		parentAcctMainContactCriteria.createCriteria("amtbContactPerson", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
//		parentAcctMainContactCriteria.add(Restrictions.eq("comp_id.mainContactType", NonConfigurableConstants.MAIN_CONTACT_TYPE_SHIPPING));
		...
		DetachedCriteria grandParentAccountCriteria = parentAccountCriteria.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN); //join corporation
		DetachedCriteria grandParentAcctMainContactCriteria = grandParentAccountCriteria.createCriteria("amtbAcctMainContacts", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		grandParentAcctMainContactCriteria.createCriteria("amtbContactPerson", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
//		grandParentAcctMainContactCriteria.add(Restrictions.eq("comp_id.mainContactType", NonConfigurableConstants.MAIN_CONTACT_TYPE_SHIPPING));
	...
	public List<AmtbAccount> getTopLevelAccountsWithEntity(String custNo,String name){
		...
		dc.createCriteria("fmtbArContCodeMaster", "ar", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		dc.createCriteria("ar.fmtbEntityMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public AmtbAccount getAccountInfo(String accNo){
		...
		if(accNo.trim().length()>0){
			...
			DetachedCriteria mainContactCriteria = accountCriteria.createCriteria("amtbAcctMainContacts", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
			mainContactCriteria.createCriteria("amtbContactPerson", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public List<AmtbAccount> getDivOrSubApplInfo(String accNo){
		...
		if(accNo.trim().length()>0){
			...
			DetachedCriteria parentAccountCriteria = divOrSubApplCriteria.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public List<AmtbAccount> getDivOrSubApplInfo2(String accNo){
		...
		if(accNo.trim().length()>0){
			...
			for(int i=0;i<accountNos.size();i+=1000){
				...
				accountCriteria
					.createCriteria("amtbAcctMainContacts", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
					.createCriteria("amtbContactPerson", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
				accountCriteria.createCriteria("amtbAcctType", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
				accountCriteria.createCriteria("amtbAcctStatuses", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
				DetachedCriteria arContCodeMasterCriteria = accountCriteria.createCriteria("fmtbArContCodeMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
				arContCodeMasterCriteria.createCriteria("fmtbEntityMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public List<AmtbAccount> getDepartmentInfoByDivisionAcctNo(String accNo){
		...
		if(accNo.trim().length()>0){
			DetachedCriteria parentAccountCriteria = divOrSubApplCriteria.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
			parentAccountCriteria.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
			parentAccountCriteria.add(Restrictions.eq("accountNo",new Integer(accNo)));
	...
	public List<AmtbAccount> getDepartmentInfo(String accNo){
		...
		DetachedCriteria dc = DetachedCriteria.forClass(AmtbAccount.class);
		if(accNo.trim().length()>0){
			DetachedCriteria parentDc = dc.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
			DetachedCriteria grandDc = parentDc.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
...
//		}
	...
	public List<AmtbAccount> getAccounts(String custNo, String parentCode, int level){
		...
		acctCriteria.createCriteria("amtbAcctStatuses", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public List<AmtbAccount> getAccounts(String custNo, String acctName, String acctCode, String contactPerson, String contactPersonTel, int level, String parentName){
		...
		if(custNo!=null && custNo.trim().length()!=0){
			...
			{
				accountCriteria.createCriteria("amtbAcctMainContacts", "main", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
				...
				contactCriteria.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN).add(Restrictions.eq("custNo", custNo));
				contactCriteria.createCriteria("amtbAcctMainContacts", "mainContacts", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public AmtbAccount retrieveAccount(String custNo){
		...
		if(accounts.isEmpty()){
			...
			if(account.getAmtbAcctType().getAcctTemplate().equals(NonConfigurableConstants.ACCOUNT_TEMPLATES_CORPORATE)){
				// if corporate
				accountCriteria.createCriteria("amtbCorporateDetails", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
			}else{
				// if personal
				accountCriteria.createCriteria("amtbPersonalDetails", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
			}
			// joining up with ar control code and entity
			{
				DetachedCriteria arCriteria = accountCriteria.createCriteria("fmtbArContCodeMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
				arCriteria.createCriteria("fmtbEntityMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
			}
			// joining up with sales person
			{
				DetachedCriteria acctSales = accountCriteria.createCriteria("amtbAcctSalespersons", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
				acctSales.createCriteria("mstbSalesperson", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
			}
			// joining up with product subscriptions
			{
				DetachedCriteria subscribeTo = accountCriteria.createCriteria("amtbSubscTos", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
				subscribeTo.createCriteria("comp_id.pmtbProductType", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
				subscribeTo.createCriteria("mstbProdDiscMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
				subscribeTo.createCriteria("lrtbRewardMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
				subscribeTo.createCriteria("mstbSubscFeeMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
				subscribeTo.createCriteria("mstbIssuanceFeeMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
			}
			...
			{
				DetachedCriteria creditLimit = accountCriteria.createCriteria("amtbAcctCredLimits", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
				creditLimit.createCriteria("satbUser", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
			}
			// joining up with business unit master
			{
				accountCriteria.createCriteria("mstbMasterTableByBusinessUnit", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
			}
	...
	public List<AmtbAccount> searchAccts(String custNo, String acctName, String acctCode, String contactPerson, String contactPersonTel, int level, String parentName, String acctStatus){
		...
		if(custNo!=null && custNo.trim().length()!=0){
			...
			DetachedCriteria lastAcctStatusCriteria = accountCriteria.createCriteria("amtbAcctStatuses", "last_status", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public List<AmtbContactPerson> getContacts(String custNo, String mainContactName, String mainContactEmail, String mainContactTel, String mainContactMobile){
		...
		DetachedCriteria contactCriteria = DetachedCriteria.forClass(AmtbContactPerson.class);
		contactCriteria.createCriteria("mstbMasterTableBySubContactSal", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		contactCriteria.createCriteria("mstbMasterTableByMainContactSal", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		contactCriteria.createCriteria("mstbMasterTableByMainContactRace", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		contactCriteria.createCriteria("mstbMasterTableBySubContactRace", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		
		contactCriteria.createCriteria("mstbMasterTableByAddressCountry", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		// joining up with account table.
		{
			DetachedCriteria acctCriteria = contactCriteria.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
			acctCriteria.add(Restrictions.eq("custNo", custNo));
		}
		// joining up with the main contact
		{
//			DetachedCriteria mainCriteria = contactCriteria.createCriteria("amtbAcctMainContacts", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
//			mainCriteria.createCriteria("comp_id.amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		}
	...
	public boolean createContact(AmtbContactPerson newContact, List<AmtbAcctMainContact> mainContacts, String userId){
		...
		for(AmtbAcctMainContact mainContact : mainContacts){
			AmtbAcctMainContact prevMainContact = (AmtbAcctMainContact)this.get(AmtbAcctMainContact.class, mainContact.getComp_id());
		...
		//Collection<AmtbAcctMainContact> collection = new ArrayList<AmtbAcctMainContact>(mainContacts);
		this.saveOrUpdateAll(mainContacts);
		return true;
	}
	@SuppressWarnings("unchecked")
	public AmtbContactPerson getContact(Integer contactPersonNo){
		...
		contactCriteria.createCriteria("mstbMasterTableByMainContactRace", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		contactCriteria.createCriteria("mstbMasterTableByAddressCountry", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		contactCriteria.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		contactCriteria.setResultTransformer(Criteria.DISTINCT_ROOT_ENTITY);
	...
	public boolean deleteContact(Integer contactPersonNo){
		...
		this.delete(this.get(AmtbContactPerson.class, contactPersonNo));
		return true;
	}
	public boolean isMainContact(Integer contactPersonNo){
		DetachedCriteria mainCriteria = DetachedCriteria.forClass(AmtbAcctMainContact.class);
		mainCriteria.createCriteria("amtbContactPerson", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.add(Restrictions.eq("contactPersonNo", contactPersonNo));
	...
	public boolean checkChildrenCreditLimit(String custNo, String code, BigDecimal creditLimit){
		...
		DetachedCriteria acctStatusCriteria = acctCriteria.createCriteria("amtbAcctStatuses", "acct_status", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public boolean createAccount(AmtbAccount newAcct, List<AmtbAcctMainContact> mainContacts, String userId){
		save(newAcct, userId);
		this.getHibernateTemplate().saveOrUpdate(mainContacts);
		return true;
	}
	@SuppressWarnings("unchecked")
	public AmtbAccount getAccount(String custNo, int level, String parentCode, String code) throws IllegalArgumentException{
		...
		if(custNo!=null && custNo.trim().length()!=0){
			...
			for(int i=0;i<level;i++){
				tempCriteria = tempCriteria.createCriteria("amtbAccount", org.hibernate.sql.JoinType.FULL_JOIN);
			...
			tempCriteria.add(Restrictions.eq("custNo", custNo));
			{
				DetachedCriteria mainContactCriteria = acctCriteria.createCriteria("amtbAcctMainContacts", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
				mainContactCriteria.createCriteria("amtbContactPerson", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
			}
			{
				DetachedCriteria subscribeCriteria = acctCriteria.createCriteria("amtbSubscTos", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
				subscribeCriteria.createCriteria("comp_id.pmtbProductType", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
				subscribeCriteria.createCriteria("mstbProdDiscMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
				subscribeCriteria.createCriteria("lrtbRewardMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
				subscribeCriteria.createCriteria("mstbSubscFeeMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
				subscribeCriteria.createCriteria("mstbIssuanceFeeMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
			}
			{
				DetachedCriteria arCtrlCriteria = acctCriteria.createCriteria("fmtbArContCodeMaster", org.hibernate.sql.JoinType.FULL_JOIN);
				arCtrlCriteria.createCriteria("fmtbEntityMaster", org.hibernate.sql.JoinType.FULL_JOIN);
			}
			//GIRO
			{
				//Default Payment Mode
				acctCriteria.createCriteria("mstbMasterTableByDefaultPaymentMode", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
				//Bank Master
				acctCriteria.createCriteria("mstbBankMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
			}
			// Govt eInvoice, Business Unit
			{
				acctCriteria.createCriteria("mstbMasterTableByBusinessUnit", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
			}
	...
	public AmtbAccount getAccount(Integer accountNo){
		...
		acctCriteria.createCriteria("amtbAcctType", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		acctCriteria.createCriteria("mstbMasterTableByInformationSource", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		acctCriteria.createCriteria("fmtbArContCodeMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		acctCriteria.createCriteria("amtbAcctMainContacts", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		acctCriteria.createCriteria("amtbContactPersons", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		acctCriteria.createCriteria("amtbSubscTos", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.createCriteria("comp_id.pmtbProductType", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		acctCriteria.createCriteria("amtbAccount", DetachedCriteria.FULL_JOIN);
	...
	public AmtbAccount getBillingDetails(String custNo){
		...
		acctCriteria.createCriteria("amtbAcctBillCycles", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		// joining up with volume discount
		acctCriteria.createCriteria("amtbAcctVolDiscs", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.createCriteria("mstbVolDiscMaster", DetachedCriteria.FULL_JOIN);
		// joining up with admin fees
		acctCriteria.createCriteria("amtbAcctAdminFees", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.createCriteria("mstbAdminFeeMaster", DetachedCriteria.FULL_JOIN);
		// joining up with credit term
		acctCriteria.createCriteria("amtbAcctCredTerms", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.createCriteria("mstbCreditTermMaster", DetachedCriteria.FULL_JOIN);
		// joining up with early payment
		acctCriteria.createCriteria("amtbAcctEarlyPymts", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.createCriteria("mstbEarlyPaymentMaster", DetachedCriteria.FULL_JOIN);
		// joining up with late payment
		acctCriteria.createCriteria("amtbAcctLatePymts", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.createCriteria("mstbLatePaymentMaster", DetachedCriteria.FULL_JOIN);
		// joining up with promotion
		acctCriteria.createCriteria("amtbAcctPromotions", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.createCriteria("mstbPromotion", DetachedCriteria.FULL_JOIN);
		// joining up with bank
		acctCriteria.createCriteria("mstbBankMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		// joining up with branch
		acctCriteria.createCriteria("mstbBranchMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
...
//		acctCriteria.addOrder(Order.asc("updatedDt"));
	...
	public AmtbAccount getBillingCycleHistoricalDetails(String custNo){
		...
		.createCriteria("mstbVolDiscMaster", DetachedCriteria.FULL_JOIN);
		// joining up with admin fees
		DetachedCriteria adminFee = acctCriteria.createCriteria("amtbAcctAdminFees", "amtbAcctAdminFees", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.createCriteria("mstbAdminFeeMaster", DetachedCriteria.FULL_JOIN);
		// joining up with bank
		acctCriteria.createCriteria("mstbBankMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		// joining up with branch
	...
	public AmtbAccount getCreditTermHistoricalDetails(String custNo){
		...
		// ensure only past billing details
		// joining up with credit term // take out for billing cycle ..
		DetachedCriteria creditTerms = acctCriteria.createCriteria("amtbAcctCredTerms", "amtbAcctCredTerms", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.createCriteria("mstbCreditTermMaster", DetachedCriteria.FULL_JOIN);
	...
	public AmtbAccount getEarlyPaymentHistoricalDetails(String custNo){
		...
		// ensure only past billing details
		// joining up with early payment
		DetachedCriteria earlyPymts = acctCriteria.createCriteria("amtbAcctEarlyPymts", "amtbAcctEarlyPymts", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.createCriteria("mstbEarlyPaymentMaster", DetachedCriteria.FULL_JOIN);
	...
	public AmtbAccount getLatePaymentHistoricalDetails(String custNo){
		...
		DetachedCriteria latePymts = acctCriteria.createCriteria("amtbAcctLatePymts", "amtbAcctLatePymts", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.createCriteria("mstbLatePaymentMaster", DetachedCriteria.FULL_JOIN);
	...
	public AmtbAccount getPromotionHistoricalDetails(String custNo){
		...
		// ensure only past billing details
		// joining up with promotion
		DetachedCriteria promotions = acctCriteria.createCriteria("amtbAcctPromotions", "amtbAcctPromotions", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.createCriteria("mstbPromotion", DetachedCriteria.FULL_JOIN);
	...
	public AmtbAccount getRewardsDetails(String custNo){
		DetachedCriteria acctCriteria = DetachedCriteria.forClass(AmtbAccount.class);
		acctCriteria.add(Restrictions.eq("custNo", custNo));
		acctCriteria.createCriteria("lrtbRewardAccounts", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.createCriteria("lrtbRewardTxns", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.createCriteria("lrtbRewardMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		List<AmtbAccount> accts = this.findAllByCriteria(acctCriteria);
		return accts.isEmpty() ? null : accts.get(0);
	}
	...
	public AmtbAccount getDepositDetails(String custNo){
		DetachedCriteria acctCriteria = DetachedCriteria.forClass(AmtbAccount.class);
		acctCriteria.add(Restrictions.eq("custNo", custNo));
		DetachedCriteria depositTxnCriteria = acctCriteria.createCriteria("bmtbInvoiceDepositTxns", "depositTxn", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		depositTxnCriteria.createCriteria("bmtbInvoiceHeader", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN).addOrder(Order.asc("invoiceNo"));
	...
	public List<AmtbAccount> getBilliableAccountOnlyTopLevel(String customerNo, String name){
		...
		accountCriteria.createCriteria("mstbMasterTableByDefaultPaymentMode", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public List<AmtbAccount> getPersAccounts(String parentCustNo, String acctName, String nric, String email){
		...
		if(parentCustNo!=null && parentCustNo.trim().length()!=0){
			DetachedCriteria parentCriteria = acctCriteria.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public void deleteAccount(Integer accountNo, String userId){
		...
		acctCriteria.add(Restrictions.eq("accountNo", accountNo));
		// joining 3 levels
		acctCriteria.createCriteria("amtbAccounts", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.createCriteria("amtbAccounts", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		acctCriteria.setResultTransformer(Criteria.DISTINCT_ROOT_ENTITY);
		List<AmtbAccount> accts = this.findAllByCriteria(acctCriteria);
		if(!accts.isEmpty()){
	...
	public boolean hasPendingBillingChangeRequest(String custNo){
		DetachedCriteria acctCriteria = DetachedCriteria.forClass(AmtbAccount.class);
		acctCriteria.add(Restrictions.eq("custNo", custNo));
		acctCriteria.createCriteria("amtbBillReqs", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.createCriteria("amtbBillReqFlows", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		List<AmtbAccount> accts = this.findAllByCriteria(acctCriteria);
		if(!accts.isEmpty()){
			AmtbAccount acct = accts.get(0);
	...
	public List<AmtbAccount> getChildrenAccountsWithStatuses(Integer parentNo){
		DetachedCriteria acctCriteria = DetachedCriteria.forClass(AmtbAccount.class);
		acctCriteria.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
	...
	public List<AmtbAcctStatus> getStatuses(Integer accountNo){
		...
		statusCriteria.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
	...
	public AmtbAccount getAccountWithCreditDetails(String custNo, int level, String parentCode, String code){
		...
		tempCriteria.add(Restrictions.eq("custNo", custNo));
		acctCriteria.createCriteria("amtbAcctCredLimits", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		acctCriteria.createCriteria("amtbCredRevReqs", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.createCriteria("amtbCredRevReqFlows", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		List<AmtbAccount> accts = this.findAllByCriteria(acctCriteria);
		if(!accts.isEmpty()){
			return accts.get(0);
		}else{
...
//		accountCriteria.add(Restrictions.in("accountCategory", new String[]{NonConfigurableConstants.ACCOUNT_CATEGORY_APPLICANT, NonConfigurableConstants.ACCOUNT_CATEGORY_CORPORATE}));
	...
	public List<AmtbBillReq> getPendingBillingRequests(){
		...
		DetachedCriteria flowCriteria = requestCriteria.createCriteria("amtbBillReqFlows", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public AmtbBillReq getBillingRequest(Integer requestId){
		...
		requestCriteria.createCriteria("amtbBillReqFlows", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN).createCriteria("satbUser", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		requestCriteria.createCriteria("amtbAcctBillCycleReqs", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		requestCriteria.createCriteria("amtbAcctVolDiscReqs", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		requestCriteria.createCriteria("amtbAcctCredTermReqs", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		requestCriteria.createCriteria("amtbAcctEarlyPymtReqs", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		requestCriteria.createCriteria("amtbAcctLatePymtReqs", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		requestCriteria.createCriteria("amtbAcctPromotionReqs", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN).createCriteria("amtbAcctPromotion", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria acctCriteria = requestCriteria.createCriteria("amtbAccount", DetachedCriteria.INNER_JOIN);
		acctCriteria.createCriteria("amtbAcctBillCycles", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		acctCriteria.createCriteria("amtbAcctVolDiscs", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN).createCriteria("mstbVolDiscMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		acctCriteria.createCriteria("amtbAcctAdminFees", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN).createCriteria("mstbAdminFeeMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		acctCriteria.createCriteria("amtbAcctCredTerms", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN).createCriteria("mstbCreditTermMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		acctCriteria.createCriteria("amtbAcctEarlyPymts", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN).createCriteria("mstbEarlyPaymentMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		acctCriteria.createCriteria("amtbAcctLatePymts", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN).createCriteria("mstbLatePaymentMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria  acctPromotionCriteria = acctCriteria.createCriteria("amtbAcctPromotions", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria promotionCriteria = acctPromotionCriteria.createCriteria("mstbPromotion", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		promotionCriteria.createCriteria("currentPromoDetail", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public List<AmtbCredRevReq> getPendingCreditReviewRequests(){
		...
		DetachedCriteria flowCriteria = requestCriteria.createCriteria("amtbCredRevReqFlows", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		flowCriteria.createCriteria("satbUser", DetachedCriteria.INNER_JOIN);
		flowCriteria.addOrder(Order.asc("flowDt"));
		requestCriteria.createCriteria("amtbAccount", DetachedCriteria.INNER_JOIN);
		requestCriteria.setResultTransformer(Criteria.DISTINCT_ROOT_ENTITY);
	...
	public AmtbCredRevReq getPendingCreditReviewRequest(Integer requestId){
		...
		requestCriteria.createCriteria("amtbCredRevReqFlows", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
	...
	public List<AmtbAcctCredLimit> getCreditLimits(Integer accountNo){
		...
		creditCriteria.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.add(Restrictions.eq("accountNo", accountNo));
	...
	public List<AmtbAcctCredLimit> getChildCreditLimits(Integer accountNo){
		DetachedCriteria creditCriteria = DetachedCriteria.forClass(AmtbAcctCredLimit.class);
		DetachedCriteria acctCriteria = creditCriteria.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		acctCriteria.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN).add(Restrictions.eq("accountNo", accountNo));
		return this.findAllByCriteria(creditCriteria);
	}
	@SuppressWarnings("unchecked")
	public List<AmtbAcctCredLimit> getChildChildCreditLimits(Integer accountNo){
		DetachedCriteria creditCriteria = DetachedCriteria.forClass(AmtbAcctCredLimit.class);
		DetachedCriteria acctCriteria = creditCriteria.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria acctacctCriteria = acctCriteria.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		acctacctCriteria.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN).add(Restrictions.eq("accountNo", accountNo));
		return this.findAllByCriteria(creditCriteria);
	}
	@SuppressWarnings("unchecked")
	public BigDecimal getActivePermCreditLimit(Integer accountNo){
		DetachedCriteria creditCriteria = DetachedCriteria.forClass(AmtbAcctCredLimit.class);
		creditCriteria.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN).add(Restrictions.eq("accountNo", accountNo));
	...
	public List<AmtbAcctCredTerm> getCreditTerms(Integer accountNo){
		...
		creditCriteria.createCriteria("mstbCreditTermMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		creditCriteria.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.add(Restrictions.eq("accountNo", accountNo));
		return this.findAllByCriteria(creditCriteria);
	}
	...
	public List<AmtbAccount> getAccountsBySalesperson(Integer salespersonNo, String industryCode){
		...
		if(industryCode!=null && industryCode.length()!=0){
			...
			acctCriteria.createCriteria("amtbCorporateDetails", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		...
		acctCriteria.createCriteria("amtbAcctSalespersons", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.add(Restrictions.isNull("effectiveDtTo"))
		.createCriteria("mstbSalesperson", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
	...
	public void transferAcct(Integer fromSalespersonNo, Integer toSalespersonNo, Date effectiveDate, Collection<Integer> accountNos, SatbUser user){
		...
		DetachedCriteria acctCriteria = DetachedCriteria.forClass(AmtbAccount.class)
		.add(Restrictions.in("accountNo", accountNos))
		.createCriteria("amtbAcctSalespersons", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.add(Restrictions.isNull("effectiveDtTo"));
		List<AmtbAccount> accounts = this.findAllByCriteria(acctCriteria);
	...
	public List<AmtbAcctSalespersonReq> getAllTransferAcctReqs(){
		...
		requestCriteria.createCriteria("mstbSalespersonByFromSalespersonNo", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		requestCriteria.createCriteria("mstbSalespersonByToSalespersonNo", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		requestCriteria.createCriteria("amtbAcctSalespersons", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		requestCriteria.setResultTransformer(Criteria.DISTINCT_ROOT_ENTITY);
	...
	public AmtbAcctSalespersonReq getTransferAcctReq(Integer requestNo){
		...
		requestCriteria.createCriteria("amtbAcctSalespersons", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		requestCriteria.createCriteria("satbUser", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		requestCriteria.setResultTransformer(Criteria.DISTINCT_ROOT_ENTITY);
	...
	public List<AmtbAcctStatus> getAccountStatus(Integer accountNo){
		...
		statusCriteria.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.add(Restrictions.eq("accountNo", accountNo));
		statusCriteria.createCriteria("satbUser", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		statusCriteria.createCriteria("mstbMasterTable", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public List<AmtbBillReq> getBillingRequest(String custNo){
		...
		requestCriteria.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.add(Restrictions.eq("custNo", custNo));
		requestCriteria.createCriteria("amtbBillReqFlows", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.createCriteria("satbUser", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		return this.findAllByCriteria(requestCriteria);
	}
	@SuppressWarnings("unchecked")
	public List<AmtbBillReq> getBillingRequest(String custNo, String acctName, Date from, Date to, String status, String requester){
		...
		DetachedCriteria acctCriteria = requestCriteria.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public AmtbCredRevReq getCreditReviewRequest(Integer requestNo){
		...
		.createCriteria("satbUser", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		requestCriteria.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.createCriteria("amtbAcctCredLimits", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
	...
	public AmtbCorporateDetail getCorporateDetail(String custNo){
		DetachedCriteria corpCriteria = DetachedCriteria.forClass(AmtbCorporateDetail.class);
		corpCriteria.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.add(Restrictions.eq("custNo", custNo));
	...
	public List<AmtbAccount> getAccounts(SearchByAccountForm form) {
		...
		.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		//DetachedCriteria statusCriteria = accountCriteria.createCriteria("amtbAcctStatuses", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public BigDecimal getLatestLatePaymentRate(AmtbAccount account, Date invoiceDate) {
		...
		try {
			this.getActiveDBTransaction();
			session = this.currentSession();
			Criteria latePaymentCriteria = session.createCriteria(AmtbAcctLatePymt.class);
			Criteria accountCriteria = latePaymentCriteria.createCriteria("amtbAccount", org.hibernate.sql.JoinType.INNER_JOIN);
			...
			Criteria latePaymentDetailCriteria = currentSession().createCriteria(MstbLatePaymentDetail.class);
	...
	public AmtbSubscTo getProductSubscription(String custNo, String productTypeId){
		...
		subscriptionCriteria.createCriteria("mstbProdDiscMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		subscriptionCriteria.createCriteria("lrtbRewardMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		subscriptionCriteria.createCriteria("mstbSubscFeeMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		subscriptionCriteria.createCriteria("mstbIssuanceFeeMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public boolean hasIssuedProducts(String custNo, String code, String parentCode, int level, List<String> productTypes){
		...
		DetachedCriteria tempCriteria = acctCriteria;
		for(int i=0;i<level;i++){
			tempCriteria = tempCriteria.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
			if(i==0 && parentCode!=null && parentCode.trim().length()!=0){
				tempCriteria.add(Restrictions.eq("code", parentCode));
			}
		}
		...
		DetachedCriteria productCriteria = acctCriteria.createCriteria("pmtbProducts", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		productCriteria
			.createCriteria("pmtbProductType", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
			.add(Restrictions.in("productTypeId", productTypes));
		List<PmtbProduct> products = (List<PmtbProduct>) getHibernateTemplate().findByCriteria(productCriteria, 0 ,1);
		if(products.isEmpty()){
...
//		return mains.isEmpty() ? null : mains.get(0).getAmtbContactPerson();
		DetachedCriteria acctCriteria = DetachedCriteria.forClass(AmtbAccount.class);
		acctCriteria.add(Restrictions.eq("custNo", custNo));
		DetachedCriteria mainCriteria = acctCriteria.createCriteria("amtbAcctMainContacts", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		mainCriteria.add(Restrictions.eq("comp_id.mainContactType", type));
		mainCriteria.createCriteria("amtbContactPerson", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		List<AmtbAccount> accts = this.findAllByCriteria(acctCriteria);
//		logger.info(accts.get(0).getAmtbAcctMainContacts().iterator().next().getAmtbContactPerson().getContactPersonNo());
	...
	public List<AmtbAccount> getBilliableAccountOnlyTopLevelWithEffectiveEntity(String customerNo, String name){
		...
		accountCriteria.createCriteria("amtbAcctType", DetachedCriteria.INNER_JOIN);
		accountCriteria.createCriteria("mstbMasterTableByDefaultPaymentMode", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria arContCodeMaster = accountCriteria.createCriteria("fmtbArContCodeMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria entity = arContCodeMaster.createCriteria("fmtbEntityMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		accountCriteria.setResultTransformer(DetachedCriteria.DISTINCT_ROOT_ENTITY);
	...
	public List<AmtbAccount> getAccountSubscribedToExternalCardWithContacts(String productTypeId){
		...
		.add(Restrictions.eq("comp_id.pmtbProductType.productTypeId", productTypeId));
		acctCriteria.createCriteria("amtbAcctStatuses", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria mainBillingContacts = acctCriteria.createCriteria("amtbAcctMainContacts", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public boolean checkPromotionOverlapping(String custNo, Integer promotionNo, Date fromDate, Date toDate){
		...
		try{
			...
			query.setParameter("promotionNo", promotionNo, StandardBasicTypes.INTEGER);
			query.setParameter("fromDate", fromDate, StandardBasicTypes.DATE);
			query.setParameter("toDate", toDate, StandardBasicTypes.DATE);
			results = query.list();
	...
	public List<AmtbAccount> getAccountsByMainContactPerson(String contactPersonNo, String contactPersonType){
		...
		DetachedCriteria acctCriteria = DetachedCriteria.forClass(AmtbAccount.class);
		DetachedCriteria mainContactCriteria = acctCriteria.createCriteria("amtbAcctMainContacts", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria contactCriteria = mainContactCriteria.createCriteria("amtbContactPerson", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public List<AmtbAccount> getChildAccountSubscribedToByTopLevelAccountNoAndProductTypeId(String custNo, String productTypeId){
		...
		DetachedCriteria subscToCrit = acctCrit.createCriteria("amtbSubscTos", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria acct2Crit = acctCrit.createCriteria("amtbAccount", "acct2", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		@SuppressWarnings("unused")
		DetachedCriteria acct3Crit = acct2Crit.createCriteria("amtbAccount", "acct3", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public List<AmtbContactPerson> getTransferContacts(String custNo, String contactPersonType) {
		...
		if (contactPersonType != null && contactPersonType.length() > 0) {
			DetachedCriteria mainContactCrit = contactPersonCrit.createCriteria(
					"amtbAcctMainContacts", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public AmtbSubscTo getSubscribeTo(AmtbAccount account, PmtbProductType productType, Date runDate){
		...
		//LEFT JOIN
		subscribeToCriteria.createCriteria("mstbProdDiscMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		subscribeToCriteria.createCriteria("lrtbRewardMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		subscribeToCriteria.createCriteria("mstbSubscFeeMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public List<AmtbAccount> getChargeToParentDivisionAccounts(AmtbAccount topAcct){
		...
		dc.createCriteria("amtbAcctStatuses", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		
		dc.createCriteria("acct.amtbAccount", "parentAcct", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public List<AmtbAccount> getChargeToParentDepartmentAccounts(AmtbAccount divAcct){
		...
		dc.createCriteria("acct.amtbAccount", "parentAcct", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		dc.createCriteria("parentAcct.amtbAccount", "grandParentAcct", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public AmtbAcctSalesperson getAccountMainSalesPerson(String custNo) {
		...
		DetachedCriteria acctCrit = amtbASCriteria.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public List<AmtbSubscProdReq> getAccountPendApproveSubscription(Integer acctNo, String productTypeId) {
		...
		DetachedCriteria acctCrit = subscProdReqCriteria.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria productCrit = subscProdReqCriteria.createCriteria("pmtbProductType", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
...
//			acctCriteria.add(Restrictions.ilike("accountName", acctName, MatchMode.ANYWHERE));
	...
	public void updateCniiAcctSyncProcedure(String account_id, String account_code, String account_name, String parent_id, Date terminate_dt, Date susp_dt_start, Date susp_dt_end, String updated_by) throws Exception
	{
		...
		try
		{
			...
			try
			{
				ps = connection.prepareStatement("begin esc_pkg_ibs_interface.sync_ps_account(?,?,?,?,?,?,?,?);end;");
