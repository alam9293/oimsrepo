...
public class BillGenRequestDaoHibernate extends GenericDaoHibernate implements BillGenRequestDao{
	public boolean checkRequestExist(List<BmtbBillGenSetup> billGenSetups, Date requestDate, Integer entityNo, Integer requestNo){
		...
		DetachedCriteria entityCriteria = billGenRequestCriteria.createCriteria("fmtbEntityMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public BmtbBillGenReq get(Integer billGenRequestNo){
		...
		billGenRequestCriteria.createCriteria("fmtbEntityMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public List<BmtbBillGenReq> get(Integer requestNo, String status, Integer setupNo, Date requestDateFrom, Date requestDateTo, Integer entityNo, String backward){
		...
		DetachedCriteria entityCriteria = billGenRequestCriteria.createCriteria("fmtbEntityMaster", "entity1", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria acctCriteria = billGenRequestCriteria.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria fmtbArContCodeCriteria = acctCriteria.createCriteria("fmtbArContCodeMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria acctEntityCriteria = fmtbArContCodeCriteria.createCriteria("fmtbEntityMaster", "entity2", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		
		DetachedCriteria temp1 = billGenRequestCriteria.createCriteria("bmtbBillGenReq", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria temp1EntityCriteria = temp1.createCriteria("fmtbEntityMaster", "entity3", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria temp1AcctCriteria = temp1.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria temp1FmtbArContCodeCriteria = temp1AcctCriteria.createCriteria("fmtbArContCodeMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria temp1AcctEntityCriteria = temp1FmtbArContCodeCriteria.createCriteria("fmtbEntityMaster",  "entity4", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		
		DetachedCriteria temp2 = temp1.createCriteria("bmtbBillGenReq", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria temp2EntityCriteria = temp2.createCriteria("fmtbEntityMaster",  "entity5", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria temp2AcctCriteria = temp2.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria temp2FmtbArContCodeCriteria = temp2AcctCriteria.createCriteria("fmtbArContCodeMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria temp2AcctEntityCriteria = temp2FmtbArContCodeCriteria.createCriteria("fmtbEntityMaster", "entity6", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		
		DetachedCriteria temp3 = temp2.createCriteria("bmtbBillGenReq", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria temp3EntityCriteria = temp3.createCriteria("fmtbEntityMaster",  "entity7", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria temp3AcctCriteria = temp3.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria temp3FmtbArContCodeCriteria = temp3AcctCriteria.createCriteria("fmtbArContCodeMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria temp3AcctEntityCriteria = temp3FmtbArContCodeCriteria.createCriteria("fmtbEntityMaster", "entity8", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		
		DetachedCriteria temp4 = temp3.createCriteria("bmtbBillGenReq", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria temp4EntityCriteria = temp4.createCriteria("fmtbEntityMaster",  "entity9", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria temp4AcctCriteria = temp4.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria temp4FmtbArContCodeCriteria = temp4AcctCriteria.createCriteria("fmtbArContCodeMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria temp4AcctEntityCriteria = temp4FmtbArContCodeCriteria.createCriteria("fmtbEntityMaster", "entity10", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		
		DetachedCriteria temp5 = temp4.createCriteria("bmtbBillGenReq", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria temp5EntityCriteria = temp5.createCriteria("fmtbEntityMaster",  "entity11", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria temp5AcctCriteria = temp5.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria temp5FmtbArContCodeCriteria = temp5AcctCriteria.createCriteria("fmtbArContCodeMaster", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria temp5AcctEntityCriteria = temp5FmtbArContCodeCriteria.createCriteria("fmtbEntityMaster",  "entity12", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		
		billGenRequestCriteria.createCriteria("bmtbBillGenSetupByRegenSetupNo", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public List<BmtbInvoiceHeader> getAllBmtbInvoicesForRecurring(AmtbAccount acct)
	{
		...
		DetachedCriteria invoiceDetailCrit = invoiceSummaryCrit.createCriteria("bmtbInvoiceDetails",
				org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
//		invoiceDetailCrit.createCriteria("bmtbInvoiceTxns", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
//		invoiceHeaderCriteria.createCriteria("bmtbBillGenReq", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
