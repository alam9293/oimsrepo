...
public class NoteDaoHibernate extends GenericDaoHibernate implements NoteDao {
	...
	public List searchNote(Long noteNo, String accountNo) {
		...
		DetachedCriteria noteDetailBillCriteria = noteCriteria.createCriteria("bmtbInvoiceDetailByBilledInvoiceDetailNo", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public List<BmtbNote> getNotes(Long invoiceHeaderNo) {
		DetachedCriteria noteCriteria = DetachedCriteria.forClass(BmtbNote.class);
		noteCriteria.createCriteria("bmtbInvoiceTxnByBilledInvoiceTxnNo", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.createCriteria("bmtbInvoiceDetail", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.createCriteria("bmtbInvoiceSummary", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.createCriteria("bmtbInvoiceHeader", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		noteCriteria.createCriteria("mstbMasterTableByReason", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		noteCriteria.createCriteria("mstbMasterTableByCancellationReason", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public List<BmtbNote> searchNote(SearchNoteForm form) {
		DetachedCriteria noteCriteria = DetachedCriteria.forClass(BmtbNote.class);
		DetachedCriteria invoiceCriteria = noteCriteria.createCriteria("bmtbInvoiceHeader", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		noteCriteria.createCriteria("bmtbInvoiceTxnByBilledInvoiceTxnNo", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.createCriteria("bmtbInvoiceDetail", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.createCriteria("bmtbInvoiceSummary", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.createCriteria("bmtbInvoiceHeader", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);

		DetachedCriteria accountCriteria = noteCriteria.createCriteria("amtbAccount", "account", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		// To link to parent
	...
	public BmtbNote getNote(Long noteNo) {
		DetachedCriteria noteCriteria = DetachedCriteria.forClass(BmtbNote.class);
		DetachedCriteria noteAccountCriteria = noteCriteria.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		noteCriteria.createCriteria("bmtbInvoiceTxnByBilledInvoiceTxnNo", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.createCriteria("bmtbInvoiceDetail", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.createCriteria("bmtbInvoiceSummary", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.createCriteria("bmtbInvoiceHeader", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		noteCriteria.createCriteria("fmtbTransactionCode", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		noteCriteria.createCriteria("mstbMasterTableByReason", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		noteCriteria.createCriteria("mstbMasterTableByCancellationReason", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);

		DetachedCriteria invoiceCriteria = noteCriteria.createCriteria("bmtbInvoiceHeader", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria invoiceAccountCriteria = invoiceCriteria.createCriteria("amtbAccountByAccountNo", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria billToAccountCriteria = invoiceCriteria.createCriteria("amtbAccountByDebtTo", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		// Get parent
	...
	public BmtbNote getNoteByAcquireTxn(int tmtbAcquireTxnNo) {
		DetachedCriteria noteCriteria = DetachedCriteria.forClass(BmtbNote.class);
		DetachedCriteria invoiceTxnCriteria = noteCriteria.createCriteria("bmtbInvoiceTxnByIssuedInvoiceTxnNo", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public List<BmtbNote> getPendingNotes(){
		...
		.createCriteria("bmtbInvoiceSummary", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
		.createCriteria("bmtbInvoiceHeader", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		invoiceCriteria.createCriteria("amtbAccountByAccountNo", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		invoiceCriteria.createCriteria("amtbAccountByDebtTo", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		
		//Join all parents
		noteCriteria.createCriteria("amtbAccount", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN)
