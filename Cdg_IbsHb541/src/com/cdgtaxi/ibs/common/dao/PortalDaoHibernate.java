...
public class PortalDaoHibernate extends GenericDaoHibernate implements PortalDao{
	...
	public List<IttbCpLogin> searchPortalUser(String userLoginId, String cardNo,
		...
		DetachedCriteria product = login.createCriteria("pmtbProduct", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria contactPerson = login.createCriteria("amtbContactPerson", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		
		DetachedCriteria account = product.createCriteria("amtbAccount", "acct", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
			DetachedCriteria masterLogTagAccount1a = account.createCriteria("ittbCpMasterTagAcct", "ittbCpMasterTagAcct1a", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
			DetachedCriteria masterLogAccount1a = masterLogTagAccount1a.createCriteria("masterLoginNo", "masterLoginNo1a", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria paccount = account.createCriteria("amtbAccount", "pacct", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
			DetachedCriteria masterLogTagAccount1b = paccount.createCriteria("ittbCpMasterTagAcct", "ittbCpMasterTagAcct1b", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
			DetachedCriteria masterLogAccount1b = masterLogTagAccount1b.createCriteria("masterLoginNo", "masterLoginNo1b", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria gpaccount = paccount.createCriteria("amtbAccount", "gpacct", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
			DetachedCriteria masterLogTagAccount1c = gpaccount.createCriteria("ittbCpMasterTagAcct", "ittbCpMasterTagAcct1c", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
			DetachedCriteria masterLogAccount1c = masterLogTagAccount1c.createCriteria("masterLoginNo", "masterLoginNo1c", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		
		DetachedCriteria account2 = contactPerson.createCriteria("amtbAccount", "acct2", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
			DetachedCriteria masterLogTagAccount2a = account2.createCriteria("ittbCpMasterTagAcct", "ittbCpMasterTagAcct2a", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
			DetachedCriteria masterLogAccount2a = masterLogTagAccount2a.createCriteria("masterLoginNo", "masterLoginNo2a", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria paccount2 = account2.createCriteria("amtbAccount", "pacct2", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
			DetachedCriteria masterLogTagAccount2b = paccount2.createCriteria("ittbCpMasterTagAcct", "ittbCpMasterTagAcct2b", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
			DetachedCriteria masterLogAccount2b = masterLogTagAccount2b.createCriteria("masterLoginNo", "masterLoginNo2b", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		DetachedCriteria gpaccount2 = paccount2.createCriteria("amtbAccount", "gpacct2", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
			DetachedCriteria masterLogTagAccount2c = gpaccount2.createCriteria("ittbCpMasterTagAcct", "ittbCpMasterTagAcct2c", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
			DetachedCriteria masterLogAccount2c = masterLogTagAccount2c.createCriteria("masterLoginNo", "masterLoginNo2c", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public IttbCpMasterLogin getCpMasterLogin(Integer masterLoginNo){
		DetachedCriteria requestCriteria = DetachedCriteria.forClass(IttbCpMasterLogin.class);
		DetachedCriteria TagCriteria = requestCriteria.createCriteria("ittbCpMasterTagAcct", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public IttbCpMasterTagAcct getMasterLoginTagAcct(Integer masterLoginNo, String acctName, Integer acctNo){
		...
		DetachedCriteria mlCriteria = requestCriteria.createCriteria("masterLoginNo", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
