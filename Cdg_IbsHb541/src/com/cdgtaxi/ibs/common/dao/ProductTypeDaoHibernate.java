...
public class ProductTypeDaoHibernate extends GenericDaoHibernate implements ProductTypeDao{
	...
	public List<PmtbProductType> getAllProductType() {
		...
		criteria.createCriteria("mstbMasterTableBySMSFormat", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		criteria.createCriteria("mstbMasterTableBySMSExpiryFormat", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		criteria.createCriteria("mstbMasterTableBySMSTopupFormat", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
	...
	public PmtbProductType getProductType(String productTypeId){
		...
		productTypeCriteria.createCriteria("mstbMasterTableBySMSFormat", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		productTypeCriteria.createCriteria("mstbMasterTableBySMSExpiryFormat", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
		productTypeCriteria.createCriteria("mstbMasterTableBySMSTopupFormat", org.hibernate.sql.JoinType.LEFT_OUTER_JOIN);
...
//		productTypeCriteria.add(disjunction);
	...
	public List<Integer> getAccountSubscribedToExternalProductType(String productTypeId){
		...
		try{
			...
			query.setParameter("productTypeId", productTypeId, StandardBasicTypes.STRING);
			results = query.list();
		}
		catch(Exception e){
			e.printStackTrace();
