...
public class CustomerUsageWindow extends ReportWindow implements CSVFormat {
	private static final long serialVersionUID = 1L;
	private static final Logger logger = Logger.getLogger(CustomerUsageWindow.class);
	public CustomerUsageWindow() throws IOException {
		super("Customer Usage", "Trips");
	}
	@Override
	...
	public StringBuffer generateCSVData(Properties reportParamsProperties) {
		...
		String productType = (String)reportParamsProperties.get("4. Product Type");
		...
		if(productType  !=null && productType.length() > 0){
			String productTypeStr = ((Listbox)this.getFellow("4. Product Type")).getSelectedItem().getLabel();
		...
		buffer.append(Constants.TEXT_QUALIFIER+"Month-Year"+Constants.TEXT_QUALIFIER+",");
		...
		//Data
		List<Object[]> results = this.businessHelper.getReportBusiness().getCustomerUsage(
				accountNo,
				accountName,
				invoiceStartMonth,
				invoiceEndMonth,
