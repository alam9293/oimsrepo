...
public class InventoryMovementReportSummary extends ReportWindow implements CSVFormat {
	private static final long serialVersionUID = 1L;
	private static final Logger logger = Logger.getLogger(InventoryMovementReportSummary.class);
	public InventoryMovementReportSummary() throws IOException {
		super("Inventory Movement Report Summary", "Inventory");
	}
	@Override
	public void generate() throws HttpException, IOException, InterruptedException, NetException {
		...
		if(format.equals(Constants.FORMAT_CSV)){
			this.generateCSVData(reportParamsProperties);
		}else{
			...
			if(format.equals(Constants.FORMAT_PDF)){
