...
public class StockTakeForInventoryItems extends ReportWindow{
	private static final long serialVersionUID = 1L;
	private static final Logger logger = Logger.getLogger(StockTakeForInventoryItems.class);
	public StockTakeForInventoryItems() throws IOException {
		super("Stock Take for Inventory Items", "Inventory");
	}
	@Override
