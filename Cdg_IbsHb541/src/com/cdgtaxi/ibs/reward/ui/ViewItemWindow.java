...
public class ViewItemWindow extends CommonWindow implements AfterCompose{
	private static final Logger logger = Logger.getLogger(ViewItemWindow.class);
	...
	public void afterCompose() {
		...
		Label itemNameTextLbl = (Label) getFellow("itemNameTextLbl");
		itemNameTextLbl.setValue(giftItem.getItemName());
		...
		Label itemPoints = (Label) getFellow("itemPoints");
		itemPoints.setValue(giftItem.getPoints().toString());
