			...
			<div class="row row-offcanvas row-offcanvas-left">
				...
				<div class="col-md-9 col-lg-10 mt-4 main mb-4">
					<div class="card card-block p-3">
						<div class="row">
							<div class="col-sm-5">
								<a href="./agendaNodedis" class="common-default-btn mt-3">Back</a>
							</div>
												...
												<c:forEach var="list" items="${evalObjList}"
													...
													<tr>
														...
														<td><input type="submit" value="View"
															...
															formaction="./viewPreparedAgendaDetailsDis?appliId=${list[0]}"
								...
								<form:form modelAttribute="PrepareAgendaNotesDis" method="post"
									...
									<div class="row mb-4">
										...
										<div class="col-sm-7 text-right">
											...
											<form:button class="common-btn mt-3">Submit For Approval</form:button>
										</div>
									</div>
