				...
				<div class="col-md-9 col-lg-10 mt-4 main mb-4">
					<div class="card card-block p-3">
						...
						<form:form modelAttribute="disViewEvaluate" method="post"
												...
												<c:forEach var="list" items="${evalObjList}"
													...
													<tr>
														...
														<td><input type="submit" value="View"
															...
															formaction="./dispalyAgendaNoteByMdPiCupDepartDis?applicantId=${list[0]}"
							...
							<div class="col-sm-12">
								<hr class="mt-2">
								<c:import url="/WEB-INF/jsp/Disbursement/commonEvaluateApplicationDis.jsp">
								</c:import>
							</div>
						</div>	
...
<div class="row">
  <div class="col-sm-12">
    <div class="form-group">
      <label>Note</label>
      <textarea class="form-control" disabled="disabled" rows="5">${disprepAgendaNotes}</textarea>
    </div>
  </div>
  <div class="col-sm-12 mt-3">
    <div class="form-group">
      <label>Nodal Agency and IIDD Recommendation</label>
      <textarea class="form-control" disabled="disabled" rows="5">${nodalAgencyNm}</textarea>
    </div>
  </div>
   
</div>
<form:form modelAttribute="PrepareAgendaNotesDis" method="post"
							action="disApprovedAgendaNoteJmd" class="mt-4"
							autocomplete="off" enctype="multipart/form-data">
							<hr class="mt-2">
							...
							<div class="row mb-4">
								...
								<%-- <div class="col-sm-7 text-right">
									...
									<form:button 
										class="common-btn mt-3">Submit For Approval</form:button>
								</div> --%>
							</div>
