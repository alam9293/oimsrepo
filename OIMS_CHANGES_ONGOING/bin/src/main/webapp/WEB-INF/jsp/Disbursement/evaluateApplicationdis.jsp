					...
					<div class="card card-block p-3">
						...
						<form:form modelAttribute="disViewEvaluate" method="post"
												...
												<c:forEach var="list" items="${evalObjList}"
													...
													<tr>
														<td><input type="text" class="form-control"
															readonly="true" c:out value="${list[0]}" /></td>
														<td><input type="text" class="form-control"
															readonly="true" c:out value="${list[1]}" /></td>
														<%-- <td><c:out value="${natureOfProject}" /></td> --%>
														<td><input type="text" class="form-control"
															readonly="true" c:out value="${products}" /></td>
														<td><input type="text" class="form-control"
															readonly="true" c:out value="${list[2]}" /></td>
														<td><input type="text" class="form-control"
															readonly="true" c:out value="${list[3]}" /></td>
														<td><input type="text" class="form-control"
															readonly="true" c:out value="${list[4]}" /></td>
														<td><input type="text" class="form-control"
															readonly="true" c:out value="${list[5]}" /></td>
														<td><input type="text" class="form-control"
															readonly="true" fmt:formatDate value="${locDate}"
							...
							<div class="table-responsive">
								<table class="table table-bordered auto-index">
									...
									<tbody>
										<tr class="ISF_Claim_Reim-row">
											<td></td>
											<td>${incentsgst}</td>
											<td style="width: 40%"><form:input type="text"
													path="table1remark1" value="" name="table2remark1"
													class="form-control alert alert-secondary border-info" /></td>
										</tr>
										<tr class="ISF_Stamp_Duty_EX-row">
											<td></td>
											<td>${incetstamp}</td>
											<td style="width: 40%"><form:input type="text"
													path="table1remark2" value="" name="table2remark2"
													class="form-control alert alert-secondary border-info" /></td>
										</tr>
										<tr class="ISF_Epf_Reim_UW-row">
											...
											<td>${incentepf}</td>
											<td style="width: 40%"><form:input type="text"
													path="table1remark3" value="" name="table2remark2"
													class="form-control alert alert-secondary border-info" /></td>
										</tr>
										<tr class="ISF_Infra_Int_Subsidy-row">
											...
											<td>${incentis}</td>
											<td style="width: 40%"><form:input type="text"
													path="table1remark4" value="" name="table2remark4"
													class="form-control alert alert-secondary border-info" /></td>
										</tr>
										<tr class="ISF_EX_E_Duty-row">
											...
											<td>${incentoth}</td>
											<td style="width: 40%"><form:input type="text"
													path="table1remark5" value="" name="table2remark5"
													class="form-control alert alert-secondary border-info" /></td>
										</tr>
										<tr class="ISF_Cis-row">
											...
											<td>${incentcap}</td>
											<td style="width: 40%"><form:input type="text"
													path="table1remark6" value="" name="table2remark"
													class="form-control alert alert-secondary border-info" /></td>
										</tr>
								...
								<!-- <div class="mt-4">
									<b>Eligibility of Incentives and date of admissibility</b>
								</div>
								<div class="text-center">
									<h4 class="h2">Table- 2</h4>
								</div> -->
								<!-- <div class="row mt-3">
									<div class="col-sm-12">
										<div class="table-responsive">
											<table class="table table-bordered">
												<thead>
													<tr>
														<th>Particulars</th>
														<th></th>
														<th>Approved vide Order/GO Ref.............. <br>
															Dated..............
														</th>
												...
												<tbody>
													...
													<tr>
														<td>Total eligibility of incentives during the
															eligible<br> period (5 years or 10 years)<br>
															(80%/90%/100%/200%/300% of fixed capital<br>

															investment as per category/region)
														</td>
														<td><input type="text"
															placeholder="Enter Value in INR" class="form-control"></td>
								...
								<!-- <div class="mt-5">
									<b>Incentive already disbursed (inclusive of benefits
										availed in the form of exemption)</b>
								</div> -->
								<!-- <div class="text-center">
									<h4 class="h2">Table-3</h4>
								</div> -->
								<!-- <div class="row mt-3">
									<div class="col-sm-12">
										<div class="table-responsive">
											<table class="table table-bordered" id="BreakUpTable3-mak-a">
												<thead>
													<tr>
														<th>GO No. &amp; Date</th>
														<th>Period</th>
												...
												<tbody class="add-from-here3-mak-a">
												...
												<tfoot>
													...
													<tr>
														<td colspan="7">
															<button type="button"
																class="btn btn-outline-success add-row-break-up-new-mak-a">
								...
								<div class="parameter-properties" id="viewAllApplicationDetails">
									<hr class="mt-2">
									<h4 class="h2">Proposal for Disbursement of Incentives</h4>
									<p>In compliance of Letter of Comfort dated DD-MM-YYYY, the
										company has submitted the application for
										disbursement/reimbursement of incentives, as per details given
										below:</p>
									<h4 class="h2 text-center">Table-4</h4>
									<p class="text-center font-italic text-secondary">(Cells
										marked in Grey in this table needs to be filled by PICUP,
										other than that all the data will be fetched from applications
										for LoC and Disbursement)</p>
										...
										<div class="row">
											<div class="col-sm-12">
												<div class="table-responsive">
													...
													<div class="isf-form mt-4">
														<h4 class="card-title mb-4 mt-4">Status of compliance
															of eligibility criteria for disbursement</h4>
														<hr class="mt-2">
														<div class="row">
															<div class="col-md-12">
													...
													<table class="table table-bordered">
														<thead>
															...
															<tr>
																...
																<th style="width: 20%;">Eligibility Criteria</th>
																<th style="width: 48%;">Compliance</th>
														...
														<tbody>
															<tr>
																<td>1.</td>
																<td><label class="table-heading">Name of
																		Company</label></td>
																<td><form:input path="companyName" type="text"
																		class="form-control" id=""
																		value="${businessEntityName}" readonly="true" name="" /></td>
																<td><form:textarea path="table2remark1" rows="3"
																		value="" name="table2remark1" class="form-control" /></td>
															</tr>
															<tr>
																<td>2.</td>
																<td><label class="table-heading">Address of
																		Registered Office of the Company</label></td>
																<td><form:input type="text" path="addOfOfficeCompl"
																		class="form-control" id="" value="${businessAddress}"
																		readonly="true" name="" /></td>
																<td><form:textarea path="table2remark2" rows="3"
																		value="" name="table2remark2" class="form-control" />
																</td>
															</tr>
															<tr>
																<td>3.</td>
																<td><label class="table-heading">Address of
																		the Industrial Unit</label></td>
																<td><form:input type="text"
																		path="addOfFactoryCompl" class="form-control" id=""
																		value="${fullAddress}" readonly="true" name="" /></td>
																<td><form:textarea path="table2remark3" rows="3"
																		value="" name="table2remark3" class="form-control" />
																</td>
															</tr>
															<tr>
																<td>4.</td>
																<td><label class="table-heading">Date of
																		filing IEM with DPIIT, GoI</label></td>
																<td><input type="text" class="form-control" id=""
																	value="${evaluateInvestMentDetails.invIemNumber}"
																	disabled="" name=""></td>
																<td><form:textarea path="table2remark4" rows="3"
																		value="" name="table2remark4" class="form-control" />
																</td>
															</tr>
															<tr>
																<td>5.</td>
																...
																<td><input type="text" class="form-control" id=""
																	value="${businessEntityType}" disabled="" name=""></td>
																<td><form:textarea path="table2remark5" rows="3"
																		value="" name="table2remark5" class="form-control" />
																</td>
															</tr>
															<tr>
																<td>6.</td>
																<td><label class="table-heading">Cut-off
																		Date opted (at application for LOC stage)</label></td>
																<td><input type="text" class="form-control" id=""
																	value="${opt}" disabled="" name=""></td>

																<td><form:textarea path="table2remark6" rows="3"
																		value="" name="table2remark6" class="form-control" />
																</td>

															</tr>
															<tr>
																<td>7.</td>
																<td><label class="table-heading">Actual
																		date of commencement of investment in project</label></td>
																<td><form:input path="actaulDate7" type="date"
																		class="form-control" id="" value="" name="actaulDate7" /></td>

																<td><form:textarea path="table2remark7" rows="3"
																		value="" name="table2remark7" class="form-control" />
																</td>
															...
															<tr>
																...
																<td><label class="table-heading">Whether
																		applicant has requested for change in cut off date</label></td>
																<td><form:input path="cutofDate8" type="date"
																		class="form-control" id="" value="" name="cutofDate8" /></td>

																<td><form:textarea path="table2remark8" rows="3"
																		value="" name="table2remark8" class="form-control" />
																</td>
															...
															<tr>
																<td>9.</td>
																<td><label class="table-heading">Nodal
																		Agency observations on cut off date.</label></td>
																<td><form:input path="nodalCutofDate9" type="date"
																		class="form-control" id="" value=""
																		name="nodalCutofDate9" /></td>

																<td><form:textarea path="table2remark9" rows="3"
																		value="" name="table2remark9" class="form-control" />
																</td>
															...
															<tr>
																...
																<td><input type="text" class="form-control" id=""
																	value="${proposedate}" disabled="" name=""></td>

																<td><form:textarea path="table2remark10" rows="3"
																		value="" name="table2remark10" class="form-control" />
																</td>
															...
															<tr>
																...
																<td><input type="text" class="form-control" id=""
																	value="${natureOfProject}" disabled="" name=""></td>
																<td><form:textarea path="table2remark11" rows="3"
																		value="" name="table2remark11" class="form-control" />
																</td>
															</tr>
																...
																<tr>
																	...
																	<td>
																		<table class="table">
																			...
																			<c:forEach var="pnlist" items="${newproduct}"
																				varStatus="counter">
																				<tr>
																					<td>${pnlist.newPropProducts}</td>
																					<td>${pnlist.newPropInstallCapacity}</td>
																				</tr>
																			</c:forEach>
																		</table>
																	</td>
																	<td><form:textarea path="table2remark11A" rows="3"
																			value="" name="table2remark11A" class="form-control" />
																	</td>
																</tr>
															</c:if>
															<c:if test="${natureOfProject=='Expansion'}">
																<tr>
																	<td>11.B</td>
																	<td><label class="table-heading">In case
																			of Expansion: i. Existing installed capacity
																			(product-wise) ii. Installed capacity after expansion
																			(product- wise) </label></td>
																	<td>
																		<table class="table">
																			<tr>
																				<td>Product Name</td>
																			...
																			<c:forEach var="list" items="${existProductsList1}"
																				varStatus="counter">
																				<tr>
																					<td><input type="text" class="form-control"
																						readonly="true" c:out
																						value="${list.epdExisProducts}" /></td>
																					<td><input type="text" class="form-control"
																						readonly="true" c:out
																						value="${list.epdExisInstallCapacity}" /></td>
																					<td><input type="text" class="form-control"
																						readonly="true" c:out
																						value="${list.epdPropInstallCapacity}" /></td>
																				</tr>
																			</c:forEach>
																		</table>
																	</td>
																	<td><form:textarea path="table2remark11B" rows="3"
																			value="" name="table2remark11B" class="form-control" />
																	</td>
																</tr>
															</c:if>
															<c:if test="${natureOfProject=='Expansion'}">
																<tr>
																	<td>11.C</td>
																	<td><label class="table-heading">In case
																			of expansion/diversification (Amount in INR) </label></td>
																	<td>
																		<table class="table">
																			<tr>
																				<td>Existing Gross Block</td>
																				<td>Actual New Eligible Capital Investment made
																				</td>
																				<td>Percentage increase over existing gross
																					block</td>
																			</tr>
																			<c:forEach var="list" items="${existProductsList1}"
																				varStatus="counter">
																				<tr>
																					...
																					<td><form:input path="expEligbleCapInv"
																							value="${list.expEligbleCapInv}" type="text"
																							class="form-control" /></td>
																					<td><form:input path="expPercOverGrsBlck"
																							value="${list.expPercOverGrsBlck}" type="text"
																							class="form-control" /></td>
																				</tr>
																			</c:forEach>
																		</table>
																	</td>
																	<td><form:textarea path="table2remark11C" rows="3"
																			value="" name="table2remark11C" class="form-control" />
																	</td>
																</tr>
															</c:if>
															<tr>
																<td>12.</td>
																<td><label class="table-heading">Whether
																		product is being set up in phases?</label></td>
																<td><input type="text" class="form-control"
																	value="${pwinfo}" disabled=""></td>
																<td><form:textarea path="table2remark12" rows="3"
																		value="" name="table2remark12" class="form-control" />
																</td>
															</tr>
															<tr>
																<td>13.</td>
																<td><label class="table-heading">Phase-wise
																		scheduled production dates and actual date of coming
																		into production</label></td>
																<td>
																	<table class="table">
																		<thead>
																			<tr>
																				<th colspan="3" class="text-center">Date of
																					Production</th>
																			</tr>
																			<tr>
																				<th>Phase</th>
																		...
																		<tbody>
																			<c:forEach var="list"
																				items="${dept_PhaseWiseInvestmentDetails}"
																				varStatus="counter">
																				
																				<tr>
																					<td><form:input path=""
																							value="${list.pwPhaseNo}" class="form-control"
																							disabled="true" /></td>
																					<td><form:input path=""
																							value="${list.pwPropProductDate}" type="date"
																							disabled="true" class="form-control" /></td>
																					<td><form:input path="phwActualdateEval"
																							value="${list.phwActualdateEval}" type="date"
																							class="form-control" /></td>
																				</tr>
																...
																<td><form:textarea path="table2remark13" rows="3"
																		value="" name="table2remark13" class="form-control" />
																</td>
															</tr>
															<tr>
																<td>14.</td>
																<td><label class="table-heading">GSTN No.
																		of the Industrial Unit/Firm/ Company</label></td>
																<td><input type="text" class="form-control"
																	value="${gstin}" disabled=""></td>
																<td><form:textarea path="table2remark14" rows="3"
																		value="" name="table2remark14" class="form-control" />
																</td>
															</tr>
															<tr>
																<td>15.</td>
																<td><label class="table-heading">PAN No. of
																		the Industrial Unit/Firm/Company</label></td>
																<td><input type="text" class="form-control"
																	value="${pan}" disabled=""></td>
																<td><form:textarea path="table2remark15" rows="3"
																		value="" name="table2remark15" class="form-control" />
																</td>
															</tr>
															<tr>
																<td>16.</td>
																<td><label class="table-heading">Name of
																		all the owners/partners/ directors of the industrial
																		unit/firm/ company alongwith DIN Nos., PAN Nos.
																		Contact Mobile/ Telephone No.</label></td>
																<td>
																	<table class="table">
																		<tbody>
																		<thead>
																		...
																		<c:forEach var="list" items="${propriter}"
																			varStatus="counter">
																			<tr>
																				<td><input type="text" class="form-control" readonly="true" value="${list.directorName}"></td>
																				<td><input type="text" class="form-control" readonly="true" value="${list.designation}"></td>
																				<td><input type="text" class="form-control" readonly="true" value="${list.din}"></td>
																				<td><input type="text" class="form-control" readonly="true" value="${list.panCardNo}"></td>
																				<td><input type="text" class="form-control" readonly="true" value="${list.mobileNo}"></td>
																			</tr>
																		</c:forEach>
																...
																<td><form:textarea path="table2remark16" rows="3"
																		value="" name="table2remark16" class="form-control" />
																</td>
															</tr>
															<tr>
																<td>17.</td>
																<td><label class="table-heading">Particulars
																		of the Technical arrangement for smooth running of the
																		industrial unit</label></td>
																<td><form:textarea path="indusUnit17" value=""
																		rows="3" name="indusUnit17" class="form-control" /></td>
																<td><form:textarea path="table2remark17" rows="3"
																		value="" name="table2remark17" class="form-control" />
																</td>
															</tr>
															<tr>
																<td>18.</td>
																<td><label class="table-heading">Name of
																		financial institutions/banks from which loan availed *</label></td>
																<td><table
																		class="table table-stripped table-bordered"
																		id="BreakUpTable3-mak-b">
																		...
																		<thead>
																			<tr>
																				...
																				<th>Amount (Rs. in crore)</th>
																			</tr>
																		</thead>
																		<tbody class="add-from-here3-mak-b">
																			<c:choose>
																				<c:when
																					test="${not empty disEvaluateBankDetailsList}">
																					<c:forEach var="list"
																						items="${disEvaluateBankDetailsList}"
																						varStatus="counter">
																						<tr>
																							<td><form:input path="loanBankName"
																									type="text" value="${list.loanBankName}"
																									class="form-control" /></td>
																							<td><form:input path="loanBankDate"
																									type="date" value="${list.loanBankDate}"
																									class="form-control" /></td>
																							<td><form:input path="loanBankROI"
																									value="${list.loanBankROI}" type="text"
																									class="form-control" /></td>
																							<td><form:input path="loanBankAmt"
																									value="${list.loanBankAmt}" type="text"
																									class="form-control bankloanAmt" /></td>
																						</tr>
																					</c:forEach>
																				</c:when>
																				<c:otherwise>
																					<tr>
																						<td><form:input path="loanBankName"
																								...
																								name="loanBankName" /></td>
																						<td><form:input path="loanBankDate"
																								type="date" value="" class="form-control"
																								name="loanBankDate" /></td>
																						<td><form:input path="loanBankAmt" value=""
																								type="text" class="form-control bankloanAmt"
																								name="loanBankAmt" /></td>
																					</tr>
																				</c:otherwise>
																			</c:choose>
																		...
																		<tfoot>
																			<tr>
																				...
																				<td><input type="text" readonly="readonly"
																					value="" class="form-control bankloanAmtTotal"
																					name=""></td>
																			...
																			<tr>
																				<td colspan="3">
																					<button type="button"
																						class="btn btn-outline-success add-row-break-up-new-mak-b">
																						<i class="fa fa-plus"></i> Add More Items
																					</button>
																				</td>
																			</tr>
																...
																<td><form:textarea path="table2remark18" rows="3"
																		value="" name="table2remark18" class="form-control" />
																</td>
															</tr>
															<tr>
																<td>19.</td>
																<td><label class="table-heading">Amount of
																		loan sanctioned on investment in Plant & Machinery</label></td>
																<td><input type="text" class="form-control"
																	placeholder="${plantnmachine}"></td>
																<td><form:textarea path="table2remark19" rows="3"
																		value="" name="table2remark19" class="form-control" />
																</td>
															</tr>
															<%-- <tr>
																<td>20.</td>
																<td><label class="table-heading">Rate of
																		Interest (%)</label></td>
																<td><input type="text" class="form-control"
																	placeholder="Enter Rate of Interest (%) "
																	value="${roi}" readonly="true"></td>
																<td><form:textarea path="table2remark20" rows="3"
																		value="" name="table2remark20" class="form-control" />
																</td>
															</tr> --%>
															<%-- <tr>
																<td>20.</td>
																<td><label class="table-heading">Date of
																		sanction</label></td>
																<td><form:input type="text" path="sactiondate"
																		class="form-control"
																		placeholder="Enter Date in DD-MM-YYYY" /></td>
																<td><form:textarea path="table2remark21" rows="3"
																		value="" name="table2remark21" class="form-control" />
																</td>
															</tr> --%>
															<tr>
																<td>21.</td>
																<td><label class="table-heading">Amount of
																		Loan Disbursed towards investment in Plant & Machinery
																		with dates of disbursement</label></td>
																<td>
																	<table class="table">
																		<thead>
																			<tr>
																		...
																		<tbody class="add-from-here3-mak-c">
																		<c:choose>
																				<c:when
																					test="${not empty disEvaluatePandMBankDetailsList}">
																					<c:forEach var="list"
																						items="${disEvaluatePandMBankDetailsList}"
																						varStatus="counter">
																			<tr>
																						<td><form:input path="pandMBankName"
																								type="text" value="${list.loanBankName}" class="form-control"
																								name="pandMBankName" /></td>
																						<td><form:input path="pandMBankDate"
																								type="date" value="${list.loanBankDate }" class="form-control"
																								name="pandMBankDate" /></td>
																						<td><form:input path="pandMBankAmt" value="${list.loanBankAmt }"
																								type="text" class="form-control"
																								name="pandMBankAmt" /></td>
																					</tr>
																			   </c:forEach>
																			  </c:when>
																			  <c:otherwise>
																			  <tr>
																						...
																						<td><form:input path="pandMBankDate"
																								type="date" value="" class="form-control"
																								name="pandMBankDate" /></td>
																						<td><form:input path="pandMBankAmt" value=""
																								type="text" class="form-control"
																								name="pandMBankAmt" /></td>
																					</tr>
																			  </c:otherwise>
																		...
																		<tr>
																			<td colspan="3">
																				<button type="button"
																					class="btn btn-outline-success add-row-break-up-new-mak-c">
																					<i class="fa fa-plus"></i> Add More Items
																				</button>
																			</td>
																		</tr>
																...
																<td><form:textarea path="table2remark22" rows="3"
																		value="" name="table2remark22" class="form-control" />
																</td>
															</tr>
															<tr>
																<td colspan="4"><label class="table-heading">Cost
																		of Project and Means of Finance</label></td>

															</tr>

															<tr>
																<td colspan="4"><h4 class="h2 text-center">Table-5</h4></td>
															</tr>
															<tr>
																<td colspan="4">
																	<p class="text-center font-italic text-secondary">(Relevant
																		CA and Valuer certificate link to be shown at
																		evaluation page)</p>
																</td>
															</tr>
															<tr>
																		...
																		<table class="table table-bordered cp-invest">
																			...
																			<thead>
																				<tr>
																					...
																					<th style="width: 20%;">Particulars <a
																						href="javascript:void(0);" class="remove-row"
																						data-toggle="tooltip" title=""
																						data-original-title="(In accordance with Rule 2.3-Table-2 and Rule 2.1.5 of Rules for implementation of IIEPP-2017)"><i
																							class="fa fa-info-circle text-info"></i></a></th>
																					<th colspan="2">Investment in the Project</th>
																					<th colspan="1">If any investment made in the
																						project prior to Opted Cut-off date <a
																						href="javascript:void(0);" class="remove-row"
																						data-toggle="tooltip" title=""
																						data-original-title="If any investment
                                                                                                made in the project prior to
                                                                                                Opted Cut-off date                 
                                                                                                (i.e. before
                                                                                                DD-MM-YYYY) then indicate -1.
                                                                                                first date of such investment
                                                                                                and 2. Amount invested from that
                                                                                                date till opted cut-off date."><i
																							class="fa fa-info-circle text-info"></i></a>${opt} <label>First
																							Date of Investment </label> <form:input type="date"
																							path="beforeopt" />
																					</th>
																					<th colspan="3">Investment made in the project
																						from opted cut-off date (first date of
																						disbursement) till date of commencement of
																						commercial production (From DD-MM-YYYY to
																						DD-MM-YYYY)
																						<table class="table">
																							<tr>
																								<td><form:input path="landAmtInv"
																										name="landAmtInv" type="date"
																										class="form-control mt-2 border-info" value=""
																										placeholder="DD-MM-YYYY" /></td>
																								<td><form:input path="buildAmtInv"
																										name="buildAmtInv" type="date"
																										class="form-control mt-2 border-info" value=""
																										placeholder="DD-MM-YYYY" /></td>
																							</tr>
																						</table>
																					</th>
																					<th>Investment, if any, in the project as per
																						Rule 2.9 <a href="javascript:void(0);"
																						class="remove-row" data-toggle="tooltip" title=""
																						data-original-title="Investment, if any, in the project (beyond date of commercial production (DD-MM-YYYY) till end of eligible investment period (DD-MM-YYYY) as per Rule 2.9"><i
																							class="fa fa-info-circle text-info"></i></a> <label>Beyond
																							date of commercial production <form:input
																								type="date" path="comprodDate" /> <label>Eligible
																								investment date</label> <form:input type="date"
																								path="eleligibiledate"
																								placeholder="Enter first date of Investment" />

																					</label>
																					</th>
																					<th>Investment considered by Nodal Agency</th>
																			...
																			<tbody>
																				<tr>
																					...
																					<td>Amount invested from first date to opted
																						Cut- off date as per certificate of Statutory
																						Auditors (to be verified by Nodal agency panel CA
																						and Tech expert)</td>
																					<td>As per certificate of Statutory <a
																						href="javascript:void(0);" class="remove-row"
																						data-toggle="tooltip" title=""
																						data-original-title="As per certificate of
                                                                                                    Statutory Auditor of the
                                                                                                    company dated"><i
																							class="fa fa-info-circle text-info"></i> </a> <%--  <form:input
																							path="optCutofDate" name="optCutofDate"
																							type="date" class="form-control mt-2 border-info"
																							value="" placeholder="DD-MM-YYYY" /> --%>
																					</td>
																					<td>Capital investment <a
																						href="javascript:void(0);" class="remove-row"
																						data-toggle="tooltip" title=""
																						data-original-title="Capital investment verified by empaneled
                                                                                                                    technical expert"><i
																							class="fa fa-info-circle text-info"></i> </a></td>
																					<td>Capital investment verified <a
																						href="javascript:void(0);" class="remove-row"
																						data-toggle="tooltip" title=""
																						data-original-title="Capital investment verified by empaneled
                                                                                        technical expert"><i
																					...
																					<td>As per certificate of statutory auditor of
																						the company dated …….(to be verified by Nodal
																						agency panel CA and tech expert)</td>
																				...
																				<tr>
																					...
																					<td><form:input type="text"
																							path="landBanknodalCA" maxlength="12"
																							class="form-control is-numeric table5v" /><small
																						class="words text-info"></small></td>
																					<td width="12%;"><form:input
																					...
																					<td width="12%;"><form:input type="text"
																							...
																							maxlength="12" /><small class="words text-info"></small></td>
																					<td><form:input type="text" path="landnodal"
																							maxlength="12"
																							class="VIandVIITotal1 form-control is-numeric" />
																				...
																				<tr>
																					...
																					<td><form:input path="buildBankApprai"
																						...
																						class="words text-info"></small></td>
																					<td><form:input type="text"
																							path="buildBanknodalCA" maxlength="12"
																							class="form-control is-numeric table5v" /><small
																						class="words text-info"></small></td>
																					...
																					<td width="12%;"><form:input
																							...
																							class="form-control is-numeric statutoryAudit1"
																							maxlength="12" /><small class="words text-info"></small></td>
																					<td><form:input type="text" path="buildnodal"
																							maxlength="12"
																							class="VIandVIITotal1 form-control is-numeric" />
																						<small class="words text-info"></small></td>
																				</tr>
																				<tr>
																					...
																					<td><form:input path="othcPerDpr" type="text"
																							readonly="true"
																							value="${capInvDetails.capInvDPRMFA}"
																							maxlength="12" class="form-control dprAmt" /></td>
																					<td><form:input path="othcBankApprai"
																							type="text" maxlength="12" readonly="true"
																							class="form-control is-numeric bankApprAmt"
																							value="${capInvDetails.capInvAppraisalMFA}" /><small
																						class="words text-info"></small></td>
																					<td><form:input type="text"
																							path="othcBanknodalCA" maxlength="12"
																							class="form-control is-numeric table5v" /><small
																						class="words text-info"></small></td>
																					<td><form:input path="othcPerCerti"
																							type="text"
																							class="VIandVII2 form-control is-numeric perCertiAuditor"
																							maxlength="12" /><small class="words text-info"></small></td>
																					<td><form:input path="othcCapInvCA"
																							type="text"
																							class="VIandVII2 form-control is-numeric capitalCA"
																							maxlength="12" /><small class="words text-info"></small></td>
																					<td><form:input path="othcCapInvValuer"
																							type="text"
																							class="form-control is-numeric capitalValuer"
																							maxlength="12" /><small class="words text-info"></small></td>
																					<td width="12%;"><form:input
																							path="othcafterinv" type="text"
																							class="form-control is-numeric statutoryAudit1"
																							maxlength="12" /><small class="words text-info"></small></td>
																					<td><form:input type="text" path="othcnodal"
																							maxlength="12"
																							class="VIandVIITotal1 form-control is-numeric" />
																						<small class="words text-info"></small></td>
																				</tr>
																				<tr>
																					...
																					<td><form:input path="plantBankApprai"
																						...
																						class="words text-info"></small></td>
																					<td><form:input type="text"
																							path="plantBanknodalCA" maxlength="12"
																							class="form-control is-numeric table5v" /><small
																						class="words text-info"></small></td>
																					...
																					<td width="12%;"><form:input
																							...
																							class="form-control is-numeric statutoryAudit1"
																							maxlength="12" /><small class="words text-info"></small></td>
																					<td><form:input type="text" path="plantnodal"
																							maxlength="12"
																							class="VIandVIITotal1 form-control is-numeric" />
																						<small class="words text-info"></small></td>
																				</tr>
																				<tr>
																					...
																					<td><form:input path="miscBankApprai"
																						...
																						class="words text-info"></small></td>
																					<td><form:input type="text"
																							path="miscBanknodalCA" maxlength="12"
																							class="form-control is-numeric table5v" /><small
																						class="words text-info"></small></td>
																					<td><form:input path="miscPerCertificate"
																							...
																							maxlength="12" /><small class="words text-info"></small></td>
																					<td><form:input path="miscCapInvCA"
																							type="text"
																					...
																					<td width="12%;"><form:input
																							...
																							class="form-control is-numeric statutoryAudit1"
																							maxlength="12" /><small class="words text-info"></small></td>
																					<td><form:input type="text" path="miscnodal"
																							maxlength="12"
																							class="VIandVIITotal1 form-control is-numeric" />
																						<small class="words text-info"></small></td>
																				</tr>
																				<tr>
																					<td></td>
																					<td><strong>SubTotal (A)</strong> (1+2+3+4+5)</td>
																					...
																					<td><form:input path="subTtlABankApprai"
																							...
																							readonly="true" maxlength="12" /></td>
																					<td><form:input type="text"
																							path="subttlabanknodalca" maxlength="12"
																							class="form-control is-numeric table5vsubtA beforeoptsubt1 " /><small
																						class="words text-info"></small></td>
																					...
																					<td width="12%;"><form:input
																							...
																							maxlength="12" /><small class="words text-info"></small></td>
																					<td><form:input type="text"
																							path="subttlanodal" maxlength="12"
																							readonly="true"
																							class="form-control is-numeric VIandVIITotal1t subTtlNodal" /><small
																						class="words text-info"></small></td>
																				</tr>
																				...
																				<tr>
																					...
																					<td>Provision for Cost Escalation &
																						Contingencies</td>
																					<td><form:input path="prelimPerDpr"
																							type="text"
																							class="form-control is-numeric perDPRAmt"
																							value="" maxlength="12" /><small
																						class="words text-info"></small></td>
																					<td><form:input path="prelimBankApprai"
																							type="text"
																							class="form-control is-numeric perBankAppr"
																							maxlength="12" value="" /><small
																						class="words text-info"></small></td>
																					<td><form:input type="text"
																							path="prelimBanknodalCA" maxlength="12"
																							class="form-control is-numeric perBankinv" /><small
																						class="words text-info"></small></td>
																					...
																					<td width="12%;"><form:input
																							...
																							maxlength="12" /><small class="words text-info"></small></td>
																					<td><form:input type="text" path="prelimnodal"
																							maxlength="12"
																							class="VIandVII2 form-control is-numeric" /> <small
																						class="words text-info"></small></td>
																				</tr>
																				<tr>
																					<td>7</td>
																					...
																					<td><form:input path="prelimBankApprai"
																						...
																						class="words text-info"></small></td>
																					<td><form:input type="text"
																							path="ppeBanknodalCA" maxlength="12"
																							class="form-control is-numeric perBankinv" /><small
																						class="words text-info"></small></td>
																					<td><form:input path="prelimPerCerti"
																							type="text"
																					...
																					<td><form:input path="prelimCapInvValuer"
																							...
																							maxlength="12" /><small class="words text-info"></small></td>
																					<td width="12%;"><form:input
																							path="prelimStatutoryAudit" type="text"
																							class="form-control is-numeric statutoryAudit2"
																							maxlength="12" /><small class="words text-info"></small></td>
																					<td><form:input type="text" path="ppenodal"
																							maxlength="12"
																							class="VIandVII2 form-control is-numeric" /> <small
																						class="words text-info"></small></td>
																				</tr>
																				<tr>
																					...
																					<td><form:input path="interestBankApprai"
																						...
																						class="words text-info"></small></td>
																					<td><form:input type="text"
																							path="interestBanknodalca" maxlength="12"
																							class="form-control is-numeric perBankinv" /><small
																						class="words text-info"></small></td>
																					...
																					<td width="12%;"><form:input
																							...
																							maxlength="12" /><small class="words text-info"></small></td>
																					<td><form:input type="text"
																							path="interestnodal" maxlength="12"
																							class="VIandVII2 form-control is-numeric" /> <small
																						class="words text-info"></small></td>
																				</tr>
																				<tr>
																					...
																					<td><form:input path="marginPerDpr"
																							type="text"
																							class="form-control is-numeric perDPRAmt"
																							maxlength="12" readonly="true"
																					...
																					<td><form:input path="marginBankApprai"
																						...
																						class="words text-info"></small></td>
																					<td><form:input type="text"
																							path="marginBanknodalca" maxlength="12"
																							class="form-control is-numeric perBankinv" /><small
																						class="words text-info"></small></td>
																					...
																					<td width="12%;"><form:input
																							...
																							class="form-control is-numeric statutoryAudit2"
																							maxlength="12" /><small class="words text-info"></small></td>
																					<td><form:input type="text" path="marginnodal"
																							maxlength="12"
																							class="VIandVII2 form-control is-numeric" /> <small
																						class="words text-info"></small></td>
																				</tr>
																				<tr>
																					<td>10</td>
																					<td>Other, If any</td>
																					<td><form:input path="othPerDpr" type="text"
																							class="form-control is-numeric subTtlDPR"
																							maxlength="12" value="" /><small
																						class="words text-info"></small></td>
																					<td><form:input path="othBankApprai"
																							type="text"
																							class="form-control is-numeric subBankAppr"
																							maxlength="12" value="" /><small
																						class="words text-info"></small></td>
																					<td><form:input type="text"
																							path="othBanknodalca" maxlength="12"
																							class="form-control is-numeric beforeoptsubt1" /><small
																						class="words text-info"></small></td>
																					<td><form:input path="othPerCerti" type="text"
																							class="VIandVII8 form-control is-numeric subTtlAuditor "
																							maxlength="12" /><small class="words text-info"></small></td>
																					<td><form:input path="othCapInvCA" type="text"
																							class="VIandVII8 form-control is-numeric subTtlCA"
																							maxlength="12" /><small class="words text-info"></small></td>
																					<td><form:input path="otherCapInvValuer"
																							type="text"
																							class="form-control is-numeric subTtlValuer"
																							maxlength="12" /><small class="words text-info"></small></td>
																					<td width="12%;"><form:input
																							path="othafterinv" type="text"
																							class="form-control is-numeric subkasubTtlStatutory"
																							maxlength="12" /><small class="words text-info"></small></td>
																					<td><form:input type="text" path="othnodal"
																							maxlength="12"
																							class="VIandVII2 form-control is-numeric subTtlNodal" />
																						<small class="words text-info"></small></td>
																				</tr>
																				<tr>
																					<td></td>
																					<td><strong>SubTotal (B)</strong> (6+7+8+9+10)</td>
																					...
																					<td><form:input path="subTtlBBankApprai"
																							type="text"
																							class="form-control perBankApprTotal subBankAppr subBankInv"
																							readonly="true" /></td>
																					<td><form:input type="text"
																							path="subTtlBAmtInv" maxlength="12"
																							class="form-control is-numeric perBankInvTotal beforeoptsubt1" />
																						<small class="words text-info"></small></td>
																					...
																					<td width="12%;"><form:input
																							...
																							maxlength="12" /><small class="words text-info"></small></td>
																					<td><form:input type="text"
																							path="subTtlBnodal" maxlength="12"
																							readonly="true"
																							class="VIandVII2total form-control is-numeric subTtlNodal" />
																						<small class="words text-info"></small></td>
																				</tr>
																				<tr>
																					<td></td>
																					<td><strong>Total (A+B)</strong></td>
																					<td><form:input path="ttlPerDpr"
																							id="ttlPerDpr" type="text"
																							class="form-control subTtlDPRTotal"
																							readonly="true" /></td>
																					<td><form:input path="TtlBankApprai"
																							type="text"
																							class="form-control subBankApprTotal subBankInvTotal"
																							readonly="true" /></td>
																					<td><form:input type="text" path="ttlAmtInve"
																							maxlength="12"
																							class="form-control is-numeric beforeoptsubttotal" /><small
																						class="words text-info"></small></td>
																					<td><form:input path="ttlPerCerti" type="text"
																							class="form-control subTtlAuditorTotal"
																							readonly="true" /></td>
																					<td><form:input path="ttlcapinvca" type="text"
																							class="form-control subTtlCATotal"
																							readonly="true" /></td>
																					<td><form:input path="ttlCapInvValuer"
																							type="text"
																							class="form-control subTtlValuerTotal"
																							readonly="true" /></td>
																					<td width="12%;"><form:input
																							path="ttlafterinv" type="text" readonly="true"
																							class="form-control is-numeric subkasubTtlStatutoryTotal"
																							maxlength="12" /><small class="words text-info"></small></td>
																					<td><form:input type="text" path="ttlnodal"
																							maxlength="12"
																							class="form-control subTtlNodalTotal is-numeric" />
																						<small class="words text-info" readonly="true"></small></td>
																				</tr>
																			</tbody>
																		</table>
																	</div>
															...
															<tr>
																<td colspan="4"><label class="table-heading">Means
																		Of Financing</label></td>
															</tr>
															<tr>
																<td colspan="4"><h4 class="h2 text-center">Table-6</h4></td>
															</tr>
															<tr>
																<td colspan="4">
																	<div class="table-responsive">
																		<table class="table table-responsive cp-invest">
																			<tr>
																				...
																				<th style="width: 12%;" rowspan="2">As per DPR


																				</th>
																				<th style="width: 12%;" rowspan="2">As per Bank
																					Appraisal</th>
																				<th style="width: 12%;">Amount invested from
																					first date to opted Cut- off date <a
																					href="javascript:void(0);" class="remove-row"
																					data-toggle="tooltip" title=""
																					data-original-title="Amount
                                                                                            invested from first date (see
                                                                                            Column 5 of Table 5) to opted
                                                                                            Cut- off date"><i
																				...
																				<th style="width: 12%;">From Opted Cut-off date
																					till the date of commencement of commercial
																					production <a href="javascript:void(0);"
																					class="remove-row" data-toggle="tooltip" title=""
																					data-original-title="From Opted
                                                                                        Cut-off date till the date of
                                                                                        commencement of commercial
                                                                                        production(From DD-MM-YYYY till
                                                                                        DD-MM-YYYY )"><i
																						class="fa fa-info-circle text-info"></i></a>
																					<table class="table mt-3">
																						<tbody>
																							<tr>
																								<td><label> Opted Cut-off date </label> <input
																									type="date" value="${opt}"
																									placeholder="Enter Opted cut-off date"
																									class="form-control mb-3"> <label>Date
																										of commencement of commercial production </label> <form:input
																										type="date" path="CommercialDate"
																										placeholder="Enter first date of Investment"
																										class="form-control" /></td>
																								<td></td>
																							</tr>
																				...
																				<th style="width: 12%;">Beyond date of
																					commercial production (DD-MM-YYYY) till end of
																					eligible investment period (DD-MM-YYYY)
																					<table class="table mt-3">
																						<tbody>
																							<tr>
																								<td><label>Beyond date of
																										commercial production </label> <form:input type="date"
																										path="byondcommercialdate"
																										placeholder="Enter first date of Investment"
																										class="form-control" /> <label>Eligible
																			...
																			<tbody>
																				...
																				<tr>
																					...
																					<td><form:input path="equAftinvdate"
																							...
																							readonly="true" maxlength="12" /> <small
																						class="words text-info"></small></td>
																				...
																				<tr>
																					<td>1.4</td>
																					<td>Other</td>
																					<td><form:input path="finOthPerDpr"
																							type="text"
																							class="form-control FinancingDPR is-numeric"
																							maxlength="12" /> <small class="words text-info"></small></td>
																				...
																				<tr>
																					<td>2.1</td>
																					<td>From FI's</td>
																					<td><form:input path="FromFiPerDpr"
																							type="text"
																							class="form-control FinancingDPR is-numeric"
																							maxlength="12" /> <small class="words text-info"></small></td>
																				...
																				<tr>
																					<td>2.2</td>
																					<td>From Bank</td>
																					<td><form:input path="FrBankPerDpr"
																							type="text"
																							class="form-control FinancingDPR is-numeric"
																							maxlength="12" /> <small class="words text-info"></small></td>
																				...
																				<td><form:input path="Plant_MachPerCerti"
																						...
																						class="form-control FinaPerCerti is-numeric" /><small
																					class="words text-info"></small></td>
																				...
																				<tr>
																					...
																					<td><form:input path="finTttlPerDpr"
																							type="text"
																							class="form-control FinancingDPRTotal"
																							readonly="true" /></td>
																					<td><form:input path="finTttlBankApprai"
																							type="text"
																							class="form-control FinaBankApprTotal"
																							readonly="true" /></td>
																					...
																					<td><form:input path="finTttldate" type="text"
																							id="finTttldate1"
																							class="form-control  finTttldate1"
																							readonly="true" /></td>
															...
															<tr>
																<td colspan="4"><h4 class="h3">Brief of
																		Detailed Project Report and Appraisal Note</h4></td>
															</tr>
															<tr>
																<td colspan="4"><label><strong>Detailed
																			Project Report</strong></label> <form:textarea path="dealPerDpr"
																		class="form-control" rows="4" /></td>
															</tr>
															<tr>
																<td colspan="4"><label><strong>Appraisal
																			Note</strong></label> <form:textarea path="SecBankApprai"
																		class="form-control" rows="4" /></td>
															</tr>
															<tr>
																<td colspan="4"><label><strong>Verification
																			of Capital Investment </strong></label> <form:textarea
																		path="SecPerCerti" class="form-control" rows="4" /></td>
															</tr>
															<tr>
																<td colspan="4">
																	<h4 class="h2">Details of various incentives
																		claimed by the company and comments of Nodal Agency</h4>
																</td>
															</tr>
															<tr>
																<td colspan="4"><label class="table-heading">SGST
																		Reimbursement</label></td>
															</tr>

															<!-- <tr>
																<td colspan="4"><label class="table-heading">
																		(a) Turnover of the company for the last financial
																		years &nbsp;&nbsp;(Will not be applicable on first
																		application for disbursement) </label></td>
															</tr> -->

															<!-- <tr>
																<td colspan="4">
																	<h4 class="h2 text-center">Table-7</h4>
																</td>
															</tr> -->
															<!-- <tr>
																<td colspan="4">
																	<div class="table-responsive mt-3">
																		<table class="table table-stripped table-bordered"
																			id="BreakUpTable4-mak4">
																			<thead>
																				<tr>
																					<th>Sl.No</th>
																					<th>Financial Year</th>
																					<th>UP Sale (For all units of Applicant)</th>
																					<th>For the unit availing incentives under the
																						scheme</th>

																				</tr>
																			</thead>
																			<tbody class="add-from-here4-mak4">
																				<tr>
																			...
																			<tfoot>
																				...
																				<tr>
																					<td colspan="4">
																						<button type="button"
																							class="btn btn-outline-success add-row-break-up-new-mak4">
																							<i class="fa fa-plus"></i> Add More Items
																						</button>
																					</td>
																				</tr>
															...
															<!-- <tr>
																<td colspan="4"><textarea class="form-control"
																		placeholder="Observations By PICUP" rows="2"></textarea>
																</td>
															</tr> -->
															<!-- <tr>
																<td colspan="4"><label class="table-heading">
																		(b) Comparative Turnover details of claim period :-
																		&nbsp;&nbsp; (Will not be applicable on first
																		application for disbursement) </label></td>
															</tr> -->
															<!-- <tr>
																<td colspan="4">
																	<h4 class="h2 text-center">Table-8</h4>
																</td>
															</tr> -->
															<!-- <tr>
																<td colspan="4">
																	<div class="table-responsive mt-3">
																		<table class="table table-stripped table-bordered"
																			id="BreakUpTable4-mak4-1">
																			<thead>
																				<tr>
																					<th>Financial Year/Period</th>
																					<th>Turnover for last FY/period</th>
																					<th>Turnover for present FY/ Period</th>
																					<th>%age increase (+)/decrease (-) for
																						corresponding period</th>

																				</tr>
																			</thead>
																			<tbody class="add-from-here4-mak4-1">
																				<tr>
																			...
																			<tfoot>
																				...
																				<tr>
																					<td colspan="7">
																						<button type="button"
																							class="btn btn-outline-success add-row-break-up-new-mak4-1">
																							<i class="fa fa-plus"></i> Add More Items
																						</button>
																					</td>
																				</tr>
															...
															<tr>
																<td colspan="4"><label class="table-heading">
																		(c) SGST Reimbursement Claim:- &nbsp;&nbsp;In case of
																		New Industrial Undertakings </label></td>
															</tr>
															<tr>
																<td colspan="4">
																	<h4 class="h2 text-center">Table-9</h4>
																</td>
															</tr>
																	...
																	<div class="table-responsive">
																		<table class="table table-bordered cp-SGST">
																			<thead>
																				<tr>
																					<th>Financial Year</th>
																					<th>Deposited net SGST for manufactured goods
																						(after adjustment of ITC) during the period</th>
																					<th>Claim for Net SGST reimbursement
																						(${category} of deposited SGST)</th>
																					<th>Payable amount of SGST reimbursement in
																						accordance with eligibility</th>
																					<!-- <th>Date of letter from Commercial Tax (vide
																						which deposited SGST amount is confirmed)</th> -->
																				</tr>
																			</thead>
																			<tbody>
                                                ...
                                                <tr>
                                                    <td colspan="4">
                                                        <label class="table-heading">
                                                            (c) SGST Reimbursement Claim:-


                                                            &nbsp;&nbsp;Turnover of Base Production In Case of
                                                ...
                                                <tr>
                                                    <td colspan="4">
                                                        <div class="table-responsive mt-3 table-9">
                                                            <table class="table table-stripped table-bordered"
                                                                id="BreakUpTable1-mak1">
                                                                <thead>
                                                                    <tr>
                                                                        <th>Financial Year </th>
                                                                        <th>Turnover of sales of Items manufactured
                                                                            Claimed before Expansion</th>
                                                                        <th>Turnover of Base Production
                                                                        </th>
															...
															<tr>
																<td colspan="4"><label class="table-heading">
																		(c) SGST Reimbursement Claim :- &nbsp;&nbsp;In Case of
																		Expansion/Diversification </label></td>
															</tr>
															<tr>
																<td colspan="4">
																	<h4 class="h2 text-center">Table-9</h4>
																	...
																	<div class="table-responsive mt-3">
																		<table class="table table-stripped table-bordered"
																			...
																			<thead>
																				<tr>
																					<th>Financial Year</th>
																					<th>Turnover of Base Production / Year in
																						which achieved</th>
																						 <th class="text-center px-0 pb-0 mb-3">
                                                                                    Financial Year/Period

                                                                            </th>
																					
																					<th>Turnover for part/full year after
																						Expansion/ diversification</th>

																					<th>Incremental Turnover</th>
																					<th>Total Net SGST paid for the FY/ period</th>
																					<th>Total Net SGST paid related to incremental
																						turnover</th>
																					<th>Net SGST reimbursement Claimed(${category}
																						of deposited SGST in accordance with category)</th>
																					<th>Net SGST reimbursement
																						eligibility(${category} of deposited SGST in
																						accordance with category)</th>
															...
															<tr>
																...
																<td colspan="4"><label class="table-heading">Capital
																		Interest Subsidy</label></td>

															</tr>
															<!-- <tr>
																<td colspan="4"><label class="table-heading">Capital
																		Interest Subsidy (CIS) paid to the company so far:-
																		(Will not be applicable on first application for
																		disbursement) </label></td>
															</tr>

															<tr>
																<td colspan="4">
																	<h4 class="h2 text-center">Table-10</h4>
																</td>
															</tr> -->
															<!-- <tr>
																<td colspan="4">
																	<div class="table-responsive mt-3">
																		<table class="table table-stripped table-bordered"
																			...
																			<tbody class="add-from-here3-mak3">
																				<tr>
																			...
																			<tfoot>
																				...
																				<tr>
																					<td colspan="7">
																						<button type="button"
																							class="btn btn-outline-success add-row-break-up-new-mak3">
																							<i class="fa fa-plus"></i> Add More Items
																						</button>
																					</td>
																				</tr>
												   ...
												   <tr>
                                                    <td colspan="4">
                                                        <label class="table-heading">Details of term loan
                                                            sanctioned/disbursed by banks towards Plant &
                                                            Machinery</label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="4">
                                                        <h4 class="h2 text-center">Table-11</h4>
                                                    </td>
                                                </tr>

                                                <tr>
                                                    <td colspan="4">
                                                        <div class="table-responsive mt-3 cp-SGST add-row-new1">
                                                            <table class="table table-bordered"
                                                                id="BreakUpTable4-mak444">
                                                                <thead>
                                                                    <!-- <th>Sl.No</th> -->
                                                                    <tr>


                                                                        <th rowspan="2">Name of Lender Bank(s)</th>

                                                                        <th colspan="2" style="text-align:center">
                                                                            Sanctioned Amount
                                                                        </th>
                                                                        <th rowspan="2">Rate of Interst (%)
                                                                        </th>
                                                                ...
                                                                <tbody class="add-from-here4-mak444">
                                                                    <tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="4">
                                                                        ...
                                                                        <button type="button"
                                                                            class="btn btn-outline-success add-row-break-up-new-mak444"><i
                                                ...
                                                <tr>
                                                    <td colspan="4">
                                                        <div class="table-responsive mt-3 cp-SGST add-row-new1"
                                                            id="BreakUpTable4-mak441">
                                                            <table class="table table-bordered"
                                                                id="BreakUpTable4-mak44">
                                                                <thead>
                                                                    <!-- <th>Sl.No</th> -->
                                                                    <tr>
                                                                ...
                                                                <tbody
                                                                    class="add-from-here4-mak44 add-from-here4-mak441">
                                                                    <tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="4">
                                                                        ...
                                                                        <button type="button"
                                                                            class="btn float-right btn-outline-success add-row-break-up-new-mak44"><i
                                                                                class="fa fa-plus"></i> Add Bank
                                                                            Detail</button>
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="4">
                                                                        ...
                                                                        <button type="button"
                                                                            class="btn btn-outline-success add-row-break-up-new-mak441"><i
															...
															<tr>
																<td colspan="4"><label class="table-heading">Details
																		of Capital Interest Subsidy (CIS) claimed/admissible</label></td>
															</tr>
															<tr>
																<td colspan="4">
																	<h4 class="h2 text-center">Table-12</h4>
																	<h6 class="text-center">(Enter Amount in INR)</h6>
																		...
																		<table class="table table-bordered">
																			<thead>
																				...
																				<tr>
																					...
																					<th rowspan="2">F.Y./Period for which CIS
																						claimed</th>
																					<th colspan="2">Payment made to bank on loan
																						amount of P&M during FY/period under consideration
																						(as per bank’s certificate)</th>

																					<th rowspan="2">CIS @ 5% certified by bank</th>

																					<th rowspan="2">CIS claimed by the company</th>

																					<th rowspan="2">Annual permissible amount of
																						CIS</th>

																					<th rowspan="2">Admissible amount of CIS</th>
																			...
																			<tbody>
																				<tr>
																					...
																					<td><input id="year1" name="yearI"
																						...
																						id="year1Msg" class="text-danger"></span></td>
																					...
																					<td colspan="1"><form:input type="text"
																							path="firstbybank" class="form-control bybank"
																							name="" maxlength="12" /></td>
																					<td colspan="1"><form:input type="text"
																							readonly="true" path="firstbycompany"
																							value="${cisincentiveDeatilsForm.firstYAmtIntSubsidy}"
																							class="form-control bycompany" name=""
																							maxlength="12" /></td>
																					<td colspan="1"><form:input type="text"
																							path="firstannualpermissible"
																							class="form-control annualpermissible" name=""
																							maxlength="12" /></td>
																					<td colspan="1"><form:input type="text"
																							path="firstadmissibleamount"
																							class="form-control admissibleamount" name=""
																							maxlength="12" /></td>
																				</tr>
																				<tr>
																					...
																					<td colspan="1"><form:input type="text"
																							path="secondbybank" class="form-control bybank"
																							name="" maxlength="12" /></td>
																					<td colspan="1"><form:input type="text"
																							readonly="true" path="secondbycompany"
																							value="${cisincentiveDeatilsForm.secondYAmtIntSubsidy}"
																							class="form-control bycompany" name=""
																							maxlength="12" /></td>
																					<td colspan="1"><form:input type="text"
																							path="secondannualpermissible"
																							class="form-control annualpermissible" name=""
																							maxlength="12" /></td>
																					<td colspan="1"><form:input type="text"
																							path="secondadmissibleamount"
																							class="form-control admissibleamount" name=""
																							maxlength="12" /></td>
																				...
																				<tr>
																					...
																					<td><input id="year3" name="yearIII"
																						class="form-control" onkeyup="yrOfSubsidy3()"
																						type="text"
																					...
																					<td colspan="1"><form:input type="text"
																							path="thirdbybank" class="form-control bybank"
																							name="" maxlength="12" /></td>
																					<td colspan="1"><form:input type="text"
																							readonly="true" path="thirdbycompany"
																							value="${cisincentiveDeatilsForm.thirdYAmtIntSubsidy}"
																							class="form-control bycompany" name=""
																							maxlength="12" /></td>
																					<td colspan="1"><form:input type="text"
																							path="thirdannualpermissible"
																							class="form-control annualpermissible" name=""
																							maxlength="12" /></td>
																					<td colspan="1"><form:input type="text"
																							path="thirdadmissibleamount"
																							class="form-control admissibleamount" name=""
																							maxlength="12" /></td>
																				...
																				<tr>
																					...
																					<td><input id="year4" name="yearIV"
																						class="form-control" onkeyup="yrOfSubsidy4()"
																						type="text"
																					...
																					<td colspan="1"><form:input type="text"
																							path="fourthbybank" class="form-control bybank"
																							name="" maxlength="12" /></td>
																					<td colspan="1"><form:input type="text"
																							path="fourthbycompany" readonly="true"
																							value="${cisincentiveDeatilsForm.fourthYAmtIntSubsidy}"
																							class="form-control bycompany" name=""
																							maxlength="12" /></td>
																					<td colspan="1"><form:input type="text"
																							path="fourthannualpermissible"
																							class="form-control annualpermissible" name=""
																							maxlength="12" /></td>
																					<td colspan="1"><form:input type="text"
																							path="fourthadmissibleamount"
																							class="form-control admissibleamount" name=""
																							maxlength="12" /></td>
																				...
																				<tr>
																					...
																					<td><input id="year5" name="yearV"
																						class="form-control" onkeyup="yrOfSubsidy5()"
																						type="text"
																					...
																					<td colspan="1"><form:input type="text"
																							path="fifthbybank" class="form-control bybank"
																							name="" maxlength="12" /></td>
																					<td colspan="1"><form:input type="text"
																							path="fifthbycompany" readonly="true"
																							value="${cisincentiveDeatilsForm.fifthYAmtIntSubsidy}"
																							class="form-control bycompany" name=""
																							maxlength="12" /></td>
																					<td colspan="1"><form:input type="text"
																							path="fifthannualpermissible"
																							class="form-control annualpermissible" name=""
																							maxlength="12" /></td>
																					<td colspan="1"><form:input type="text"
																							path="fifthadmissibleamount"
																							class="form-control admissibleamount" name=""
																							maxlength="12" /></td>
																				...
																				<tr>
																					...
																					<td colspan="1"><form:input type="text"
																							path="totalbybank"
																							class="form-control bybanktotal" name=""
																							readonly="true" /></td>
																					<td colspan="1"><form:input type="text"
																							path="totalbycompany"
																							class="form-control bycompanytotal" name=""
																							readonly="true" /></td>
																					<td colspan="1"><form:input type="text"
																							path="totalannualpermissible"
																							class="form-control annualpermissibletotal"
																							name="" readonly="true" /></td>
																					<td colspan="1"><form:input type="text"
																							path="totaladmissibleamount"
																							class="form-control admissibleamounttotal"
																							name="" readonly="true" /></td>
															...
															<tr>
																<td colspan="4"><textarea class="form-control"
																		rows="4" placeholder=" Observations by PICUP"></textarea>
																</td>
															</tr>
															<tr>


																<td colspan="4"><label class="table-heading">Infrastructure
																		Interest Subsidy </label></td>
																<!-- <tr>
																<td colspan="4"><label class="table-heading">Infrastructure
																		Interest Subsidy (IIS) paid to the company so far:-
																		(Will not be applicable on first application for
																		disbursement) </label></td>
															</tr>
															<tr>
																<td colspan="4">
																	<h4 class="h2 text-center">Table-13</h4>
																</td>
															</tr>
															<tr>
																<td colspan="4">
																	<div class="table-responsive mt-3">
																		<table class="table table-stripped table-bordered"
																			...
																			<tbody class="add-from-here3-mak-d">
																				<tr>
																			...
																			<tfoot>
																				...
																				<tr>
																					<td colspan="7">
																						<button type="button"
																							class="btn btn-outline-success add-row-break-up-new-mak-d">
																							<i class="fa fa-plus"></i> Add More Items
																						</button>
																					</td>
																				</tr>
                                                    ...
                                                    <td colspan="4">
                                                        <label class="table-heading">Details of term loan
                                                            sanctioned/disbursed by banks towards Infrastructure</label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="4">
                                                        <h4 class="h2 text-center">Table-14</h4>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="4">
                                                        <div class="table-responsive mt-3 cp-SGST add-row-new1">
                                                            <table class="table table-bordered"
                                                                ...
                                                                <tbody class="add-from-here4-mak4444">
                                                                    <tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="4">
                                                                        ...
                                                                        <button type="button"
                                                                            class="btn btn-outline-success add-row-break-up-new-mak4444"><i
                                                                                class="fa fa-plus"></i> Add More
                                                                            Items</button>
                                                                    </td>
                                                                </tr>
                                                ...
                                                <tr>
                                                    <td colspan="4">
                                                        <div class="table-responsive mt-3 cp-SGST add-row-new1"
                                                            id="BreakUpTable4-mak44444-1">
                                                            <table class="table table-bordered"
                                                                id="BreakUpTable4-mak44444">
                                                                <thead>
                                                                    <!-- <th>Sl.No</th> -->
                                                                    <tr>
                                                                ...
                                                                <tbody
                                                                    class="add-from-here4-mak44444 add-from-here4-mak44444-1">
                                                                    <tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="4">
                                                                        ...
                                                                        <button type="button"
                                                                            class="btn float-right btn-outline-success add-row-break-up-new-mak44444"><i
                                                                                class="fa fa-plus"></i> Add Bank
                                                                            Detail</button>
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="4">
                                                                        ...
                                                                        <button type="button"
                                                                            class="btn btn-outline-success add-row-break-up-new-mak44444-1"><i
                                                                                class="fa fa-plus"></i> Add
                                                                            Bank</button>
                                                                    </td>
                                                                </tr>
															...
															<tr>
																<td colspan="4"><label class="table-heading">Details
																		of Infrastructure Interest Subsidy (IIS)
																		claimed/admissible</label></td>
															</tr>
															<tr>
																<td colspan="4">
																	<h4 class="h2 text-center">Table-15</h4>
																</td>
															</tr>
															<tr>
																<td colspan="4">
																		...
																		<table class="table table-bordered">
																			<thead>
																				...
																				<tr>
																					...
																					<th rowspan="2">F.Y./Period for which IIS
																						claimed</th>
																					<th colspan="2">Payment made to bank on loan
																						amount of P&M during FY/period under consideration
																						(as per bank’s certificate)</th>

																					<th rowspan="2">IIS @ 5% certified by bank</th>

																					<th rowspan="2">IIS claimed by the company</th>

																					<th rowspan="2">Annual permissible amount of
																						IIS</th>

																					<th rowspan="2">Admissible amount of IIS</th>
																			...
																			<tbody>
																				<tr>
																					...
																					<td colspan="1"><form:input type="text"
																							path="firstbybankiis"
																							class="form-control bybankiis" name=""
																							maxlength="12" /></td>
																					<td colspan="1"><form:input type="text"
																							path="firstbycompanyiis" readonly="true"
																							value="${iisincentiveDeatilsForm.firstYAmtIntSubsidy}"
																							class="form-control bycompanyiis" name=""
																							maxlength="12" /></td>
																					<td colspan="1"><form:input type="text"
																							path="firstannualpermissibleiis"
																							class="form-control annualpermissibleiis" name=""
																							maxlength="12" /></td>
																					<td colspan="1"><form:input type="text"
																							path="firstadmissibleamountiis"
																							class="form-control admissibleamountiis" name=""
																							maxlength="12" /></td>
																				...
																				<tr>
																					...
																					<td colspan="1"><form:input type="text"
																							path="secondbybankiis"
																							class="form-control bybankiis" name=""
																							maxlength="12" /></td>
																					<td colspan="1"><form:input type="text"
																							path="secondbycompanyiis" readonly="true"
																							value="${iisincentiveDeatilsForm.secondYAmtIntSubsidy}"
																							class="form-control bycompanyiis" name=""
																							maxlength="12" /></td>
																					<td colspan="1"><form:input type="text"
																							path="secondannualpermissibleiis"
																							class="form-control annualpermissibleiis" name=""
																							maxlength="12" /></td>
																					<td colspan="1"><form:input type="text"
																							path="secondadmissibleamountiis"
																							class="form-control admissibleamountiis" name=""
																							maxlength="12" /></td>
																				...
																				<tr>
																					...
																					<td colspan="1"><form:input type="text"
																							...
																							maxlength="12" /></td>
																					<td colspan="1"><form:input type="text"
																							path="thirdbycompanyiis" readonly="true"
																							value="${iisincentiveDeatilsForm.thirdYAmtIntSubsidy}"
																							class="form-control bycompanyiis" name=""
																							maxlength="12" /></td>
																					<td colspan="1"><form:input type="text"
																							path="thirdannualpermissibleiis"
																							class="form-control annualpermissibleiis" name=""
																							maxlength="12" /></td>
																					<td colspan="1"><form:input type="text"
																							path="thirdadmissibleamountiis"
																							class="form-control admissibleamountiis" name=""
																							maxlength="12" /></td>
																				...
																				<tr>
																					...
																					<td colspan="1"><form:input type="text"
																							path="fourthbybankiis"
																							class="form-control bybankiis" name=""
																							maxlength="12" /></td>
																					<td colspan="1"><form:input type="text"
																							path="fourthbycompanyiis" readonly="true"
																							value="${iisincentiveDeatilsForm.fourthYAmtIntSubsidy}"
																							class="form-control bycompanyiis" name=""
																							maxlength="12" /></td>
																					<td colspan="1"><form:input type="text"
																							path="fourthannualpermissibleiis"
																							class="form-control annualpermissibleiis" name=""
																							maxlength="12" /></td>
																					<td colspan="1"><form:input type="text"
																							path="fourthadmissibleamountiis"
																							class="form-control admissibleamountiis" name=""
																							maxlength="12" /></td>
																				...
																				<tr>
																					...
																					<td colspan="1"><form:input type="text"
																							...
																							maxlength="12" /></td>
																					<td colspan="1"><form:input type="text"
																							path="fifthbycompanyiis" readonly="true"
																							value="${iisincentiveDeatilsForm.fifthYAmtIntSubsidy}"
																							class="form-control bycompanyiis" name=""
																							maxlength="12" /></td>
																					<td colspan="1"><form:input type="text"
																							path="fifthannualpermissibleiis"
																							class="form-control annualpermissibleiis" name=""
																							maxlength="12" /></td>
																					<td colspan="1"><form:input type="text"
																							path="fifthadmissibleamountiis"
																							class="form-control admissibleamountiis" name=""
																							maxlength="12" /></td>
																				...
																				<tr>
																					...
																					<td colspan="1"><form:input type="text"
																							path="totalbybankiis"
																							class="form-control bybanktotaliis" name=""
																							readonly="true" /></td>
																					<td colspan="1"><form:input type="text"
																							path="totalbycompanyiis"
																							class="form-control bycompanytotaliis" name=""
																							readonly="true" /></td>
																					<td colspan="1"><form:input type="text"
																							path="totalannualpermissibleiis"
																							class="form-control annualpermissibletotaliis"
																							name="" readonly="true" /></td>
																					<td colspan="1"><form:input type="text"
																							path="totaladmissibleamountiis"
																							class="form-control admissibleamounttotaliis"
																							name="" readonly="true" /></td>
															...
															<!-- <tr>
																...
																<td colspan="4"><label class="table-heading">Interest
																		Subsidy for Industrial Research </label></td> -->
															<!-- <tr>
																<td colspan="4"><label class="table-heading">Interest
																		Subsidy for Industrial Research paid to the company so
																		far:- (Will not be applicable on first application for
																		disbursement) </label></td>
															</tr> -->
															<!-- <tr>
																<td colspan="4">
																	<h4 class="h2 text-center">Table-16</h4>
																</td>
															</tr> -->
															<!-- <tr>
																<td colspan="4">
																	<div class="table-responsive mt-3">
																		<table class="table table-stripped table-bordered"
																			id="BreakUpTable3-mak-c">
																			<thead>
																				<tr>
																					<th>Financial Year/Period</th>
																					<th>Industrial Research Paid (Rs.)</th>
																					<th>Paid on</th>
															...
															<!-- <tr>
																<td colspan="4"><label class="table-heading">Details
																		of term loan sanctioned/disbursed by banks towards
																		Industrial Research</label></td>
															</tr>
															<tr>
																<td colspan="4">
																	<h4 class="h2 text-center">Table-17</h4>
																</td>
															</tr>
															<tr>
																<td colspan="4">
																		...
																		<table class="table table-bordered"
																			...
																			<thead>
																				...
																				<tr>
																					...
																					<th rowspan="2">Name of Lender Bank(s)</th>
																					<th colspan="2">Sanctioned Amount</th>
																					<th colspan="2">Disbursed Amount</th>
																					<th rowspan="2">Rate of Interst (%)</th>
																			...
																			<tbody class="add-from-here3-mak-f">
																				<tr>
																			...
																			<tfoot>
																				...
																				<tr>
																					<td colspan="7">
																						<button type="button"
																							class="btn btn-outline-success add-row-break-up-new-mak-f">
																							<i class="fa fa-plus"></i> Add More Items
																						</button>
																					</td>
																				</tr>
															...
															<!-- <tr>
																<td colspan="4"><label class="table-heading">Details
																		of Interest Subsidy for Industrial Research
																		claimed/admissible</label></td>
															</tr> -->
															<!-- <tr>
																<td colspan="4">
																	<h4 class="h2 text-center">Table-18</h4>
																</td>
															</tr> -->
															<%-- <tr>
																<td colspan="4">
																		...
																		<table class="table table-bordered">
																			<thead>
																				...
																				<tr>
																					...
																					<th rowspan="2">F.Y./Period for which
																						Industrial Research claimed</th>
																					<th colspan="2">Payment made to bank on loan
																						amount of P&M during FY/period under consideration
																						(as per bank’s certificate)</th>

																					<th rowspan="2">Industrial Research @ 5%
																						certified by bank</th>

																					<th rowspan="2">Industrial Research claimed by
																						the company</th>

																					<th rowspan="2">Annual permissible amount of
																						Industrial Research</th>

																					<th rowspan="2">Admissible amount of
																						Industrial Research</th>
																			...
																			<tbody>
																				<tr>
																					...
																					<td colspan="1"><form:input type="text" path ="firstbybankqis"
																						class="form-control bybankqis" name="" maxlength ="12"/></td>
																					<td colspan="1"><form:input type="text" path ="firstbycompanyqis"
																						class="form-control bycompanyqis" name="" maxlength ="12"/></td>
																					<td colspan="1"><form:input type="text" path ="firstannualpermissibleqis"
																						class="form-control annualpermissibleqis" name="" maxlength ="12"/></td>
																					<td colspan="1"><form:input type="text" path ="firstadmissibleamountqis"
																						class="form-control admissibleamountqis" name="" maxlength ="12"/></td>
																				...
																				<tr>
																					...
																					<td colspan="1"><form:input type="text" path ="secondbybankqis"
																						class="form-control bybankqis" name="" maxlength ="12"/></td>
																					<td colspan="1"><form:input type="text" path ="secondbycompanyqis"
																						class="form-control bycompanyqis" name="" maxlength ="12"/></td>
																					<td colspan="1"><form:input type="text" path ="secondannualpermissibleqis"
																						class="form-control annualpermissibleqis" name="" maxlength ="12"/></td>
																					<td colspan="1"><form:input type="text"  path ="secondadmissibleamountqis"
																						class="form-control admissibleamountqis" name="" maxlength ="12"/></td>
																				...
																				<tr>
																					...
																					<td colspan="1"><form:input type="text" path ="thirdbybankqis"
																						class="form-control bybankqis" name="" maxlength ="12"/></td>
																					<td colspan="1"><form:input type="text" path ="thirdbycompanyqis"
																						class="form-control bycompanyqis" name="" maxlength ="12"/></td>
																					<td colspan="1"><form:input type="text" path ="thirdannualpermissibleqis"
																						class="form-control annualpermissibleqis" name="" maxlength ="12"/></td>
																					<td colspan="1"><form:input type="text" path ="thirdadmissibleamountqis"
																						class="form-control admissibleamountqis" name="" maxlength ="12"/></td>
																				...
																				<tr>
																					...
																					<td colspan="1"><form:input type="text"  path = "fourthbybankqis"
																						class="form-control bybankqis" name="" maxlength ="12"/></td>
																					<td colspan="1"><form:input type="text" path = "fourthbycompanyqis" 
																						class="form-control bycompanyqis" name="" maxlength ="12"/></td>
																					<td colspan="1"><form:input type="text" path = "fourthannualpermissibleqis"
																						class="form-control annualpermissibleqis" name="" maxlength ="12"/></td>
																					<td colspan="1"><form:input type="text" path = "fourthadmissibleamountqis"
																						class="form-control admissibleamountqis" name="" maxlength ="12"/></td>
																				...
																				<tr>
																					...
																					<td colspan="1"><form:input type="text"  path ="fifthbybankqis"
																						class="form-control bybankqis" name="" maxlength ="12"/></td>
																					<td colspan="1"><form:input type="text" path ="fifthbycompanyqis"
																						class="form-control bycompanyqis" name="" maxlength ="12"/></td>
																					<td colspan="1"><form:input type="text" path ="fifthannualpermissibleqis"
																						class="form-control annualpermissibleqis" name="" maxlength ="12"/></td>
																					<td colspan="1"><form:input type="text" path ="fifthadmissibleamountqis"
																						class="form-control admissibleamountqis" name="" maxlength ="12"/></td>
																				...
																				<tr>
																					...
																					<td colspan="1"><form:input type="text" path ="totalbybankqis"
																						class="form-control bybanktotalqis" name="" readonly="true"/></td>
																					<td colspan="1"><form:input type="text" path ="totalbycompanyqis"
																						class="form-control bycompanytotalqis" name="" readonly="true"/></td>
																					<td colspan="1"><form:input type="text" path ="totalannualpermissibleqis"
																						class="form-control annualpermissibletotalqis" name="" readonly="true"/></td>
																					<td colspan="1"><form:input type="text" path ="totaladmissibleamountqis"
																						class="form-control admissibleamounttotalqis" name="" readonly="true"/></td>
															...
															<%-- <tr>
																<td colspan="4"><form:textarea class="form-control" path ="qisobservation"
																		maxlenght="10000" rows="4" placeholder=" Observations by PICUP" /></textarea>
																</td>
															</tr> --%>
															<tr class="disstamp-row">
																<td colspan="4"><label class="table-heading">Stamp
																...
																<td colspan="4">
																	<div class="table-responsive">
																		<table class="table table-bordered">
																			...
																			<tbody>
																				<tr>
																					<td><form:input path="computationFinYr"
																							type="text" class="form-control"
																							name="computationFinYr" /></td>
																					<td><input type="date" class="form-control"
																						name=""></td>
																					<td><input type="date" class="form-control"
																						name=""></td>
																					<td><form:input path="admissibleStampDuty"
																							type="text" class="form-control"
																							name="admissibleStampDuty" /></td>
																					...
																					<td><form:input path="stampDutyReimElig"
																							...
																							class="form-control" name="stampDutyReimElig" /></td>
																					<td><form:input path="stampDutyReimAvail"
																							type="text" class="form-control"
																							name="stampDutyReimAvail" /></td>
																				</tr>
																				<tr>
																					<td><strong>Total</strong></td>
																					<td></td>
																					...
																					<td><form:input path="ttlAdmissibleStampDuty"
																							type="text" class="form-control"
																							name="ttlAdmissibleStampDuty" readonly="true" /></td>
																					<td><form:input
																							path="ttlClaimStampDutyReimAmt" type="text"
																							class="form-control" readonly="true"
																							name="ttlClaimStampDutyReimAmt" /></td>
																					<td><form:input path="ttlStampDutyReimElig"
																							type="text" class="form-control" readonly="true"
																							name="ttlStampDutyReimElig" /></td>
																					<td><form:input path="ttlStampDutyReimAvail"
																							type="text" class="form-control" readonly="true"
																							name="ttlStampDutyReimAvail" /></td>
																				</tr>
																			</tbody>
															...
															<tr>
																<td colspan="4"><label class="table-heading">Electricity
															...
															<!-- <tr>
															<td colspan="4"><textarea class="form-control"
																	rows="4" placeholder="Relevant  Department comments"></textarea></td>
														</tr> -->
															<tr>
																<td colspan="4"><form:textarea class="form-control"
																		path="electricityObservation" rows="4"
																		placeholder=" Observations by PICUP" /> </textarea></td>
															</tr>

															<tr class="disepf-row">
																<td colspan="4"><label class="table-heading">EPF
																...
																<td colspan="4">
																	<div class="table-responsive">
																		<table class="table table-bordered">
																			...
																			<tbody>
																			<c:forEach items="${epfCompandElgibty}" var="epfList">
																				<tr>
																					<td><form:input path="epfComputFinYr1"
																							type="text" class="form-control"
																							name="epfComputFinYr1" value="${epfList.epfComputFinYr1}"/></td>
																					<td><form:input path="dateFrom"
																							type="date" class="form-control"
																							name="dateFrom" value="${epfList.dateFrom}"/></td>
																					<td><form:input path="dateTo"
																							type="date" class="form-control"
																							name="dateTo" value="${epfList.dateTo}"/></td>
																					<%-- <td><form:select path="epfComputFinYr1"
																							type="text" placeholder="Enter Year"
																							class="form-control  financial-year" value="${epfList.epfComputFinYr1}"
																					...
																					<td><form:input
																							path="employerContributionEPF1" type="text"
																							class="form-control  is-numeric epfclaim"
																							name="employerContributionEPF1" value="${epfList.employerContributionEPF1}"
																				...
																				<%-- <tr>
																					...
																					<td><form:input
																							path="employerContributionEPF2" type="text"
																							class="form-control is-numeric epfclaim"
																				...
																				<tr>
																					...
																					<td><form:input
																							path="employerContributionEPF3" type="text"
																							class="form-control is-numeric epfclaim"
																		...
																		<table class="table table-bordered">
																			<thead>
																				<tr>
																					...
																					<th>Date From</th>
																					<th>Date To</th>
																					<th>Claimed Mandi Fee Exemption</th>
																					<th>Eligible Amount</th>
																				</tr>
																			</thead>
																			<tbody>
															...
															<tr class="disallow-row">
																<td colspan="4"><label class="table-heading">Reimbursement
																		...
																		<table class="table table-bordered">
																			...
																			<tbody>
																				<tr>
																					...
																					<td><form:input path="eligiDisallowAvailAmt"
																							type="text" class="form-control"
																							name="eligiDisallowAvailAmt" /></td>
																				</tr>
																				<tr>
																					<td><strong>Total</strong></td>
																					...
																					<td><form:input
																							path="ttleligiDisallowAvailAmt" type="text"
																							class="form-control" readonly="true"
																							name="ttleligiDisallowAvailAmt" /></td>
																				</tr>
																			</tbody>
																		</table>
																	</div>
															...
															<tr>
																<td colspan="4"><label class="table-heading">
																		Brief of incentives claimed under IIEPP 2017</label></td>
															</tr>
															...
															<tr>
																<td colspan="4">
																	<h4 class="h2 text-center">Table-19</h4>
																</td>
															</tr>
															<tr>
																<td colspan="4">
																	<div class="table-responsive mt-3 cp-SGST add-row-new2">
																		<table class="table table-bordered">
																			<thead>
																				<tr>

																					<th>Financial Year/Period</th>
																					<th>Net SGST Deposited</th>
																					<th>Type of Incentives</th>
																					<th>Amount Claimed</th>
																					<th>Amount Already disbursed/ availed</th>
																					<th>Computed Amount for eligibility</th>
																				</tr>
																			...
																			<tbody>
																				...
																				<tr>
																					...
																					<td colspan="5"><strong>As the sum of
																							payable benefits cannot more than the deposited
																							Net SGST as well as 20% of admissible capital
																							investment (Rs……. crores), company is eligible
																							for total benefits during FY/Period </strong></td>
																				...
																				<tr>
																					...
																					<td colspan="5"><strong>Less: </strong>Already
																						reimbursed/availed -</td>
																				...
																				<tr>
																					...
																					<td colspan="5"><strong>Balance
																							amount eligible during FY/Period </strong></td>
															...
															<!-- <tr>
																<td colspan="4"><label class="table-heading">Company’s
																		Ledger Account in brief :- (Will be applicable 2nd
																		application for disbursement onwards) </label></td>
															</tr> -->

															<!-- <tr>
																<td colspan="4">
																	<h4 class="h2 text-center">Table-20</h4>
																</td>
															</tr> -->
															<!-- <tr>
																<td colspan="4">
																	<div class="table-responsive">
																		<table class="table table-bordered">
																			...
																			<tbody>
																				...
																				<tr>
																					<td>A.</td>
																					<td>Total eligibility of incentives
																						(80%/90%/100%/200%/300% of fixed capital
																						investment as per category/region)</td>
																					<td><input type="text" class="form-control"
																						name=""></td>
																				</tr>
																				<tr>
																					<td>B.</td>
																					<td>Date of admissibility for incentives</td>
																					<td><input type="text" class="form-control"
																						name=""></td>
																				</tr>
																				<tr>
																					<td>C.</td>
																					<td>Eligibility period for incentives (5 or 10
																						years)</td>
																					<td><input type="text" class="form-control"
																						name=""></td>
																				</tr>
																				<tr>
																					<td>D.</td>
																					<td>Disbursement effected till date</td>
																					<td><input type="text" class="form-control"
																						name=""></td>
																				</tr>
																				<tr>
																					<td>E.</td>
																					<td><strong>Balance as on date (A-D)</strong>
																					</td>
																					<td><input type="text" class="form-control"
																						name=""></td>
																				</tr>
																				<tr>
																					<td>F.</td>
																					<td>Now proposed (including ED exemption
																						availed Rs. __________/- ) for the period __________ to
																						_________)</td>
																					<td><input type="text" class="form-control"
																						name=""></td>
																				</tr>
																				<tr>
																					...
																					<td>Balance amount of eligibility of benefits
																						after proposed disbursal of benefits/incentives
																						(E-F)</td>
																					<td><input type="text" class="form-control"
																						name=""></td>
																				</tr>
																				<tr>
																					<td>H.</td>
																					<td>Balance period for total benefits</td>
																					<td><input type="text" class="form-control"
																						name=""></td>
																				</tr>
																				<tr>
																					<td>I.</td>
																					<td>Balance period for Capital Interest
																						Subsidy</td>
																					<td><input type="text" class="form-control"
																						name=""></td>
																				</tr>
																				<tr>
																					<td>J.</td>
																					<td>Balance period of Infrastructure Interest
																						Subsidy</td>
																					<td><input type="text" class="form-control"
																						name=""></td>
																				</tr>
																				<tr>
																					<td>K.</td>
																					<td>Balance period of EPF</td>
																					<td><input type="text" class="form-control"
																						name=""></td>
																				</tr>
																				<tr>
																					<td>L.</td>
																					<td>Balance period of Industrial Research
																						Subsidy</td>
																					<td><input type="text" class="form-control"
																						name=""></td>
																				</tr>
															...
															<tr>
																<td colspan="4"><label class="table-heading">Comments
																		of Nodal Agency</label> <textarea class="form-control mt-4"
																		placeholder="Comments of Nodal Agency " rows="2"></textarea>
																</td>
															</tr>
															<tr>
																<td colspan="4"><label class="table-heading">Proposal
																		for consideration of EC/SC </small>
																</label></td>
															</tr>
															<tr>
																<td colspan="4"><textarea class="form-control mt-4"
																		placeholder="Proposal for consideration of EC/SC "
																		rows="3"></textarea></td>
															</tr>
																		...
																		<table class="table table-bordered">
																			<tbody>
																				<tr>
																					...
																					<td colspan="3" width="40%">Total Eligibility
																						of incentives (80%/90%/100%/200%/300% of fixed
																						capital investment being Small/Medium/Large/Mega
																						Category in Region)</td>
																					



																					<td><input type="text"
																						placeholder=" Amount in INR" class="form-control"
																						name=""></td>
																				</tr>
																			</tbody>
																			...
																			<tbody>
																				<tr>
																					<td rowspan="2">2</td>
																					<td colspan="3" width="40%">Date of
																						admissibility of incentives</td>
																					</td>
															...
															<tr>
															 ...
															 <tr>
                                                <td colspan="4">
                                                    <h4 class="h2 text-center">Table-21</h4>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="4">
                                                    <label class="table-heading">Disbursement proposal as under
                                                    </label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="4">
                                                    <div class="table-responsive mt-3">
                                                        ...
                                                        <div class="table-responsive mt-3" id="productsDetailsTbl-222">
                                                            <table class="table table-stripped table-bordered">
                                                                <thead>
                                                                    <tr>
                                                                        <th>Financial Year </th>
                                                                        <th class="text-center">Duration / Period
                                                                ...
                                                                <tbody class="existing-proposed-products-222">
                                                                   <!--  <tr>
                                                                        <td>2015-2016</td>
                                                                        <td>1/2/2016</td>
                                                                        <td>XYZ</td>
                                                                ...
                                                                <tfoot>
                                                                    <tr>
                                                                        <td>
                                                                            <input type="text" id="ExistingProducts"
                                                                                class="form-control" name=""
                                                                                value="2015-2016">
                                                                        </td>
<td>
                                                                        ...
                                                                        <td>
                                                                           <select name="cars" id="cars" style="width:100% !important" style="height:20% !important">
                                                                                <option value="volvo">SGST Reimbursement</option>
                                                                                <option value="saab">Stamp Duty Exemption/Reimbursement</option>
                                                                                <option value="opel">EPF Reimbursement</option>
                                                                                 <option value="audi">Capital Interest Subsidy</option>
                                                                                  <option value="volvo">Infrastructure Interest Subsidy</option>
                                                                                <option value="saab">Interest Subsidy On Loans Research
                                                                                 Quality Improvement Etc.</option>
                                                                                <option value="opel">Reimbursement Of Disallowed Input Tax 
                                                                                Credit On Plant,building materials, and other Capitals goods</option>
                                                                                 <option value="audi">Exemption from Electricity Duty from capitive power for self-use</option>
                                                                                  <option value="volvo">Exemption from Electricity Duty on power drawn from power companies</option>
                                                                                <option value="saab">Exemption from Mandi Fee</option>
                                                                                <option value="opel">Industrial unit providing employment to differently abled workers
                                                                                 will be provided payroll assistence of Rs.500 per month for each such worker</option>
                                                                                
                                                                            </select>
                                                                        </td>
                                                                        <td>
                                                                            <input type="text"
                                                                                id="ProposedInstalledCapacity"
                                                                                class="form-control" name=""
                                                                                value="5000">
                                                                        </td>
                                                                        ...
                                                                        <td class="text-center">
                                                                            <a href="javascript:void();"
                                                                                class="btn btn-outline-success btn-sm add-save-data-222">Add</a>
                                                                        </td>
                                                                    </tr>
                                                                </tfoot>
                                                            </table>
                                            ...
                                            <tr>
                                                <td colspan="12">
                                                    <textarea class="form-control" placeholder="Observations By PICUP"
                                                        rows="2"></textarea>
                                                </td>
                                            </tr>

															<!-- <tr>
																<td colspan="4"><label><strong>Capital
																			Interest Subsidy</strong></label> <textarea class="form-control"
																		rows="4"></textarea></td>
															</tr> -->
															<!-- <tr>
																<td colspan="4"><label class="table-heading">Details
																		of term loan sanctioned/disbursed towards Plant &
																		Machinery</label></td>
															</tr> -->
															<!-- <tr>
																<td colspan="4"><h4 class="h2 text-center">Table-8</h4></td>
															</tr> -->
															<!-- <tr>
																<td colspan="4"><textarea class="form-control"
																		rows="4" placeholder=" Observations by PICUP"></textarea></td>
															</tr> -->
															<!-- <tr>
																<td colspan="4"><label class="table-heading">Brief
																		of incentives claimed under IIEPP 2017</label></td>
															</tr> -->
															<!-- <tr>
																<td colspan="4"><h4 class="h2 text-center">Table-10</h4></td>
															</tr> -->
															<!-- <tr>
																<td colspan="4">
																	<div class="table-responsive mt-3 cp-SGST add-row-new2">
																		<table class="table table-bordered">
																			<thead>
																				<tr>
																					<th>Financial Year / Pired</th>
																					<th>SGST Deposited</th>
																					<th>Type of Incentives</th>
																					<th>Amount Claimed</th>
																					<th>Amount Already disbursed/ availed</th>
																					<th>Computed Amount for eligibility</th>
																			...
																			<tbody>
																				<tr>
																					...
																					<td class="text-center"><a
																						...
																						class="btn btn-outline-success btn-sm add-save-data-gst2">Add</a></td>
																				</tr>
																			</tbody>
																		</table>
																	</div>
																...
																<td colspan="3"><form:form
																					...
																					<table class="table table-stripped table-bordered">
																						<thead>
																							<tr>
																								...
																								<th style="width: 10%;">Amount of
																									Incentives <small>(Rs. in crores)</small>
																								</th>
																						...
																						<tbody>
																							<tr class="ISF_Claim_Reim-row">
																								<td>1</td>
																								<td>Amount of SGST claimed for
																									reimbursement <br> <strong>Industrial
																							...
																							<tr class="ISF_Reim_SCST-row">
																								...
																								<td>Additional 10% GST where 25% minimum
																									SC/ST workers employed subject to minimum of
																									400 total workers in industrial undertakings
																									located in Paschimanchal and minimum of 200
																									total workers in B-P-M <br> <strong>Industrial
																										Development/ Commercial Tax</strong>
																								...
																								<td><a
																									href="./pdffiles/IIEPP_Rules_2017.pdf#page=6"
																									target="_blank">As per Table 3</a> of The
																									Rules, there is a provision for 75% Stamp Duty
																									Exemption in Paschimanchal Region. <br>Further,
																									as per G.O. No. 1515/77-6-18-5(M)/17, dated
																									1.5.2018, there is a provision for
																									reimbursement equivalent to the paid Stamp
																									Duty, for which company will have to apply
																							...
																							<c:if
																								...
																								<tr class="ISF_Reim_SCST-row">
																									<td colspan="5"><p class="text-info">Comment
																											From : Industrial Development/ Commercial Tax</p>
																										<form:textarea class="form-control"
																											path="isfScstComment" name="isfScstComment"
																							...
																							<tr class="ISF_Reim_FW-row">
																								...
																								<td><a
																									...
																									of The Rules, there is a provision for
																									incentive of reimbursement of EPF to the extent
																									of 50% of employer's contribution to all such
																									new Industrial undertakings providing direct
																							...
																							<c:if
																								...
																								<tr class="ISF_Reim_FW-row">
																									<td colspan="5"><p class="text-info">Comment
																											From : Industrial Development/ Commercial Tax</p>
																										<form:textarea class="form-control"
																											path="isffwComment" name="isffwComment"
																											disabled="" rows="3" placeholder="Comments"></form:textarea></td>
																								</tr>
																							</c:if>
																							<tr class="ISF_Reim_BPLW-row">
																								<td>1.3</td>
																								<td>Additional 10% GST where 25% minimum
																									BPL workers employed subject to minimum of 400
																									total workers in industrial undertakings
																									located in Paschimanchal and minimum of 200
																									total workers in B-P-M</td>
																							...
																							<c:if
																								...
																								<tr class="ISF_Reim_BPLW-row">
																									<td colspan="5"><p class="text-info">Comment
																											From : Industrial Development/ Commercial Tax</p>
																										<form:textarea class="form-control"
																											path="isfBplComment" name="isfBplComment"
																											disabled="" rows="3" placeholder="Comments"></form:textarea></td>
																								</tr>
																							</c:if>
																							<tr class="ISF_Stamp_Duty_EX-row">
																		...
																		<tr class="ISF_Additonal_Stamp_Duty_EX-row">
																			<td colspan="5"><p class="text-info">Comment
																					From : Stamp & Registration</p> <form:textarea
																											class="form-control"
																											path="isfStampscstComment"
																											name="isfStampscstComment" disabled=""
																					...
																					From : Labour/Industrial Development</p> <form:textarea
																						...
																						<tr class="ISF_Add_Epf_Reim_DIVSCSTF-row">
																							...
																							<td><form:input
																										...
																										maxlength="12"
																										name="ISF_Add_Epf_Reim_DIVSCSTF"
																		...
																		<tr class="ISF_EX_E_Duty-row">
																			<td colspan="5"><p class="text-info">Comment
																					From : UPPCL</p> <form:textarea class="form-control"
																											...
																											name="isfelepodownComment" disabled=""
																											rows="3" placeholder="Comments"></form:textarea></td>
																		</tr>
																	</c:if>
																		...
																		<tr class="ISF_EX_E_Duty_PC-row">
																			<td colspan="5"><p class="text-info">Comment
																					From : UPPCL</p> <form:textarea class="form-control"
																											path="isfElecdutyComment"
																											name="isfElecdutyComment" disabled=""
																											rows="3" placeholder="Comments"></form:textarea></td>
																		</tr>
																	</c:if>
															...
															<!-- <tr>
															<td colspan="4"><label class="table-heading">Turnover
																	of Base Production (For Item's Approved)</label></td>
														</tr> -->
														...
														<tr class="disiis-row">
															...
															<td colspan="3"><form:textarea path="iisCMAmtObserv"
																		id="iisCMAmtObserv"
																		placeholder="Observations By PICUP"
																		name="iisCMAmtObserv" class="form-control border-info"
																		rows="2"></form:textarea></td>
														</tr> --%>
															<!-- 	<tr>
															<td colspan="4"><label class="table-heading">Eligible
																	Amout of IIS</label></td>
														</tr> -->
															<%-- <tr>
															<td colspan="4">
																<table class="table table-bordered">
																	<thead>
																		...
																		<th>Eligible IIS (lower value of actual, applied
																			and IIS% subject to ceiling) <a
																				href="javascript:void(0);" class="remove-row"
																				data-toggle="tooltip" title=""
																				data-original-title="(Infrastructure Interest Subsidy @ 5% p.a. or actual interest paid whichever is
                                            less annually for 5 years in the form of reimbursement of interest paid on outstanding loan taken for procurement of
                                            Infrastructure, subject to an annual ceiling of Rs. 1 Cr. However, additional Infrastructure
                                            Interest Subsidy @ 2.5% upto maximum of 7.5% shall be applicable in case of industrial undertakings having 75% equity owned by Divyang/SC/CT/Females Promoters.)"><i
																	...
																	<tbody>
																		<tr>
																			...
																			<td><form:input path="propIntInfraPA1"
																						...
																						class="form-control"
																						value="${finterPnMateligiiis}" readonly="true" /></td>
																		...
																		<tr>
																			...
																			<td><form:input path="propIntInfraPA2"
																						...
																						class="form-control"
																						value="${sinterPnMateligiiis}" readonly="true" /></td>
																		...
																		<tr>
																			...
																			<td><form:input path="propIntInfraPA3"
																						...
																						class="form-control"
																						value="${tinterPnMateligiiis}" readonly="true" /></td>
															...
															<!-- <tr class="dismandi-row">
															<td colspan="4"><label class="table-heading">Mandi
															...
															<td colspan="4">
																<div class="table-responsive">
																	<table class="table table-bordered">
																		...
																		<tbody>
																			<tr>
																				<td width="50%"><form:input
																							path="mandiFeeExeFinYr1" type="text"
																							class="form-control" name="mandiFeeExeFinYr1" /></td>
														...
														<tr class="disallow-row">
															...
															<td colspan="4"><form:textarea
																...
																<!-- <tr>
															<td colspan="4"><label class="table-heading">Admissible
																	Benefits (<a
																		href="./pdffiles/IIEPP_Rules_2017.pdf#page=6"
													...
													<tbody>
														...
														<tr>
															...
															<td><form:input path="invPeriodCompl" type="text"
																		class="form-control" id="invPeriodCompl"
																		readonly="true" /></td>
														...
														<c:if test="${natureOfProject !='NewProject'}">
															<tr>
																...
																<td><strong>List of Assets</strong> Whether List of
																	...
																	preceding financial year before first date Of
																	investment (Cut Off Date). <a
																		href="./downloadExistProjDoc?fileName=${charatEngFileName}">View
																		File</a></td>
																<td><form:input path="listOfAssetsCompl"
																			type="text" class="form-control" name="" /></td>
														...
														<tr>
															...
															<td><form:input path="authSignCompl" type="text"
																		class="form-control" value="${bussAuthSigName}"
																		name="" readonly="true" /></td>
																...
																<table class="table table-bordered">
																	...
																	<tbody>
																		<tr>
																			...
																			<td width="50%"><form:input path="ttlEligAmt"
																						type="text" id="ttlEligAmt"
																		...
																		<tr>
																			...
																			<td width="50%"><form:input path="propDisbAmt"
																						type="text" class="form-control is-numeric" /> <small
																					class="words text-info"></small></td>
																		</tr>
																		<tr>
																			<td>C.</td>
																			...
																			<td width="50%"><form:input
																						path="eligBenefitsAmt" type="text"
																						class="form-control is-numeric" /> <small
																					class="words text-info"></small></td>
																		</tr>
																		...
																		<tr>
																			...
																			<td width="50%"><form:input
																						path="balancePeriodAmt" type="text"
																						class="form-control is-numeric" /> <small
																					class="words text-info"></small></td>
																		</tr>
																	</tbody>
									...
									<div class="row mt-4">
										<div class="col-sm-12 text-center">
											...
											<button type="submit" id="button1"
												...
												onclick="return enableButton2()">Evaluation
												Completed</button>
	...
	<script type="text/javascript">
		...
		function totalbybank() {
			var sum = 0;
			$(".bybank").each(function() {
				sum += +$(this).val();
			});
			$(".bybanktotal").val(sum);
		}

		$(document).ready(totalbybank);
		$(document).on("keyup", totalbybank);
		$(document).on("change", totalbybank);

		function totalbycompany() {
			var sum = 0;
			$(".bycompany").each(function() {
				sum += +$(this).val();
			});
			$(".bycompanytotal").val(sum);
		}

		$(document).ready(totalbycompany);
		$(document).on("keyup", totalbycompany);
		$(document).on("change", totalbycompany);

		function totalannualpermissible() {
			var sum = 0;
			$(".annualpermissible").each(function() {
				sum += +$(this).val();
			});
			$(".annualpermissibletotal").val(sum);
		}

		$(document).ready(totalannualpermissible);
		$(document).on("keyup", totalannualpermissible);
		$(document).on("change", totalannualpermissible);

		function totaladmissibleamount() {
			var sum = 0;
			$(".admissibleamount").each(function() {
				sum += +$(this).val();
			});
			$(".admissibleamounttotal").val(sum);
		}

		$(document).ready(totaladmissibleamount);
		$(document).on("keyup", totaladmissibleamount);
		$(document).on("change", totaladmissibleamount);

		function totalbybankiis() {
			var sum = 0;
			$(".bybankiis").each(function() {
				sum += +$(this).val();
			});
			$(".bybanktotaliis").val(sum);
		}

		$(document).ready(totalbybankiis);
		$(document).on("keyup", totalbybankiis);
		$(document).on("change", totalbybankiis);

		function totalbycompanyiis() {
			var sum = 0;
			$(".bycompanyiis").each(function() {
				sum += +$(this).val();
			});
			$(".bycompanytotaliis").val(sum);
		}

		$(document).ready(totalbycompanyiis);
		$(document).on("keyup", totalbycompanyiis);
		$(document).on("change", totalbycompanyiis);

		function totalannualpermissibleiis() {
			var sum = 0;
			$(".annualpermissibleiis").each(function() {
				sum += +$(this).val();
			});
			$(".annualpermissibletotaliis").val(sum);
		}

		$(document).ready(totalannualpermissibleiis);
		$(document).on("keyup", totalannualpermissibleiis);
		$(document).on("change", totalannualpermissibleiis);

		function totaladmissibleamountiis() {
			var sum = 0;
			$(".admissibleamountiis").each(function() {
				sum += +$(this).val();
			});
			$(".admissibleamounttotaliis").val(sum);
		}

		$(document).ready(totaladmissibleamountiis);
		$(document).on("keyup", totaladmissibleamountiis);
		$(document).on("change", totaladmissibleamount);


		function totalbybankqis() {
			var sum = 0;
			$(".bybankqis").each(function() {
				sum += +$(this).val();
			});
			$(".bybanktotalqis").val(sum);
		}

		$(document).ready(totalbybankqis);
		$(document).on("keyup", totalbybankqis);
		$(document).on("change", totalbybankqis);

		function totalbycompanyqis() {
			var sum = 0;
			$(".bycompanyqis").each(function() {
				sum += +$(this).val();
			});
			$(".bycompanytotalqis").val(sum);
		}

		$(document).ready(totalbycompanyqis);
		$(document).on("keyup", totalbycompanyqis);
		$(document).on("change", totalbycompanyqis);

		function totalannualpermissibleqis() {
			var sum = 0;
			$(".annualpermissibleqis").each(function() {
				sum += +$(this).val();
			});
			$(".annualpermissibletotalqis").val(sum);
		}

		$(document).ready(totalannualpermissibleqis);
		$(document).on("keyup", totalannualpermissibleqis);
		$(document).on("change", totalannualpermissibleqis);

		function totaladmissibleamountqis() {
			var sum = 0;
			$(".admissibleamountqis").each(function() {
				sum += +$(this).val();
			});
			$(".admissibleamounttotalqis").val(sum);
		}

		$(document).ready(totaladmissibleamountqis);
		$(document).on("keyup", totaladmissibleamountqis);
		$(document).on("change", totaladmissibleamount);
		...
		function VIandVIITotal1() {
			var sum = 0;
			$(".VIandVIITotal1").each(function() {
				sum += +$(this).val();
			});
			$(".VIandVIITotal1t").val(sum);
		}
		...
		function StatutoryAmountTotal() {
			var sum = 0;
			$(".table5v").each(function() {
				sum += +$(this).val();
			});
			$(".table5vsubtA", this).val(sum);
		}
		$(document).ready(StatutoryAmountTotal);
		$(document).on("keyup", StatutoryAmountTotal);
		$(document).on("change", StatutoryAmountTotal);
		
		function BeforeOptTotal() {
			var sum = 0;
			$(".beforeoptsubt1").each(function() {
				sum += +$(this).val();
			});
			$(".beforeoptsubttotal", this).val(sum);
		}

		$(document).ready(BeforeOptTotal);
		$(document).on("keyup", BeforeOptTotal);
		$(document).on("change", BeforeOptTotal);
		...
		function perBankInvTotal() {
			var sum = 0;
			$(".perBankinv").each(function() {
				sum += +$(this).val();
			});
			$(".perBankInvTotal", this).val(sum);
		}

		$(document).ready(perBankInvTotal);
		$(document).on("keyup", perBankInvTotal);
		$(document).on("change", perBankInvTotal);

		function subBankInvTotal() {
			var sum = 0;
			$(".subBankInv").each(function() {
				sum += +$(this).val();
			});
			$(".subBankInvTotal", this).val(sum);
		}

		$(document).ready(subBankInvTotal);
		$(document).on("keyup", subBankInvTotal);
		$(document).on("change", subBankInvTotal);
		...
		function subTtlNodalTotal() {
			var sum = 0;
			$(".subTtlNodal").each(function() {
				sum += +$(this).val();
			});
			$(".subTtlNodalTotal", this).val(sum);
		}

		$(document).ready(subTtlNodalTotal);
		$(document).on("keyup", subTtlNodalTotal);
		$(document).on("change", subTtlNodalTotal);
...
function bankLoanTotal() {
	var sum = 0;
	$(".bankloanAmt").each(function() {
		sum += +$(this).val();
	});
	$(".bankloanAmtTotal", this).val(sum);
}

$(document).ready(bankLoanTotal);
$(document).on("keyup", bankLoanTotal);
$(document).on("change", bankLoanTotal);
