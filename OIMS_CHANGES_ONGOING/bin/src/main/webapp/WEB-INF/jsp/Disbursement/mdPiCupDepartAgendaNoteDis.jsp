		...
		<div class="container-fluid" id="main">
			<div class="row row-offcanvas row-offcanvas-left">
				...
				<div class="col-md-9 col-lg-10 mt-4 main">
					<h4
						class="card-title mb-4 mt-4 text-center">Agenda
						Note</h4>
					<div class="card card-block p-4 mb-5 prepare-agenda-note-tabs">
						...
						<div class="step-links">
							<ul class="only-steps">
								<li><a href="./mdPiCupAgendaNote" class="pr-3">Prepare Agenda
										Note for LOC</a></li>
								<li><a href="./mdPiCupAgendaNoteDis" class="active pr-3">Prepare
														...
														<tbody>
															<c:forEach var="list"
																...
																<%-- <tr>
																	...
																	<td>${list.appliId}</td>
																	<td>${megaSubmissionDate}</td>
																	<td><a
																		href="./viewAgendaDetailsByMdPiCupLargeDepartDis?applicantId=${list.appliId}"
																		class="btn btn-outline-info btn-sm">View</a> <a
																		href="#commentNote"
																		class="btn btn-outline-success btn-sm"
																		data-toggle="modal" id="${list.appliId}"
																		data-target="#edit-modal">Comment</a> <a
																		href="./disApprovedAgendaNoteACS?applicantId=${list.appliId}"
																		class="btn btn-outline-success btn-sm"
																		onclick="return ApprovedAgendaNoteValidation();">Forward to
																			ACS Industry</a></td>
																</tr>
															</c:forEach>
														</tbody>
														...
														<tbody>
															<c:forEach var="list"
																...
																<%-- <tr>
																	...
																	<td class="text-center">${counter.index+1}</td>
																	<td>${list.appliId}</td>
																	<td>${largeSubmissionDate}</td>
																	<td><a
																		href="./viewAgendaDetailsByMdPiCupLargeDepartDis?applicantId=${list.appliId}"
																		class="btn btn-outline-info btn-sm" onsubmit="return preAgenNoSanctionCommVali()">View</a> <a
																		href="#commentNote"
																		class="btn btn-outline-success btn-sm"
																		data-toggle="modal" id="${list.appliId}"
																		data-target="#edit-modal">Comment</a> <a
																		href="./disApprovedAgendaNoteACS?applicantId=${list.appliId}"
																		class="btn btn-outline-success btn-sm"
																		onsubmit="return preAgenNoSanctionCommVali()">Forward to
																			ACS Industry</a></td>
																</tr>
		...
		<div class="modal fade" id="edit-modal">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<form:form modelAttribute="PrepareAgendaNotesDis"
						action="saveCommenSubByMdPicupDepartmentDis" class="mt-4"
						name="PrepareAgendaNotes" method="post">
						<!-- Modal body -->
						<div class="modal-body">
							<div class="row">
								<div class="col-sm-12">
									<div class="form-group">
										<form:textarea path="mdComments" class="form-control"
