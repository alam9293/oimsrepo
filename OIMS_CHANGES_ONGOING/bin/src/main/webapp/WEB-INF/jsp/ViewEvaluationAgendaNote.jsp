												...
												<c:forEach var="list" items="${investmentDetailsmixedList}"
													...
													<tr>
														...
														<td><input type="submit" value="View"
															...
															formaction="./dispalyAgendaNoteByJICDepart?appliId=${list.appliId}"
						...
						<div class="row" id="showHide2">
							<div class="col-sm-12">
								<div class="mt-4">
									<div class="without-wizard-steps">
										<h4
											class="card-title mb-4 mt-4 text-center animate__animated animate__fadeInDown"> INCENTIVES SOUGHT</h4>
									</div>
								</div>
								<hr class="mt-2 mb-5">
								<div class="row">
										...
										<div class="table-responsive">
											<table class="table table-stripped table-bordered">
												<thead>
													<tr>
														<th>Sr. No.</th>
														<th style="width: 25%;">Details of Incentive Sought
												...
												<tbody>
													<tr>
														...
														<td><a href="./pdffiles/IIEPP_Rules_2017.pdf"
															target="_blank">As per Table â 3</a> of Rules
															related to IIEPP-2017 (The Rules), there is a provision
															for reimbursement of 70% of deposited GST (Net SGST) for
															10 years.</td>
