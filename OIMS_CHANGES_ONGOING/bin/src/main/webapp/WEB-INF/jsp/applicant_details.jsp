...
<script>
	...
	$(document).ready(function() {
		$(document).on("change", ".form-control", function() {
			...
			//$('.appAadharNo').rules('remove');
			 document.getElementById("appAadharNo").disableValidation = true;
			 document.getElementById("appDesignation").disableValidation = true;
			 
			document.getElementById("myFormA").action = "autosaveApplicantDetails";
					...
					<div class="form-card">
						<div class="without-wizard-steps">
							<div class="step-links">
								<div class="row">
									<ul>
										<li><a href="#" class="active"><span>1</span>Authorized Signatory Details</a></li>
										<li>
										<c:if test="${not empty Bflag}">
										<a href="./getIdByTabs1?busiTab=busiTab" class="filled"><span>2</span> Business Entity Details</a>
										</c:if>
										<c:if test="${ empty Bflag}">
										<a href="./getIdByTabs1?busiTab=busiTab"><span>2</span> Business Entity Details</a>
										</c:if>
										</li>
										
										<li>
										<c:if test="${not empty Pflag}">
										<a href="./getIdByTabs2?projTab=projTab" class="filled"><span>3</span> Project Details</a>
										</c:if>
										<c:if test="${ empty Pflag}">
										<a href="./getIdByTabs2?projTab=projTab"><span>3</span> Project Details</a>
										</c:if>
										</li>
										
									    <li>
									    <c:if test="${not empty Iflag}">
									    <a href="./getIdByTabs3?investTab=investTab" class="filled"><span>4</span> Investment Details</a>
									    </c:if>
									     <c:if test="${empty Iflag}">
									    <a href="./getIdByTabs3?investTab=investTab"><span>4</span> Investment Details</a>
									    </c:if>
									    </li>
									    
									    <li>
									    <c:if test="${not empty PEflag}">
									    <a href="./getIdByTabs4?propoTab=propoTab" class="filled"><span>5</span> Proposed Employment Details</a>
									    </c:if>
									    <c:if test="${empty PEflag}">
									    <a href="./getIdByTabs4?propoTab=propoTab"><span>5</span> Proposed Employment Details</a>
									    </c:if>
									    </li>												
									</ul>
								</div>
								...
								<form:form action="saveApplicantDetails" class="isf-form"
									...
									<div class="tab-content py-2">
										<div class="tab-pane active">
											<div class="row">
												<div class="col-sm-12 mt-4">
													<h3 class="common-heading">Authorized Signatory
														Details <a href="javascript:void(0);" class="remove-row" data-toggle="tooltip" title="" data-original-title="Please Enter the Authorized Person Details of your Company"><i class="fa fa-info-circle text-info"></i></a></h3>
												</div>
											</div>
											<div class="row">
												...
												<div class="col-md-6 col-lg-4 col-xl-4">
													<div class="form-group">
														...
														<form:input path="appFirstName" class="form-control"
															...
															id="appFirstName" readonly="true"></form:input>
												...
												<div class="col-md-6 col-lg-4 col-xl-4">
													<div class="form-group">
														...
														<form:input path="appMiddleName" class="form-control"
															readonly="true" onkeypress="return validateTextField()"
												...
												<div class="col-md-6 col-lg-4 col-xl-4">
													<div class="form-group">
														...
														<form:input path="appMobileNo" class="form-control"
															readonly="true" onkeypress="return validateNumberField()"
															maxlength="10" id="appMobileNo"></form:input>
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<form:input path="appAadharNo" class="form-control"
															onkeyup="return AadharValidate();" onkeypress="return validateNumberField()" maxlength="12"
											...
											<div class="col-sm-6">
												<div class="form-group">
													...
													<form:input path="appAddressLine1" class="form-control"
														maxlength="250" readonly="true" id="appAddressLine1"></form:input>
										...
										<div class="row">
											...
											<button type="button" class="common-btn mt-3" onclick="editApplicantDetails()"><i class="fa fa-edit"></i>Edit</button>
											</c:if>
