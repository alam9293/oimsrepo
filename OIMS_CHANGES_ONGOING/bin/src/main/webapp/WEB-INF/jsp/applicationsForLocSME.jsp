...
<title>View And Forward SME Applications</title>
...
<body>
														...
														<c:forEach var="list" items="${investmentDetailsList}"
															...
															<tr>
																...
																<td class="text-center"><a
																	href="./viewApplicationDetailsSME?applicantId=${list[0]}"
																...
																<td class="text-center"><a id="appId"
																	onclick="forwardtoDIC('${list[0]}')"
																	class="btn btn-outline-success btn-sm mb-3"
																	href="./forwardToDICSMDepart?appliId=${list[0]}">Forward
																		to DIC</a></td>
															</tr>
	...
	<script>
		function forwardtoDIC(appId) {

			var r = confirm("Are you Sure Want to Forward the Application to DIC?");

			var dicID = appId;

			if (r == true) {

				alert("Your Application ID - " + dicID
						+ " Forwarded to DIC Successfully");
