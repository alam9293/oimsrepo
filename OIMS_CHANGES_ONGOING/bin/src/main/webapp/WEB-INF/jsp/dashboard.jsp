				...
				<div class="col-md-3 col-lg-2 sidebar-offcanvas pt-3" id="sidebar"
					...
					<ul class="nav flex-column pl-1">
						<li class="nav-item animate__animated animate__bounce"><a
							class="nav-link active" href="./dashboard"><i
				...
				<div class="col-md-9 col-lg-10 mt-4 main">
					...
					<div class="row mb-5">
						...
						<div class="col-sm-4">
							<div class="card card-block p-4 h-100">
								<a href="javascript:void(0);"
									class="dashboard-tiels pendings-tiels"> <label>${countDeferLoc}	<i class="fa fa-clock-o pull-right"></i>
								</label>
					...
					<div class="row mb-5">
						...
						<div class="col-sm-4">
							<div class="card card-block p-4 h-100">
								<a href="javascript:void(0);"
									class="dashboard-tiels raised-tiels"> <label>${countQueryLoc} <i
										class="fa fa-question-circle pull-right"></i></label>
					...
					<div class="row mb-5">
						<div class="col-sm-4">
							<div class="card card-block p-4 h-100">
								<a href="javascript:void(0);"
									class="dashboard-tiels ready-tiels"> <label>${countPreparedLoc } <i
										class="fa fa-thumbs-up pull-right"></i></label>
						...
						<div class="col-sm-4">
							<div class="card card-block p-4 h-100">
								<a href="javascript:void(0);"
									class="dashboard-tiels agenda-tiels"> <label>${countApprovalLoc} <i
										class="fa fa-clipboard pull-right"></i></label>
						...
						<div class="col-sm-4">
							<div class="card card-block p-4 h-100">
								<a href="javascript:void(0);"
									class="dashboard-tiels review-tiels"> <label>${ApprovedByCommitee} <i
										class="fa fa-check pull-right"></i></label>
...
<!-- //-------------------------------------------------------------------------------------------------------------------------------------------------- -->
					...
					<div class="row mb-5">
						<div class="col-sm-4">
							<div class="card card-block p-4 h-100">
								<a href="javascript:void(0);"
									class="dashboard-tiels received-tiels"> <label>${countIssuedDis}<i
										class="fa fa-get-pocket pull-right"></i></label>
									<hr> <span>Total Number of Applications Received</span>
								</a>
							</div>
						</div>
						<div class="col-sm-4">
							<div class="card card-block p-4 h-100">
								<a href="javascript:void(0);"
									class="dashboard-tiels issued-tiels"> <label>0
										<i class="fa fa-clipboard pull-right"></i>
								</label>
									<hr> <span>Number of Disbursement Issued</span>
								</a>
							</div>
						</div>
						<div class="col-sm-4">
							<div class="card card-block p-4 h-100">
								<a href="javascript:void(0);"
									class="dashboard-tiels pendings-tiels"> <label>${countDeferDis}
...
<!-- //========================================================================================================================================== -->					
					<div class="row mb-5">
						<div class="col-sm-4">
							<div class="card card-block p-4 h-100">
								<a href="javascript:void(0);"
									class="dashboard-tiels rejected-tiels"> <label>${countRejectDis} <i
										class="fa fa-window-close pull-right"></i></label>
									<hr> <span>Number of Applications Rejected</span>
								</a>
							</div>
						</div>
						<div class="col-sm-4">
							<div class="card card-block p-4 h-100">
								<a href="javascript:void(0);"
									class="dashboard-tiels raised-tiels"> <label>${countQueryDis}
						...
						<div class="col-sm-4">
							<div class="card card-block p-4 h-100">
								<a href="javascript:void(0);"
									class="dashboard-tiels evaluation-tiels"> <label>${countIncludeDis}
										<i class="fa fa-sliders pull-right"></i>
								</label>
									<hr> <span>Number of Applications Under Evaluation</span>
								</a>
...
<!-- //########################################################################################################################### -->					
		...
		<div class="row mb-5">
						<div class="col-sm-4">
							<div class="card card-block p-4 h-100">
								<a href="javascript:void(0);"
									class="dashboard-tiels ready-tiels"> <label>${countAgendaNotePreparedDis}<i
										class="fa fa-thumbs-up pull-right"></i></label>
									<hr> <span>Number of Applications Ready for
										Sanctioning/Empowered Committee</span>
								</a>
						...
						<div class="col-sm-4">
							<div class="card card-block p-4 h-100">
								<a href="javascript:void(0);"
									class="dashboard-tiels agenda-tiels"> <label>${countApprovedByAcsDis}
										<i class="fa fa-clipboard pull-right"></i>
								</label>
									<hr> <span>Number of Applications Pending for
										Approval of Hon'ble Cabinet</span>
						...
						<div class="col-sm-4">
							<div class="card card-block p-4 h-100">
								<a href="javascript:void(0);"
									class="dashboard-tiels review-tiels"> <label>${countApprovedByAcsDis}
										<i class="fa fa-check pull-right"></i>
								</label>
									<hr> <span>Number of Applications Approved by
										Sanctioning Committee/Hon'ble Cabinet and Pending for Issuance
										of Disbursement</span>
								</a>
							</div>
						</div>
					</div>
