			...
			<div class="row row-offcanvas row-offcanvas-left">
				<div class="col-md-3 col-lg-2 sidebar-offcanvas pt-3" id="sidebar"
					...
					<ul class="nav flex-column pl-1">
						...
						<li class="nav-item animate__animated animate__bounce"><a
							class="nav-link active" href="./viewAndEvaluate"><i
				...
				<div class="col-md-9 col-lg-10 mt-4 main mb-4">
					...
					<div class="card card-block p-3">
						...
						<spring:url value="/EvaluateProjectDetails"
							var="EvaluateProjectDetailsActionUrl" />
						<form:form modelAttribute="EvaluateProjectDetails" method="post"
							action="${EvaluateProjectDetailsActionUrl}" class="mt-4"
							autocomplete="off">
							<form:hidden path="id" />
							<div class="row mt-5">
								<div class="col-sm-12">
								...
								<div class="col-md-12 mt-4">
									<div class="form-group">
										...
										<form:textarea path="propsProdtDetailObserv"
											name="propsProdtDetailObserv" class="form-control"
											value="${propsProdtDetailObserv}" rows="5"></form:textarea>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-12">
									<div class="mt-4">
										<div class="without-wizard-steps">
											<h4
												class="card-title mb-4 mt-4 text-center animate__animated animate__fadeInDown">Evaluate
												Application</h4>
										</div>
									</div>
									<hr class="mt-2 mb-5">
												...
												<table class="table table-bordered">
													...
													<tbody>
														<tr>
															...
															<td><form:textarea name="projectObserv"
																	path="projectObserv" value="${projectObserv}"
																	class="form-control" rows="2"></form:textarea></td>
														...
														<tr class="hidep-tbl-row">
															<td><label class="table-heading">Product
																	Details</label></td>
															<td><form:input path="productDetails" type="text"
																	maxlength="500" value="${products}"
																	class="form-control" name=""></form:input></td>
															<td><form:textarea path="prodDetailObserv"
																	name="prodDetailObserv" class="form-control" rows="2" />
															</td>
														</tr>
														<tr>
															<td colspan="3" class="p-4">
																	...
																	<table class="table table-stripped table-bordered"
																		...
																		<tbody class="existing-proposed-products">
																			<c:forEach var="list"
																				...
																				varStatus="counter">
																				<tr>
																					<td><form:hidden path="epdId"
																							value="${list.epdId}" /></td>
																					<td><form:input path="epdExisProducts"
																							id="epdExisProductsId" name="epdExisProducts"
																							value="${list.epdExisProducts}"
																							class="form-control"></form:input></td>
																					<td><form:input path="epdExisInstallCapacity"
																							id="epdExisInstallCapacityId"
																							name="epdExisInstallCapacity"
																							value="${list.epdExisInstallCapacity}"
																							class="form-control"></form:input></td>
																					<td><form:input path="epdPropProducts"
																							id="epdPropProductsId" name="epdPropProducts"
																							value="${list.epdPropProducts}"
																							class="form-control"></form:input></td>
																					<td><form:input path="epdPropInstallCapacity"
																							id="epdPropInstallCapacityId"
																							name="epdPropInstallCapacity"
																							value="${list.epdPropInstallCapacity}"
																							class="form-control"></form:input></td>
																					<td><form:input path="epdExisGrossBlock"
																							id="epdExisGrossBlockId" name="epdExisGrossBlock"
																							value="${list.epdExisGrossBlock}"
																							class="form-control"></form:input></td>
																					<td><form:input path="epdPropoGrossBlock"
																							id="epdPropoGrossBlockId"
																...
																<div class="table-responsive mt-3">
																	<table class="table table-stripped table-bordered">
																		<tbody>
																			<tr>
																				<td style="width: 33%;">Full Registered Address
																					of Company</td>
																				<td style="width: 33%;"><input type="text"
																					name="fullAddress" class="form-control"
																					id="fullAddress" readonly="true"
																					value="${businessAddress}" /> <span
																					id="fullAddress" class="text-danger color:red"></span>
																					<form:errors path="fullAddress"
																						class="control-label" cssStyle="color:red" /></td>
																				<td rowspan="4"><form:textarea
																						name="locationObserv" path="locationObserv"
																						placeholder="Observations Comment By PICUP"
																						value="${locationObserv}" class="form-control"
																						rows="10"></form:textarea></td>
																			</tr>
																			<tr>
																				<td>Full Address of Unit</td>
																				<td><input type="text" class="form-control"
																					value="${fullAddrs}" disabled="" name=""></td>
																			</tr>
																			<tr>
																				<td>District</td>
																				<td><input type="text" name="districtName"
																					class="form-control" readonly="true"
																					id="districtName" value="${district}"><span
																					id="DistrictName" class="text-danger color:red"></span>
																			...
																			<tr>
																				...
																				<td><input type="text" name="resionName"
																					class="form-control" id="resionName"
																					readonly="true" value="${region}"> <span
																					id="resionName" class="text-danger color:red"></span>
																					<form:errors path="resionName"
														...
														<tr>
															<td colspan="3">
																<div class="table-responsive">
																	<label class="table-heading mb-3">Director
																		Details</label>
																	<table class="table table-bordered">
																		<thead>
																			<tr>
																	...
																	<form:textarea name="dirDetailsObserv"
																		path="dirDetailsObserv" id="direcObserv"
																		placeholder="Observations Comment By PICUP"
																		value="${dirDetailObserv}" class="form-control"
																	...
																	<table class="table table-stripped table-bordered">
																		<tbody>
																			<tr>
																				...
																				<td><form:textarea name="totalDetailObserv"
																						path="totalDetailObserv" id="totalempObserv"
																						placeholder="Observations Comment By PICUP"
																						value="${totalEmpDetailObserv}"
																						class="form-control" rows="2"></form:textarea></td>
																			</tr>
																			<tr>
																				<td colspan="3">
														...
														<c:if test="${natureOfProject=='Expansion'}">
															<tr>
																<td><label class="table-heading">If
																		...
																		block more than 25% of the existing gross block <a
																		href="./downloadExistProjDoc?fileName=${caCertificateFileName}"><small>(View
																				File)</small></a>
																</label></td>
																<td><input type="text" class="form-control"
																	value="Yes" readonly="readonly" id="pergrosblockId"></td>
																<td><form:textarea name="expDivfObserv"
																		path="expDivfObserv"
																		placeholder="Observations Comment By PICUP"
																		value="${expDivfObserv}" class="form-control" rows="2"></form:textarea></td>
															</tr>
														</c:if>
														...
														<tr>
															...
															<td><form:input path="invIndType"
																	class="form-control" value="${category}"
																	readonly="true" id="categoryId"></form:input></td>
															<td><form:textarea name="catIndusUndtObserv"
																	path="catIndusUndtObserv" id="catObserv"
																	placeholder="Observations Comment By PICUP"
																	value="${invcatundtakObserv}" class="form-control"
																	rows="2"></form:textarea></td>

														</tr>

														<tr>
															<td><label class="table-heading">Total cost
																	of project and Investment in Plant and Machinery</label></td>
															<td><textarea class="form-control" rows="2"
																	disabled="disabled">Total Cost of Project ${InvTPC} , &#13;&#10;Plant & Machinery Cost ${invPlantAndMachCost} </textarea>
															</td>
															<td><form:textarea name="propsPlntMcnryCostObserv"
																	path="propsPlntMcnryCostObserv" id="plantMachObserv"
																	placeholder="Observations Comment By PICUP"
																	value="${propsPlntMcnryCostObserv}"
																	class="form-control" rows="2"></form:textarea></td>
														</tr>


														<tr>
															<td><label class="table-heading">Opted
																	Cut-off date investment</label></td>
															<td><form:input type="text" path="invCommenceDate"
																	value="${optedcufoffdate}" class="form-control"
																	readonly="true"></form:input></td>
															<td><form:textarea name="optcutofdateobserv"
																	path="optcutofdateobserv" id="cutoffdateObserv"
																	placeholder="Observations Comment By PICUP"
																	value="${optcutofdateObserv}" class="form-control"
																	rows="2"></form:textarea></td>
														</tr>
														<tr>
															<td><label class="table-heading">Proposed
																	Date of Commencement of Commercial Production</label></td>
															<td><form:input type="text" path="propCommProdDate"
																	value="${invPropCommProdDate}" class="form-control"
																	readonly="true"></form:input></td>
															<td><form:textarea name="dateofComProdObserv"
																	path="dateofComProdObserv" id="comprodObserv"
																	placeholder="Observations Comment By PICUP"
																	value="${dateofcumProdObserv}" class="form-control"
																	rows="2"></form:textarea></td>
														</tr>
														...
														<c:if test="${natureOfProject=='Expansion'}">
															<tr>
																...
																<td><form:textarea name="detailProjReportObserv"
																		path="detailProjReportObserv"
																		id="detailProjReportObserv"
																		placeholder="Observations Comment By PICUP"
																		value="${projreportObserv}" class="form-control"
																		rows="2"></form:textarea></td>
															</tr>
														</c:if>
														...
														<c:if test="${natureOfProject !='NewProject'}">
															<tr>
																<td><label class="table-heading">List of
																		Assets</label>
																	<p>
																		Whether List of Assets (in Expansion/Diversification
																		Cases only) certified by C.E. Submitted. <a
																			href="./downloadExistProjDoc?fileName=${charatEngFileName}">View
																			File</a>
																	</p></td>
																<td><textarea name="listAssets"
																		class="form-control" rows="3">${listAssets}</textarea></td>
																<td><form:textarea name="listAssetsObserv"
																		path="listAssetsObserv"
																		placeholder="Observations Comment By PICUP"
																		value="${listAssetsObserv}" class="form-control"
																		rows="2"></form:textarea></td>
															</tr>
														</c:if>
														...
														<tr>
															<td><label class="table-heading">Undertaking</label>
																<p>
																	Whether notarized undertaking as per format placed at
																	Annexure I-A (as per format of IIEPP Rules- 2017) on
																	Stamp Paper of Rs. 10/-submitted. <a
																		href="./downloadBusinessEntityDoc?fileName=${bodDocFname}">View
																		File</a>
																</p></td>
															<td><select name="anexurUndertk"
																class="form-control" disabled="">
																	<option value="Yes" selected="">Yes</option>
																	<option value="No">No</option>
															</select></td>
															<td><form:textarea name="anexurUndertkObserv"
																	path="anexurUndertkObserv"
																	placeholder="Observations Comment By PICUP"
																	value="${anexurUndertkObserv}" class="form-control"
																	rows="2"></form:textarea></td>
														</tr>
														...
														<tr>
															<td colspan="3" class="p-4">
																<div class="row">
																	<div class="col-sm-12">
																		<label class="table-heading">Capital
																	...
																	<table class="table table-stripped table-bordered">
																		<tbody>
																			<tr>
																				...
																				<td><form:input id="invFci" path="invFci"
																						class="form-control" value="${InvFCI}"
																						onkeypress="return validateNumberField()"
																						maxlength="12" readonly="true"></form:input></td>
																				<td><form:textarea name="propCapInvObserv"
																						path="propCapInvObserv" id="capinvObserv"
																						placeholder="Observations Comment By PICUP"
																						value="${propCapInvObserv}" class="form-control"
																						rows="2"></form:textarea></td>
																			</tr>
																			<tr>
																				<td>Total Cost of Project</td>
																				<td><form:input id="invtpc"
																						path="invTotalProjCost" class="form-control"
																						value="${InvTPC}"
																						onkeypress="return validateNumberField()"
																						maxlength="12" readonly="true"></form:input></td>
																				<td><form:textarea name="totlCostProjObserv"
																						path="totlCostProjObserv" id="totlcostObserv"
																						placeholder="Observations Comment By PICUP"
																						value="${totlcostprojObserv}" class="form-control"
																						rows="2"></form:textarea></td>
																			</tr>
																		</tbody>
																	</table>
																...
																<div class="table-responsive mt-3">
																	<table id="BreakUpTable"
																		...
																		<tbody class="add-from-here">
																			<tr>
																				...
																				<td><form:select class="form-control"
																						path="landcostFci" id="landcostfci"
																						disabled="true">
																				...
																				<td><form:input type="text" id="iieplandcost"
																						path="landcostIIEPP" maxlength="12"
																						onkeypress="return validateNumberField()"
																						class="CostasperIIEPP form-control"
																						readonly="true"></form:input></td>

																				<td><form:textarea class="form-control"
																						path="landcostRemarks" rows="2"
																						value="${invLandcostRemarks}" maxlength="1000"></form:textarea>
																				</td>
																				<td rowspan="4">&nbsp;</td>
																			</tr>
																			<tr>
																				...
																				<td>Building,Site Development & Civil Works
																					Cost</td>
																				<td><form:select class="form-control"
																						path="buildingFci" id="buildingfci"
																						disabled="true">
																						<form:option value="Yes">Yes</form:option>
																						<form:option value="No">No</form:option>
																					</form:select></td>
																				...
																				<td><form:input type="text"
																						path="buildingIIEPP" value="${invBuildingIIEPP}"
																						maxlength="12"
																						onkeypress="return validateNumberField()"
																						class="CostasperIIEPP form-control" name=""></form:input>
																					<small class="d-block text-info" id="iiepwords"></small>
																				</td>
																				<td><form:textarea type="text"
																						path="buildingRemarks"
																						value="${invBuildingRemarks}" maxlength="1000"
																						rows="2" class="form-control" name=""></form:textarea></td>
																			</tr>
																			<tr>
																				<td>Plant & Machinery Cost</td>
																				<td><form:select class="form-control"
																						path="plantAndMachFci" id="plantfci"
																						disabled="true">
																						<form:option value="Yes">Yes</form:option>
																						<form:option value="No">No</form:option>
																					</form:select></td>
																				...
																				<td><form:input type="text"
																						path="plantAndMachIIEPP"
																						value="${invPlantAndMachIIEPP}" maxlength="12"
																						onkeypress="return validateNumberField()"
																						class="CostasperIIEPP form-control"></form:input>
																					<small class="d-block text-info" id="plantwords"></small>
																				</td>
																				<td><form:textarea type="text"
																						path="plantAndMachRemarks"
																			...
																			<tr>
																				...
																				<td><form:select class="form-control"
																						path="fixedAssetFci" id="fixassetfci"
																						disabled="true">
																						<form:option value="Yes">Yes</form:option>
																						<form:option value="No">No</form:option>
																					</form:select></td>
																				...
																				<td><form:input type="text"
																						path="fixedAssetIIEPP"
																						value="${invFixedAssetIIEPP}" maxlength="12"
																						onkeypress="return validateNumberField()"
																						class="CostasperIIEPP form-control"></form:input>
																					<small class="d-block text-info" id="dprwords"></small>
																				</td>
																				<td><form:textarea type="text"
																						path="fixedAssetRemarks"
																						value="${invFixedAssetRemarks}" maxlength="1000"
																						rows="2" class="form-control" name=""></form:textarea></td>
																			</tr>
																			...
																			<c:if test="${not empty evalCapitalInvList}">
																				...
																				<c:forEach var="eciObj"
																					items="${evalCapitalInvList}" varStatus="counter">
																					...
																					<c:if
																						...
																						<tr>
																							<td><input type="text"
																								value="${eciObj.eciItem}" id="itemName1"
																								maxlength="500"
																							...
																							<td><select class="form-control"
																								id="ConsiderasFCI" disabled="true">
																									<option>${eciObj.eciIsFci}</option>
																									<%-- <form:option value="No">No</form:option> --%>
																							</select></td>
																							<td><input type="text"
																								value="${eciObj.eciDPRInvest}" id="DPRInput1"
																								maxlength="12"
																								onkeypress="return validateNumberField()"
																								onblur="removeAddMoreItemsErrMsg()"
																								class=" CostasperDPR form-control"
																								readonly="readonly"></input> <span id="dprinput"
																								class="text-danger"></span></td>
																							<td><input type="text"
																								value="${eciObj.eciIIEPPInvest}"
																								id="IIEPPInput1" maxlength="12"
																								readonly="readonly"
																								onkeypress="return validateNumberField()"
																								onblur="removeAddMoreItemsErrMsg()"
																							...
																							<td><input
																								value="${eciObj.eciPICUP_Remarks}"
																								maxlength="1000" class="form-control"
																								id="PICUPRemarks1" rows="2" readonly="readonly"></input></td>


																							<td class="text-center">
																								<button class="border-0 bg-white"
																									onclick="return confirm('Are you sure? Do you want to delete?')"
																									formaction="${pageContext.request.contextPath }/deleteEvaluateCapInvest?selectedRow=${counter.index}"
																		...
																		<tfoot>
																			<tr>
																				<td><form:input path="eciItem" type="text"
																						id="itemName" maxlength="500"
																						onblur="removeAddMoreItemsErrMsg()"
																						class="form-control"></form:input> <span
																					id="itemname" class="text-danger"></span></td>
																				<td><form:select path="eciIsFci"
																						class="form-control" id="ConsiderasFCII">
																						<form:option value="Yes">Yes</form:option>
																						<form:option value="No">No</form:option>
																					</form:select></td>
																				<td><form:input type="text" path="eciDPRInvest"
																						id="DPRInput" maxlength="12"
																						onkeypress="return validateNumberField()"
																						onblur="removeAddMoreItemsErrMsg()"
																						class="CostasperDPRECI form-control"></form:input>
																					<span id="dprinput" class="text-danger"></span></td>
																				<td><form:input type="text"
																						path="eciIIEPPInvest" id="IIEPPInput"
																						maxlength="12"
																						onkeypress="return validateNumberField()"
																						onblur="removeAddMoreItemsErrMsg()"
																						class="CostasperIIEPP form-control"></form:input>
																					<span id="iieppinput" class="text-danger"></span> <small
																					class="d-block text-info" id="pppwords"></small></td>
																				<td><form:textarea path="eciPICUP_Remarks"
																						class="form-control" id="PICUPRemarks" rows="2"></form:textarea>
																				</td>
																			...
																			<tr>
																				...
																				<td><strong>Total:</strong><input type="text"
																					...
																					name="dprtotal" id="TotalCostasperDPRId"></td>
																...
																<div class="row">
																	<div class="col-sm-6">
																		<label class="table-heading">Means of
																			Financing <a
																	...
																	<div class="col-sm-3">
																		<div class="form-group">
																			<form:input path="emfphsInvestAmt" id="emfinvestamt"
																				...
																				class="form-control" name="emfphsInvestAmt"></form:input>
																			<small class="d-block text-info" id="empfwords"></small>
																...
																<div class="row">
																	<div class="col-sm-12">
																				...
																				<tbody>
																					<c:forEach var="emf"
																						...
																						<tr>
																							...
																							<td class="text-center">
																								<%-- <a
																								href='./editMeanofFinance?editmofRecord=<c:out value="${counter.index}"/>'
																								onclick="return confirm('Are you sure you want to edit Mean of Finance Record?')"
																								class="action-btn"> <i
																								...
																								<button class="border-0 bg-white"
																									onclick="return confirm('Are you sure you want to edit Mean of Finance Record?')"
																									formaction="${pageContext.request.contextPath }/editMeanofFinance?editmofRecord=${counter.index}"
																								...
																								<button class="border-0 bg-white"
																									onclick="return confirm('Are you sure? Do you want to delete?')"
																									formaction="${pageContext.request.contextPath }/deleteMeanofFinance?selectedRow=${counter.index}"
																									data-toggle="tooltip" title="Delete">
																									<i class="fa fa-trash text-danger"></i>
																								</button>
																							</td>
																		...
																		<form:textarea name="mofObserv" path="mofObserv"
																			placeholder="Observations Comment By PICUP"
																			value="${mofObserv}" class="form-control" rows="4"></form:textarea>
																	</div>
																</div>
															</td>
														</tr>
															...
															<td width="33%">
																<table class="table">
																	<tr>
																		...
																		<td><form:input type="text" path="iemNumber"
																				value="${invIemNumber}" maxlength="50"
																				class="form-control" placeholder="Enter IEM Number"
																				name=""></form:input></td>
																	</tr>
																</table>

															</td>
															<td width="33%"><form:textarea name="IemRegObserv"
																	path="IemRegObserv" id="regGoiObserv"
																	placeholder="Observations Comment By PICUP"
																	value="${IemRegObserv}" class="form-control" rows="2"></form:textarea></td>
														...
														<tr>
															...
															<td><form:select path="govtEquity" id="govtequity"
																	class="form-control" disabled="true">
																	<form:option value="Yes">Yes</form:option>
																	<form:option value="No">No</form:option>
																</form:select></td>
															<td><form:textarea name="indusUntkObserv"
																	path="indusUntkObserv" id="indusUndtakObserv"
																	placeholder="Observations Comment By PICUP"
																	value="${IndusUndrtkObserv}" class="form-control"
																	rows="2"></form:textarea></td>
																	...
																	<table class="table table-stripped table-bordered">
																		<tbody>
																			<tr class="in-case-of-small-row">
																				...
																				<td>In case of small & medium industrial
																					undertakings, the period commencing from cutoff
																					date falling in the effective period of these Rules
																					upto 3 years or till the date of commencement of
																					commercial production, whichever is earlier. Such
																					cases will also be covered in which the cut-off
																					date is within the period immediately preceding 3
																					years from the effective date, subject to the
																					condition that commercial production in such cases
																					commences on or after the effective date. In any
																					case, the maximum eligible investment period shall
																					not be more than 3 years.</td>
																			...
																			<tr class="in-case-of-large-row">
																				...
																				<td style="width: 33%;"><form:textarea
																						id="eligInvObserv" name="eligblInvPerdLargeObserv"
																						path="eligblInvPerdLargeObserv"
																						placeholder="Observations Comment By PICUP"
																						value="${eligblInvPerdLargeObserv}"
																						class="form-control" rows="2"></form:textarea></td>
																			</tr>
																			<tr class="in-case-of-mega-row">
																				...
																				<td style="width: 33%;"><form:textarea
																						id="megaObserv" name="eligblInvPerdMegaObserv"
																						path="eligblInvPerdMegaObserv"
																						placeholder="Observations Comment By PICUP"
																						value="${eligblInvPerdMegaObserv}"
																						class="form-control" rows="2"></form:textarea></td>
																			</tr>
																			<tr class="in-case-of-supermega-row">
																				...
																				<td style="width: 33%;"><form:textarea
																						id="supermegaObserv"
																						name="eligblInvPerdSupermegaObserv"
																						path="eligblInvPerdSupermegaObserv"
																						placeholder="Observations Comment By PICUP"
																						value="${eligblInvPerdSupermegaObserv}"
																						class="form-control" rows="2"></form:textarea></td>
																			</tr>
																		</tbody>
																	</table>
														...
														<tr class="in-case-of-inMMSM-row">
															<td><label class="table-heading">Company has
																	invested atleast 40% of the eligible capital investment
																	after the effective date of policy i.e. 13/07/2017</label></td>

															<td><form:select path="eligcapInvest"
																	disabled="true" class="form-control" id="eligcapinvest">
																	<form:option value="Yes">Yes</form:option>
																	<form:option value="No">No</form:option>
																</form:select></td>
															<td><form:textarea name="eligblCapInvObserv"
																	path="eligblCapInvObserv" id="eligcapinvObserv"
																	placeholder="Observations Comment By PICUP"
																	value="${eligblCapInvObserv}" class="form-control"
																	rows="2"></form:textarea></td>
														...
														<tr>
															<td><label class="table-heading">Whether the
																	project is planned in phases (if yes phase wise details
																	to be added).</label></td>

															<td><input type="text" class="form-control"
																value="${phsWsAply}" readonly="readonly"></td>
															<td><form:textarea name="projPhasesObserv"
																	path="projPhasesObserv" id="projphaseObserv"
																	placeholder="Observations Comment By PICUP"
																	value="${projPhasesObserv}" class="form-control"
																	rows="2"></form:textarea></td>
														</tr>
														...
														<tr>
															<td><label class="table-heading">Investment
																	made till <form:input type="Date"
																		path="cAStatutoryDate" class="till-date"
																		value="${invCAStatutoryDate}"
																		pattern="^([0-9]{2})-([0-9]{2})-([0-9]{4})$"
																		title="enter Date in dd-mm-yyyy"
																		placeholder="dd-mm-yyyy"></form:input> as per
																	CA/Statutory Certificate
															</label></td>
															<td><form:input type="text" class="form-control"
																	path="cAStatutoryAmt" maxlength="12" readonly="true"
																	onkeypress="return validateNumberField()"
																	value="${invCAStatutoryAmount}"
																	placeholder="Amount in Rs." name=""></form:input> <small
																class="mt-2 d-block text-info" id="cAStatutoryAmtWord"></small>
															</td>
															<td><form:textarea name="caStatutoryObserv"
																	path="caStatutoryObserv" id="castatObserv"
																	placeholder="Observations Comment By PICUP"
																	value="${caStatutoryObserv}" class="form-control"
																	rows="2"></form:textarea></td>
														</tr>
														...
														<tr>
															<td><label class="table-heading">Name of
																	Authorized Signatory. (Board Resolution copy provided.)
																	<a
																	href="./downloadBusinessEntityDoc?fileName=${bodDocFname}">(View
																		File)</a>
															</label></td>
															<td><form:input type="text"
																	path="authorisedSignatoryName" value="${authSignName}"
																	class="form-control" readonly="true"></form:input></td>
															<td><form:textarea name="authSignatoryObserv"
																	path="authSignatoryObserv" id="authsignObserv"
																	placeholder="Observations Comment By PICUP"
																	value="${authSignatoryObserv}" class="form-control"
																	rows="2"></form:textarea></td>
														</tr>
														<tr>
															<td><label class="table-heading">Application
																	Format- (Whether application is as per prescribed
																	format & signed by Authorized Signatory with Name,
																	Designation and Official Seal.)</label></td>
															<td><form:select class="form-control"
																	path="presFormat" id="presFormatId" disabled="true">
																	<form:option value="Yes">Yes</form:option>
																	<form:option value="No">No</form:option>
																</form:select></td>
															<td><form:textarea name="appformatObserv"
																	path="appformatObserv" id="appformatObserv"
																	placeholder="Observations Comment By PICUP"
																	value="${appformatObserv}" class="form-control"
																	rows="2"></form:textarea></td>
														</tr>
														<tr>
															<td><label class="table-heading">Whether all
																	supporting document of application authenticated by a
																	Director/Partner/Officer duly authorized by the
																	competent authority of the applicant on its behalf. </label></td>
															<td><form:select class="form-control"
																	path="docAuthorized" id="docAuthorizedId"
																	disabled="true">
																	<form:option value="Yes">Yes</form:option>
																	<form:option value="No">No</form:option>
																</form:select></td>
															<td><form:textarea name="supprtdocObserv"
																	path="supprtdocObserv" id="docObserv"
																	placeholder="Observations Comment By PICUP"
																	value="${supprtdocObserv}" class="form-control"
																	rows="2"></form:textarea></td>
														</tr>
														<tr>
															<td><label class="table-heading">Online
																	Submission of Date of Application </label></td>
															<td><form:input type="text" path="CreatedDate"
																	class="form-control" value="${onlineSubmitDate}"
																	readonly="true"></form:input></td>
															<td><form:textarea name="subDateAppObserv"
																	path="subDateAppObserv" id="submitdateObserv"
																	placeholder="Observations Comment By PICUP"
																	value="${subDateAppObserv}" class="form-control"
																	rows="2"></form:textarea></td>
														</tr>
														<tr>
															<td><label class="table-heading">GSTIN
																	Number</label></td>
															<td><form:input type="text" class="form-control"
																	path="gstin" value="${GSTno}" readonly="true"></form:input></td>
															<td><form:textarea name="gstinObserv"
																	path="gstinObserv" id="gstObserv"
																	placeholder="Observations Comment By PICUP"
																	value="${gstinObserv}" class="form-control" rows="2"></form:textarea></td>
														</tr>
														<tr>
															<td><label class="table-heading">PAN Number</label></td>
															<td><form:input type="text" path="companyPanNo"
																	class="form-control" value="${companyPANno}"
																	readonly="true"></form:input></td>
															<td><form:textarea name="panObserv" path="panObserv"
																	id="pannumObserv"
																	placeholder="Observations Comment By PICUP"
																	value="${panObserv}" class="form-control" rows="2"></form:textarea></td>
														</tr>

														<tr>
															<td><label class="table-heading">Solar/Captive
																	Power</label></td>
															<td><form:input path="solarCaptivePower" type="text"
																	name="solarCaptivePower" class="form-control"
																	value="${solarCaptivePower}" /></td>
															<!-- path="solarCaptivePower" -->
															<td><form:textarea path="solarCaptivePowerObserv"
																	name="solarCaptivePowerObserv"
																	placeholder="Observations Comment By PICUP"
																	class="form-control" rows="2" />${solarCaptivePowerObserv}</td>
									...
									<div class="row">
										<div class="col-sm-12">
															...
															<table class="table table-stripped table-bordered">
																...
																<tbody>
																	...
																	<tr>
																		...
																		</span> % Stamp Duty Exemption in ${region} Region. Further,
																			as per G.O. No. 1515/77-6-18-5(M)/17, dated 1.5.2018,
																			there is a provision for reimbursement equivalent to
																			the paid Stamp Duty, for which company will have to
																			apply before concerned GM, DIC.</td>
																	...
																	<tr>
																		...
																		<td colspan="4">All incentives in the form of
																			reimbursement, subsidies, exemptions etc., will be
																			subject to a maximum of <span id="percent"> </span> %
																			of fixed capital investment made in ${region} area.
																		</td>
																	</tr>
											...
											<!-- vinay  -->
											<form:form modelAttribute="applicationAgendaNote"
												class="mt-4" name="applicationAgendaNote" method="post">
												<div class="row mt-4">
													<div class="col-sm-12 text-center">
														...
														<button type="button" id="button1"
															...
															class="btn btn-outline-secondary evaluate-btn btn-sm mb-3">Evaluation
															Completed</button>
										...
										Acknowledgement to Investor</button>-->
														...
														<button type="submit" id="button2"
															class="btn btn-outline-info btn-sm mb-3 disable-btn"
														...
														<button data-target="#RejectApplication" type="button"
															class="btn btn-outline-danger btn-sm mb-3 disable-btn"
															id="reject" data-toggle="modal">Reject</button>
											...
											<div class="row">
												...
												<div class="col-sm-7 text-right">
													<a href="javacript:void(0);" onclick="myEditInput()"
														class="common-btn mt-3"><i class="fa fa-edit"></i>Edit</a>
	...
	<div class="modal fade" id="RaiseQuery">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<form:form action="saveRaiseQuery" class="isf-form" method="POST"
					modelAttribute="raiseQuery" enctype="multipart/form-data">
					<!-- Modal body -->
					...
					<div class="modal-footer">
						<form:button type="submit" id="button1"
							onclick="return RaiseQuery()" class="common-btn mt-3">Submit Query</form:button>
					</div>
						...
						<div class="col-sm-12">
							<div class="table-responsive">
								<table class="table table-bordered">
									...
									<tbody>
										<c:forEach var="list" items="${EvaluationAuditTrailList}"
											varStatus="counter">
											<tr>
												...
												<td><fmt:formatDate type="both" dateStyle="short"
														timeStyle="short" pattern="dd/MM/yyyy  HH:mm:ss a"
														value="${list.modifyedDate}"></fmt:formatDate></td>
											</tr>
										</c:forEach>
									</tbody>
								</table>
		...
		<div class="modal fade" id="RejectApplication">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					...
					<!-- Modal body -->
					<form:form action="saveRejectApplication" class="isf-form"
						method="POST">
						<div class="modal-body">
							<div class="row">
								<div class="col-md-12">
