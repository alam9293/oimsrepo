			...
			<div class="row row-offcanvas row-offcanvas-left">
				<div class="col-md-3 col-lg-2 sidebar-offcanvas pt-3" id="sidebar"
					...
					<ul class="nav flex-column pl-1">
						...
						<li class="nav-item"><a class="nav-link"
							href="./meetingschedulebyDIC"><i class="fa fa-calendar"></i>
								Schedule meeting</a></li>
						<li class="nav-item"><a class="nav-link" href="./momgobyDIC"><i
				...
				<div class="col-md-9 col-lg-10 mt-4 main mb-4">
					...
					<div class="card card-block p-3">
						<div class="row">
							<div class="col-sm-5">
								<a
									href="./viewApplicationDetailsSMEDIC?applicantId=<%=session.getAttribute("appId")%>"
						...
						<!-- vinay start -->
						<spring:url value="/EvaluateSMEProjectDetails"
							var="EvaluateSMEProjectDetailsActionUrl" />
						<form:form modelAttribute="EvaluateProjectDetails" method="post"
							action="${EvaluateSMEProjectDetailsActionUrl}" class="mt-4">
							<div class="row mt-5">
								<div class="col-sm-12">
								...
								<div class="col-md-12 mt-4">
									<div class="form-group">
										...
										<textarea name="propsProdtDetailObserv" class="form-control"
											rows="5">${propsProdtDetailObserv}</textarea>
									</div>
								</div>
							</div>
													...
													<tbody>
																		...
																		<tbody>
																			<%-- <tr>
																				...
																				<td style="width: 33%;"><form:input
																						path="registeredAddr" class="form-control"
																						id="registeredAddr" readonly="true"></form:input>
																					<span id="registeredAddr"
																					class="text-danger color:red"></span> <form:errors
																						path="registeredAddr" class="control-label"
																						cssStyle="color:red" /></td>
																				<td rowspan="4"><form:textarea
																						path="registeredAddr" name="registeredAddr"
																			...
																			<tr>
																				<td>Full Address</td>
																				<td><form:input path="fullAddress"
																						class="form-control" id="fullAddress"
																						readonly="true"></form:input> <span
																			...
																			<tr>
																				<td>District</td>
																				<td><form:input path="districtName"
																						class="form-control" readonly="true"
																						id="districtName"></form:input> <span
																...
																<div class="table-responsive">
																	...
																	<table class="table table-bordered">
																		...
																		<tbody>
																			...
																			<c:forEach var="dptobj"
																				items="${deptProprietorDetailsList}"
																				varStatus="counter">
																				<!-- Iterating the list using JSTL tag  -->
																				<c:if test="${not empty deptProprietorDetailsList}">

																					<tr>

																						<%-- <td class="text-center"><%=++i%></td> --%>
																						<td>${dptobj.directorName}</td>
																						<td>${dptobj.designation}</td>
																						<td>${dptobj.equity}</td>
																						<td>${dptobj.mobileNo}</td>
																						<td>${dptobj.proprietorDetailsaddress}</td>
																						<td>${dptobj.email}</td>
																						<td>${dptobj.gender}</td>
																						<td>${dptobj.category}</td>
																						<td>${dptobj.div_Status}</td>
																						<td>${dptobj.panCardNo}</td>
																						<td>${dptobj.din}</td>
																	...
																	<textarea name="dirDetailsObserv"
																		placeholder="Observations Comment By PICUP"
																		class="form-control" rows="3">${dirDetailObserv}</textarea>
																</div>
															</td>
														</tr>
																		...
																		<tbody>
																			<tr>
																				...
																				<td><textarea name="totalDetailObserv"
																						placeholder="Observations Comment By PICUP"
																						class="form-control" rows="2">${totalEmpDetailObserv}</textarea></td>
																			</tr>
																			<tr>
																				<td colspan="3">
																					<div class="table-responsive">
														...
														<c:if test="${natureOfProject=='ExistingProject'}">
															<tr>
																...
																<td><input type="text" class="form-control"
																	value="${pergrosblock}" readonly="readonly"
																	id="pergrosblockId"></td>
																<td><textarea name="expDivfObserv"
																		placeholder="Observations Comment By PICUP"
																		class="form-control" rows="2">${EvaluateProjectDetails.expDivfObserv}</textarea></td>
															</tr>
														</c:if>
														...
														<tr>
															...
															<td><textarea name="catIndusUndtObserv"
																	placeholder="Observations Comment By PICUP"
																	class="form-control" rows="2">${invcatundtakObserv}</textarea></td>
														</tr>
														...
														<tr>
															...
															<td><form:input type="text" path="invCommenceDate"
																	...
																	disabled="disabled"></form:input></td>
															<td><textarea name="optcutofdateobserv"
																	placeholder="Observations Comment By PICUP"
																	class="form-control" rows="2">${optcutofdateObserv}</textarea></td>
														</tr>
														<tr>
															...
															<td><form:input type="text" path="propCommProdDate"
																	value="${invPropCommProdDate}" disabled="disabled"
																	class="form-control"></form:input></td>
															<td><textarea name="dateofComProdObserv"
																	placeholder="Observations Comment By PICUP"
																	class="form-control" rows="2">${dateofcumProdObserv} </textarea></td>
														</tr>
														...
														<c:if test="${natureOfProject=='ExistingProject'}">
															<tr>
																...
																<td><textarea name="detailProjReportObserv"
																		placeholder="Observations Comment By PICUP"
																		class="form-control" rows="2">${projreportObserv} </textarea></td>
															</tr>
														</c:if>
																		...
																		<tbody>
																			<tr>
																				...
																				<td><textarea name="propCapInvObserv"
																						placeholder="Observations Comment By PICUP"
																						class="form-control" rows="2">${propCapInvObserv}</textarea></td>
																			</tr>
																			<tr>
																				...
																				<td><textarea name="totlCostProjObserv"
																						placeholder="Observations Comment By PICUP"
																						class="form-control" rows="2">${totlcostprojObserv}</textarea></td>
																			</tr>
																		</tbody>
																	</table>
																</div>
														<tr>
															<td colspan="3" class="p-4">
																		...
																		<tbody class="add-from-here">
																			<tr>
																				...
																				<td><form:input type="text"
																						path="landcostIIEPP" value="${invLandcostIIEPP}"
																						maxlength="12"
																						onkeypress="return validateNumberField()"
																						class="CostasperIIEPP form-control"></form:input></td>
																				<td><form:input class="form-control"
																						path="landcostRemarks"
																						value="${invLandcostRemarks}" maxlength="1000"></form:input>
																				</td>
																				<td rowspan="4">&nbsp;</td>
																			</tr>
																			<tr>
																				...
																				<td><form:input type="text"
																						...
																						maxlength="12"
																						onkeypress="return validateNumberField()"
																						class="CostasperIIEPP form-control" name=""></form:input></td>
																				<td><form:input type="text"
																			...
																			<c:if test="${not empty evalCapitalInvList}">
																				...
																				<c:forEach var="eciObj"
																					...
																					<c:if
																						...
																						<tr>
																							<td><input type="text"
																								value="${eciObj.eciItem}" id="itemName"
																								maxlength="500"
																							...
																							<td><input
																								...
																								id="PICUPRemarks" rows="2"></input></td>
																		...
																		<tfoot>
																			<tr>
																				...
																				<td><form:input type="text" path="eciDPRInvest"
																						...
																						onkeypress="return validateNumberField()"
																						onblur="removeAddMoreItemsErrMsg()"
																						class="CostasperDPR form-control"></form:input> <span
																					id="dprinput" class="text-danger"></span></td>
																				<td><form:input type="text"
																					...
																					<span id="iieppinput" class="text-danger"></span></td>
																...
																<div class="row">
																	<div class="col-sm-6">
																		<label class="table-heading">Break-Up of
																			Project Cost & Means of Financing <a
																...
																<div class="row mt-4">
																	<div class="col-sm-3">
																		<div class="form-group">
																			<input type="text" placeholder="Phase Number"
																...
																<div class="row">
																	<div class="col-sm-12">
																				...
																				<tbody>
																					<tr>
																						...
																						<td class="text-center"><a href="#"
																							class="action-btn"><i
																								class="fa fa-edit text-info"></i></a> <a href="#"
																		...
																		<textarea name="mofObserv"
																			placeholder="Observations Comment By PICUP"
																			class="form-control" rows="4">${mofObserv}</textarea>
																	</div>
																</div>
															</td>
														</tr>
														...
														<tr>
															<td><label class="table-heading">Whether the
																	company have filed LOI/IEM registration with the
															...
															<td><textarea name="IemRegObserv"
																	placeholder="Observations Comment By PICUP"
																	class="form-control" rows="2">${IemRegObserv}</textarea></td>
														...
														<tr>
															...
															<td><textarea name="indusUntkObserv"
																	placeholder="Observations Comment By PICUP"
														...
														<tr>
															...
															<td><textarea name="eligblCapInvObserv"
																	placeholder="Observations Comment By PICUP"
														...
														<tr>
															...
															<td><textarea name="projPhasesObserv"
																	placeholder="Observations Comment By PICUP"
														...
														<tr>
															<td><label class="table-heading">Investment
																	made till <form:input type="text"
																		path="cAStatutoryDate" class="till-date"
																		value="${invCAStatutoryDate}"
																		placeholder="Enter Date in DD/MM/YYYY"></form:input>
																	as per CA/Statutory Certificate
															</label></td>
															<td><form:input type="text" class="form-control"
																	path="cAStatutoryAmt" maxlength="12"
																	onkeypress="return validateNumberField()"
															...
															<td><textarea name="caStatutoryObserv"
																	placeholder="Observations Comment By PICUP"
														...
														<tr>
															...
															<td><form:input type="text"
																	...
																	class="form-control" readonly="readonly"></form:input></td>
														...
														<tr>
															...
															<td><form:select class="form-control"
																	path="presFormat" id="presFormatId">
																	<form:option value="Yes">Yes</form:option>
																	<form:option value="No">No</form:option>
																</form:select></td>
															<td><textarea name="appformatObserv"
																	placeholder="Observations Comment By PICUP"
														...
														<tr>
															...
															<td><textarea name="supprtdocObserv"
																	placeholder="Observations Comment By PICUP"
														...
														<tr>
															...
															<td><form:input type="text" path="CreatedDate"
																	...
																	disabled="" name=""></form:input></td>
															<td><textarea name="subDateAppObserv"
																	placeholder="Observations Comment By PICUP"
														...
														<tr>
															<td><label class="table-heading">GSTIN
																	Number</label></td>
															<td><form:input type="text" class="form-control"
																	path="gstin" value="${GSTno}" disabled="disabled"
																	name=""></form:input></td>
															<td><textarea name="gstinObserv"
																	placeholder="Observations Comment By PICUP"
														...
														<tr>
															...
															<td><form:input type="text" path="companyPanNo"
																	...
																	disabled="disabled" name=""></form:input></td>
															<td><textarea name="panObserv"
																	placeholder="Observations Comment By PICUP"
	...
	<div class="modal fade" id="RaiseQuery">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				...
				<form:form action="saveRaiseQueryDIC" class="isf-form" method="POST"
					...
					<!-- Modal footer -->
					<div class="modal-footer">
						<form:button type="submit" id="button3"
							onclick="return RaiseQuery()" class="common-btn mt-3">Submit Query</form:button>
					</div>
						...
						<div class="col-sm-12">
							<div class="table-responsive">
								<table class="table table-bordered">
									...
									<tbody>
										<c:forEach var="list" items="${EvaluationAuditSMETrailList}"
											varStatus="counter">
											<tr>
