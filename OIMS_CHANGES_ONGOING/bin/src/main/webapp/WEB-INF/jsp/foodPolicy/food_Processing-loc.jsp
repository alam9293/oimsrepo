...
<script src="js/uploadxls.js"></script>
</head>
										...
										<div class="row">
											<div class="col-sm-8">
												<a href="./foodProcessIndustryPolicy"
													class="common-default-btn mt-0">Back</a>
												
													  <a
													href="./evaluationViewCsIs" class="common-btn mt-3"
																					...
																					<table class="table table-bordered">
																						<tbody>
																							<tr>
																								...
																								<td><input type="text" class="form-control"
																									id="" value="${projectandproposedemploymentdetails.district}" disabled=""
																									name=""></td>
																							</tr>
																							<tr>
																								<td>Division</td>
																								<td><input type="text" class="form-control"
																									id="" value="${projectandproposedemploymentdetails.division}" disabled=""
																									name=""></td>
																							</tr>
																							<tr>
																								<td>Sector</td>
																								<td><input type="text" class="form-control"
																									id="" value="${projectandproposedemploymentdetails.sector}" disabled=""
																									name=""></td>
																							...
																							<tr>
																								<td>Sub-Sector</td>
																								<td><input type="text" class="form-control"
																									id="" value="${projectandproposedemploymentdetails.selectsubsector}" disabled="" name=""></td>
																							</tr>
																							<tr>
																								<td>Name of the Project</td>
																								<td><input type="text" class="form-control"
																									id="" value="${projectandproposedemploymentdetails.nameoftheproject}"
																									disabled="" name=""></td>
																							</tr>
																							<tr>
																								<td>Location/Area of the project</td>
																								<td><input type="text" class="form-control"
																									id="" value="${projectandproposedemploymentdetails.locationareaoftheproject}" disabled="" name=""></td>
																							</tr>
																						...
																						id="" value="${list.byproducts}" disabled="" name=""></td>
																							...
																							<tr>
																								...
																								<td><input type="text"
																									...
																									value="${projectandproposedemploymentdetails.technology}" readonly=""
																									aria-invalid="false">
																								<td>
																							</tr>
																							...
																							<table
																								...
																								<tbody>
																									<tr>
																										...
																										<td><input type="text"
																											class="form-control" id="" value="${capacityoftheplantorunit.existingunitcapacity}"
																											disabled="" name=""></td>
																										<td><input type="text"
																											class="form-control" id="" value="${capacityoftheplantorunit.newunitcapacity}"
																											disabled="" name=""></td>
																										<td><input type="text"
																											class="form-control" id="" value="${capacityoftheplantorunit.totalafterexpansioncapacity}"
																											disabled="" name=""></td>
																									</tr>
																							...
																							<table
																								...
																								<tbody>
																									<tr>
																										...
																										<td><input type="text"
																											class="form-control" id="" value="${employmentgeneration.noofpersondirect}"
																											disabled="" name=""></td>
																									</tr>
																									<tr>
																										<td><strong>Indirect</strong></td>
																										<td><input type="text"
																											class="form-control" id="" value="${employmentgeneration.noofpersonindirect}"
																											disabled="" name=""></td>
																									</tr>
																									<tr>
																										<td><strong>Total</strong></td>
																										<td><input type="text"
																											class="form-control" id="" value="${employmentgeneration.noofpersontotal}"
																											disabled="" name=""></td>
																									</tr>
																												...
																												<tbody>
																													...
																													<tr>
																														...
																														<input type="text"
																															...
																															name="unittype" id="unittypeId"
																															value="${investmentDetailsFood.unittype}" readonly=""
																															aria-invalid="false">
																													</tr>
																													<tr>
																														<td><strong>Project
																													...
																													<table
																														...
																														<tbody>
																															...
																															<tr>
																																...
																																<td><input type="text"
																																	class="form-control" id="" value="${pidList.existinginvestmentlandcost}"
																																	disabled="" name=""></td>
																																<td><input type="text"
																																	class="form-control" id="" value="${pidList.proposedinvestmentlandcost}"
																																	disabled="" name=""></td>
																																<td><input type="text"
																																	class="form-control" id="" value="${pidList.appraisedcostbybanklandcost}"
																																	disabled="" name=""></td>
																															</tr>
																															<tr>
																																<td><strong>Building</strong></td>
																																<td><input type="text"
																																	class="form-control" id="" value="${pidList.existinginvestmentbuilding}"
																																	disabled="" name=""></td>
																																<td><input type="text"
																																	class="form-control" id="" value="${pidList.proposedinvestmentbuilding}"
																																	disabled="" name=""></td>
																																<td><input type="text"
																																	class="form-control" id="" value="${pidList.appraisedcostbybankbuilding}"
																																	disabled="" name=""></td>
																															</tr>
																															<tr>
																																<td><strong>Plant &
																																		Machinery</strong></td>
																																<td><input type="text"
																																	class="form-control" id="" value="${pidList.existinginvestmentplantmachinery}" 
																																	disabled="" name=""></td>
																																<td><input type="text"
																																	class="form-control" id="" value="${pidList.proposedinvestmentplantmachinery}"
																																	disabled="" name=""></td>
																																<td><input type="text"
																																	class="form-control" id="" value="${pidList.appraisedcostbybankplantmachinery}" 
																																	disabled="" name=""></td>
																															</tr>
																															<tr>
																																<td><strong>Pre-operative
																																		expenses</strong></td>
																																<td><input type="text"
																																	class="form-control" id="" value="${pidList.existinginvestmentpreoperativeexpenses}"  
																																	disabled="" name=""></td>
																																<td><input type="text"
																																	class="form-control" id="" value="${pidList.proposedinvestmentpreoperativeexpenses}" 
																																	disabled="" name=""></td>
																																<td><input type="text"
																																	class="form-control" id="" value="${pidList.appraisedcostbybankpreoperativeexpenses}" 
																																	disabled="" name=""></td>
																															</tr>
																															<tr>
																																<td><strong>Working
																																		Capital</strong></td>
																																<td><input type="text"
																																	class="form-control" id="" value="${pidList.existinginvestmentmarginmoneyforworkingcapital}" 
																																	disabled="" name=""></td>
																																<td><input type="text"
																																	class="form-control" id="" value="${pidList.proposedinvestmentmarginmoneyforworkingcapital}" 
																																	disabled="" name=""></td>
																																<td><input type="text"
																																	class="form-control" id="" value="${pidList.appraisedcostbybankmarginmoneyforworkingcapital}" 
																																	disabled="" name=""></td>
																															</tr>
																															<tr>
																																<td><strong>Total</strong></td>
																																<td><input type="text"
																																	class="form-control" id="" value="${pidList.existinginvestmenttotal}" 
																																	disabled="" name=""></td>
																																<td><input type="text"
																																	class="form-control" id="" value="${pidList.proposedinvestmenttotal}" 
																																	disabled="" name=""></td>
																																<td><input type="text"
																																	class="form-control" id="" value="${pidList.appraisedcostbybanktotal}" 
																																	disabled="" name=""></td>
																														...
																														<c:forEach var="mofList" items="${meansofFinancing}" varStatus="counter">
																															<tr>
																																<td><strong>Promoter's
																																		Equity</strong></td>
																																	<td><input type="text"
																																	class="form-control" id="" value="${mofList.existinginvestmentpromotersequity}" 
																																	disabled="" name=""></td>
																																<td><input type="text"
																																	class="form-control" id="" value="${mofList.proposedinvestmentpromotersequity}" 
																																	disabled="" name=""></td>
																																<td><input type="text"
																																	class="form-control" id="" value="${mofList.appraisedcostbybankpromotersequity}" 
																																	disabled="" name=""></td>
																															...
																															<tr>
																																...
																																<td><input type="text"
																																	class="form-control" id="" value="${mofList.existinginvestmenttermloan}" 
																																	disabled="" name=""></td>
																																<td><input type="text"
																																	class="form-control" id=""
																																	value="${mofList.proposedinvestmenttermloan}"  disabled="" name=""></td>
																																<td><input type="text"
																																	class="form-control" id=""
																																	value="${mofList.appraisedcostbybanktermloan}"  disabled="" name=""></td>
																															...
																															<tr>
																																<td><strong>Margin Money
																																		...
																																		<td><input type="text"
																																	class="form-control" id="" value="${mofList.existinginvestmentmarginmoneyforworkingcapital}" 
																																	disabled="" name=""></td>
																																<td><input type="text"
																																	class="form-control" id=""
																																	value="${mofList.proposedinvestmentmarginmoneyforworkingcapital}"  disabled="" name=""></td>
																																<td><input type="text"
																																	class="form-control" id=""
																																	value="${mofList.appraisedcostbybankmarginmoneyforworkingcapital}"  disabled="" name=""></td>

																															</tr>
																															<tr>
																																<td><strong>Others</strong></td>
																																<td><input type="text"
																																	class="form-control" id="" value="${mofList.existinginvestmentothers}" 
																																	disabled="" name=""></td>
																																<td><input type="text"
																																	class="form-control" id=""
																																	value="${mofList.proposedinvestmentothers}"  disabled="" name=""></td>
																																<td><input type="text"
																																	class="form-control" id=""
																																	value="${mofList.appraisedcostbybankothers}"  disabled="" name=""></td>

																															</tr>
																															<tr>
																																<td><strong>Total</strong></td>
																																<td><input type="text"
																																	class="form-control" id="" value="${mofList.existinginvestmenttotal}" 
																																	disabled="" name=""></td>
																																<td><input type="text"
																																	class="form-control" id=""
																																	value="${mofList.proposedinvestmenttotal}"  disabled="" name=""></td>
																																<td><input type="text"
																																	class="form-control" id=""
																																	value="${mofList.appraisedcostbybanktotal}"  disabled="" name=""></td>
																													...
																													<table
																														...
																														<c:forEach var="bdList" items="${bankTermLoanDetails}" varStatus="counter">
																															<tr>
																																...
																																<td><input type="text"
																																	class="form-control" id=""
																																	value="${bdList.detailsifsccode}" disabled="" name=""></td>
																															...
																															<tr>
																																<td><strong>Name of the
																																		Bank / FI</strong></td>
																																<td><input type="text"
																																	class="form-control" id="" value="${bdList.detailsnameofthebankfi}"
																																	disabled="" name=""></td>
																															...
																															<tr>
																																...
																																<td><input type="text"
																																	class="form-control" id=""
																																	value="${bdList.detailsbranchaddress}" disabled="" name=""></td>
																															...
																															<tr>
																																...
																																<td><input type="text"
																																	class="form-control" id=""
																																	value="${bdList.detailsbankemail}" disabled=""
																																	name=""></td>
																															...
																															<tr>
																																...
																																<td><input type="text"
																																	class="form-control" id=""
																																	value="${bdList.detailsbanktelephone}" disabled="" name=""></td>
																															...
																															<tr>
																																...
																																<td><input type="text"
																																	class="form-control" id=""
																																	value="${bdList.detailsaccountno}" disabled="" name=""></td>
																															...
																															<tr>
																																<td><strong>Rate of
																																		interest (%)</strong></td>
																																<td><input type="text"
																																	class="form-control" id="" value="${bdList.detailsrateofinterest}"
																																	disabled="" name=""></td>
																															...
																															<tr>
																																...
																																<td><input type="text"
																																	class="form-control" id=""
																																	value="${bdList.detailsdateofsanctionoftermloan}" disabled="" name=""></td>
																															</tr>
																															<tr>
																																...
																																<td><input type="text"
																																	class="form-control" id=""
																																	value="${bdList.detailsdateoffirstdisbursement}" disabled="" name=""></td>
																															</tr>
																															<tr>
																																...
																																<td><input type="text"
																																	class="form-control" id=""
																																	value="${bdList.detailsdateoflastdisbursement}" disabled="" name=""></td>
																															</tr>
																															<tr>
																																...
																																<td><input type="text"
																																	class="form-control" id=""
																																	value="${bdList.detailstotalamountoftermloansanctioned}" disabled="" name=""></td>
																															</tr>
																															<tr>
																																<td><strong>Total Amount
																																...
																																<td><input type="text"
																																	class="form-control" id=""
																																	value="${bdList.detailstotalamountoftermloansanctionedfornewplantmachineryspares}" disabled="" name=""></td>
																															</tr>
																															<tr>
																																<td><strong>Total Amount
																																		of term loan disbursed</strong></td>
																																<td><input type="text"
																																	class="form-control" id="" value="${bdList.detailstotalamountoftermloandisbursed}"
																																	disabled="" name=""></td>
																															</tr>
																															<tr>
																																<td><strong>Total Amount
																																...
																																<td><input type="text"
																																	class="form-control" id="" value="${bdList.detailstotalamountoffirstdisbursement}"
																																	disabled="" name=""></td>
																															</tr>
																															<tr>
																																<td><strong>Total Amount
																																...
																																<td><input type="text"
																																	class="form-control" id="" value="${bdList.detailstotalamountoflastdisbursement}"
																																	disabled="" name=""></td>
																															</tr>                    
                                                                                                                                 </c:forEach>
																														</tbody>
																																		...
																																		<tbody>
																																			...
																																			<tr>
																																				<td width="50%"><strong>Udyog
																																						Aadhar / Udyam Registration</strong></td>
																																			...
																																			<tr>
																																				<td width="50%"><strong>NOC
																																						for Pollution</strong></td>
																																			...
																																			<tr>
																																				<td width="50%"><strong>Power
																																						load sanction letter form UPPCL</strong></td>
																																			...
																																			<tr>
																																				<td width="50%"><strong>FSSAI
																																						License/Certificate</strong></td>
																																			...
																																			<tr>
																																				...
																																				<td><a
																																					href="./downloadFoodDocument?fileName=${foodDocument.annexurea6}">${foodDocument.annexurea6}</a>
																																				</td>
																																			</tr>
																																			<tr>
																																	...
																																	<div class="parameter-properties"
																																		...
																																		<p class="mb-2 text-center">
																																			<i>(all supporting documents must
																																				...
																																				authority of the Applicant on its
																																				behalf)</i>
																																		</p>
																																					...
																																					<table class="table table-bordered">
																																						<tbody>
																																							<tr>
																																								...
																																								<td rowspan="2">More than
																																									Rs 25 lakhs but does not exceed
																																									Rs 5 Crore</td>
																																								<td rowspan="2">More than
																																									Rs 5 crores but does not exceed
																																									Rs. 10 crores</td>
																																							</tr>
																																							<tr>
																																		...
																																		<div class="row mt-4">
																																			<div class="col-sm-12">
																																						...
																																						<tbody>
																																							...
																																							<tr>
																																								...
																																								<td>Phase-wise details of
																																									Proposed Investment and dates
																																									of start of commercial
																																									production</td>
																																								<td></td>
																																								<td></td>
																																							</tr>
																																					...
																																					<table class="table table-bordered">
																																						...
																																						<tbody>
																																							...
																																							<tr>
																																								<td>12.3</td>
																																								<td>Additional
																																									Reimbursement of deposited GST</td>
																																								<td></td>
																																							</tr>
																																							<tr>
																																								<td>12.3.1</td>
																																				...
																																				<p>The above information are
																																					completely true and no fact has
																																					been concealed or misrepresented.
																																					It is further certified that the
																																					company has not applied for
																																					benefits of the above nature under
																																					any sector-specific or other policy
																																					of the Govt of UP for purpose of
																																		...
																																		<div class="row mt-4 mb-5">
																																			...
																																			<div class="col-md-12">
																																				...
																																				<p>(c) Charted Accountant’s
																																					Certificate for existing gross
																																					block industrial undertaking.</p>
																																	...
																																	<div class="parameter-properties"
																																		...
																																		<p class="mb-4 text-center">
																																			<strong>Category of
																																				Industrial Undertaking Applied For
																																				Based on Capital Investment,
																																				Location and Employment Proposed</strong>
																																		</p>
																																		<p class="mb-4 mt-5">
																																			<strong>A. Based on
