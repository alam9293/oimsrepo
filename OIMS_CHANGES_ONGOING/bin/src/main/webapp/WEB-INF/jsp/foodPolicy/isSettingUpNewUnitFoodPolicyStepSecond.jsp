          ...
          <div class="col-sm-12">
            <div class="form-card">
              <div class="without-wizard-steps">
                ...
                <div class="step-links">
                  <a href="./isSettingUpNewUnitFoodPolicyStepFirst" class="common-second-btn mt-0 top-step-btn btn-sm">Back</a>
                  <ul class="only-steps">
                ...
                <div class="isf-form">
                  <form>
                    ...
                    <div class="row">
                      <div class="col-sm-4">
                        <a href="./isSettingUpNewUnitFoodPolicyStepFirst" class="common-second-btn mt-3">Back</a>
                      </div>
                      <div class="col-sm-8 text-right">
                        <a href="./isSettingUpNewUnitFoodPolicyStepThird" class="common-btn mt-3 next-step">Save and Continue</a>
                      </div>
                    </div>
