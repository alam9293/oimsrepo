				...
				<div class="col-md-9 col-lg-10 mt-4 main mb-4">
					<div class="card card-block draft-box">
						...
						<div class="row">
							<div class="col-sm-9">
								<p>
									<label>Ref.No.: <font face="Arial,Helvetica,Sans serif"
										size="3"><b>${viewSignatoryDetail.appId }</b></font></label>
								</p>
								<p>
									<label>M/s</label> <font face="Arial,Helvetica,Sans serif"
										size="3"><b>${businessEntityName}</b></font>
								</p>
							</div>
							<div class="col-sm-3">
								<p>
						...
						<div class="row">
							<div class="col-sm-12">
								...
								<p class="indent">
									...
									investment of Rs. <b>${fci1}</b> crores at - <b>${fullAddress}</b>
									Distt : <b>${districtName}</b> (Region : <b>${resionName}</b>)
									in the State of Uttar Pradesh under the G.O. No.
									1359/77-6-17-5(M)/17 dated 25.10.2017, as amended from time to
									time.
								</p>

								<p class="indent">
									In this connection, it is to inform that your request for grant
									of special incentives (as per Rules - 2017) has been considered
									and approved vide G.O. No. <font
										face="Arial,Helvetica,Sans serif" size="3"><b>IIEPP
											Rules Draft_GO</b></font> dated <font face="Arial,Helvetica,Sans serif"
										size="3"><b>26-10-2017</b></font> (photocopy enclosed),
								</p>
								...
								<p class="indent">
									...
									1359/77-6-17-5(M)/17 dated 25.10.2017 and G.O. No. <font
										face="Arial,Helvetica,Sans serif" size="3"><b>IIEPP
											Rules Draft_GO</b></font> dated <font face="Arial,Helvetica,Sans serif"
										size="3"><b>26-10-2017</b></font>, as amended from time to
									time, the above proposed project shall be entitled for
									consideration of grant of the following facilities/ reliefs:-
								</p>
									...
									<table class="table table-bordered">
										<thead>
											<tr>
												...
												<th>Facilities/Reliefs</th>
											</tr>
										</thead>
										<tbody>
											<tr>
												<td>1.</td>
												<td>SGST REIMBURSEMNT</td>
											</tr>
											<tr>
												<td>2.</td>
												<td>STAMP DUTY EXEMPTION/REIMBURSEMENT</td>
											</tr>
											<tr>
												<td>3.</td>
												<td>EPF REIMBURSEMENT</td>
											</tr>
											<tr>
												<td>4.</td>
												<td>INTEREST SUBSIDIES</td>
											</tr>
										</tbody>
									</table>
								</div>
						...
						<div class="row">
							<div class="col-sm-12">
								<p class="indent">
									...
									<font face="Arial,Helvetica,Sans serif" size="3"><b>IIEPP
											Rules Draft_GO</b></font> dated <font face="Arial,Helvetica,Sans serif"
										size="3"><b>26-10-2017</b></font>, as amended from time to
									time and subject to the following terms & conditions:-
								</p>
							</div>
						</div>
								...
								<ol class="p-0 m-0 pl-2">
									...
									<li>
										<p>Application for any modifications/changes in nature of
											the project, or in the cost of project so as to effect change
											in its category, or for changes in LOC conditions, etc. will
											be made by the company and will be examined by Nodal Agency
											(PICUP) on its own or through an outside competent agency and
											will be placed before the sanctioning authority, whose
									...
									<li>
										<p>The right to clarify any subject matter and approval to
											carry out modification in the scheme shall rest with the
											Empowered Committee.</p>
									</li>
									<li>
										<p>If any information submitted by the company is found to
											be false, or benefits are found to have been drawn based on
											concealment of material facts, the LOC shall be cancelled,
											and all benefits released to the undertaking shall become
											recoverable under the applicable state laws as arrears of
											land revenue.</p>
									</li>
									<li>
										<p>
											...
											and G.O. No. <font face="Arial,Helvetica,Sans serif" size="3"><b>IIEPP
													Rules Draft_GO</b></font> dated <font
											...
											initiate action to recall the benefits availed by the company
