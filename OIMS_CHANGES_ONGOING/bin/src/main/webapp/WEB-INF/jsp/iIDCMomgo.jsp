...
<head>
    ...
    <title>Minutes of Meeting and GO's MD PICUP</title>
                ...
                <div class="col-md-3 col-lg-2 sidebar-offcanvas pt-3" id="sidebar"
					...
					<ul class="nav flex-column pl-1">
						<li class="nav-item"><a class="nav-link active"
							href="./dashboardCS"><i class="fa fa-tachometer"></i> Dashboard</a></li>



						<li class="nav-item"><a class="nav-link"
							href="./iIDCMomgo"><i class="fa fa-calendar"></i> View
                            ...
                            <div class="col-sm-12">
                                <div class="mt-4">
                                    <div class="without-wizard-steps">
                                        <h4 class="card-title mb-4 mt-4 text-center">Minutes of Meeting and GO's</h4>
                                    </div>
                                </div>
                                <hr class="mt-2 mb-3">
                                  ...
                                  <div class="table-responsive">
                                    <table class="table table-bordered">
                                      ...
                                      <tbody>
                                       ...
                                       <td>${counter.index+1}</td>                                 
                                       <td>${list.gosName}</td>                                       
                                       <td><fmt:formatDate pattern = "dd/MM/yyyy" value = "${list.gosDate}"/></td>                                  
                ...
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <div class="custom-file">
                      ...
                      <label class="custom-file-label" for="UploadMom1">Choose File</label>
                    </div>
                  </div>
                </div>
              </div>
