...
<body class="bottom-bg" onload="reimbursement(); showYesOrNo()">
				...
				<div class="col-sm-12">
					<div class="form-card">
						<div class="without-wizard-steps">
							...
							<div class="isf-form">
								<form:form modelAttribute="incentiveDeatilsForm"
									name="incentiveDeatilsform" method="post" id="myForm"
									enctype="multipart/form-data">
									...
									<div id="accordion" class="accordion mt-5 mb-3">
										<div class="card mb-0 border-0">
											...
											<div class="card-header collapsed mb-4"
												data-toggle="collapse" href="#collapseOne">
												<a class="card-title"> <strong>SGST
														Reimbursemnt</strong></a>
											</div>
																...
																<tbody>
																	<tr>
																		...
																		<td><form:input path="ISF_Claim_Reim" type="text"
																				...
																				placeholder="Enter Amount INR (Cr)"
																				name="ISF_Claim_Reim" id="ISF_Claim_Reim"
																				onkeypress="return numeric_only (event, this);"
																				value="" maxlength="12"></form:input> <span
																			id="ISF_claim_reim"
																			class="text-danger d-inline-block mt-2"></span>
																			<small class="d-block text-info" id="SGSTwords"></small>
																			</td>
																	...
																	<tr>
																		<td>
																			<div class="custom-control custom-checkbox mb-4">
																				<input type="checkbox" class="custom-control-input"
																					id="Add_SCST_checkbox" name="ISF_SGST_Claim_Reim">
																				<label class="custom-control-label"
																					id="unselect_SCST_checkbox" for="Add_SCST_checkbox">Additional
																		...
																		<td><form:input path="ISF_Reim_SCST" type="text"
																				...
																				<small class="d-block text-info" id="SCSTwords"></small></td>
																	</tr>
																	<tr>
																		<td>
																			<div class="custom-control custom-checkbox mb-4">
																				<input type="checkbox" class="custom-control-input"
																					id="Add_FW_checkbox" name="ISF_SGST_Claim_Reim">
																				<label class="custom-control-label"
																					id="unselect_FW_checkbox" for="Add_FW_checkbox">Additional
																	...
																	<tr>
																		<td>
																			<div class="custom-control custom-checkbox mb-4">
																				<input type="checkbox" class="custom-control-input"
																					id="Add_BPLW_checkbox" name="ISF_SGST_Claim_Reim">
																				<label class="custom-control-label"
																					id="unselect_BPLW_checkbox" for="Add_BPLW_checkbox">Additional
																	...
																	<tr>
																		...
																		<td><form:input path="ISF_Ttl_SGST_Reim"
																				type="text" class="Total_SGST_Reim form-control"
																				name="ISF_Ttl_SGST_Reim" id="ISF_Ttl_SGST_Reim"
											...
											<div class="card-header collapsed mb-4"
												...
												href="#collapseTwo">
												<a class="card-title"> <strong>Stamp Duty
														Exemption/Reimbursement</strong>
												</a>
											</div>
																...
																<tbody>
																	<tr>
																		...
																		<td><form:input path="ISF_Stamp_Duty_EX"
																				id="ISF_Stamp_Duty_EX" type="text"
																				class="Stamp_Duty_EX form-control"
																				placeholder="Enter Amount INR (Cr)"
																				name="ISF_Stamp_Duty_EX" maxlength="12"
																				onkeypress="return numeric_only (event, this);"
																				value=""></form:input> <span id="ISF_Stamp_Duty_ex"
																			class="text-danger d-inline-block mt-2"></span>
																			<small class="d-block text-info" id="ISFTwords"></small>
																			</td>
																	</tr>
																	...
																	<tr>
																		...
																		<td><form:input path="ISF_Amt_Stamp_Duty_Reim"
																				id="ISF_Amt_Stamp_Duty_Reim" type="text"
																				class="Stamp_Duty_EX form-control"
																				placeholder="Enter Amount INR (Cr)"
																				name="ISF_Amt_Stamp_Duty_Reim" maxlength="12"
																				onkeypress="return numeric_only (event, this);"
																				value=""></form:input> <span
																			id="ISF_Amt_Stamp_Duty_reim"
																			class="text-danger d-inline-block mt-2"></span>
																			<small class="d-block text-info" id="Reimwords"></small>
																			</td>
																	</tr>
																	...
																	<tr>
																		<td>
																			<div class="custom-control custom-checkbox mb-4">
																				<input type="checkbox" class="custom-control-input"
																					id="Add_Stamp_Duty_checkbox" name="ISF_Stamp_Duty">
																				<label class="custom-control-label"
																					id="unselect_Stamp_Duty_checkbox"
																					for="Add_Stamp_Duty_checkbox">Additional
																		...
																		<td><form:input
																				...
																				id="Add_Stamp_Duty_Textbox"
																				class="Stamp_Duty_EX form-control"
																				name="ISF_Additonal_Stamp_Duty_EX" maxlength="12"
																				onkeypress="return numeric_only (event, this);"
																				readonly="true"></form:input>
																	...
																	<tr>
																		...
																		<td><form:input path="ISF_Ttl_Stamp_Duty_EX"
																				type="text" class="Total_Stamp_Duty_EX form-control"
																				id="ISF_Ttl_Stamp_Duty_EX" value="" readonly="true"
																				name="ISF_Ttl_Stamp_Duty_EX"></form:input>
											...
											<div class="card-header collapsed  mb-4"
												data-toggle="collapse" data-parent="#accordion"
												href="#collapseThree" id="efphide">
												<a class="card-title"> <strong>EPF
																...
																<tbody>
																	<tr>
																		...
																		<td><form:input path="ISF_Epf_Reim_UW"
																				type="text" class="EPF_Reim form-control"
																				placeholder="Enter Amount INR (Cr)"
																				name="ISF_Epf_Reim_UW" maxlength="12"
																				onkeypress="return numeric_only (event, this);"
																				value=""></form:input> <span id="ISF_Epf_Reim_uw"
																	...
																	<tr>
																		<td>
																			<div class="custom-control custom-checkbox mb-4">
																				<input type="checkbox" class="custom-control-input"
																					id="Add_EFP_Reim_SkUkW_checkbox"
																					name="Add_EFP_Reim_SkUkW_checkbox"> <label
																					class="custom-control-label"
																					id="unselect_EFP_Reim_SkUkW_checkbox"
																					for="Add_EFP_Reim_SkUkW_checkbox">Additional
																					10% EPF Reimbursement (200 direct skilled and
																					unskilled workers)</label>
																			</div>
																		</td>
																		<td><form:input path="ISF_Add_Epf_Reim_SkUkW"
																				type="text" id="Add_EFP_Reim_SkUkW_Textbox"
																				class="EPF_Reim form-control"
																				name="ISF_Add_Epf_Reim_SkUkW" maxlength="12"
																				onkeypress="return numeric_only (event, this);"
																	...
																	<tr>
																		<td>
																			<div class="custom-control custom-checkbox mb-4">
																				<input type="checkbox" class="custom-control-input"
																					id="Add_EFP_Reim_DIVSCSTF_checkbox"
																					name="Add_EFP_Reim_DIVSCSTF_checkbox"> <label
																					class="custom-control-label"
																					id="unselect_EFP_Reim_DIVSCSTF_checkbox"
																					for="Add_EFP_Reim_DIVSCSTF_checkbox">Additional
																					10% EPF Reimbursement upto maximum of 70% in case
																					of industrial undertakings having 75% equity owned
																					by Divyang/SC/CT/Females Promoters</label>
																			</div>
																		</td>
																		<td><form:input path="ISF_Add_Epf_Reim_DIVSCSTF"
																				type="text" id="Add_EFP_Reim_DIVSCSTF_Textbox"
																				class="EPF_Reim form-control"
																				name="ISF_Add_Epf_Reim_DIVSCSTF" maxlength="12"
																				onkeypress="return numeric_only (event, this);"
																				readonly="true"></form:input></td>
																	</tr>
																	<tr>
																		<td><strong>Total EPF Reimbursement</strong></td>
																		<td><form:input path="ISF_Ttl_EPF_Reim"
																				type="text" class="Total_EPF_Reim form-control"
																				readonly="true" name="ISF_Ttl_EPF_Reim"></form:input></td>
																	</tr>
																</tbody>
															</table>
														</div>
											...
											<div class="card-header collapsed mb-4"
												data-toggle="collapse" data-parent="#accordion"
												href="#collapseFour">
												<a class="card-title"> <strong>Interest
														Subsidies</strong>
												</a>
											</div>
																...
																<table
																	...
																	<tbody>
																		<tr>
																			...
																			<td><form:input path="ISF_Cis" id="ISF_Cis" type="text" 
																					class="ISF_CIS form-control"
																					placeholder="Enter Amount INR (Cr)" name="ISF_Cis"
																					onkeypress="return numeric_only (event, this);"
																					maxlength="12" value=""></form:input> <span
																				id="ISF_cis" class="text-danger d-inline-block mt-2"></span>
																				<small class="d-block text-info" id="Subsidywords"></small>
																				</td>
																		</tr>
																		<tr>
																			<td>
																				<div class="custom-control custom-checkbox mb-4">
																					<input type="checkbox" class="custom-control-input"
																						id="Add_CIS_checkbox" name="Add_CIS_checkbox">
																					<label class="custom-control-label"
																						id="unselect_CIS_checkbox" for="Add_CIS_checkbox">Additional
																						Capital Interest Subsidy@2.5% upto maximum of 7.5%
																						in case of industrial undertakings having 75%
																						equity owned by Divyang/SC/CT/Females Promoters</label>
																				</div>
																			</td>
																			<td><form:input path="ISF_ACI_Subsidy_Indus"
																					type="text" id="Add_CIS_Textbox"
																					class="ISF_CIS form-control"
																					name="ISF_ACI_Subsidy_Indus" maxlength="12"
																					onkeypress="return numeric_only (event, this);"
																					readonly="true"></form:input>
																		...
																		<tr>
																			...
																			<td><form:input path="ISF_Infra_Int_Subsidy"
																					type="text" class="ISF_CIS form-control"
																					placeholder="Enter Amount INR (Cr)"
																					name="ISF_Infra_Int_Subsidy" maxlength="12"
																					onkeypress="return numeric_only (event, this);"
																					value=""></form:input>
																		...
																		<tr>
																			<td>
																				<div class="custom-control custom-checkbox mb-4">
																					<input type="checkbox" class="custom-control-input"
																						id="Add_IIS_checkbox" name="Add_IIS_checkbox">
																					<label class="custom-control-label"
																						id="unselect_IIS_checkbox" for="Add_IIS_checkbox">Additional
																						Infrastructure Interest Subsidy @2.5% upto maximum
																						of 7.5% in case of industrial undertakings having
																						75% equity owned by Divyang/SC/CT/Females
																						Promoters</label>
																				</div>
																			</td>
																			<td><form:input path="ISF_AII_Subsidy_DIVSCSTF"
																					type="text" id="Add_IIS_Textbox"
																					class="ISF_CIS form-control"
																					name="ISF_AII_Subsidy_DIVSCSTF" maxlength="12"
																					onkeypress="return numeric_only (event, this);"
																					readonly="true"></form:input>
																		...
																		<tr>
																			...
																			<td><form:input path="ISF_Loan_Subsidy"
																					type="text" class="ISF_CIS form-control"
																					placeholder="Enter Amount INR (Cr)"
																					name="ISF_Loan_Subsidy" maxlength="12"
																					onkeypress="return numeric_only (event, this);"
																					value=""></form:input>
																		...
																		<tr>
																			...
																			<td><form:input path="ISF_Total_Int_Subsidy"
																					type="text" class="Total_ISF_CIS form-control"
																					readonly="true" name="ISF_Total_Int_Subsidy"></form:input></td>
																		</tr>
																	</tbody>
																</table>
															</div>
																	...
																	<tbody>
																		<tr>
																			...
																			<td><form:input path="ISF_Tax_Credit_Reim" 
																					...
																					placeholder="Enter Amount INR (Cr)"
																					name="ISF_Tax_Credit_Reim" maxlength="12"
																					onkeypress="return numeric_only (event, this);"></form:input>
																		...
																		<tr class="condition-on-electric">
																			...
																			<td><form:input path="ISF_EX_E_Duty" type="text"
																					...
																					placeholder="Enter Amount INR (Cr)"
																					name="ISF_EX_E_Duty" maxlength="12"
																					onkeypress="return numeric_only (event, this);"></form:input></td>
																		</tr>
																		<tr class="condition-on-electric">
																			...
																			<td><form:input path="ISF_EX_E_Duty_PC"
																					type="text" class="Other_Incentives form-control"
																					placeholder="Enter Amount INR (Cr)"
																					name="ISF_EX_E_Duty_PC" maxlength="12"
																					onkeypress="return numeric_only (event, this);"></form:input></td>
																		</tr>
																		<tr  class="condition-on-electric">
																			...
																			<td><form:input path="ISF_EX_Mandee_Fee"
																					type="text" class="Other_Incentives form-control"
																					placeholder="Enter Amount INR (Cr)"
																					name="ISF_EX_Mandee_Fee" maxlength="12"
																					onkeypress="return numeric_only (event, this);"></form:input></td>
																		</tr>
																		<tr>
																			...
																			<td><form:input path="ISF_Indus_Payroll_Asst"
																					type="text" class="Other_Incentives form-control"
																					placeholder="Enter Amount INR (Cr)" maxlength="12"
																					name="ISF_Indus_Payroll_Asst"
																					onkeypress="return numeric_only (event, this);"></form:input>
																		...
																		<tr>
																			...
																			<td><form:input path="Total_Other_Incentive"
																					type="text"
																					class="Total_Other_Incentives form-control"
																					readonly="true" name="Total_Other_Incentive"></form:input></td>
																		</tr>
																	</tbody>
																</table>
															</div>
									...
									<div class="row condition-on-super-mega">
										<div class="col-sm-12">
											...
											<div
												...
												<form:radiobutton path="ISF_Cstm_Inc_Status"
													class="custom-control-input" id="CstmIncStatusYes"
													name="ISF_Cstm_Inc_Status" value="Yes"></form:radiobutton>
												<label class="custom-control-label" for="CstmIncStatusYes">Yes</label>
											</div>
											<div
												class="custom-control custom-radio custom-control-inline">
												<form:radiobutton path="ISF_Cstm_Inc_Status"
													class="custom-control-input" id="CstmIncStatusNo"
													name="ISF_Cstm_Inc_Status" value="No"></form:radiobutton>
									...
									<div class="row condition-on-super-mega" id="AddIncentiveType">
										<div class="col-sm-12">
											<div class="form-group">
												...
												<form:hidden path="acdid" name="acdid" id="acdid"
													value="${acdid}" />
												<form:input path="addIncentiveType" type="text"
													class="form-control" placeholder="Please Add Incentive"
													id="addIncentiveType" name="addIncentiveType"
													onkeypress="return /[a-zедц ]/i.test(event.key)"></form:input>
											</div>
										</div>
										<div class="col-sm-12">
											<div class="form-group">
												...
												<form:input path="addAmt" type="text" maxlength="12"
													class="form-control" placeholder="Enter Amount INR (Cr)"
													name="addAmt"
													onkeypress="return numeric_only (event, this);"></form:input>
											</div>
										...
										<div class="col-sm-12">
											<div class="form-group">
												...
												<form:textarea path="typeDtlCusIncentives"
													class="form-control" name="typeDtlCusIncentives"
													placeholder="Add details here" maxlength="250" rows="4"></form:textarea>
											</div>
										</div>
									</div>
									...
									<div class="row condition-on-super-mega add-incentive-type">
										<div class="col-sm-12">
											<div class="form-group">
												...
												<form:textarea path="othAddRequest" rows="4"
													class="form-control" placeholder="" maxlength="250"
													name="othAddRequest"></form:textarea>
											</div>
										</div>
									</div>
									...
									<div class="row condition-on-super-mega add-incentive-type">
										<div class="col-sm-12 text-right">
											<button type="submit" formaction="availCustomisedDetails"
												onclick="return validationAvailCustomisedDetailsForm()"
												class="common-btn mt-3 mb-4">Add</button>
										</div>
									</div>
										...
										<div class="col-sm-12">
											<div class="table-responsive">
												<table
													...
													<tbody>
														<c:forEach var="list"
															items="${availCustomisedDetailsList}" varStatus="counter">
															<tr>
																...
																<td class="text-center"><a
																	href="./editAvailCustomisedDetails?editAvailCustomisedRecord=<c:out value="${counter.index}"/>"
																	onclick="return confirm('Are you sure you want to edit Customised Incentive Record?')">
																		<i class="fa fa-edit text-info"></i>
																</a> <a
																	href="./removeAvailList?deleteAvailRecord=${counter.index}"
																	onclick="return confirm('Are you sure you want to Delete Customised Incentive Details?')"><i
									...
									<div class="row  condition-on-super-mega add-incentive-type">
										<div class="col-md-12">
											<div class="form-group">
												<label>Upload Document <small>(In PDF format
														less than 2 MB)</small> <img src="images/pdf-icon.png"
													class="pdf-icon" alt="pdf-icon"></label>
												<div class="custom-file">
													<input type="file" class="custom-file-input"
														id="UploadDocumentISF" name="isfCustIncDocName"
														onchange="ValidateSize(this)"> <label
														class="custom-file-label" for="UploadDocumentISF"
														id="UploadDocumentISFId">Choose file</label> <span
														id="UploadDocumentisf"
														class="text-danger d-inline-block mt-2"></span>
												</div>
											</div>
										</div>
										...
										<div class="col-sm-12">
											<div class="form-group">
												...
												<!-- <input  path="othAddRequest"
														type="text" class="form-control" placeholder=""
														name="othAddRequest"></input> -->
												<form:textarea path="othAddRequest1" rows="4"
													class="form-control" placeholder="" maxlength="250"
													name="othAddRequest1"></form:textarea>
											</div>
										</div>
										<div class="col-sm-12">
											<div class="form-group">
									...
									<div class="row">
										<div class="col-sm-4">
											<a href="./skilUnskEmplDet"
												onclick="return confirm('Are you sure you want to go to Proposed Employment Details?')"
												class="common-default-btn mt-3">Back</a>
										</div>
										<div class="col-sm-8 text-right">
											<a href="./previewAfIfForm" target="_blank"
												class="common-green-btn mt-3">Preview of Application
												Form</a>
											<button type="submit" formaction="saveIncentiveDetails"
												onclick="confirm('Are you sure, You want to save Incentive Details record.'); ValidateSize(this) "
												class="common-btn mt-3">Save</button>
 ...
 -->
											<button type="submit" formaction="submitIncentiveDetails"
												onclick="return incentiveDeatilsSubmitForm()"
												class="common-btn mt-3">Submit</button>
										</div>
									</div>
