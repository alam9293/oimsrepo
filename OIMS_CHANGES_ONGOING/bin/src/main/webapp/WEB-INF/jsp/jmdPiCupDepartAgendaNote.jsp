				...
				<div class="col-md-9 col-lg-10 mt-4 main">
					...
					<div class="card card-block p-4 mb-5">
						<div class="step-links">
							<ul class="only-steps">
								<li><a href="./jmdPiCupAgendaNote"
									class="active pr-3">Agenda Note for LOC</a></li>
								<li><a href="./jmdPiCupAgendaNoteDis"
									class="pr-3">Agenda Note for Disbursement</a></li>
							</ul>
						</div>
						<div id="accordion"
														...
														<tbody>
															<c:forEach var="list"
																...
																<tr>
																	...
																	<td><a
																		href="./downloadDocSctnyComt?applicantId=${list.appliId}">${list.pkupFilename}</a></td>
																	<td><a
																		href="./viewAgendaDetailsByJMdPiCupDepart?applicantId=${list.appliId}"
																		class="btn btn-outline-info btn-sm">View</a> <a
																		href="#commentNote"
																		class="btn btn-outline-success btn-sm"
																		data-toggle="modal" id="${list.appliId}"
																		data-target="#edit-modal">Comment</a> <a
																		href="./saveForwardedToMdpicup?applicantId=${list.appliId}"
																		class="btn btn-outline-success btn-sm"
	...
	<div class="modal fade" id="edit-modal">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<form:form modelAttribute="PrepareAgendaNotes"
					action="saveCommenSubByJMdPicupDepartment" class="mt-4"
					name="PrepareAgendaNotes" method="post">
					<!-- Modal body -->
					<div class="modal-body">
						<div class="row">
