...
<title>Meeting Schedule | DIS</title>
...
<body>
				...
				<div class="col-md-9 col-lg-10 mt-4 main mb-4">
					...
					<div class="card card-block p-3 overflow-v">
						<div class="step-links">
							<ul class="only-steps">
								<li><a href="./meetingschedule" class="pr-3">Meeting
										Scheduler for LOC</a></li>
								<li><a href="./meetingscheduleDis" class="active pr-3">Meeting
						...
						<div class="row">
							<div class="col-sm-12">
								<hr class="mt-2 mb-3">
								<spring:url value="/meetingSchedulerDis"
										...
										<div class="row">
												<div class="col-sm-5">
													<div class="form-group multiple-select">
														<label class="d-block">Select Department<font color="red"><span>*</span></font></label>
											...
											<div class="row">
												...
												<div class="col-sm-5 megaId">
													<div class="form-group multiple-select">
														<label class="d-block">Select Application ID<font color="red"><span>*</span></font></label>
														<form:select path="appId" class="form-control" name="appId" 
														id="gosAppMega1ID" multiple="multiple" style="display: none;">
															<c:forEach items="${listpreAgendaNotesMega}" var="list">
																<form:option value="${list.appliId} , ${list.appliacntEmailId}">${list.appliId}</form:option>
															</c:forEach>
														</form:select>
												...
												<div class="col-sm-5 largeId">
													<div class="form-group multiple-select">
														<label class="d-block">Select Application ID<font color="red"><span>*</span></font></label>
														<form:select path="appId" class="form-control" name="appId" 
														id="gosAppLargeID" multiple="multiple" style="display: none;"> 
	...
	<script>
		...
		function getSelectedValues() {
			var selectedVal = $("#gosAppMega1ID").val();
			for (var i = 0; i < selectedVal.length; i++) {
				function innerFunc(i) {
					setTimeout(function() {
						location.href = selectedVal[i];
