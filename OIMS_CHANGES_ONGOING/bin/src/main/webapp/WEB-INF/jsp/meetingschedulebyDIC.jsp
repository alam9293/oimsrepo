...
<title>Meeting Schedule DIC</title>
				...
				<div class="col-md-3 col-lg-2 sidebar-offcanvas pt-3" id="sidebar"
					...
					<ul class="nav flex-column pl-1">
						<li class="nav-item"><a class="nav-link "
							href="./dicDepartmentDashboard"><i class="fa fa-tachometer"></i>Dashboard</a></li>
						<li class="nav-item"><a class="nav-link"
					...
					<div class="card card-block p-3 overflow-v">
						<div class="row">
							<div class="col-sm-12">
								...
								<hr class="mt-2 mb-3">
								<spring:url value="/meetingSchedulerByDIC"
												...
												<div class="col-sm-6">
													<div class="form-group">
														...
														<form:select path="commiteeDepartment"
															...
															<%-- <form:option value="Empowered Commitee">Empowered Commitee</form:option> --%>
															<form:option value="Sanction Commitee">Sanction Commitee</form:option>
														</form:select>
