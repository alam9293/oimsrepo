...
<body>
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="step-links">
									<ul class="only-steps">
										<li><a href="./momgo" class="active pr-3">MOM for LOC</a></li>
										<li><a href="./momgoDis" class="pr-3">MOM for
												Disbursement </a></li>
									</ul>
								</div>
								<hr class="mt-2 mb-3">
															...
															<tbody>
																<c:forEach var="list"
																	...
																	<tr>
																		...
																		<td><a href="./downloadDocMom?fileNameMomId=${list.id}"
																			target="_blank"><small>${list.uploadMomFile}</small></a></td>
																			 <input type="hidden" id="thisField" name="inputName" value="${list.gosAppID}">
															...
															<tbody>
																<c:forEach var="list"
																	...
																	<tr>
																		...
																		<td> <button type="button" class="btn btn-outline-success btn-sm"
																			id="${list.gosAppID}" data-target="#CirculateDraftSanction"
																		value="Submit" data-toggle="modal">Circulate Minutes of Meeting</button>
																			</td>
																			</tr>
																</c:forEach>
															</tbody>
															...
															<tbody>
																<c:forEach var="list"
																	...
																	<tr>
																		...
																		<td> <button type="button" class="btn btn-outline-success btn-sm"
																			id="${list.gosAppID}" data-target="#CirculateDraftGo"
																		value="Submit" 
																			data-toggle="modal">Circulate GO's</button>
																			</td>
																		</tr>
																</c:forEach>
															</tbody>
		...
		<div class="modal fade" id="UploadMOM">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<spring:url value="/minutesOfMeetings"
	...
	<div class="container">
        ...
        <form:form modelAttribute="department"
					action="momconcerncirculateem" autocomplete="off" method="POST">
          <div class="modal-content">

            <!-- Modal Header -->
            <div class="modal-header">
              <h4 class="modal-title">Send to Departments Empowered</h4>
	...
	<div class="container">
        ...
        <form:form modelAttribute="department"
					action="momconcerncirculatest" autocomplete="off" method="POST">
          <div class="modal-content">
	...
	<div class="container">
        ...
        <form:form modelAttribute="department" 
					action="momconcerncirculatego" autocomplete="off" method="POST">
          <div class="modal-content">
