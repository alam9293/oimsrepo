...
<head>
    ...
    <title>MOM and GO's | JMD PICUP</title>
                    ...
                    <ul class="nav flex-column pl-1">
						...
						<li class="nav-item"><a class="nav-link"
							href="./jmdPiCupAgendaNote"><i class="fa fa-list"></i> Agenda
								Note</a></li>
						<li class="nav-item"><a class="nav-link active" href="./momgobyJMDPICUP"><i
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="step-links">
									<ul class="only-steps">
										<li><a href="./momgobyJMDPICUP" class="active pr-3">MOM for LOC</a></li>
										<li><a href="./disMomgobyJMDPICUP" class="pr-3">MOM for
												Disbursement </a></li>
									</ul>
								</div>
