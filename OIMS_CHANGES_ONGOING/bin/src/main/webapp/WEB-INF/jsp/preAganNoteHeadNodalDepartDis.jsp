						...
						<div class="step-links">
							<ul class="only-steps">
								<li><a href="./preAgenNoteheadNodDepart"
									class="pr-3">Agenda Note for LOC</a></li>
								<li><a href="./preAgenNoteheadNodDepartDis"
									class="active pr-3">Agenda Note for Disbursement </a></li>
							</ul>
						</div>
						<div id="accordion"
													...
													<tbody>
														<c:forEach var="list"
															...
															<tr>
																...
																<!-- <td></td> -->
																<td><a
																	href="./viewAgendaHeadNodalDepartDis?applicantId=${list.appliId}"
																	class="btn btn-outline-info btn-sm">View</a> <a
																	href="#commentNote"
																	class="btn btn-outline-success btn-sm"
																	data-toggle="modal" id="${list.appliId}"
																	data-target="#edit-modal">Comment</a> <a
																	href="./savePreAganByHeadNodalDepartDis?applicantId=${list.appliId}"
																	class="btn btn-outline-success btn-sm">Approve</a> 
																<!-- <a href="#CirculateDraft" class="btn btn-outline-info btn-sm" data-toggle="modal">Circulate
																		Agenda Note</a></td> -->
															</tr>
														</c:forEach>
													</tbody>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<form:form modelAttribute="PrepareAgendaNotesDis"
						action="saveCommentHeadNodalDepartmentDis" class="mt-4"
						...
						<div class="modal-body">
							<div class="row">
								<div class="col-sm-12">
									...
									<form:textarea path="acsComments" class="form-control"
											placeholder="Enter Your Comment" rows="4"
											name="acsComments" maxlength="500"></form:textarea>
									</div>
