...
<title>Evaluation View MDPICUP</title>
			...
			<div class="row row-offcanvas row-offcanvas-left">
				...
				<div class="col-md-9 col-lg-10 mt-4 main mb-4">
					<div class="card card-block p-3">
						<div class="row">
							<div class="col-sm-5">
								<a href="./jmdPiCupAgendaNote" class="common-default-btn mt-3">Back</a>
							</div>
						</div>
												...
												<c:forEach var="list" items="${investmentDetailsmixedList}"
													...
													<tr>
														...
														<td><input type="submit" value="View"
															...
															formaction="./dispalyAgendaNoteByJMdPiCupDepart?appliId=${list.appliId}"
