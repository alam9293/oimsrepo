...
<div class="without-wizard-steps" id="printform">
	...
	<form:form action="saveApplicantDetails" class="isf-form" method="get"
		modelAttribute="applicantDetail" enctype="multipart/form-data">
		<!-- <hr class="mt-2">	 -->

		<div class="isf-form mt-4">
			<h4
				class="card-title mb-4 mt-4 text-center animate__animated animate__fadeInDown">Authorized
						...
						<table class="table table-bordered">
							<tbody>
								...
								<tr>
									<td>Last Name</td>
									<td><input type="text" class="form-control"
										value="${appLastName}" disabled="disabled" id="appLastNameId"
										name="appLastName"></td>
								</tr>
								<tr>
									<td>Email ID</td>
									<td><input type="text" class="form-control"
										value="${appEmailId}" disabled="disabled" id="appEmailId"
										name="appEmailId"></td>
								</tr>
								<tr>
									<td>Mobile No:(+91)</td>
									<td colspan="2"><input type="text" class="form-control"
										value="${appMobileNo}" disabled="disabled" id="appMobileNoId"
										name="appMobileNo"></td>
								</tr>
								<tr>
									<td>Phone No. (Landline)</td>
									<td colspan="2"><input type="text" class="form-control"
										value="${appPhoneNo}" disabled="disabled" id="appPhoneNo"
										name="appPhoneNo"></td>
								</tr>
								<tr>
									<td>Designation</td>
									<td colspan="2"><input type="text" class="form-control"
										value="${appDesignation}" disabled="disabled"
										id="appDesignation" name="appDesignation"></td>
								</tr>
								<tr>
									<td>Gender</td>
									<td colspan="2">
										<div class="form-group">
											<div
												...
												<input type="radio" class="custom-control-input"
													id="MaleOpt" disabled="disabled" name="gender" value="Male">
								...
								<tr>
									...
									<td colspan="2"><input type="text" value="${appAadharNo}"
										disabled="disabled" class="form-control" name="appAadharNo"></td>
								</tr>
								<tr>
									<td>PAN Number</td>
									<td colspan="2"><input type="text" value="${appPancardNo}"
										disabled="disabled" class="form-control" name="appPancardNo"></td>
								</tr>
								<tr>
									<td>Address Line - 1</td>
									<td colspan="2"><input type="text" class="form-control"
										value="${appAddressLine1}" disabled="disabled"
										id="appAddressLine1" name="appAddressLine1"></td>
								</tr>
								<tr>
									<td>Address Line - 2</td>
									<td colspan="2"><input type="text" class="form-control"
										value="${appAddressLine2}" disabled="disabled"
										id="appAddressLine2" name="appAddressLine2"></td>
								</tr>
								<tr>
									<td>Country</td>
									<td colspan="2"><input type="text" value="${appCountry}"
										disabled="disabled" class="form-control" name="appCountry"></td>
								</tr>
								<tr>
									<td>State/UT</td>
									<td colspan="2"><input type="text" value="${appState}"
										disabled="disabled" class="form-control" name="appState"></td>
								</tr>
								<tr>
									<td>District</td>
									<td colspan="2"><input type="text" value="${appDistrict}"
										disabled="disabled" class="form-control" name="appDistrict"></td>
								</tr>
								<tr>
									<td>Pin Code</td>
									<td colspan="2"><input type="text" class="form-control"
										value="${appPinCode}" disabled="disabled" id="appPinCode"
										name="appPinCode"></td>
								</tr>
							</tbody>
						</table>
			...
			<div class="col-sm-12">
				<div class="table-responsive">
						...
						<tbody>
							...
							<tr>
								...
								<td><input type="text" class="form-control"
									...
									id="authorisedSignatoryName" name="authorisedSignatoryName"></td>
							</tr>
							<tr>
								<td>Designation</td>
								<td><input type="text" class="form-control"
							...
							<tr>
								<td>Mobile No.</td>
								<td><input type="text" class="form-control"
									value="${mobileNumber}" disabled="disabled" id="mobileNumber"
									name="mobileNumber"></td>
							</tr>
							<tr>
								<td>Phone No. (Landline)</td>
								<td colspan="2"><input type="text" class="form-control"
									value="${phoneNo}" disabled="disabled" id="phoneNo"
									name="phoneNo"></td>
							</tr>
							<tr>
								<td>Fax</td>
								<td><input type="text" class="form-control" value="${fax}"
									disabled="disabled" id="fax" name="fax"></td>
							</tr>
							<tr>
							...
							<tr>
								<td colspan="2"><strong>Director / Partner / Owner
										/ Proprietor Details</strong></td>
							</tr>

						</tbody>
					</table>
					<table class="table table-stripped table-bordered directors-table"
						id="customFields">
					...
					<table class="table table-bordered">
						<tbody>
							<tr>
								<td colspan="2"><strong>Uploaded Documents and
							...
							<tr>
								<td>GSTIN</td>
								<td><input type="text" value="${gstin}" disabled="disabled"
									class="form-control" id="gstin" name="gstin"></td>
							</tr>
							<tr>
								<td>CIN</td>
								<td><input type="text" value="${cin}" disabled="disabled"
									class="form-control" id="cin" name="cin"></td>
							</tr>
							<tr>
								<td>Company PAN No.</td>
								<td><input type="text" class="form-control"
									value="${companyPanNo}" disabled="disabled" id="companyPanNo"
									name="companyPanNo"></td>
							</tr>
							<tr>
								<td>MoA / Partnership Deed Attachment</td>
								<%-- <td><a href="./downloadDocBusiness?fileName=${moaDocFname}"><small>${moaDocFname}</small></a> --%>
								<td><a
									href="./downloadBusinessEntityDoc?fileName=${moaDocFname}"><small>${moaDocFname}</small></a>
								</td>
							</tr>
							<tr>
								<td>Certificate Of Incorporation/Registration</td>
								<td><a
									href="./downloadBusinessEntityDoc?fileName=${regisAttacDocFname}"><small>${regisAttacDocFname}</small></a>
								</td>
							</tr>
							<tr>
								...
								<td><a
									href="./downloadBusinessEntityDoc?fileName=${bodDocFname}"><small>${bodDocFname}</small></a>
								</td>
							</tr>
							<%-- <tr>
							...
							<tr>
								<td>Notarized undertaking (as per format placed at Annexure
									I-A) on Stamp Paper of Rs. 10</td>
								<td><a
									href="./downloadBusinessEntityDoc?fileName=${annexureiaformat}"><small>${annexureiaformat}</small></a>
								</td>
							</tr>
						</tbody>
					</table>
					...
					<table class="table table-bordered">
						<tbody>
							...
							<tr>
								<td>Designation</td>
								<td><input type="text" class="form-control"
									value="${designation}" disabled="disabled" id="designation"
									name="designation"></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="text" class="form-control"
									value="${webSiteName}" disabled="disabled" id="webSiteName"
									name="webSiteName"></td>
							</tr>
					...
					<%-- 		<tr>
						<td>Full Registered Address
							...
							<tr>
								<td>Full Address</td>
								<td><input type="text" class="form-control"
									value="${fullAddress}" disabled="disabled" id="fullAddress"
									name="fullAddress"></td>
							</tr>
							<tr>
								<td>District</td>
								<td><input type="text" class="form-control"
									value="${districtName}" disabled="disabled" id="districtName"
									name="districtName"></td>
							</tr>
							<tr>
								<td>Mandal</td>
								<td><input type="text" class="form-control"
									value="${mandalName}" disabled="disabled" id="mandalName"
									name="mandalName"></td>
							</tr>
							<tr>
								<td>Region</td>
								<td><input type="text" class="form-control"
									value="${resionName}" disabled="disabled" id="resionName"
									name="resionName"></td>
							</tr>
							<tr>
								<td>Pin Code</td>
								<td style="width: 50%;"><input type="text"
									class="form-control" value="${pinCode}" disabled="disabled"
										...
										<div class="form-group mt-3">
											...
											<div
												...
												<input type="checkbox" disabled="disabled"
													...
													name="diversification" value="Diversification"> <label
													class="custom-control-label" for="Diversification">Diversification</label>
											</div>
										</div>
									</div>
								</td>
							...
							<tr class="natureOfProject">
								<td colspan="2"><strong>Details of
										existing/proposed products to be manufactured and its capacity
										(for expansion projects only)</strong></td>
							</tr>
							...
							<tr id="hideByRowId4">
								<td colspan="2"><strong>Relevant Documentary
										Support</strong></td>
							</tr>
							<c:if test="${natureOfProject=='ExistingProject'}">

								<tr id="hideByRowId3">
									<td>Enclose Detailed Project Report prepared by External
										Consultant/Chartered Accountants</td>
									<td><a
										href="./downloadExistProjDoc?fileName=${enclDetProRepFileName}"><small>${enclDetProRepFileName}</small></a></td>
								</tr>
							</c:if>
							...
							<c:if test="${natureOfProject=='NewProject'}">
								...
								<tr id="hideByRowId3">
									<td>Enclose Detailed Project Report prepared by External
										Consultant/Chartered Accountants</td>
									<td><a
										href="./downloadNewProjDoc?fileName=${enclDetProRepFileName}"><small>${enclDetProRepFileName}</small></a></td>
								</tr>
							</c:if>
							...
							<tr id="hideByRowId1">
								...
								<td><a
									href="./downloadExistProjDoc?fileName=${caCertificateFileName}"><small>${caCertificateFileName}</small></a></td>
							</tr>
							<tr id="hideByRowId2">
								<td>Chartered Engineer’s Certified List of Fixed Assets
									in support of existing gross block.</td>
								<td><a
									href="./downloadExistProjDoc?fileName=${charatEngFileName}"><small>${charatEngFileName}</small></a></td>
							</tr>
						</tbody>
					</table>
				</div>
					...
					<table class="table table-bordered">
						<tbody>
							<tr>
								...
								<td><input type="text" class="form-control" id=""
									value="${categorytype}" disabled="" name=""></td>
							</tr>
							<tr>
								<td>Proposed Capital Investment</td>
								<td><input type="text" class="form-control"
									value="${invFci}" disabled="disabled" id="invFci" name="invFci"></td>
							</tr>
							<tr>
							...
							<tr>
								<td>Land Cost</td>
								<td><input type="text" class="form-control"
									value="${invLandCost}" disabled="disabled" id="invLandCost"
									name="invLandCost"></td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><input type="text" class="form-control"
									value="${invOtherCost}" disabled="disabled" id="invOtherCost"
									name="invOtherCost"></td>
							</tr>
							<tr>
							...
							<c:if test="${categorytype=='Small' || categorytype=='Medium' }">
								<tr>
									...
									<td><a
										href="./downloadInvestmentDoc?fileName=${regiOrLicenseFileName}"><small>${regiOrLicenseFileName}</small></a>
									</td>
								</tr>
							...
							<c:if
								test="${categorytype=='Mega' || categorytype=='Large' || categorytype=='Super Mega' || categorytype=='Mega Plus' }">
								<tr>
							...
							<tr>
								<td colspan="2"><strong>Phase Wise Investment</strong></td>
							</tr>
							...
							<tr>
								<td>Upload for Break-Up of Project Cost & Means of
									Financing</td>
								<td><a
									href="./downloadInvestmentDoc?fileName=${invFileName}"><small>${invFileName}</small></a></td>
							</tr>
					...
					<table class="table table-bordered">
						<tbody>
							...
							<tr>
								...
								<td><input type="text" class="form-control" id=""
									value="${grossTotalFemaleEmployment}" disabled="" name=""></td>
							</tr>
							<tr>
					...
					<table class="table table-stripped table-bordered loc-stage-table">
						<tbody>
							<tr class="ISF_Claim_Reim-row">
								<td style="width: 50%;"><strong>Amount of SGST
										claimed for reimbursement</strong></td>
								<td><input type="text" class="form-control"
									value="${ISF_Claim_Reim}" disabled="disabled"
									name="ISF_Claim_Reim"></td>
							</tr>
							<tr class="ISF_Reim_SCST-row">
								<td><label>Additional 10% GST where 25% minimum
										SC/ST workers employed subject to minimum of 400 total workers
										in industrial undertakings located in Paschimanchal and
										minimum of 200 total workers in B-P-M</label></td>
								<td><input type="text" class="form-control"
									value="${ISF_Reim_SCST}" disabled="disabled"
									name="ISF_Reim_SCST"></td>
							</tr>
							<tr class="ISF_Reim_FW-row">
								<td><label>Additional 10% GST where 40% minimum
										female workers employed subject to minimum of 400 total
										workers in industrial undertakings located in Paschimanchal
										and minimum of 200 total workers in B-P-M</label></td>
								<td><input type="text" class="form-control"
									value="${ISF_Reim_FW}" disabled="disabled" name="ISF_Reim_FW"></td>
							</tr>
							<tr class="ISF_Reim_BPLW-row">
								<td><label>Additional 10% GST where 25% minimum BPL
										workers employed subject to minimum of 400 total workers in
										industrial undertakings located in Paschimanchal and minimum
										of 200 total workers in B-P-M</label></td>
								<td><input type="text" class="form-control"
					...
					<table class="table table-stripped table-bordered loc-stage-table">
						<tbody>
							<tr class="ISF_Stamp_Duty_EX-row">
								<td style="width: 50%;"><strong>Amount of Stamp
										Duty Exemption</strong></td>
								<td><input type="text" class="form-control"
							...
							<tr class="ISF_Additonal_Stamp_Duty_EX-row">
								<td><label>Additional Stamp Duty exemption @20%
										upto maximum of 100% in case of industrial undertakings having
										75% equity owned by Divyang/SC/ ST/Females Promoters</label></td>
								<td><input type="text" class="form-control"
					...
					<table class="table table-stripped table-bordered loc-stage-table">
						<tbody>
							<tr class="ISF_Epf_Reim_UW-row">
								<td style="width: 50%;"><strong>EPF Reimbursement
										(100 or more unskilled workers)</strong></td>
								<td><input type="text" class="form-control"
									value="${ISF_Epf_Reim_UW}" disabled="disabled"
									name="ISF_Epf_Reim_UW"></td>
							</tr>
							<tr class="ISF_Add_Epf_Reim_SkUkW-row">
								<td><label>Additional 10% EPF Reimbursement (200
										direct skilled and unskilled workers)</label></td>
								<td><input type="text" class="form-control"
									value="${ISF_Add_Epf_Reim_SkUkW}" disabled="disabled"
									name="ISF_Add_Epf_Reim_SkUkW"></td>
							</tr>
							<tr class="ISF_Add_Epf_Reim_DIVSCSTF-row">
								<td><label>Additional 10% EPF Reimbursement upto
										maximum of 70% in case of industrial undertakings having 75%
										equity owned by Divyang/SC/ST/Females Promoters</label></td>
								<td><input type="text" class="form-control"
					...
					<table class="table table-stripped table-bordered loc-stage-table">
						<tbody>
							<tr class="ISF_Cis-row">
								<td style="width: 50%;"><strong>Capital Interest
										Subsidy</strong></td>
								<td><input type="text" class="form-control"
									value="${ISF_Cis}" disabled="disabled" name="ISF_Cis"></td>
							</tr>
							<tr class="ISF_ACI_Subsidy_Indus-row">
								<td><label>Additional Capital Interest Subsidy@2.5%
										upto maximum of 7.5% in case of industrial undertakings having
										75% equity owned by Divyang/SC/ST/Females Promoters</label></td>
								<td><input type="text" class="form-control"
							...
							<tr class="ISF_AII_Subsidy_DIVSCSTF-row">
								<td><label>Additional Infrastructure Interest
										Subsidy @2.5% upto maximum of 7.5% in case of industrial
										undertakings having 75% equity owned by Divyang/SC/ST/Females
										Promoters</label></td>
								<td><input type="text" class="form-control"
							...
							<tr class="ISF_Loan_Subsidy-row">
								<td style="width: 50%;"><strong>Interest Subsidy
										on loans for industrial research, quality improvement, etc.</strong></td>
								<td><input type="text" class="form-control"
					...
					<table class="table table-stripped table-bordered loc-stage-table">
						<tbody>
							<tr class="ISF_Tax_Credit_Reim-row">
								<td style="width: 50%;">Reimbursement of Disallowed Input
									Tax Credit on plant, building materials, and other capital
									goods.</td>
								<td><input type="text" class="form-control"
							...
							<tr class="ISF_Indus_Payroll_Asst-row">
								<td>Industrial units providing employment to differently
									abled workers will be provided payroll assistance of Rs. 500
									per month for each such worker.</td>
								<td><input type="text" class="form-control"
							...
							<tr id="showHide3">
								<td colspan="2">
									<table
										...
										<tbody>
											<c:forEach var="list" items="${availCustomisedDetailsList}"
												varStatus="counter">
												<tr>
							...
							<tr id="showHide4">
								...
								<td><a
									href="./downloadDocIncentive?fileName=${isfCustIncDocName}"><small>${isfCustIncDocName}</small></a>
								</td>
							</tr>
						</tbody>
					</table>
