...
<title>Select Policy SME MD PICUP</title>
		...
		<div class="container-fluid" id="main">
			<div class="row row-offcanvas row-offcanvas-left">
				...
				<div class="col-md-9 col-lg-10 mt-4 main">
					...
					<h4 class="card-title mb-4 animate__animated animate__fadeInDown">Select
						Policy</h4>
						...
						<div class="col-sm-3 mb-5">
							<div class="card card-block policy-box-card p-4 h-100">
								<div class="ploicy-name">
									<a href="./JMDPICUPSMEApplicationForLoc"> <img
										src="images/industry-policy-icon.png" alt="Policy Icon">
										<label>Industrial Investment & Employment Promotion
											Policy 2017</label>
									</a>
								</div>
							</div>
							...
							<div class="card card-block policy-box-card p-4 h-100">
								<div class="ploicy-name">
									<a href="javacript:void(0);"> <img
										src="images/logistics-policy-icon.png" alt="Policy Icon">
