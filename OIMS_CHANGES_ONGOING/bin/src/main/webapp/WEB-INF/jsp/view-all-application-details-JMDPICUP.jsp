...
<title>View All Applicant Details MD PICUP</title>
...
<script type="text/javascript">
	$(document).on(
			...
			function(e) {
				...
				var printArea = document
						.getElementById('viewAllApplicationDetails').innerHTML;
		...
		<div class="container-fluid" id="main">
			<div class="row row-offcanvas row-offcanvas-left">
				<div class="col-md-3 col-lg-2 sidebar-offcanvas pt-3" id="sidebar"
					role="navigation">
					<ul class="nav flex-column pl-1" id="sidebartab">
						...
						<li class="nav-item"><a class="nav-link"
							href="./jmdPiCupAgendaNote"><i class="fa fa-list"></i> Agenda
								Note</a></li>
						<li class="nav-item"><a class="nav-link"
							href="./momgobyJMDPICUP"><i class="fa fa-calendar"></i> View
										...
										<div class="row" id="BPA">
											<div class="col-sm-8">
												<a href="./JMDPICUPApplicationForLoc"
													...
													Print</a> <a href="./JMDPICUPEvaluateApplication"
													class="common-btn mt-3">View Evaluated Application</a>
											</div>
														...
														<table class="table table-stripped table-bordered">
															<tbody>
																...
																<tr id="hideByRowId2">
																	<td>
																		<ul class="common-list">
																			<li>Chartered Engineer’s Certified List of
																...
																<table class="table table-bordered">
																	<tbody>
																		...
																		<tr>
																			<td>11.1</td>
																			<td>Date from which capital investment has
																				commenced, or is proposed to be commenced
						...
						<div class="modal-body">
							<div class="row">
								<div class="col-sm-12">
									...
									<div class="custom-control custom-checkbox">
										<form:checkbox path="deptName" value="UPPCL"
									...
									<div class="custom-control custom-checkbox">
										<form:checkbox path="deptName" value="DIC"
							...
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
										...
										<form:input type="text" path="newDeptName"
											class="form-control" id="depttName" maxlength="50"
