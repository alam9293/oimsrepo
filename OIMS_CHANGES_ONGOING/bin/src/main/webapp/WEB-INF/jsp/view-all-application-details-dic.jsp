...
<title>View All Applicant Details Department</title>
...
<script type="text/javascript">
	...
	window.onload = function() {
		...
		if (cat === "Large") {
			...
			else if (resionName === "GAUTAM BUDH NAGAR"
					|| resionName === "GHAZIABAD") {
				$(
						'input:checkbox[name="GBNG_Checkbox"][value="${categorytype}"]')
						.prop('checked', true);
			}
		...
		var cat = '${categorytype}';
		if (cat === "Large") {
			document.getElementById("fciL").innerHTML = '${fci}';
			document.getElementById("resionNameL").innerHTML = '${resionName}';
			document.getElementById("districtNameL").innerHTML = '${districtName}';
		}

		var cat = '${categorytype}';
		var resionName = '${resionName}';
		var grossEmployment = '${grossTotalMaleandFemaleEmployment}';
		//alert(cat);
		//alert(grossEmployment);
		//alert(resionName);
		if (resionName === "Bundelkhand" || resionName === "Poorvanchal") {
			if (cat === "Mega") {
				if (grossEmployment > 500)
				...
				if (grossEmployment > 1000)

					$('input:checkbox[name="BP_MP"][value="${categorytype}"]')
							.prop('checked', true);
			} else if (cat === "Super Mega") {
				if (grossEmployment > 2000)
			...
			if (cat === "Mega") {
				...
				if (grossEmployment > 1500)

					$('input:checkbox[name="MP_MP"][value="${categorytype}"]')
							.prop('checked', true);
			} else if (cat === "Super Mega") {
				if (grossEmployment > 3000)
			...
			if (cat === "Mega") {
				...
				if (grossEmployment > 2000)
					...
					$('input:checkbox[name="GG_MP"][value="${categorytype}"]')
							.prop('checked', true);
			} else if (cat === "Super Mega") {
				if (grossEmployment > 4000)

					$('input:checkbox[name="GG_SM"][value="${categorytype}"]')
							.prop('checked', true);
			}
				...
				<div class="col-md-3 col-lg-2 sidebar-offcanvas pt-3" id="sidebar"
					...
					<ul class="nav flex-column pl-1">
						<li class="nav-item"><a class="nav-link"
							href="dashboard-department.html"><i class="fa fa-tachometer"></i>
								Dashboard</a></li>
						<li class="nav-item"><a class="nav-link active"
							href="./viewDeptApplication"><i class="fa fa-eye"></i> View
								Applications</a></li>
						<li class="nav-item"><a class="nav-link"
							href="./deptEvaluateApplication"><i class="fa fa-eye"></i>
								View Circulated Agenda Note</a></li>
						<li class="nav-item"><a class="nav-link"
							href="view-circulated-draft-LOC.html"><i class="fa fa-eye"></i>
										...
										<div class="row">
											<div class="col-sm-8">
												<a href="./deptApplicationForLoc"
													...
													href="javascript:void(0);" class="common-btn mt-0"><i
										...
										<div class="parameter-properties"
											...
											<div class="isf-form mt-4">
												...
												<div class="row">
													...
													<div class="col-md-6 col-lg-4 col-xl-4">
														<div class="form-group">
															<label>Organization Type<span>*</span></label> <select
										...
										<div class="row">
											...
											<div class="col-sm-7 text-right">
												<a href="javacript:void(0);"
													onclick="printDiv('printableArea')" class="common-btn mt-3"><i
													class="fa fa-print"></i> Print</a> <a
													href="./facilitiesReliefSought" class="common-btn mt-3">Next </a>
											</div>
										</div>
									</div>
