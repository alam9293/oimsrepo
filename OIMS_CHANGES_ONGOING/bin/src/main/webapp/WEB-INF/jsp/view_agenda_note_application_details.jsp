...
<script type="text/javascript">
	...
	$(document).on('click', '#printMethod', function(e) {
		...
		var printArea =	document.getElementById('content2').innerHTML;
					...
					<ul class="nav flex-column pl-1">
						...
						<!-- <li class="nav-item"><a class="nav-link"
							href="./viewQueryResponse"><i class="fa fa-question-circle"></i>
								Query Response By Enterpreneur</a></li> -->
							...
							<div class="col-sm-12">
								<div class="mt-4">
									<div class="without-wizard-steps">
										<div class="row">
											<div class="col-sm-8">
												<a href="./agendaNode" class="common-default-btn mt-0">Back</a>
										...
										<h4 class="card-title mb-4 mt-5 text-center">Business
											Entity Details</h4>
										<div class="isf-form mt-4" id="content">
											...
											<div class="row">
												...
												<div class="col-md-6 col-lg-4 col-xl-4">
													<div class="form-group">
														<label>Phone No. (Landline)</label> <input type="text" class="form-control"
															value="${phoneNo}" disabled="disabled" id="phoneNo" name="phoneNo">
													</div>
												</div>
												<div class="col-md-6 col-lg-4 col-xl-4">
													<div class="form-group">
										...
										<div class="isf-form">
											...
											<div class="row">
												<div class="col-sm-12 mt-4">
													<h3 class="common-heading">Break-up of Cost of Project
														and Proposed Fixed Capital Investment</h3>
												</div>
											</div>
											<div class="row">
												<div class="col-md-6">
											...
											<c:if test="${not empty unSkilledDisplay}">
												<div class="row">
													...
													<div class="col-md-6 col-lg-4 col-xl-4">
														<div class="form-group">
															<label>Total Skilled Employees</label> <input type="text"
																class="form-control" value="${totalUnSkilledEmployment}"
																disabled="disabled">
														</div>
													</div>
												</div>
												...
												<div class="col-sm-12">
													<div class="table-responsive">
														<table
															...
															<tbody>
																<tr>
																	<td style="width: 70%;"><strong>Amount of
																...
																<tr>
																	<td>
																			...
																			<label>Additional
																				...
																				minimum of 200 total workers in B-P-M</label>
																...
																<tr>
																	<td>
																		<label>Additional
																				...
																				in case of industrial undertakings having 75% equity
																				owned by Divyang/SC/ST/Females Promoters</label>
