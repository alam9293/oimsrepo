				...
				<div class="col-md-3 col-lg-2 sidebar-offcanvas pt-3" id="sidebar"
					...
					<ul class="nav flex-column pl-1">
						<li class="nav-item"><a class="nav-link"
							href="./aggricultureDashboard"><i class="fa fa-tachometer"></i>
								Dashboard</a></li>
						<li class="nav-item"><a class="nav-link"
							href="./viewAggricultureDeptApplication"><i class="fa fa-eye"></i> View
								Applications</a></li>
						<li class="nav-item"><a class="nav-link"
							href="./circulateAggricultureViewAgendaNote"><i class="fa fa-eye"></i>
								View Circulated Agenda Note</a></li>
						<li class="nav-item"><a class="nav-link active" href="./viewLocAggriculture"><i
								class="fa fa-eye"></i> View Circulated Draft LOC</a></li>
					</ul>
				</div>
				<!--/col-->
				<div class="col-md-9 col-lg-10 mt-4 main">
					<h4 class="card-title mb-4 mt-4 text-center">CIRCULATED DRAFT LOC</h4>
					<div class="card card-block p-4 mb-5">
						<div class="step-links">
							<ul class="only-steps"></ul>
						</div>
						<div id="accordion"
							...
							<div class="mb-0 border-0">
								<div class="card-header collapsed mb-4" data-toggle="collapse"
									...
									<a class="card-title"> <strong>APPLICATION SUBMITTED TO SANCTION COMMITTEE</strong>
									</a>
								</div>
														...
														<table class="table table-bordered">
															...
															<tr>
																...
																<td><a class="btn btn-outline-success btn-sm"
																	target="_blank"
																	href="./savegenerateLoc1?applicantId=${list[0]}">View
																		Draft LoC</a></td>
															</tr>
														</c:forEach>
															</tbody> 
