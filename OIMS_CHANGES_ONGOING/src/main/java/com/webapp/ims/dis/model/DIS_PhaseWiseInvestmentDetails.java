...
@Entity
@Table(name = "DIS_PW_Investment_Details", schema = "loc")
public class DIS_PhaseWiseInvestmentDetails implements Serializable {
	...
	@Column(name = "PW_Enc_CertificateFName")
	private String encCertificateFName;

	@Column(name = "PW_Enc_CetificateData")
	private byte[] encCetificateData;
	...
	public byte[] getEncCetificateData() {
		return encCetificateData;
	}

	public void setEncCetificateData(byte[] encCetificateData) {
		this.encCetificateData = encCetificateData;
	}

	public DIS_PhaseWiseInvestmentDetails() {
		super();
	}
