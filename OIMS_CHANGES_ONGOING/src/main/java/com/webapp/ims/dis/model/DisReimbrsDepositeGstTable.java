...
@Entity
@Table(name = "Dis_ReimOfDepositGST_Table", schema = "loc")
public class DisReimbrsDepositeGstTable implements Serializable {
	...
	@Column(name = "Amt_Of_Net_SGST_Reim1_New")
	private String amtOfNetSGSTReim1New;
	
	@Column(name = "Payable_Amount_Of_SGST_New")
	private String payableAmountOfSGSTNew;
