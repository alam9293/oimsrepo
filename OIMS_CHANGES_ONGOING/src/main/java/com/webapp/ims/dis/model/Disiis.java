...
@Entity
@Table(name = "Dis_Iis_Detail", schema = "loc")
public class Disiis implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@Column(name = "DIS_IIS_ID")
	...
	@Column(name = "DIS_IISLAON")
	private long iisloan;

	@Column(name = "Amt_Inv_PNM_Iis")
	private Long amtInvPNMIis;
	...
	@Column(name = "DIS_IIS_Create_Date")
	@Temporal(TemporalType.TIMESTAMP)
	private Date createDate;

	@Column(name = "DIS_IIS_Modified_By")
	private String modifiedBy;

	@Column(name = "DIS_IIS_Modify_Date")
	@Temporal(TemporalType.TIMESTAMP)
...
//	List Column
	...
	@Column(name = "DIS_IIS_YearI")
	private String yearI;

	@Column(name = "DIS_IIS_firstYTI")
	private String firstYTI;

	@Column(name = "DIS_IIS_firstYP")
	private String firstYP;

	@Column(name = "DIS_IIS_firstYI")
	private long firstYI;

	@Column(name = "DIS_IIS_firstYAmtIntSubsidy")
	private String firstYAmtIntSubsidy;

	@Column(name = "DIS_IIS_yearII")
	private String yearII;

	@Column(name = "DIS_IIS_secondYTI")
	private String secondYTI;

	@Column(name = "DIS_IIS_secondYP")
	private String secondYP;

	@Column(name = "DIS_IIS_secondYI")
	private long secondYI;

	@Column(name = "DIS_IIS_secondYAmtIntSubsidy")
	private String secondYAmtIntSubsidy;

	@Column(name = "DIS_IIS_yearIII")
	private String yearIII;

	@Column(name = "DIS_IIS_thirdYTI")
	private String thirdYTI;

	@Column(name = "DIS_IIS_thirdYP")
	private String thirdYP;

	@Column(name = "DIS_IIS_thirdYI")
	private long thirdYI;

	@Column(name = "DIS_IIS_thirdYAmtIntSubsidy")
	private String thirdYAmtIntSubsidy;

	@Column(name = "DIS_IIS_yearIV")
	private String yearIV;

	@Column(name = "DIS_IIS_fourthYTI")
	private String fourthYTI;

	@Column(name = "DIS_IIS_fourthYP")
	private String fourthYP;

	@Column(name = "DIS_IIS_fourthYI")
	private long fourthYI;

	@Column(name = "DIS_IIS_fourthYAmtIntSubsidy")
	private String fourthYAmtIntSubsidy;

	@Column(name = "DIS_IIS_yearV")
	private String yearV;

	@Column(name = "DIS_IIS_fifthYTI")
	private String fifthYTI;

	@Column(name = "DIS_IIS_fifthYP")
	private String fifthYP;

	@Column(name = "DIS_IIS_fifthYI")
	private long fifthYI;

	@Column(name = "DIS_IIS_fifthYAmtIntSubsidy")
	...
	public Long getAmtInvPNMIis() {
		return amtInvPNMIis;
	}

	public void setAmtInvPNMIis(Long amtInvPNMIis) {
		this.amtInvPNMIis = amtInvPNMIis;
	}
	...
	public long getIisloan() {
		return iisloan;
	}

	public void setIisloan(long iisloan) {
		this.iisloan = iisloan;
	}
