...
@Repository
public interface ProjectandProposedEmploymentDetailsRepository extends JpaRepository<ProjectandProposedEmploymentDetails, Identifier> {

	@Query(value = "from ProjectandProposedEmploymentDetails paped")
	public List<ProjectandProposedEmploymentDetailsRepository> getAll();
