...
@Entity
@Table(name = "Business_Entity_Details", schema = "loc")
public class BusinessEntityDetails implements Serializable {
	...
	/*
	 * public List<ProprietorDetails> getProprietorDetails() { return
	 * proprietorDetails; }
	 * 
	...
	public BusinessEntityDetails() {
		super();
	}

	public BusinessEntityDetails(String id, String businessEntityName, String businessEntityType,
