...
@Entity
@Table(name = "Dept_ISF_Form_Details", schema = "loc")
@JsonIgnoreProperties(ignoreUnknown = true)
public class DeptIncentiveDetails implements Serializable {
	...
	// INCENTIVE SOUGHT Remark columns
	...
	// observation Column
	@Column(name = "ISF_SubDateApp_Observ")
	private String subDateAppObserv;
