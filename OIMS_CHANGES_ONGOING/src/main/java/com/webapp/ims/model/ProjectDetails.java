...
@Entity
@Table(name = "Project_Details", schema = "loc")
...
public class ProjectDetails implements Serializable {
	...
	private transient String proposedProductsNew;

	private transient String proposedInstalledCapacityNew;

	public String getProposedInstalledCapacityNew() {
		return proposedInstalledCapacityNew;
	}

	public void setProposedInstalledCapacityNew(String proposedInstalledCapacityNew) {
		this.proposedInstalledCapacityNew = proposedInstalledCapacityNew;
	}

	public String getProposedProductsNew() {
		return proposedProductsNew;
	}

	public void setProposedProductsNew(String proposedProductsNew) {
		this.proposedProductsNew = proposedProductsNew;
	}

	private transient Long proposedInstalledCapacity;

	private transient String proposedProductsnew;
	private transient Long proposedInstalledCapacitynew;
	...
	private transient String registeredAddr;
	...
	public Long getProposedInstalledCapacitynew() {
		return proposedInstalledCapacitynew;
	}

	public void setProposedInstalledCapacitynew(Long proposedInstalledCapacitynew) {
		this.proposedInstalledCapacitynew = proposedInstalledCapacitynew;
	}
