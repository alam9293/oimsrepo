...
import org.springframework.validation.annotation.Validated;Error starting ApplicationContext. To display the conditions report re-run your application with 'debug' enabled.
...
/*
@Controller
public class PendingWorksApprovalController 
{
	...
	public List<TblApprovalWorks> getLiError starting ApplicationContext. To display the conditions report re-run your application with 'debug' enabled.stofDataTobeApproved(HttpSession session)
	{
