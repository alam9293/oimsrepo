				...
				<div class="col-md-9 col-lg-10 mt-4 main mb-4">
					<div class="card card-block p-3">
						<div class="row">
							<div class="col-sm-12">
								<a
									href="./viewApplicationDetailsDisConcern?applicantId=<%=session.getAttribute("appId")%>"
 ...
 --%>																		<tr class="ISF_Claim_Reim-row">
																			<td colspan="5">
																				<p class="text-info">Comment From : Industrial
																					...
																					class="form-control" path="isfSgstCommentdis"
																					name="isfSgstCommentdis" disabled="" rows="3"
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_Reim_SCST-row">
																			<td colspan="5"><p class="text-info">Comment
																					...
																					class="form-control" path="isfScstCommentdis"
																					name="isfScstCommentdis" disabled="" rows="3"
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_Reim_FW-row">
																			<td colspan="5"><p class="text-info">Comment
																					From : Industrial Development/ Commercial Tax</p> <form:textarea
																					class="form-control" path="isffwCommentdis"
																					name="isffwCommentdis" disabled="" rows="3"
																					placeholder="Comments"></form:textarea></td>
																		</tr>
																	<%-- </c:if> --%>
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_Reim_BPLW-row">
																			<td colspan="5"><p class="text-info">Comment
																					From : Industrial Development/ Commercial Tax</p> <form:textarea
																					class="form-control" path="isfBplCommentdis"
																					name="isfBplCommentdis" disabled="" rows="3"
																					placeholder="Comments"></form:textarea></td>
																		</tr>
																	<%-- </c:if> --%>
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_Stamp_Duty_EX-row">
																			<td colspan="5"><p class="text-info">Comment
																					...
																					class="form-control" path="isfStampCommentdis"
																					name="isfStampCommentdis" disabled="" rows="3"
																					placeholder="Comments"></form:textarea></td>
																		</tr>
																	<%-- </c:if> --%>
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_Additonal_Stamp_Duty_EX-row">
																			<td colspan="5"><p class="text-info">Comment
																					From : Stamp & Registration</p> <form:textarea
																					class="form-control" path="isfStampscstCommentdis"
																					name="isfStampscstCommentdis" disabled="" rows="3"
																					placeholder="Comments"></form:textarea></td>
																		</tr>
																	<%-- </c:if> --%>
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_Epf_Reim_UW-row">
																			<td colspan="5"><p class="text-info">Comment
																					...
																					class="form-control" path="isfepfCommentdis"
																					name="isfepfCommentdis" disabled="" rows="3"
																					placeholder="Comments"></form:textarea></td>
																		</tr>
																	<%-- </c:if> --%>
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_Add_Epf_Reim_SkUkW-row">
																			<td colspan="5"><p class="text-info">Comment
																					From : Labour/Industrial Development</p> <form:textarea
																					class="form-control" path="isfepfaddCommentdis"
																					name="isfepfaddCommentdis" disabled="" rows="3"
																					placeholder="Comments"></form:textarea></td>
																		</tr>
																	<%-- </c:if> --%>
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_Add_Epf_Reim_DIVSCSTF-row">
																			<td colspan="5"><p class="text-info">Comment
																					From : Labour/Industrial Development</p> <form:textarea
																					class="form-control" path="isfepfscCommentdis"
																					name="isfepfscCommentdis" disabled="" rows="3"
																					placeholder="Comments"></form:textarea></td>
																		</tr>
																	<%-- </c:if> --%>
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_Cis-row">
																			<td colspan="5"><p class="text-info">Comment
																					...
																					class="form-control" path="isfcapisCommentdis"
																					name="isfcapisCommentdis" disabled="" rows="3"
																					placeholder="Comments"></form:textarea></td>
																		</tr>
																	<%-- </c:if> --%>
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_ACI_Subsidy_Indus-row">
																			<td colspan="5"><p class="text-info">Comment
																					From : Industrial Development</p> <form:textarea
																					class="form-control" path="isfcapisaCommentdis"
																					name="isfcapisaCommentdis" disabled="" rows="3"
																					placeholder="Comments"></form:textarea></td>
																		</tr>
																	<%-- </c:if> --%>
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_Infra_Int_Subsidy-row">
																			<td colspan="5"><p class="text-info">Comment
																					From : Industrial Development</p> <form:textarea
																					class="form-control" path="isfinfCommentdis"
																					name="isfinfCommentdis" disabled="" rows="3"
																					placeholder="Comments"></form:textarea></td>
																		</tr>
																	<%-- </c:if> --%>
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_AII_Subsidy_DIVSCSTF-row">
																			<td colspan="5"><p class="text-info">Comment
																					From : Industrial Development</p> <form:textarea
																					class="form-control" path="isfinfaCommentdis"
																					name="isfinfaCommentdis" disabled="" rows="3"
																					placeholder="Comments"></form:textarea></td>
																		</tr>
																	<%-- </c:if> --%>
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_Loan_Subsidy-row">
																			<td colspan="5"><p class="text-info">Comment
																					From : Industrial Development</p> <form:textarea
																					class="form-control" path="isfloanCommentdis"
																					name="isfloanCommentdis" disabled="" rows="3"
																					placeholder="Comments"></form:textarea></td>
																		</tr>
																	<%-- </c:if> --%>
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_Tax_Credit_Reim-row">
																			<td colspan="5"><p class="text-info">Comment
																					From : Industrial Development</p> <form:textarea
																					class="form-control" path="isfdisCommentdis"
																					name="isfdisCommentdis" disabled="" rows="3"
																					placeholder="Comments"></form:textarea></td>
																		</tr>
																	<%-- </c:if> --%>
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_EX_E_Duty-row">
																			<td colspan="5"><p class="text-info">Comment
																					...
																					path="isfelepodownCommentdis"
																					name="isfelepodownCommentdis" disabled="" rows="3"
																					placeholder="Comments"></form:textarea></td>
																		</tr>
																	<%-- </c:if> --%>
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_EX_E_Duty_PC-row">
																			<td colspan="5"><p class="text-info">Comment
																					From : UPPCL</p> <form:textarea class="form-control"
																					path="isfElecdutyCommentdis" name="isfElecdutyCommentdis"
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_EX_Mandee_Fee-row">
																			<td colspan="5"><p class="text-info">Comment
																					...
																					class="form-control" path="isfMandiCommentdis"
																					name="isfMandiCommentdis" disabled="" rows="3"
																					placeholder="Comments"></form:textarea></td>
																		</tr>
																	<%-- </c:if> --%>
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_Indus_Payroll_Asst-row">
																			<td colspan="5"><p class="text-info">Comment
																					From : Labour/Industrial Development</p> <form:textarea
																					class="form-control" path="isfdifferabilCommentdis"
																					name="isfdifferabilCommentdis" disabled="" rows="3"
																					placeholder="Comments"></form:textarea></td>
																		</tr>
																	<%-- </c:if> --%>
									...
									<div class="row">
										...
										<div class="col-sm-7 text-right">
											...
											<button class="common-btn mt-3" formaction="addIsfCommentsdis">Submit</button>
										</div>
									</div>
								</form:form>
							</div>
