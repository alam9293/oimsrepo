...
<head>
    ...
    <title>MOM and GO's | Nodal PICUP</title>
					...
					<ul class="nav flex-column pl-1">
						...
						<li class="nav-item"><a class="nav-link"
							href="./preAgenNoteheadNodDepart"><i class="fa fa-list"></i>
								Agenda Note</a></li>
						<li class="nav-item"><a class="nav-link active" href="./nodalmomgo"><i
						...
						<div class="row">
							<div class="col-sm-12">
								<div class="step-links">
									<ul class="only-steps">
										<li><a href="./nodalmomgo" class=" pr-3">MOM for LOC</a></li>
										<li><a href="./nodalmomgoDis" class="active pr-3">MOM for
												Disbursement </a></li>
									</ul>
								</div>
