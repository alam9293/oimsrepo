				...
				<div class="col-md-3 col-lg-2 sidebar-offcanvas pt-3" id="sidebar"
					...
					<ul class="nav flex-column pl-1">
						<li class="nav-item"><a class="nav-link active"
							href="./dashboardID6"><i class="fa fa-tachometer"></i> Dashboard</a></li>
						<li class="nav-item"><a class="nav-link" href="#"><i
								class="fa fa-sticky-note"></i> View Agenda Note</a></li>
						<li class="nav-item"><a class="nav-link"
							href="./momgoid6Dis"><i class="fa fa-file"></i>MOM, GO's and Cabinet Note</a></li>
						<li class="nav-item"><a class="nav-link" href="#"><i
								class="fa fa-credit-card"></i> Payment</a></li>
					</ul>
				</div>
				<!--/col-->
				<div class="col-md-9 col-lg-10 mt-4 main mb-4">
					<div class="mt-4">
						<div class="without-wizard-steps">
							<h4
								class="card-title mb-4 mt-4 text-center animate__animated animate__fadeInDown">MOM, GO's and Cabinet Note</h4>
						</div>
					</div>
						...
						<!-- <div class="row">
							<div class="col-sm-12">
								<div class="step-links">
									<ul class="only-steps">
										<li><a href="./id6MomGo" class="active pr-3">MOM for LOCcc</a></li>
										<li><a href="./momgoid6Dis" class="pr-3">MOM for
												Disbursement </a></li>
									</ul>
								</div> -->
								<!-- <hr class="mt-2 mb-3">
