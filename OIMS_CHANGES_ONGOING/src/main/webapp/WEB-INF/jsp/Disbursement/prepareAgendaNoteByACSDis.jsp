...
<title>Evaluation View ACS</title>
			...
			<div class="row row-offcanvas row-offcanvas-left">
				...
				<div class="col-md-9 col-lg-10 mt-4 main mb-4">
					<div class="card card-block p-3">
						<div class="row">
							<div class="col-sm-5">
								<a href="./preAgenNoteheadNodDepartDis" class="common-default-btn mt-3">Back</a>
							</div>
						</div>
												...
												<c:forEach var="list" items="${evalObjList}"
													...
													<tr>
														...
														<td><input type="submit" value="View"
															...
															formaction="./displayAgendaHeadNodalDepartDis?appliId=${list[0]}"
							...
							<div class="row" id="showHide2">
								<div class="col-sm-12">
									...
									<div class="row mb-4">
										<div class="col-sm-5">
											<a
												href="./preAgenNoteheadNodDepartDis"
