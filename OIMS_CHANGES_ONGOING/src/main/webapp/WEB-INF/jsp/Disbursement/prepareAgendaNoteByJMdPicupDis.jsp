...
<title>Evaluation View JMD-PICUP</title>
			...
			<div class="row row-offcanvas row-offcanvas-left">
				<div class="col-md-3 col-lg-2 sidebar-offcanvas pt-3" id="sidebar"
					...
					<ul class="nav flex-column pl-1">
						<li class="nav-item"><a class="nav-link"
							href="./mdPICUPDepartmentDashboard"><i
								class="fa fa-tachometer"></i> Dashboard</a></li>
						<li class="nav-item"><a class="nav-link"
							href="select-policy-MDPICUP.html"><i class="fa fa-eye"></i>
								View Applications</a></li>
						<!-- <li class="nav-item"><a class="nav-link"
							href="select-policy-SME-MDPICUP.html"><i class="fa fa-eye"></i>
								View SME Applications</a></li> -->
						<li class="nav-item"><a class="nav-link active"
							href="./jmdPiCupAgendaNote"><i class="fa fa-list"></i> Agenda
								Note</a></li>
						<li class="nav-item"><a class="nav-link"
							href="./jmomgobyMDPICUP"><i class="fa fa-calendar"></i> View
				...
				<div class="col-md-9 col-lg-10 mt-4 main mb-4">
					<div class="card card-block p-3">
						<div class="row">
							<div class="col-sm-5">
								<a href="./jmdPiCupAgendaNoteDis" class="common-default-btn mt-3">Back</a>
							</div>
						</div>
												...
												<c:forEach var="list" items="${evalObjList}"
													...
													<tr>
														...
														<td><input type="submit" value="View"
															...
															formaction="./displayAgendaDetailsByJMdPiCupDepartDis?appliId=${list[0]}"
							...
							<div class="row" id="showHide2">
								<div class="col-sm-12">
									...
									<div class="row">
										<div class="col-sm-12">
											<div class="form-group">
												<label>Note</label>
												<textarea class="form-control" name="note" rows="5" readonly="readonly">${disprepAgendaNotes}</textarea>
											</div>
										</div>
										<div class="col-sm-12 mt-3">
											<div class="form-group">
												<label>Nodal Agency and IIDD Recommendation</label>
												<textarea class="form-control" name="nodalAgency" rows="5" readonly="readonly">${nodalAgencyNm}</textarea>
											</div>
										</div>
									</div>
									...
									<div class="row mb-4">
										<div class="col-sm-5">
											<a
												href="./jmdPiCupAgendaNoteDis"
												class="common-default-btn mt-3">Back</a>
										</div>
										<div class="col-sm-7 text-right" hidden="">
