...
<title>Disbursement View Applicant</title>
																				...
																				<thead>
																					<tr>
																						...
																						<th rowspan="2">Amount of Quarterly SGST paid during the
																							Financial Year</th>
																						<th rowspan="2">Amount of net SGST paid during Financial
																							Year</th>
																						<th rowspan="2">Total Amount of SGST Claimed for
																							Reimbursement</th>
																						<th rowspan="2">Amount of admitted Tax on manufacture
																	...
																	<tbody>
																		<tr>
																			<td colspan="2"><strong>Particulars of
																					Claims for Sanction of Capital Interest Subsidytt</strong></td>
																		</tr>
																		<tr>
																			<td colspan="2">
																				<div class="table-responsive">
																						...
																						<tbody>
																							<tr>
																								...
																								<td><input type="text" readonly="true"
																									...
																									<td><input type="text" readonly="true"
																									name="" class="form-control" value="${durationFr1}"></td>
																									
																									<td><input type="text" readonly="true"
																									name="" class="form-control" value="${durationTo1}"></td>
																							...
																							<tr>
																								...
																								<td><input type="text" class="form-control"
																									...
																									<td><input type="text" readonly="true"
																									name="" class="form-control" value="${durationFr2}"></td>
																									
																									<td><input type="text" readonly="true"
																									name="" class="form-control" value="${durationTo2}"></td>
																							...
																							<tr>
																								...
																								<td><input type="text" class="form-control"
																									...
																									<td><input type="text" readonly="true"
																									name="" class="form-control" value="${durationFr3}"></td>
																									
																									<td><input type="text" readonly="true"
																									name="" class="form-control" value="${durationTo3}"></td>
																								<%-- <td><input type="text" readonly="true"
																								placeholder="Enter Amount in INR"
																							...
																							<tr>
																								...
																								<td><input type="text" class="form-control"
																									...
																									<td><input type="text" readonly="true"
																									name="" class="form-control" value="${durationFr4}"></td>
																									
																									<td><input type="text" readonly="true"
																									name="" class="form-control" value="${durationTo4}"></td>
																								<%-- <td><input type="text" readonly="true"
																								placeholder="Enter Amount in INR"
																							...
																							<tr>
																								...
																								<td><input type="text" name=""
																									...
																									<td><input type="text" readonly="true"
																									name="" class="form-control" value="${durationFr5}"></td>
																									
																									<td><input type="text" readonly="true"
																									name="" class="form-control" value="${durationTo5}"></td>
																								<%-- <td><input type="text" readonly="true"
																								placeholder="Enter Amount in INR"
																						...
																						<tbody>
																							<tr>
																								...
																								<td><input type="text" readonly="true"
																									...
																									<td><input type="text" readonly="true"
																									name="" class="form-control" value="${durationFr1i}"></td>
																									
																									<td><input type="text" readonly="true"
																									name="" class="form-control" value="${durationTo1i}"></td>
																							...
																							<tr>
																								...
																								<td><input type="text" readonly="true"
																									...
																									<td><input type="text" readonly="true"
																									name="" class="form-control" value="${durationFr2i}"></td>
																									
																									<td><input type="text" readonly="true"
																									name="" class="form-control" value="${durationTo2i}"></td>
																								<%-- <td><input type="text" readonly="true"
																								placeholder="Enter Amount in INR"
																								class="form-control AllYearTotlIntrstiis"
																							...
																							<tr>
																								...
																								<td><input type="text" readonly="true"
																									...
																									<td><input type="text" readonly="true"
																									name="" class="form-control" value="${durationFr3i}"></td>
																									
																									<td><input type="text" readonly="true"
																									name="" class="form-control" value="${durationTo3i}"></td>
																								<%-- <td><input type="text" readonly="true"
																								placeholder="Enter Amount in INR"
																								class="form-control AllYearTotlIntrstiis"
																							...
																							<tr>
																								...
																								<td><input type="text" readonly="true"
																									...
																									<td><input type="text" readonly="true"
																									name="" class="form-control" value="${durationFr4i}"></td>
																									
																									<td><input type="text" readonly="true"
																									name="" class="form-control" value="${durationTo4i}"></td>
																								<%-- <td><input type="text" readonly="true"
																								placeholder="Enter Amount in INR"
																								class="form-control AllYearTotlIntrstiis"
																							...
																							<tr>
																								...
																								<td><input type="text" readonly="true"
																									...
																									<td><input type="text" readonly="true"
																									name="" class="form-control" value="${durationFr5i}"></td>
																									
																									<td><input type="text" readonly="true"
																									name="" class="form-control" value="${durationTo5i}"></td>
																								<%-- <td><input type="text" readonly="true"
																								placeholder="Enter Amount in INR"
																								class="form-control AllYearTotlIntrstiis"
											...
											<div class="row">
												...
												<div class="col-sm-8 text-right">
													<a href="javacript:void(0);" id="printMethod1"
														...
														Print</a> <a href="./evaluateApplicationDis" id="evaluateBtn"
