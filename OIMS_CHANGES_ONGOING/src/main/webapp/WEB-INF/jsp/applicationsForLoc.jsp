...
<title>View Incentive Application</title>
														...
														<c:forEach var="list" items="${investmentDetailsList}"
															...
															<tr>
																...
																<td class="text-center"><a
																	href="./viewApplicationDetails?applicantId=${list[0]}"
								...
								<div id="collapseTwo" class="card-body collapse"
									...
									<div class="row">
										<div class="col-sm-9">
											<div class="form-group">
												<div class="search-box">
													<input type="text" class="form-control" id="myInputDis"
														placeholder="Search by Application ID/Policy Name/Business Entity Name/Investment/Category/Status"
														name=""> <a href="javascript:void();"><i
														class="fa fa-search"></i></a>
												</div>
										...
										<div class="col-sm-3">
											<div class="form-group text-right">
												<a href="javascript:void();" title="Excel Report"
													class="excel-icon"><img src="images/excel-icon.png"
													alt="Excel Icon" onclick="generateExcelDis();"></a>
											</div>
										</div>
										<div class="col-sm-12">

											<div class="table-responsive mt-3">
												<table class="table table-stripped table-bordered" id="generateExceldis">
													<c:if test="${ not empty investmentDetailsListdis}">
														<thead>
															<tr>
																<th>S.No.</th>
																<th>Application ID</th>
													...
													<tbody id="myTableDis">
														<c:forEach var="list" items="${investmentDetailsListdis}"
															...
															<tr>
																<td class="text-center">${counter.index+1}</td>
																<td class="text-center"><a
																	href="./viewApplicationDetailsDis?applicantId=${list[0]}"
																	class="view-btn">${list[0]}</a></td>
																<td>Industrial Policy</td>
																<td><c:out value="${list[1]}" /></td>
																<td><c:out value="${list[2]}" /></td>
...
"//cdn.rawgit.com/rainabba/jquery-table2excel/1.1.0/dist/jquery.table2excel.min.js"> 
	...
	<script>
		...
		function generateExcelDis()
		{

			 $("#generateExceldis").table2excel({ 
			        filename: "APPLICATIONS FOR Dis.xls" 
			    }); 
			}

		//Search JS
		$(document).ready(function(){
		  $("#myInputDis").on("keyup", function() {
		    var value = $(this).val().toLowerCase();
		    $("#myTableDis tr").filter(function() {
