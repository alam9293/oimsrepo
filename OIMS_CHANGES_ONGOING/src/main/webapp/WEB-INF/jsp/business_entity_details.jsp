...
.table-scroll-1 thead tr th{
    position: sticky;
    top: 0;
}
.directors-table.table td .fa-trash{
padding: 5px 7px;
}
			...
			if (designation.includes("Director") || designation.includes("DIRECTOR") || designation.includes("director")) {
				...
				if (dinNo == null || dinNo == '') 
				{
				  ...
				  //alert("bye getEquity");
		            ...
		            //var totalEquity=document.getElementById('equityId').value;
		            var totalEquity=document.getElementById('totalEquiId').value;
		            //alert(totalEquity);
		           // var equity=$('#equityvalue').val();
		            //var currentEquity=document.getElementById('equityvalue').value;
		            var currentEquity=$("#equityId").val();
		            //alert(currentEquity);
		            //alert("currentequity="+currentEquity);
		           	 /* <c:forEach var="list" items="${ProprietorDetailsList}">
		           	...
		           	if(currentEquity>0.0)
		               	{
		           		totalEquity=parseFloat(totalEquity) + parseFloat(currentEquity);
		               	}
		          // alert("final"+totalEquity);
		              ...
		              $("#businessEntityType").removeAttr("disabled");
		    			...
		    			addProprieterDetails();
		    			 
			 
}

	
function addProprieterDetails(){
	
	
	var add = {}
	  add["propId"] = $("#editappid").val();
    add["directorName"] = $("#directorNameId").val();
	add["designation"] = $("#designationId").val();
	add["proprietorDetailsaddress"] = $("#proprietorDetailsaddressId").val();
	add["mobileNo"] = $("#mobileNoId").val();
	add["equity"] = $("#equityId").val();
	add["email"] = $("#email").val();
	/* add["gender"] = $("#gender").val(); */
	 add["gender"] =$("input[name='gender']:checked").val();
	add["category"] = $("#category").val();
	add["div_Status"] = $("input[name='div_Status']:checked").val();
	add["panCardNo"] = $("#panCardNOId").val();
	add["din"] = $("#din").val();
     ...
     $.ajax({
        ...
        success: function (data) {
        	...
        	for (var i= 0; i < data.length; i++) {        		
        		...
        		tableData=tableData+"<tr><td>"+(i+1)+"</td><td>"+data[i].propId+"</td><td>"+data[i].directorName+"</td><td>"+data[i].designation+"</td><td>"+data[i].proprietorDetailsaddress+"</td><td>"+data[i].mobileNo+"</td><td>"+data[i].equity+"</td><td>"+data[i].email+"</td><td>"+data[i].gender+"</td><td>"+data[i].category+"</td><td>"+data[i].div_Status+"</td><td>"+data[i].panCardNo+"</td><td>"+data[i].din+"</td><td><a id='editButton' disabled='true' href='#editPropId' onclick='editPropritorDetailsValidation(\""+data[i].propId+"\",\""+data[i].directorName+"\",\""+data[i].designation+"\",\""+data[i].proprietorDetailsaddress+"\",\""+data[i].mobileNo+"\",\""+data[i].equity+"\",\""+data[i].email+"\",\""+data[i].gender+"\",\""+data[i].category+"\",\""+data[i].div_Status+"\",\""+data[i].panCardNo+"\",\""+data[i].din+"\")'><i class='fa fa-edit text-info'></i></a><a id='deleteButton' onclick='deletePropritorDetailsValidation(\""+data[i].propId+"\")'><i class='fa fa-trash text-danger'></i></a></td></tr>";       
        		       	
        		
        	}
        	//alert(tableData);
        	$("#editPropDetButton").val("");
        	$("#editPropDetButton").empty();
        	$("#editPropDetButton").append(tableData);
        	...
        	$("#proprietorDetailsaddressId").val("");
        	...
        	$("input:radio[name='div_Status']").each(function(i) {
     	       this.checked = false;
     	});
...
function addPropritorsDtlsOnLoad()

{
	 ...
	 $.ajax({
	        ...
	        success: function (data) {
	        	...
	        	for (var i= 0; i < data.length; i++) {        		
	        		...
	        		tableData=tableData+"<tr><td>"+(i+1)+"</td><td>"+data[i].propId+"</td><td>"+data[i].directorName+"</td><td>"+data[i].designation+"</td><td>"+data[i].proprietorDetailsaddress+"</td><td>"+data[i].mobileNo+"</td><td>"+data[i].equity+"</td><td>"+data[i].email+"</td><td>"+data[i].gender+"</td><td>"+data[i].category+"</td><td>"+data[i].div_Status+"</td><td>"+data[i].panCardNo+"</td><td>"+data[i].din+"</td><td><a id='editButton' href='#editPropId' disabled='true' onclick='editPropritorDetailsValidation(\""+data[i].propId+"\",\""+data[i].directorName+"\",\""+data[i].designation+"\",\""+data[i].proprietorDetailsaddress+"\",\""+data[i].mobileNo+"\",\""+data[i].equity+"\",\""+data[i].email+"\",\""+data[i].gender+"\",\""+data[i].category+"\",\""+data[i].div_Status+"\",\""+data[i].panCardNo+"\",\""+data[i].din+"\")'><i class='fa fa-edit text-info'></i></a><a onclick='deletePropritorDetailsValidation(\""+data[i].propId+"\")'><i class='fa fa-trash text-danger'></i></a></td></tr>";       
	...
	function deletePropritorDetailsValidation(propid)
	{
		 ...
		 $.ajax({
		        ...
		        success: function (result) {
		        	...
		        	for (var i= 0; i < result.length; i++) {        		
		        		...
		        		tableData=tableData+"<tr><td>"+(i+1)+"</td><td>"+result[i].propId+"</td><td>"+result[i].directorName+"</td><td>"+result[i].designation+"</td><td>"+result[i].proprietorDetailsaddress+"</td><td>"+result[i].mobileNo+"</td><td>"+result[i].equity+"</td><td>"+result[i].email+"</td><td>"+result[i].gender+"</td><td>"+result[i].category+"</td><td>"+result[i].div_Status+"</td><td>"+result[i].panCardNo+"</td><td>"+result[i].din+"</td><td><a onclick='editPropritorDetailsValidation(\""+result[i].propId+"\",\""+result[i].directorName+"\",\""+result[i].designation+"\",\""+result[i].proprietorDetailsaddress+"\",\""+result[i].mobileNo+"\",\""+result[i].equity+"\",\""+result[i].email+"\",\""+result[i].gender+"\",\""+result[i].category+"\",\""+result[i].div_Status+"\",\""+result[i].panCardNo+"\",\""+result[i].din+"\")'><i class='fa fa-edit text-info'></i></a><a onclick='deletePropritorDetailsValidation(\""+result[i].propId+"\")'><i class='fa fa-trash text-danger'></i></a></td></tr>";       
...
function editPropritorDetailsValidation(propId,dName,designation,address,mobno,equity,email,gender,category,divstatus,panno,din)
{
	
	$("#editappid").val("");
	$("#editappid").val(propId);
	
	$("#directorNameId").val("");
	$("#directorNameId").val(dName);
	
	$("#designationId").val("");
	$("#designationId").val(designation);
	
	$("#proprietorDetailsaddressId").val("");
	$("#proprietorDetailsaddressId").val(address);
	
	$("#mobileNoId").val("");
	$("#mobileNoId").val(mobno);
	...
	$("#div_Status").val("");
	$("input[name=div_Status][value=" + divstatus + "]").prop('checked', true);
	
	$("#panCardNOId").val("");
	$("#panCardNOId").val(panno);
 ...
 $(function(){
	 ...
	 var dtToday = new Date();
	    ...
	    if('${bussinessId}'!=null && '${bussinessId}'!='')
		 ...
		 $("input[name='businessDesignation']").attr("disabled", true);
		 ...
		 $("#businessEntityType").removeAttr("disabled");
			...
			$("#businessStateName").removeAttr("disabled");
			$("#businessDistrictName").removeAttr("disabled");
			$("input[name='businessDesignation']").attr("disabled", false);
	...
	$.ajax({
        ...
        success: function (data) {
        	...
        	for (var i= 0; i < data.length; i++) {      		                                                                                                                                                                                                                                                                                                                                                                                                                                                                 
        		...
        		totalEque=parseFloat(totalEque) + parseFloat(data[i].equity);	       	
        		//alert(totalEque);
        	}
        	
        	
        	$("#totalEquiId").val(totalEque);
	        },
	        error: function (e) {
	        	alert("error");
	            var json = "<h4>Ajax Response</h4>&lt;pre&gt;"
				...
				<div class="collapse navbar-collapse" id="navbarTogglerDemo02">
					<ul class="navbar-nav ml-auto mt-2 mt-lg-0">
						<li class="nav-item"><a class="nav-link active"
							href="http://72.167.225.87/Testing_NMSWP/nmmasters/Entrepreneur_Dashboard.aspx">Home</a>
						</li>
					...
					<div class="form-card">
						<div class="without-wizard-steps">
							<div class="step-links">
								<ul>
									<li><a href="./getIdByTabs11?authoTab=authoTab"
										class="filled"><span>1</span>Authorized Signatory Details</a>
									</li>
									<li><a href="#" class="active"><span>2</span>Business
											Entity Details</a></li>
									<li><c:if test="${not empty Pflag}">
											<a href="./getIdByTabs12?projTab=projTab" class="filled"><span>3</span>Project
												Details</a>
										</c:if> <c:if test="${empty Pflag}">
											<a href="./getIdByTabs12?projTab=projTab"><span>3</span>Project
												Details</a>
										</c:if></li>
									<li><c:if test="${not empty Iflag}">
											<a href="./getIdByTabs13?investTab=investTab" class="filled"><span>4</span>Investment
												Details</a>
										</c:if> <c:if test="${empty Iflag}">
											<a href="./getIdByTabs13?investTab=investTab"><span>4</span>Investment
												Details</a>
										</c:if></li>
									<li><c:if test="${not empty PEflag}">
											<a href="./getIdByTabs14?propoTab=propoTab" class="filled"><span>5</span>Proposed
												Employment Details</a>
										</c:if> <c:if test="${empty PEflag}">
											<a href="./getIdByTabs14?propoTab=propoTab"><span>5</span>Proposed
												Employment Details</a>
										</c:if></li>
								</ul>
							</div>
							<div class="isf-form">
								<form:form modelAttribute="businessEntityDetails" id="myFormB"
									...
									<c:if test="${ not empty propritorsDtlMsg}">
									<div><font color="red">${propritorsDtlMsg}</font></div>
									</c:if>
									...
									<div class="row">
										...
										<div class="col-md-6 col-lg-4 col-xl-4">
											<spring:bind path="businessEntityType">
												<div class="form-group">
													...
													<%-- <form:select path="businessEntityType" class="form-control" id="businessEntityType" value="${organizationType}" name="businessEntityType">
														<form:option value="">Select One</form:option>
														<form:option value="Limited">Limited</form:option>
														<form:option value="Private Limited Company">Private Limited</form:option>
													...
													<form:input path="businessEntityType" class="form-control"
														id="businessEntityType" readonly="true"></form:input>
										...
										<div class="col-md-6 col-lg-4 col-xl-4">
											<div class="form-group">
												<form:label path="authorisedSignatoryName">Enterpreneur Name<span>*</span>
												</form:label>
									...
									<div class="row">
										<div class="col-md-6 col-lg-4 col-xl-4">
											<div class="form-group">
												...
												<form:input path="businessDesignation" class="form-control"
													...
													maxlength="30" readonly="false"></form:input>
										...
										<div class="col-md-6 col-lg-4 col-xl-4">
											<div class="form-group">
												...
												<form:input path="emailId" type="email" class="form-control"
													...
													maxlength="60" name="emailId" readonly="true"
										...
										<div class="col-md-6 col-lg-4 col-xl-4">
											<div class="form-group">
												...
												<form:input path="mobileNumber" type="text" readonly="true"
									...
									<div class="row">
										<div class="col-md-6 col-lg-4 col-xl-4">
											<div class="form-group">
												<form:label path="businessCountryName">Country <span>*</span>
												</form:label>
												<%-- <form:select path="businessCountryName" class="form-control"
													id="businessCountryName" name="businessCountryName"
													onchange="IsCountry();" readonly="true">
													<form:option value="">Select One</form:option>
													<form:option value="India">India</form:option>
												</form:select> --%>
												<form:input tyep="text" path="businessCountryName"
													class="form-control" id="businessCountryName"
													name="businessCountryName" readonly="true"></form:input>
										...
										<div class="col-md-6 col-lg-4 col-xl-4">
											<div class="form-group">
												...
												<form:input tyep="text" path="businessStateName"
													class="form-control" id="businessStateName"
													name="businessStateName" readonly="true"></form:input>
										...
										<div class="col-md-6 col-lg-4 col-xl-4">
											<div class="form-group">
												...
												<%-- <form:select path="businessDistrictName" readonly="true"
												...
												<form:input tyep="text" path="businessDistrictName"
													class="form-control" id="businessDistrictName"
													name="businessDistrictName" readonly="true"></form:input>
										...
										<div class="col-md-6 col-lg-4 col-xl-4">
											<div class="form-group">
												...
												<form:input path="PinCode" type="text" class="form-control"
													...
													autocomplete="off" maxlength="6" readonly="true"
										...
										<div class="col-sm-12 mt-4">
											<h3 class="common-heading">
												Fill Director / Partner / Owner / Proprietor Details <a
													id="editPropId" class="remove-row"
													data-toggle="tooltip" title=""
								...
								<form:hidden path="id" value="" id="editappid" />
									<div class="row">
									
									<input type="hidden" id="totalEquiId" value="">
											...
											<div class="form-group">
												...
												<div
													...
													<input type="radio" class="custom-control-input"
														onkeyup="return IsGender(event)"
														onclick="return IsGenderclick(event)" id="MaleOpt2"
												...
												<div
													...
													<input type="radio" class="custom-control-input"
														onkeyup="return IsGender(event)"
														onclick="return IsGenderclick(event)" id="FemaleOpt2"
										...
										<div class="col-md-6 col-lg-4 col-xl-4">
											<div class="form-group">
												...
												<form:select class="form-control" path="category"
													onchange="Iscategory();" onkeyup="Iscategory();"
										...
										<div class="col-md-6 col-lg-4 col-xl-4">
											<div class="form-group">
												...
												<div
													...
													<input type="radio" class="custom-control-input"
														onkeyup="return Isdivyang(event)"
														onclick="return Isdivyangclick(event)" id="DivyangYes"
												...
												<div
													...
													<input type="radio" class="custom-control-input"
														onkeyup="return Isdivyang(event)"
														onclick="return Isdivyangclick(event)" id="DivyangNo"
										...
										<div class="col-md-12 col-lg-12 col-xl-12">
											<div class="form-group text-right mb-5">
												<c:if test="${empty edit}">
													<!-- <button type="submit" class="common-btn mt-4" formaction="proprietorDetails" onclick="return validationProprietorDetailsForm()" id="addButtonId">Add</button> -->
													<button type="submit" class="common-btn mt-4" disabled="disabled"
												...
												<c:if test="${not empty edit}">
													...
													<button type="submit" class="common-btn mt-4"
														onclick="return validationProprietorDetailsForm()"
														id="addButtonId">Save</button>
												</c:if>
												<%-- <c:if test="${not empty edit}">
													<button type="submit" class="common-btn mt-4"
														formaction="./proprietorDetails?newpropId=${list.propId}"
														onclick="return validationProprietorDetailsForm()">Save</button>
												</c:if> --%>
											</div>
										</div>
									</div>
									<div class="row" id="table-wrapper">
										<div class="col-sm-12" id="table-scroll">
											<div class="table-responsive" >
												...
												<table 
													class="table table-stripped table-bordered directors-table table-scroll-1 "
													id="customFields">
													<%-- <c:if test="${ not empty ProprietorDetailsList}"> --%>
														<thead>
															<tr>
															    <th class="sortable asc">Sn.</th>
																<th class="sortable">Prop ID</th>
																<th>Director Name</th>
																<th>Designation</th>
																<th>Address</th>
																<th>Mobile No.</th>
														...
														<%-- <c:forEach var="list" items="${ProprietorDetailsList}"
															...
															<tr>
																...
																<a
																 ...
																 <a href="./removeList?removeItem=${list.propId}"
																	class="ref-rmv"
																	onclick="return confirm('Are you sure want to remove Proprietor Details?')"><i
																		class="fa fa-trash text-danger"></i></a></td>
																		
																		<!-- <td class="text-center">
																		<a onclick="editPropritorDetailsValidation()">
																		<i class="fa fa-edit text-info"></i>
																        </a>
																
																 <a 
																	class="ref-rmv"
																	onclick="deletePropritorDetails()"><i
																		class="fa fa-trash text-danger"></i></a></td> -->
															</tr>
														</c:forEach> --%>
													</tbody>
								...
								<form:form modelAttribute="businessEntityDetails"
									...
									<div class="row">
										<div class="col-sm-12 mt-4">
											<h3 class="common-heading">Documents and Certificates</h3>
										</div>
									</div>
									<form:hidden path="id" value="${id}" />
									<div class="row">
										<div class="col-md-6 col-lg-4 col-xl-4">
											<div class="form-group">
												...
												<%-- <form:input path="yearEstablishment" type="date"  class="form-control" id="yearEstablishmentId" onkeyup="return IsyearEstablishment(event)" autocomplete="off" name="yearEstablishment"></form:input>
												<span id="YearEstablishment" class="text-danger"></span> --%>
												<div id="datepicker" class="input-group date"
													data-date-format="dd-mm-yyyy">
													<input type="text" value="${bedDate}" class="form-control"
														id="yearEstablishmentId"
														onkeyup="return IsyearEstablishment(event)"
														autocomplete="off" name="yearEstablishment"> <span
														id="YearEstablishment"
														class="input-group-addon text-danger"><i
										...
										<div class="col-sm-12 mt-3 mb-3">
											<div class="table-responsive">
												<table class="table table-bordered">
													<tbody>
														<tr>
															<td width="40%">Notarized undertaking (as per format
																placed at Annexure I-A) on Stamp Paper of Rs. 10 <span
															...
															<td>
																<div class="custom-file">
																	<input type="file"
																		...
																		class="custom-file-input" id="annexureiaformatId"
																		name="annexureiaformat"></input>
																	<form:label path="annexureiaformat"
																		class="custom-file-label" for="annexureiaformatId"
																		id="annexureiaformatDoc">Choose file</form:label>
														...
														for="annexureiaformat" id="annexureiaformatDoc">Choose file</form:label>
																...
																</div> --%> <span id="AnnexureiaformatId"
