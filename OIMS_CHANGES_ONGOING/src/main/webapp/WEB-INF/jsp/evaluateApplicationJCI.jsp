...
<script type="text/javascript">
	...
	function sendAcknowledgeInvestor() {
		...
		if (r == true) {
			alert("Your Application ID -XXXXXXX Evaluated Successfully, Please Keep your Application ID for Your Reference in the Future.");
			// return false
		...
		<div class="container-fluid" id="main">
					...
					<ul class="nav flex-column pl-1">
						...
						<li class="nav-item"><a class="nav-link"
							href="./viewAjendaNoteByJCI"><i class="fa fa-list"></i>
								Agenda Note</a></li>
						<li class="nav-item"><a class="nav-link"
							href="mom-go-JCI.html"><i class="fa fa-calendar"></i> View
					...
					<div class="card card-block p-3">
						<form:form modelAttribute="applicationAgendaNote" class="mt-4"
							...
							<div class="row mt-4">
								<div class="col-sm-12 text-center">
									...
									<button type="submit" id="button2"
										...
										formaction="applicationAgendaNoteDIC"
							...
							<div class="row">
								<div class="col-sm-5">
									<a
										href="./viewApplicationDetailsSMEJCI?applicantId=<%=session.getAttribute("appId")%>"
																		...
																		<tbody>
																			<tr>
																				...
																				<td colspan="2"><input type="text"
																					class="form-control" value="4964" disabled=""
																					name=""></td>
																			</tr>
																			<tr>
																			...
																			<tr>
																				...
																				<td colspan="2"><input type="text"
																					class="form-control" value="964" disabled=""
																					name=""></td>
																			</tr>
																			<tr>
																			...
																			<tr>
																				...
																				<td colspan="2"><input type="text"
																					class="form-control" value="8000" disabled=""
																					name=""></td>
																			</tr>
																			<tr>
																				<td>Proposed Gross Block</td>
																				<td colspan="2"><input type="text"
																					class="form-control" value="9000" disabled=""
																					name=""></td>
																			</tr>
																		</tbody>
																	</table>
		 ...
		 -->
																	...
																	<table id="BreakUpTable"
																		...
																		<tbody class="add-from-here">
																			...
																			<tr>
																				...
																				<td>Building and Civil Work Cost
																					Cost</td>
																				<td><select class="form-control"
																					disabled="disabled">
																						<option value="1">Yes</option>
														...
														<tr>
															...
															<td colspan="2"><select class="form-control" disabled="disabled">
																	<option value="1">Yes</option>
														...
														<tr>
															...
															<td><input type="text" class="form-control"
																value="${phsWsAply}" readonly="readonly">
												...
												<div class="row mt-4">
													<div class="col-sm-12 text-center">
														...
														<button type="submit" id="button4"
															...
															disabled="disabled" formaction="applicationAgendaNoteDIC"
															onclick="return includeAgendaNote()">Include
															Application in Agenda Note</button>
