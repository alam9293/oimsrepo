															...
															<table class="table table-stripped table-bordered">
																...
																<tbody>
																	<tr class="ISF_Claim_Reim-row">
																		...
																		<td><form:textarea path="sgstRemark" rows="4" readonly="true"
 ...
 --%>																		<tr class="ISF_Claim_Reim-row">
																			<td colspan="5">
																				<p class="text-info">Comment From : Industrial
																					...
																					class="form-control wordcount" path="isfSgstComment"
																					name="isfSgstComment" disabled="" rows="3"
																					maxlength="1000" placeholder="Comments"></form:textarea><span class="text-danger"></span>
																			</td>
																		</tr>
																	<%-- </c:if> --%>
																	<tr class="ISF_Reim_SCST-row">
																		...
																		<td><form:textarea path="scstRemark" rows="4" readonly="true"
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_Reim_SCST-row">
																			<td colspan="5"><p class="text-info">Comment
																					...
																					class="form-control  wordcount" path="isfScstComment"
																					name="isfScstComment" disabled="" rows="3"
																					maxlength="1000" placeholder="Comments"></form:textarea><span class="text-danger"></span></td>
																		</tr>
																	<%-- </c:if> --%>
																	...
																	<tr class="ISF_Reim_FW-row">
																		...
																		<td><form:textarea path="fwRemark" rows="4" readonly="true"
																				maxlength="1000" class="form-control" /></td>
																	</tr>
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_Reim_FW-row">
																			<td colspan="5"><p class="text-info">Comment
																					From : Industrial Development/ Commercial Tax</p> <form:textarea
																					class="form-control wordcount" path="isffwComment"
																	...
																	<tr class="ISF_Reim_BPLW-row">
																		...
																		<td><form:textarea path="bplRemark" readonly="true"
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_Reim_BPLW-row">
																			<td colspan="5"><p class="text-info">Comment
																					From : Industrial Development/ Commercial Tax</p> <form:textarea
																					class="form-control wordcount" path="isfBplComment"
																	...
																	<tr class="ISF_Stamp_Duty_EX-row">
																		...
																		<td><a
																			...
																			before concerned GM, DIC.</td>
																		<td><form:textarea path="stampDutyExemptRemark" readonly="true"
																				maxlength="1000" rows="4" class="form-control wordcount"></form:textarea></td>
																	</tr>
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_Stamp_Duty_EX-row">
																			<td colspan="5"><p class="text-info">Comment
																					...
																					class="form-control wordcount" path="isfStampComment"
																					name="isfStampComment" disabled="" rows="3"
																					maxlength="1000" placeholder="Comments"></form:textarea><span class="text-danger"></span></span></td>
																		</tr>
																	<%-- </c:if> --%>
																	...
																	<tr class="ISF_Amt_Stamp_Duty_Reim-row">
																		...
																		<td><a
																			...
																			paid Stamp Duty, for which company will have to apply
																			before concerned GM, DIC.</td>
																		<td><form:textarea path="stampDutyReimRemark" readonly="true"
																				maxlength="1000" rows="4" class="form-control"></form:textarea></td>
																	</tr>
																	<%-- <c:if
																		test="${not empty incentiveDeatilsData.isfStampComment}"> --%>
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_Additonal_Stamp_Duty_EX-row">
																			<td colspan="5"><p class="text-info">Comment
																					From : Stamp & Registration</p> <form:textarea
																					class="form-control wordcount" path="isfStampscstComment"
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_Epf_Reim_UW-row">
																			<td colspan="5"><p class="text-info">Comment
																					...
																					class="form-control wordcount" path="isfepfComment"
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_Add_Epf_Reim_SkUkW-row">
																			<td colspan="5"><p class="text-info">Comment
																					From : Labour/Industrial Development</p> <form:textarea
																					class="form-control wordcount" path="isfepfaddComment"
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_Add_Epf_Reim_DIVSCSTF-row">
																			<td colspan="5"><p class="text-info">Comment
																					From : Labour/Industrial Development</p> <form:textarea
																					class="form-control wordcount" path="isfepfscComment"
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_Cis-row">
																			<td colspan="5"><p class="text-info">Comment
																					...
																					class="form-control wordcount" path="isfcapisComment"
																					name="isfcapisComment" disabled="" rows="3"
																					maxlength="1000" placeholder="Comments"></form:textarea><span id="textcount" class="text-danger"></span></td>
																		</tr>
																	<%-- </c:if> --%>
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_ACI_Subsidy_Indus-row">
																			<td colspan="5"><p class="text-info">Comment
																					From : Industrial Development</p> <form:textarea
																					class="form-control wordcount" path="isfcapisaComment"
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_Infra_Int_Subsidy-row">
																			<td colspan="5"><p class="text-info">Comment
																					From : Industrial Development</p> <form:textarea
																					class="form-control wordcount" path="isfinfComment"
																					maxlength="1000" name="isfinfComment" disabled="" rows="3"
																					placeholder="Comments"></form:textarea><span class="text-danger"></span></td>
																		</tr>
																	<%-- </c:if> --%>
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_AII_Subsidy_DIVSCSTF-row">
																			<td colspan="5"><p class="text-info">Comment
																					From : Industrial Development</p> <form:textarea
																					class="form-control wordcount" path="isfinfaComment"
																					maxlength="1000" name="isfinfaComment" disabled="" rows="3"
																					placeholder="Comments"></form:textarea><span class="text-danger"></span></td>
																		</tr>
																	<%-- </c:if> --%>
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_Loan_Subsidy-row">
																			<td colspan="5"><p class="text-info">Comment
																					From : Industrial Development</p> <form:textarea
																					class="form-control wordcount" path="isfloanComment"
																					maxlength="1000" name="isfloanComment" disabled="" rows="3"
																					placeholder="Comments"></form:textarea><span class="text-danger"></span></td>
																		</tr>
																	<%-- </c:if> --%>
																	...
																	<tr class="ISF_Tax_Credit_Reim-row">
																		...
																		<td><form:textarea path="inputTaxRemark" rows="4" readonly="true"
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_Tax_Credit_Reim-row">
																			<td colspan="5"><p class="text-info">Comment
																					From : Industrial Development</p> <form:textarea
																					class="form-control wordcount" path="isfdisComment"
																					maxlength="1000" name="isfdisComment" disabled="" rows="3"
																					placeholder="Comments"></form:textarea><span class="text-danger"></span></td>
																		</tr>
																	<%-- </c:if> --%>
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_EX_E_Duty-row">
																			<td colspan="5"><p class="text-info">Comment
																					From : UPPCL</p> <form:textarea class="form-control wordcount"
																					path="isfelepodownComment"
																					maxlength="1000" name="isfelepodownComment" disabled="" rows="3"
																					placeholder="Comments"></form:textarea><span class="text-danger"></span></td>
																		</tr>
																	<%-- </c:if> --%>
																	...
																	<tr class="ISF_EX_E_Duty_PC-row">
																		...
																		<td><form:textarea path="elecDutyDrawnRemark" readonly="true"
																				maxlength="1000" rows="4" class="form-control"></form:textarea></td>
																	</tr>
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_EX_E_Duty_PC-row">
																			<td colspan="5"><p class="text-info">Comment
																					From : UPPCL</p> <form:textarea class="form-control wordcount"
																					maxlength="1000" path="isfElecdutyComment" name="isfElecdutyComment"
																					disabled="" rows="3" placeholder="Comments"></form:textarea><span class="text-danger"></span></td>
																		</tr>
																	<%-- </c:if> --%>
																	...
																	<tr class="ISF_EX_Mandee_Fee-row">
																		...
																		<td><form:textarea path="mandiFeeRemark" rows="4" readonly="true"
																				maxlength="1000" class="form-control"></form:textarea></td>
																	</tr>
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_EX_Mandee_Fee-row">
																			<td colspan="5"><p class="text-info">Comment
																					...
																					class="form-control wordcount" path="isfMandiComment"
																					maxlength="1000" name="isfMandiComment" disabled="" rows="3"
																					placeholder="Comments"></form:textarea><span class="text-danger"></span></td>
																		</tr>
																	<%-- </c:if> --%>
																	...
																	<%-- <c:if
																		...
																		<tr class="ISF_Indus_Payroll_Asst-row">
																			<td colspan="5"><p class="text-info">Comment
																					From : Labour/Industrial Development</p> <form:textarea
																					class="form-control wordcount" path="isfdifferabilComment"
																					maxlength="1000" name="isfdifferabilComment" disabled="" rows="3"
																					placeholder="Comments"></form:textarea><span class="text-danger"></span></td>
																		</tr>
																	<%-- </c:if> --%>
