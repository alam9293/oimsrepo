...
<title>Food Policy Dashboard</title>
		...
		<div class="container-fluid" id="main">
			<div class="row row-offcanvas row-offcanvas-left">
				...
				<div class="col-md-9 col-lg-10 mt-4 main">
					...
					<h4 class="card-title mb-4">LOC Stage</h4>

					<div class="row mb-5">
						<div class="col-sm-4">
							<div class="card card-block p-4 h-100">
								<a href="javascript:void(0);"
									class="dashboard-tiels received-tiels"> <label>3
										<i class="fa fa-get-pocket pull-right"></i>
								</label>
						...
						<div class="col-sm-4">
							<div class="card card-block p-4 h-100">
								<a href="javascript:void(0);"
									class="dashboard-tiels issued-tiels"> <label>1 <i
						...
						<div class="col-sm-4">
							<div class="card card-block p-4 h-100">
								<a href="javascript:void(0);"
									class="dashboard-tiels pendings-tiels"> <label>1
					...
					<div class="row mb-5">
						<div class="col-sm-4">
							<div class="card card-block p-4 h-100">
								<a href="javascript:void(0);"
									class="dashboard-tiels rejected-tiels"> <label>0
						...
						<div class="col-sm-4">
							<div class="card card-block p-4 h-100">
								<a href="javascript:void(0);"
									class="dashboard-tiels raised-tiels"> <label>0 <i
						...
						<div class="col-sm-4">
							<div class="card card-block p-4 h-100">
								<a href="javascript:void(0);"
									class="dashboard-tiels evaluation-tiels"> <label>0
					...
					<div class="row mb-5">
						<div class="col-sm-4">
							<div class="card card-block p-4 h-100">
								<a href="javascript:void(0);"
									class="dashboard-tiels ready-tiels"> <label>1 <i
						...
						<div class="col-sm-4">
							<div class="card card-block p-4 h-100">
								<a href="javascript:void(0);"
									class="dashboard-tiels agenda-tiels"> <label>0 <i
										class="fa fa-clipboard pull-right"></i></label>
						...
						<div class="col-sm-4">
							<div class="card card-block p-4 h-100">
								<a href="javascript:void(0);"
									class="dashboard-tiels review-tiels"> <label>0 <i
					...
					<h4 class="card-title mb-4">Disbursement Stage</h4>

					<div class="row mb-5">
						<div class="col-sm-4">
							<div class="card card-block p-4 h-100">
								<a href="javascript:void(0);"
									class="dashboard-tiels received-tiels"> <label>0
										<i class="fa fa-get-pocket pull-right"></i>
								</label>
									<hr> <span>Total Number of Applications Received</span>
								</a>
						...
						<div class="col-sm-4">
							<div class="card card-block p-4 h-100">
								<a href="javascript:void(0);"
									class="dashboard-tiels issued-tiels"> <label>0 <i
										class="fa fa-clipboard pull-right"></i></label>
						...
						<div class="col-sm-4">
							<div class="card card-block p-4 h-100">
								<a href="javascript:void(0);"
									class="dashboard-tiels pendings-tiels"> <label>0
										<i class="fa fa-clock-o pull-right"></i>
								</label>
									<hr> <span>Number of Applications Deferred</span>
								</a>
					...
					<div class="row mb-5">
						<div class="col-sm-4">
							<div class="card card-block p-4 h-100">
								<a href="javascript:void(0);"
									class="dashboard-tiels ready-tiels"> <label>0 <i
										class="fa fa-thumbs-up pull-right"></i></label>
									<hr> <span>Number of Applications Ready for
										Sanctioning/Empowered Committee</span>
								</a>
