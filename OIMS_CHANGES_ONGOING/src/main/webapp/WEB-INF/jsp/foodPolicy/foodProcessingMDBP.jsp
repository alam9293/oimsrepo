...
<title>Food MDBP View All Applicant Details</title>
										...
										<div class="row">
											<div class="col-sm-8">
												<a href="./foodProcessIndustryPolicy"
													...
													href="./evaluationViewmdbp" class="common-btn mt-3"
													...
													<div class="col-sm-12">
														<div class="table-responsive">
															...
															<tr>
																...
																<td colspan="2"><input type="text"
																	class="form-control" id=""
																	value="${projectDtailsMDBP.nameoftheunit}" disabled=""
																	name=""></td>
															</tr>
															<tr>

																<td>Location/Area of the unit</td>
																<td colspan="2"><input type="text"
																	class="form-control" id=""
																	value="${projectDtailsMDBP.locationareaoftheunit}"
																	disabled="" name=""></td>
															</tr>
															<tr>

																<td>Technology (Indigenous/ imported)</td>
																<td colspan="2"><input type="text"
																	class="form-control" id=""
																	value="${projectDtailsMDBP.technology}" disabled=""
																	name=""></td>
															</tr>

															<tr>
																<td colspan="3"><strong>Capacity of the
																		Plant</strong></td>
															</tr>
															<table
																class="table table-stripped table-bordered directors-table"
																...
																<tbody>
																	<c:forEach items="${capacityofthePlantFood}"
																		var="capacityofthePlantFood">
																		<tr>
																			<td>Capacity</td>
																			<td><input type="text" class="form-control"
																				id=""
																				value="${capacityofthePlantFood.unitcapacity }"
																				disabled="" name=""></td>
																		</tr>
																	</c:forEach>
																</tbody>
															...
															<tr>
																...
																<label for="yearofestablishingtheunit"
																	class="formbuilder-text-label">Year of
																	establishing the Unit<span class="formbuilder-required"></span>
																</label>
																<td colspan="2"><input type="text"
																	class="form-control" id=""
																	value="${projectDtailsMDBP.yearofestablishingtheunit}"
																	disabled="" name=""></td>
															</tr>
															...
															<tr>
																...
																<label for="yearofestablishingtheunit"
																	class="formbuilder-text-label">Date of
																	Commercial production<span class="formbuilder-required"></span>
																</label>
																<td colspan="2"><input type="text"
																	class="form-control" id=""
																	value="${projectDtailsMDBP.dateofcommercialproduction}"
																	disabled="" name=""></td>
															</tr>
															...
															<tr>
																...
																<label for="yearofestablishingtheunit"
																	class="formbuilder-text-label">Name of the
																	Agricultural Commodity used<span
																	class="formbuilder-required"></span>
																</label>
																<td colspan="2"><input type="text"
																	class="form-control" id=""
																	value="${projectDtailsMDBP.nameoftheagriculturalcommodityused}"
																	disabled="" name=""></td>
															</tr>

															<td colspan="3"><strong>Details of product
																	exported*</strong></td>
															</tr>
															<table
																class="table table-stripped table-bordered directors-table"
																...
																<tbody>
																	<c:forEach items="${detailsofproductExported}"
																		var="detailsofproductExportedList">

																		<tr>
																			<td><input type="text" class="form-control"
																				id="" value="${detailsofproductExportedList.raw}"
																				disabled="" name=""></td>
																			<td><input type="text" class="form-control"
																				id=""
																				value="${detailsofproductExportedList.processed}"
																				disabled="" name=""></td>
																		</tr>
																	</c:forEach>
																</tbody>
															...
															<h3 class="common-heading" access="false"
																id="detailsoffinishedproduct" value="">Details of
																finished product</h3>
															<tr>
																<td>Quantity of total Raw material used for
																	processing</td>
																<td><input type="text" class="form-control" id=""
																	value="${projectDtailsMDBP.quantityoftotalrawmaterialusedforprocessing}"
																	disabled="" name=""></td>
															</tr>
															<td colspan="3"><strong>Finished product
																	Quantity</strong></td>
															</tr>
															<table
																class="table table-stripped table-bordered directors-table"
																...
																<tbody>
																	<c:forEach items="${finishedproductQuantity}"
																		var="finishedproductQuantityList">
																		<tr>
																			<td><input type="text" class="form-control"
																				id=""
																				value="${finishedproductQuantityList.quantityexported}"
																				disabled="" name=""></td>
																			<td><input type="text" class="form-control"
																				id=""
																				value="${finishedproductQuantityList.nameofcountries}"
																				disabled="" name=""></td>
																		</tr>
																	</c:forEach>
																</tbody>
															</table>
															<td colspan="3"><strong>Total Annual Export
																	Turnover of unit (Fiscal year)</strong></td>
															</tr>
															<table
																class="table table-stripped table-bordered directors-table"
																id="customFields">
																...
																<tbody>
																	<c:forEach items="${totalAnnualExportTurnoverofunit}"
																		var="totalAnnualExportTurnoverofunitList">
																		<tr>
																			<td><input type="text" class="form-control"
																				id=""
																				value="${totalAnnualExportTurnoverofunitList.year}"
																				disabled="" name=""></td>
																			<td><input type="text" class="form-control"
																				id=""
																				value="${totalAnnualExportTurnoverofunitList.amount}"
																				disabled="" name=""></td>
																		</tr>
																	</c:forEach>
																</tbody>
															</table>
															<td colspan="3"><strong>Export incentive
																	calculated on the basis of Annual Export Turnover</strong></td>
															</tr>
															<table
																class="table table-stripped table-bordered directors-table"
																id="customFields">
																...
																<tbody>
																	<c:forEach items="${exptInctvCalAnualExptTrnOver}"
																		var="exptInctvCalAnualExptTrnOverList">
																		<tr>
																			<td><input type="text" class="form-control"
																				id=""
																				value="${exptInctvCalAnualExptTrnOverList.year}"
																				disabled="" name=""></td>
																			<td><input type="text" class="form-control"
																				id=""
																				value="${exptInctvCalAnualExptTrnOverList.amount}"
																				disabled="" name=""></td>
																		</tr>
																	</c:forEach>
																</tbody>
															</table>
															<td colspan="3"><strong>Registration
																	Certificate from APEDA*</strong></td>
															</tr>
															<table
																class="table table-stripped table-bordered directors-table"
																id="customFields">
																...
																<tbody>
																	<c:forEach items="${registrationCertificatefromAPEDA}"
																		var="registrationCertificatefromAPEDAList">
																		<tr>
																			<td><input type="text" class="form-control"
																				id=""
																				value="${registrationCertificatefromAPEDAList.registrationnumber}"
																				disabled="" name=""></td>
																			<td><input type="text" class="form-control"
																				id=""
																				value="${registrationCertificatefromAPEDAList.registrationdate}"
																				disabled="" name=""></td>
																		</tr>
																	</c:forEach>
																</tbody>
															</table>
															<td colspan="3"><strong>Import export code
																	and Address of issuing DGFT office</strong></td>
															</tr>
															<table
																class="table table-stripped table-bordered directors-table"
																id="customFields">
																...
																<tbody>
																	<c:forEach items="${ImptExptCodeAddDGFToff}"
																		var="ImptExptCodeAddDGFToffList">
																		<tr>
																			<td><input type="text" class="form-control"
																				id=""
																				value="${ImptExptCodeAddDGFToffList.consignmentcode}"
																				disabled="" name=""></td>
																			<td><input type="text" class="form-control"
																				id="" value="${ImptExptCodeAddDGFToffList.address}"
																				disabled="" name=""></td>
																		</tr>
																	</c:forEach>
																</tbody>
															</table>
															<td colspan="3"><strong>Details of Export</strong></td>
															</tr>
															<table
																class="table table-stripped table-bordered directors-table"
																id="customFields">
																<thead>
																	<tr>
																		...
																		<th>Weight of Exported Products</th>
																		<th>Name of the countries</th>
																		<th>Sl. No. and dates of shipping/Air way bills</th>
																		<th>Amount of the bills</th>

																	</tr>
																</thead>
																<tbody>
																	<c:forEach items="${detailsofExport}"
																		var="detailsofExportList">
																		<tr>
																			<td><input type="text" class="form-control"
																				id="" value="${detailsofExportList.dateofexport}"
																				disabled="" name=""></td>
																			<td><input type="text" class="form-control"
																				id="" value="${detailsofExportList.namecommodity}"
																				disabled="" name=""></td>
																			<td><input type="text" class="form-control"
																				id=""
																				value="${detailsofExportList.weightofexportedproducts}"
																				disabled="" name=""></td>
																			<td><input type="text" class="form-control"
																				id=""
																				value="${detailsofExportList.nameofthecountries}"
																				disabled="" name=""></td>
																			<td><input type="text" class="form-control"
																				id=""
																				value="${detailsofExportList.slnoanddatesofshippingairwaybills}"
																				disabled="" name=""></td>
																			<td><input type="text" class="form-control"
																				id=""
																				value="${detailsofExportList.amountofthebills}"
																				disabled="" name=""></td>
																		</tr>
																	</c:forEach>
																</tbody>
															...
															<td colspan="3"><strong>Bank Details</strong></td>
															</tr>
															<table
																class="table table-stripped table-bordered directors-table"
																id="customFields">
																...
																<tbody>
																	<c:forEach var="bankDetails" items="${bankDetails}">
																		<tr>
																			<td>Name of the Bank</td>
																			<td><input type="text" class="form-control"
																				id="" value="${bankDetails.detailsnameofthebank}"
																				disabled="" name=""></td>
																		</tr>
																		<tr>
																			<td>Branch Address</td>
																			<td><input type="text" class="form-control"
																				id="" value="${bankDetails.detailsbranchaddress}"
																				disabled="" name=""></td>
																		</tr>
																		<tr>
																			<td>Bank Email</td>
																			<td><input type="text" class="form-control"
																				id="" value="${bankDetails.detailsbankemail}"
																				disabled="" name=""></td>
																		</tr>
																		<tr>
																			<td>IFSC Code</td>
																			<td><input type="text" class="form-control"
																				id="" value="${bankDetails.detailsifsccode}"
																				disabled="" name=""></td>
																		</tr>
																		<tr>
																			<td>Account No</td>
																			<td><input type="text" class="form-control"
																				id="" value="${bankDetails.detailsaccountno}"
																				disabled="" name=""></td>
																		</tr>
																	</c:forEach>
																</tbody>
													...
													<div class="col-sm-12">
														<div class="table-responsive">
															<table class="table table-bordered">
																<tbody>
																	<tr>
																		...
																		<td><a
																			href="./downloadfoodDocumentMDBP?fileName=${foodDocumentMDBP.incorporationcertificateoffirm}">${foodDocumentMDBP.incorporationcertificateoffirm}</a>
																		</td>
																	</tr>
																	<tr>
																		...
																		<td><a
																			href="./downloadfoodDocumentMDBP?fileName=${foodDocumentMDBP.partnershipdeedbyelawsofthefirm}">${foodDocumentMDBP.partnershipdeedbyelawsofthefirm}</a>
																		</td>
																		
																	</tr>
																	<tr>
																		<td width="50%"><strong>Affiliation
																				letter from authorized signatory of application of
																				organization</strong></td>

																		<td><a
																			href="./downloadfoodDocumentMDBP?fileName=${foodDocumentMDBP.affiliationletterfromauthorizedsignatoryofapplicationoforgani}">${foodDocumentMDBP.affiliationletterfromauthorizedsignatoryofapplicationoforgani}</a>
																		</td>
																	</tr>
																	<tr>
																		<td width="50%"><strong>Self attested
																				Promoter’s Bio-Data of organization</strong></td>

																		<td><a
																			href="./downloadfoodDocumentMDBP?fileName=${foodDocumentMDBP.selfattestedpromotersbiodataoforganization}">${foodDocumentMDBP.selfattestedpromotersbiodataoforganization}</a>
																		</td>
																	</tr>
																	<tr>
																		<td width="50%"><strong>For completion
																				of export responsibility / shipment / air-way bill &
																				export general manifest for quantity of exported
																				material</strong></td>

																		<td><a
																			href="./downloadfoodDocumentMDBP?fileName=${foodDocumentMDBP.forcompletionofexportresponsibilityshipmentairwaybillampexpor}">${foodDocumentMDBP.forcompletionofexportresponsibilityshipmentairwaybillampexpor}</a>
																		</td>
																	</tr>
																	<tr>
																		<td width="50%"><strong>Detail of
																				quantity of Agriculture & exported produce</strong></td>

																		<td><a
																			href="./downloadfoodDocumentMDBP?fileName=${foodDocumentMDBP.detailofquantityofagricultureampexportedproduce}">${foodDocumentMDBP.detailofquantityofagricultureampexportedproduce}</a>
																		</td>
																	</tr>
																	<tr>
																		<td width="50%"><strong>Importer-Exporter
																				code certificate from DGFT office</strong></td>

																		<td><a
																			href="./downloadfoodDocumentMDBP?fileName=${foodDocumentMDBP.importerexportercodecertificatefromdgftoffice}">${foodDocumentMDBP.importerexportercodecertificatefromdgftoffice}</a>
																		</td>
																	</tr>
																	<tr>
																		<td width="50%"><strong>RCMC
																				registration certificate from APEEDA</strong></td>

																		<td><a
																			href="./downloadfoodDocumentMDBP?fileName=${foodDocumentMDBP.rcmcregistrationcertificatefromapeeda}">${foodDocumentMDBP.rcmcregistrationcertificatefromapeeda}</a>
																		</td>
																	</tr>
																	<tr>
																		<td width="50%"><strong>Bills of
																				shipment/air for exported material quantity</strong></td>

																		<td><a
																			href="./downloadfoodDocumentMDBP?fileName=${foodDocumentMDBP.billsofshipmentairforexportedmaterialquantity}">${foodDocumentMDBP.billsofshipmentairforexportedmaterialquantity}</a>
																		</td>
																	</tr>
																	<tr>
																		<td width="50%"><strong>Export general
																				manifest certificate from custom Department</strong></td>

																		<td><a
																			href="./downloadfoodDocumentMDBP?fileName=${foodDocumentMDBP.exportgeneralmanifestcertificatefromcustomdepartment}">${foodDocumentMDBP.exportgeneralmanifestcertificatefromcustomdepartment}</a>
																		</td>
																	</tr>
																	<tr>
																		<td width="50%"><strong>Details of Raw
																				Material</strong></td>

																		<td><a
																			href="./downloadfoodDocumentMDBP?fileName=${foodDocumentMDBP.detailsofrawmaterialnbsp}">${foodDocumentMDBP.detailsofrawmaterialnbsp}</a>
																		</td>
																	</tr>
																	<tr>
																		<td width="50%"><strong>Freight bills
																				issuing authority details</strong></td>

																		<td><a
																			href="./downloadfoodDocumentMDBP?fileName=${foodDocumentMDBP.freightbillsissuingauthoritydetails}">${foodDocumentMDBP.freightbillsissuingauthoritydetails}</a>
																		</td>
																	</tr>
																	<tr>
																		<td width="50%"><strong>Buyer Purchase
																				Order from importing country</strong></td>

																		<td><a
																			href="./downloadfoodDocumentMDBP?fileName=${foodDocumentMDBP.buyerpurchaseorderfromimportingcountry}">${foodDocumentMDBP.buyerpurchaseorderfromimportingcountry}</a>
																		</td>
																	</tr>

																	<tr>
																		<td width="50%"><strong>Phyto sanitary
																				Certificate</strong></td>

																		<td><a
																			href="./downloadfoodDocumentMDBP?fileName=${foodDocumentMDBP.phytosanitarycertificate}">${foodDocumentMDBP.phytosanitarycertificate}</a>
																		</td>
																	</tr>


																	<tr>
																		<td width="50%"><strong>Export Invoice
																				cum packing list issuing authority details</strong></td>

																		<td><a
																			href="./downloadfoodDocumentMDBP?fileName=${foodDocumentMDBP.exportinvoicecumpackinglistissuingauthoritydetails}">${foodDocumentMDBP.exportinvoicecumpackinglistissuingauthoritydetails}</a>
																		</td>
																	</tr>
																	<tr>
																		<td width="50%"><strong>Name of bank
																				Realization Certificate</strong></td>

																		<td><a
																			href="./downloadfoodDocumentMDBP?fileName=${foodDocumentMDBP.nameofbankrealizationcertificate}">${foodDocumentMDBP.nameofbankrealizationcertificate}</a>
																		</td>
																	</tr>
																	<tr>
																		<td width="50%"><strong>Shipping Bills
																				for exports</strong></td>

																		<td><a
																			href="./downloadfoodDocumentMDBP?fileName=${foodDocumentMDBP.shippingbillsforexports}">${foodDocumentMDBP.shippingbillsforexports}</a>
																		</td>
																	</tr>

																	<tr>
																		<td width="50%"><strong>Declaration
																				Upload</strong></td>

																		<td><a
																			href="./downloadfoodDocumentMDBP?fileName=${foodDocumentMDBP.declarationupload}">${foodDocumentMDBP.declarationupload}</a>
																		</td>
																	</tr>
															...
															<div class="parameter-properties" id="Annexure-I">
																...
																<p class="mt-4 mb-1 text-center">
																	<strong>APPLICATION FORM FOR
																		SANCTION/DISBURSAL OF INCENTIVES FOR SMALL, MEDIUM &
																		LARGE INDUSTRIAL UNDERTAKINGS</strong>
																</p>
																<p class="mb-2 text-center">
																	<i>(all supporting documents must be authenticated
																		by a Director/Partner/Officer duly authorized by the
																		Competent authority of the Applicant on its behalf)</i>
																</p>
																<p class="mb-4 text-center">
																	<strong>Category of Industrial Undertaking
																		Applied For Based on Capital Investment & Location</strong>
																</p>
																				...
																				<tbody>
																					<tr>
																						<td colspan="2" style="width: 17%;">Criteria
																							for investment</td>
																						<td rowspan="2">Investment in Plant and
																							Machinery as defined in MSMED Act, 2006</td>
																						<td rowspan="2">More than Rs 25 lakhs but
																							does not exceed Rs 5 Crore</td>
																						<td rowspan="2">More than Rs 5 crores but
																							does not exceed Rs. 10 crores</td>
																					</tr>
																					<tr>
																					...
																					<tr>
																						<td class="text-center">
																							<div
																								...
																								<input type="checkbox"
																									class="custom-control-input" id="Small-p"
																						...
																						<td class="text-center">
																							<div
																								class="custom-control custom-checkbox custom-control-inline">
																								<input type="checkbox"
																									class="custom-control-input" id="Medium-p"
																									name="Capital-Interest-Subsidy"> <label
																						...
																						<td class="text-center">
																							<div
																								class="custom-control custom-checkbox custom-control-inline">
																								<input type="checkbox"
																									class="custom-control-input" id="25exceedRs"
																									name="Capital-Interest-Subsidy"> <label
																						...
																						<td class="text-center">
																							<div
																								class="custom-control custom-checkbox custom-control-inline">
																								<input type="checkbox"
																									class="custom-control-input" id="5exceedRs"
																									name="Capital-Interest-Subsidy"> <label
																	...
																	<div class="col-sm-12">
																		<div class="table-responsive">
																			<table class="table table-bordered">
																				<tbody>
																					<tr>
																						<td style="width: 17%;">Criteria for
																							investment of Large</td>
																						<td colspan="3">Eligible Capital Investment
																							as Defined in the Rules</td>
																					</tr>
																					<tr>
																						<td rowspan="2">Beyond the investment amount
																							in Plant & Machinery for Medium Industrial
																							Undertakings (Rs 10 Crore) and upto capital
																							investment Rs</td>
																						<td>Bundelkhand & Poorvanchal Investment
																							amount upto Rs 100 Crore</td>
																						<td>Madhyanchal & Paschimanchal (except
																							Gautam Buddh Nagar & Ghaziabad) <br>Investment
																					...
																					<tr>
																						<td class="text-center">
																							<div
																								class="custom-control custom-checkbox custom-control-inline">
																								<input type="checkbox"
																									class="custom-control-input" id="Bundelkhand"
																									name="Capital-Interest-Subsidy"> <label
																						...
																						<td class="text-center">
																							<div
																								class="custom-control custom-checkbox custom-control-inline">
																								<input type="checkbox"
																									class="custom-control-input" id="Madhyanchal"
																									name="Capital-Interest-Subsidy"> <label
																						...
																						<td class="text-center">
																							<div
																								class="custom-control custom-checkbox custom-control-inline">
																								<input type="checkbox"
																									class="custom-control-input" id="Ghaziabad"
																									name="Capital-Interest-Subsidy"> <label
																...
																<div class="row mt-4">
																	<div class="col-sm-12">
																				...
																				<tbody>
																					<tr>
																						...
																						<td>Certificate of Incorporation, registered
																							partnership deed, trust /society registration
																							deed.</td>
																					</tr>
																					<tr>
																						<td>2.</td>
																					...
																					<tr>
																						<td>3.</td>
																						<td>Location of the Existing/ Proposed
																					...
																					<tr>
																						...
																						<td></td>
																						<td>Industrial Categorization as per ID&R
																							Act/NIC</td>
																					</tr>
																					<tr>
																						<td>8.</td>
																				...
																				<tbody>
																					...
																					<tr>
																						...
																						<td>Date from which capital investment has
																							commenced, or is proposed to 17 be commenced
																					...
																					<tr>
																						<td>11.2</td>
																						<td>Is the capital investment proposed in
																							phases</td>
																						<td></td>
																						<td></td>
																					</tr>
																					<tr>
																						<td>11.3</td>
																						<td>Phase-wise details of Proposed Investment
																							and dates of start of commercial production</td>
																						<td></td>
																						<td></td>
																					</tr>
																				</tbody>
																				...
																				<tbody>
																					...
																					<tr>
																						...
																						<td>10% GST where 25% minimum SC/ST workers
																							employed subject to minimum of 400 total workers
																							in industrial undertakings located in
																					...
																					<tr>
																						...
																						<td>Additional Stamp Duty exemption @20% upto
																							maximum of 100% in case of industrial
																					...
																					<tr>
																						...
																						<td>Additional 10% EPF Reimbursement upto
																							maximum of 70% in case of industrial undertakings
																					...
																					<tr>
																						...
																						<td>Additional Infrastructure Interest
																							Subsidy @2.5% upto 18 maximum of 7.5% in case of
																		...
																		<p>The above information are completely true and
																			no fact has been concealed or misrepresented. It is
																			further certified that the company has not applied
																			for benefits of the above nature under any
																			sector-specific or other policy of the Govt of UP for
																			purpose of availing benefits of the above nature.</p>
																		<p>I/we hereby agree that I/we shall forthwith
																			repay the benefits released to me/us under Rules of
																			Policy for Promotion of Industrial Investment and
																...
																<div class="row mt-4 mb-5">
																	...
																	<div class="col-md-6 text-right">
																		<p class="mb-0">
																			<strong>Signature of Authorised Signatory
																				with</strong>
																		</p>
																		<p>
																...
																<div class="row mt-4 mb-5">
																	...
																	<div class="col-md-12">
																		...
																		<p>(c) Charted Accountantâs Certificate for
																			existing gross block industrial undertaking.</p>
																		<p>(d) Chartered Engineerâs Certified List of
																			Fixed Assets of existing industrial undertaking in
																			support of gross block.</p>
																		<p>(e) Notarized Undertaking (as per format placed
																			at Annexure I-A) on Stamp Paper of Rs. 10</p>
																	</div>
																</div>
															...
															<div class="parameter-properties" id="Annexure-III">
																...
																<p class="mt-4 mb-1 text-center">
																	<strong>APPLICATION FORM FOR MEGA, MEGA PLUS
																		AND SUPER MEGA INDUSTRIAL UNDERTAKINGS</strong>
																</p>
																<p class="mb-2 text-center">
																	<i>(all supporting documents must be authenticated
																		by a Director/Partner/Officer duly authorized by the
																...
																<p class="mb-4 text-center">
																	<strong>Category of Industrial Undertaking
																		Applied For Based on Capital Investment, Location and
																		Employment Proposed</strong>
																</p>
																<p class="mb-4 mt-5">
																		...
																		<div class="table-responsive">
																			<table class="table table-bordered">
																				...
																				<tbody>
																					...
																					<tr>
																						<td rowspan="3">Capital Investment as Defined
																							in the Rules</td>
																						<td rowspan="3">Beyond the investment amount
																							for Large Industrial Undertakings and upto
																							capital investment of Rsâ¦..,</td>
																						<td>>100<250</td>
																						<td>>150<300</td>
																						<td>>200<500</td>
																						<td>MEGA</td>
																						<td>
																							<div
																								class="custom-control custom-checkbox custom-control-inline">
																								<input type="checkbox"
																									class="custom-control-input" id="checkIII1"
																									name="Capital-Interest-Subsidy"> <label
																					...
																					<tr>
																						...
																						<td>
																							<div
																								class="custom-control custom-checkbox custom-control-inline">
																								<input type="checkbox"
																									class="custom-control-input" id="checkIII2"
																									name="Capital-Interest-Subsidy"> <label
																					...
																					<tr>
																						...
																						<td>
																							<div
																								class="custom-control custom-checkbox custom-control-inline">
																								<input type="checkbox"
																									class="custom-control-input" id="checkIII3"
																									name="Capital-Interest-Subsidy"> <label
																			...
																			<table class="table table-bordered">
																				<thead>
																					<tr>
																						...
																						<th>REGION</th>
																						<th>QUALIFYING CATEGORY OF INDUSTRIAL
																							UNDERTAKING</th>
																						<th>TICK AS APPLICABLE</th>
																					</tr>
																				</thead>
																					...
																					<tr>
																						...
																						<td>
																							<div
																								class="custom-control custom-checkbox custom-control-inline">
																								<input type="checkbox"
																									class="custom-control-input" id="checkIII4"
																									name="Capital-Interest-Subsidy"> <label
																									class="custom-control-label" for="checkIII4"></label>
																							</div>
																						</td>
																					</tr>
																					<tr>
																						...
																						<td>
																							<div
																								class="custom-control custom-checkbox custom-control-inline">
																								<input type="checkbox"
																									class="custom-control-input" id="checkIII5"
																									name="Capital-Interest-Subsidy"> <label
																									class="custom-control-label" for="checkIII5"></label>
																							</div>
																						</td>
																					</tr>
																					<tr>
																						...
																						<td>
																							<div
																								class="custom-control custom-checkbox custom-control-inline">
																								<input type="checkbox"
																									class="custom-control-input" id="checkIII6"
																									name="Capital-Interest-Subsidy"> <label
																									class="custom-control-label" for="checkIII6"></label>
																							</div>
																						</td>
																					</tr>
																					<tr>
																						...
																						<td>
																							<div
																								class="custom-control custom-checkbox custom-control-inline">
																								<input type="checkbox"
																									class="custom-control-input" id="checkIII7"
																									name="Capital-Interest-Subsidy"> <label
																									class="custom-control-label" for="checkIII7"></label>
																							</div>
																						</td>
																					</tr>
																					<tr>
																						...
																						<td>
																							<div
																								class="custom-control custom-checkbox custom-control-inline">
																								<input type="checkbox"
																									class="custom-control-input" id="checkIII8"
																									name="Capital-Interest-Subsidy"> <label
																									class="custom-control-label" for="checkIII8"></label>
																							</div>
																						</td>
																					</tr>
																					<tr>
																						...
																						<td>
																							<div
																								class="custom-control custom-checkbox custom-control-inline">
																								<input type="checkbox"
																									class="custom-control-input" id="checkIII9"
																									name="Capital-Interest-Subsidy"> <label
																									class="custom-control-label" for="checkIII9"></label>
																							</div>
																						</td>
																					</tr>
																					<tr>
																						...
																						<td>
																							<div
																								class="custom-control custom-checkbox custom-control-inline">
																								<input type="checkbox"
																									class="custom-control-input" id="checkIII10"
																									name="Capital-Interest-Subsidy"> <label
																									class="custom-control-label" for="checkIII10"></label>
																							</div>
																						</td>
																					</tr>
																					<tr>
																						...
																						<td>
																							<div
																								class="custom-control custom-checkbox custom-control-inline">
																								<input type="checkbox"
																									class="custom-control-input" id="checkIII11"
																									name="Capital-Interest-Subsidy"> <label
																									class="custom-control-label" for="checkIII11"></label>
																							</div>
																						</td>
																					</tr>
																					<tr>
																						...
																						<td>
																							<div
																								class="custom-control custom-checkbox custom-control-inline">
																								<input type="checkbox"
																									class="custom-control-input" id="checkIII12"
																									name="Capital-Interest-Subsidy"> <label
																									class="custom-control-label" for="checkIII12"></label>
																							</div>
																						</td>
																					</tr>
																				</tbody>
																				...
																				<tbody>
																					...
																					<tr>
																						...
																						<td>Date from which capital investment has 28
																							commenced, or is proposed to commence (Cut-off
																							date, as opted)</td>
																						<td></td>
																						<td></td>
																					</tr>
																...
																<div class="row mt-4">
																	<div class="col-sm-12">
																		<p class="mb-4 mt-3">
																			<strong>12. BENEFITS REQUESTED BY APPLICANT
																			</strong>
																		</p>
																		<div class="table-responsive">
																			<table class="table table-bordered">
																				...
																				<tbody>
																					...
																					<tr>
																						<td>12.5.2</td>
																						<td>Addl. 10% EPF Reimbursement upto maximum
																							of 70% in case of industrial undertakings having
																							75% equity owned by Divyang/SC/CT/Female
																							Promoters</td>
																						<td></td>
																					</tr>
																					<tr>
															...
															<div class="isf-form mt-4">
																...
																<div class="row mt-4">
																	<div class="col-sm-12 text-center">
																		<button type="button"
																			class="btn btn-outline-success btn-sm mb-3">
																			<i class="fa fa-download"></i> Download Only
																			Application Form
																		</button>
																...
																<div class="row">
																	...
																	<div class="col-sm-8 text-right">
																		...
																		<a href="./evaluationViewmdbp" id="evaluateBtn"
