				...
				<div class="col-md-9 col-lg-10 mt-4 main">
					...
					<div class="card card-block p-4 mb-5">
						<div class="step-links">
							<ul class="only-steps">
								<li><a href="./jmdPiCupAgendaNote" class="pr-3">Agenda
										Note for LOC</a></li>
								<li><a href="./jmdPiCupAgendaNoteDis" class="active pr-3">Agenda
														...
														<tbody>
															<c:forEach var="list"
																...
																<tr>
																	...
																	<td>
																		<%-- <a	href="./downloadDocSctnyComt?applicantId=${list.appliId}">${list.pkupFilename}</a> --%>
																	</td>
																	<td><a
																		href="./viewAgendaDetailsByJMdPiCupDepartDis?applicantId=${list.appliId}"
																		class="btn btn-outline-info btn-sm">View</a> <a
																		href="#commentNote"
																		class="btn btn-outline-success btn-sm"
																		data-toggle="modal" id="${list.appliId}"
																		data-target="#edit-modal">Comment</a> <a
																		href="./saveForwardedToMdpicupDis?applicantId=${list.appliId}"
																		class="btn btn-outline-success btn-sm"
													...
													<table class="table table-bordered">
														...
														<tbody>
															<c:forEach var="list"
																...
																varStatus="counter">
																<tr>
																	<%-- <td><input type="checkbox" name="JMD" id="JMD"
																		value="${list.appliId}"> </td> --%>
																	<td class="text-center">${counter.index+1}</td>
																	<td>${list.appliId}</td>
																	<td>
															...
															<tr>
																...
																<td>
																	<textarea class="form-control"
																		disabled="disabled">${list.jmdComment}</textarea>
																</td>
															</tr>
														</c:forEach>
													</tbody>
                                  ...
                                  <div class="table-responsive">
                                    <table class="table table-bordered">
                                      ...
                                      <c:forEach var="list"
														...
														<tr>
															<td class="text-center align-middle">${list.appliId}</td>
															<td><textarea class="form-control" disabled="disabled">${list.comments}</textarea></td>
														</tr>
													</c:forEach>
	...
	<div class="modal fade" id="edit-modal">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<!-- Modal Header -->
				<div class="modal-header">
					<h4 class="modal-title">JMD Recommendations</h4>
					<button type="button" class="close" data-dismiss="modal">&times;</button>
				</div>

				<form:form modelAttribute="PrepareAgendaNotesDis"
					action="saveCommenJMdPicupDepartmentDis" class="mt-4"
					name="PrepareAgendaNotes" method="post">
					<!-- Modal body -->
					<div class="modal-body">
						<div class="row">
							...
							<div class="col-sm-12">
								<div class="form-group">
									<form:textarea path="jmdComment" class="form-control"
										placeholder="Enter Your Comment" rows="4" name="jmdComment"
