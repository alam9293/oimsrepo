      ...
      <div class="d-flex justify-content-center h-100">
        <div class="user_card">
          ...
          <div class="d-flex justify-content-center form_container"> 
            ...
            <spring:url value="/UserLogin2"	var="loginActionUrl" />
			<form:form modelAttribute="login2" method="post" action="${loginActionUrl}" onsubmit="return loginValidation()" class="login-form">
              ...
              <div class="input-group mb-2 mt-3">
                <div class="row">
                  <div class="col-sm-6">
                    <input  type="text" name="captcha" class="form-control input_pass" placeholder="Captcha" maxlength="10" id="captchaId"></input>                  
                  </div>
