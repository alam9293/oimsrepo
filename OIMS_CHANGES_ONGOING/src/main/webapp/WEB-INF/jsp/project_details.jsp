	...
	$(function() {
	     ...
	     if('${projectId}'!=null && '${projectId}'!='')
	  	  {	       		 
		  	...
		  	$("input[name='contactPersonName']").attr("readonly", true);
		  	...
		  	document.getElementById("picUnitEx").disabled = true; 
		  	document.getElementById("picUnitNew").disabled = true; 
		   ...
		   $("input[name='contactPersonName']").attr("readonly", false);
		   ...
		   $("#existingProducts").removeAttr("readonly");
		  	...
		  	document.getElementById("picUnitEx").disabled = false; 
		  	document.getElementById("picUnitNew").disabled = false; 
...
function validateExistProjDetails(){
        ...
        var picunit=document.getElementById("picUnitEx").value;	
			    ...
			    if (picunit == null || picunit == '') {
					document.getElementById('picunitEx').innerHTML = "Please select unit.";
...
function validateNewProjDetails(){

	var proposedProducts=document.getElementById("proposedProductsNew").value;
    var proposedInstalledCapacity=document.getElementById("proposedInstalledCapacityNew").value;
    //var picunit=$('select[name="picUnitNew"]').val();
    var picunit=document.getElementById("picUnitNew").value;	
     
   	
		    if (proposedProducts == null || proposedProducts == '') {
		    	alert("Proposed products is Required.");
				document.getElementById('ProposedProducts').innerHTML = "Proposed products is Required.";
				document.getElementById('proposedProducts').focus();
				return false;
			}
		    ...
		    if (proposedInstalledCapacity == null || proposedInstalledCapacity == '') {
		    	alert("Proposed installed capacity is Required.");
				document.getElementById('ProposedInstalledCapacity').innerHTML = "Proposed installed capacity is Required.";
				document.getElementById('ProposedInstalledCapacity').focus();
				return false;
			}
		    ...
		    if (picunit == null || picunit == '') {
				...
				document.getElementById('picunitspan').innerHTML = "Please select unit.";
				document.getElementById('picunitspan').focus();
				return false;
			}
											...
											<spring:bind path="contactPersonName">
												<div class="form-group">
													...
													<form:input path="contactPersonName" class="form-control"
														...
														onkeypress="return IsCharacter111(event)" readonly="false"></form:input>
                                         ...
                                         <option value="c">c</option>
                                               ...
                                               <div id="reset">
												...
												<form:select path="natureOfProject" class="form-control"
													...
													<form:option value="${natureOfProject}">Select One</form:option>
														...
														<tr>
															...
															<td><form:input path="proposedInstalledCapacity"
																...
																class="text-danger color:red"></span> <form:select
																	...
																	onblur="emptyExistProjDetails()" id="picUnitEx">
																	<form:option value="">Select Unit</form:option>
																	<form:options items="${unitListMap}" />
													...
													<tfoot>
														<tr>
															...
															<td><form:input path="proposedProductsNew"
																	name="proposedProducts" class="form-control"
																	id="proposedProductsNew" maxlength="50"></form:input> <span
																id="ProposedProducts" class="text-danger color:red"></span></td>
															<td>
																	...
																	<tr>
																		<td width="50%" class="border-0 pl-0 pt-0 pb-0">
																			<form:input path="proposedInstalledCapacityNew"
																				...
																				class="form-control" id="proposedInstalledCapacityNew"
																		...
																		<td class="border-0 p-0"><form:select
																				...
																				onblur="emptyExistProjDetails()" id="picUnitNew">
																				<form:option value="">Select Unit</form:option>
																				<form:options items="${unitListMap}" />
																			</form:select> <span id="picunitspan" class="text-danger color:red"></span>
																		</td>
																	</tr>
																</table>
															...
															<c:if test="${empty editnpd}">
																<td class="text-center"><button
																		formaction="addNewProjectDetails"
																		onclick="return validateNewProjDetails();"
																		 id="newProjAdd"
																		class="btn btn-outline-success btn-sm add-save-data">Add</button>
																	<!-- onclick="return propGrossBlockAmt(); validateExistProjDetails()"  -->
															...
															<td>
																<div class="custom-file">
																	<input type="file" class="custom-file-input"
																		...
																		id="encloseDetailProReportFileName1">Choose
																		file</label>
