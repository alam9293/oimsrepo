...
<html lang="en">
  <head>
    ...
    <title>Select Policy Head Department</title>
        ...
        <div class="row row-offcanvas row-offcanvas-left">
          <div class="col-md-3 col-lg-2 sidebar-offcanvas pt-3" id="sidebar" role="navigation">
            <ul class="nav flex-column pl-1">
              <li class="nav-item"><a class="nav-link" href="./nodalDeptHeadDashboard"><i class="fa fa-tachometer"></i> Dashboard</a></li>
              <li class="nav-item"><a class="nav-link active" href="./viewAndEvaluateNodalDept"><i class="fa fa-eye"></i> View Applications</a></li>
              
              <li class="nav-item"><a class="nav-link" href="prepare-agenda-note-head-department.html"><i class="fa fa-list"></i> Agenda Note</a></li>
              <li class="nav-item"><a class="nav-link" href="mom-go-head-department.html"><i class="fa fa-calendar"></i> View Minutes of Meeting and GO's</a></li>
            </ul>
          </div>
          <!--/col-->
              ...
              <div class="col-sm-3 mb-5">
                <div class="card card-block policy-box-card p-4 h-100">
                  <div class="ploicy-name">
                    <a href="./nodalDeptApplicationsForLoc">
