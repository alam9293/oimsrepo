...
<head>
  ...
  <title>OIMS DEPARTMENT CREATION</title>
    ...
    <div class="content">
       ...
       <div align ="center">
						<table class="table table-bordered">
							<tbody>
								<form:form modelAttribute ="addDepartmentmodel" >
									<tr>
										<td>Department</td>
										<td><input type="text"  class="form-control" name="department" id="deptid"/>
								    </tr>
									<tr>
										<td>Department Description</td>
										<td><input type="text"  class="form-control" name="deptDesc" id="deptDescid"/>									</tr>
									<tr>
										<td colspan=2>
										   <input type="submit"  value ="Add" formaction ="./AddNewDepartment"/>
										</td>
									</tr>
								</form:form>
							</tbody>
