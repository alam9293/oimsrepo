...
<head>
  ...
  <title>OIMS FORM CREATION</title>
...
jQuery(document).ready(function($) {
    $("#actionNameId").change(function (){
    	var userData = $("#actionNameId").val();
    	
    	$.ajax({
			type : "POST",
			contentType : "text/plain",
			url : "checkActionnameduplicacy",
			data : userData,
			dataType : 'text',				
			success : function(data) {
				
				if(data=="duplicate")
				document.getElementById("actionNamespn").innerHTML = "ACTION ALREADY EXIST!";
...
function validateValues()
{
	...
	if(document.getElementById("actionNameId").value==null||document.getElementById("actionNameId").value=="")
	{
		document.getElementById("actionNamespn").innerHTML ="PLEASE ENTER FORM ACTION NAME";
		return false;
	}
	else
	{
		document.getElementById("actionNamespn").innerHTML ="";
	}
	if(document.getElementById("displayNameId").value==null||document.getElementById("displayNameId").value=="")
	{
		document.getElementById("displayNamespn").innerHTML ="PLEASE ENTER FORM DISPLAY NAME";
		return false;
	}
	else
	{
		document.getElementById("displayNamespn").innerHTML ="";
	}
	
	if(document.getElementById("departmentId").selectedIndex==0)
	{
		document.getElementById("departmentspn").innerHTML ="PLEASE SELECT DEPARTMENT";
		return false;
	}
	else
	{
		document.getElementById("departmentspn").innerHTML ="";
	}	
	return true;
}
</script>
    ...
    <div class="content">
       ...
       <div align ="center">
						<table class="table table-bordered">
							<tbody>
								<form:form modelAttribute ="addFormmodel" onSubmit ="return validateValues()">
									<tr>
										<td>Form Action Name</td>
										   <td>
										      <input type="text" class="form-control" name="actionName" id="actionNameId" onchange="return validateValues()">
										      <span id="actionNamespn" class="text-danger color:red"></span>
										   
										</tr>
										<tr>
										   <td>Form Display Name</td>
										   <td>
										      <input type="text" class="form-control" name="displayName" id="displayNameId" onchange="return validateValues()">
										      <span id="displayNamespn" class="text-danger color:red"></span>
										   </td>
									</tr>
									<tr>
										<td>Department</td>
										<td>
										   <div class="input-group mb-3">
										    ...
										    <span id="departmentspn" class="text-danger color:red"></span>
										 </td>
									</tr>
									 <tr>
										<td colspan=2>
										   <input type="submit"  value ="Add" formaction ="./AddNewForm"/>
										</td>
									</tr>
								</form:form>
							</tbody>
