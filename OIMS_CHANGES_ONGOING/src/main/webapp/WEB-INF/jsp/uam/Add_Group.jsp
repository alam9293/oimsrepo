...
<head>
  ...
  <title>OIMS GROUP CREATION</title>
...
function validateValues()
{
	...
	if(document.getElementById("groupid").value==null||document.getElementById("groupid").value=="")
	{
		document.getElementById("groupspn").innerHTML ="PLEASE ENTER GROUP NAME";
		return false;
	}
	else
	{
		document.getElementById("groupspn").innerHTML ="";
	}
	if(document.getElementById("groupDescId").value==null||document.getElementById("groupDescId").value=="")
	{
		document.getElementById("groupDescspn").innerHTML ="PLEASE ENTER GROUP DESCRIPTION";
		return false;
	}
	else
	{
		document.getElementById("groupDescspn").innerHTML ="";
	}
	return true;
}
</script>
    ...
    <div class="content">
       ...
       <div align ="center">
						<table class="table table-bordered">
							<tbody>
								<form:form modelAttribute ="userGroupmodel" onSubmit ="return validateValues()">
									<tr>
										<td>Group</td>
										<td>
										   <input type="text" class="form-control" name="group" id="groupid" onchange="return validateValues()">
										   <span id="groupspn" class="text-danger color:red"></span>
										</td>
										</tr>
										<tr>
										   <td>Group Description</td>
										<td>
										    <input type="text" class="form-control" name="groupDesc" id="groupDescId" onchange="return validateValues()">
										    <span id="groupDescspn" class="text-danger color:red"></span>
										</td>
									</tr>
									 <tr>
										<td colspan=2>
										   <input type="submit"  value ="Add" formaction ="./AddNewGroup"/>
										</td>
									</tr>
								</form:form>
							</tbody>
