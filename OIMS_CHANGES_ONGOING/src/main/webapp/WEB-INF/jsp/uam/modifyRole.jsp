...
function validateValues()
{
	...
	{
		if(document.getElementById("enblroleId").selectedIndex==0)
		{
			document.getElementById("enblrolespn").innerHTML ="PLEASE SELECT USER ID";
			return false;
		}
		else
		{
			document.getElementById("enblrolespn").innerHTML ="";
		}
	}
...
<script type="text/javascript">
	...
	{
		var dataarray = document.getElementById("enblroleId").value.split("seprator");
		var role         = dataarray[1];
		var roleDesc     = dataarray[2];
		
		if(document.getElementById("enblroleId").selectedIndex==0)
		{
			document.getElementById("enblrolespn").innerHTML ="PLEASE SELECT ROLEID";
		}
		else
		{
			document.getElementById("enblrolespn").innerHTML ="";
			document.getElementById("enblroleDescid").value = dataarray[2];
		}
	}
</script>
<script type="text/javascript">
	function loaddsblUserDesc()
	{
		...
		else
		{
			...
			document.getElementById("dsblroleDescid").value = dataarray[2];
		}
	}
</script>
</head>
    ...
    <div class="content">
       ...
       <div align ="center">
						<table class="table table-bordered" id ="mainTableid">
							<tbody>
								<form:form modelAttribute ="enbldsblrolemodel">
								   <tr>
										<td>ACTIVITY</td>
										<td>
										   <div class="input-group mb-3">
										    ...
										    <span id="enbldsblmodifyrolespn" class="text-danger color:red"></span>
										 </td>
									</tr>
									<tbody id ="enbltbodyid" hidden ="hidden">
									     <tr>
									      <td>ROLE IDS</td>
											<td>
											   <div class="input-group mb-3">
									                <form:select path="roleId" class="form-control" id="enblroleId" onchange ="loadenblUserDesc()">
									                  <form:option path="Role" value="">--PLEASE SELECT ROLEID --</form:option>
									                  <c:forEach var="list" items="${enblRolelist}" varStatus="counter">
									                     <form:option path="Role" value="${list.roleId}seprator${list.role}seprator${list.roleDescription}">${list.role}</form:option>
									                  </c:forEach>
									                </form:select>
											    </div>
											    <span id="enblrolespn" class="text-danger color:red"></span>
											 </td>
										  </tr>
										   <tr>
											    <td>ROLE DESCRIPTION</td>
											    <td><input type="text" class="form-control" name="enblroleDesc" id="enblroleDescid" readonly="readonly"></td>
										    </tr>
										    
										    <tr>
												<td colspan=2>
												   <input type="submit" id ="enblbtn"  value ="Disable" formaction ="./dsblRole" onclick ="return validateValues()"/>
												</td>
										   </tr>
									</tbody>
									...
									<tbody id ="dsbltbodyid" hidden ="hidden">
									     <tr>
									      <td>USER IDS</td>
											<td>
											   <div class="input-group mb-3">
									                <form:select path="roleId" class="form-control" id="dsbluserId" onchange ="loaddsblUserDesc()">
									                  <form:option path="Role" value="">--PLEASE SELECT ROLEID --</form:option>
									                  <c:forEach var="list" items="${dsblRolelist}" varStatus="counter">
									                     <form:option path="Role" value="${list.roleId}seprator${list.role}seprator${list.roleDescription}">${list.role}</form:option>
									                  </c:forEach>
									                </form:select>
											    </div>
										   ...
										   <tr>
											    <td>ROLE DESCRIPTION</td>
											    <td><input type="text" class="form-control" name="dsblroleDesc" id="dsblroleDescid" readonly="readonly"></td>
										    </tr>
										 <tr>
											<td colspan=2>
											   <input type="submit" id ="dsblbtn"  value ="Enable" formaction ="./enblRole"  onclick ="return validateValues()"/>
											</td>
										</tr>
									</tbody>
								</form:form>
