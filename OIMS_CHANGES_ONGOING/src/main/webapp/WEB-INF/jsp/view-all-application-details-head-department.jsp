...
<title>View All Applicant Details Head Department</title>
							...
							<div class="col-sm-12">
								<div class="mt-4">
									<div class="without-wizard-steps">
										<div class="row">
											<div class="col-sm-8">
												<a href="./viewAndEvaluateNodalDept"
													class="common-default-btn mt-0">Back</a> <a
													href="javascript:void(0);" id="printMethod" class="common-btn mt-0"><i
													class="fa fa-print"></i> Print</a> <a
													href="./evaluatedNodalDeptHeadApplication"
										...
										<hr>
										<form:form modelAttribute="downloadSupportMD" class="mt-4"
											name="downloadSupportMD" method="post">
											<div class="row mt-4">
											...
											<div class="row">
												...
												<div class="col-sm-8 text-right">
													<a href="javacript:void(0);" id="printMethod1"
														onclick="printDiv('printableArea')"
														class="common-btn mt-3"><i class="fa fa-print"></i>
														Print</a> <a href="./evaluatedNodalDeptHeadApplication"
														class="common-btn mt-3">View Evaluated Application</a>
												</div>
											</div>
										</div>
