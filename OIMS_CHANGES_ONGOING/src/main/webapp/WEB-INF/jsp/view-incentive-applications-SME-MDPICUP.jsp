...
<title>View Incentive Application SME MD PICUP</title>
														...
														<c:forEach var="list" items="${investmentDetailsList}"
															...
															<tr>
																...
																<td class="text-center"><a
																	href="./viewMDPICUPSMEApplicationDetails?applicantId=${list[0]}"
