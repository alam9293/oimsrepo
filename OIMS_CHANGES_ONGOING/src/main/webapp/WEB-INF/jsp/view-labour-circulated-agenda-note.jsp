			...
			<div class="row row-offcanvas row-offcanvas-left">
				<div class="col-md-3 col-lg-2 sidebar-offcanvas pt-3" id="sidebar"
					...
					<ul class="nav flex-column pl-1">
						...
						<li class="nav-item"><a class="nav-link" href="./viewLocLabour"><i
				...
				<div class="col-md-9 col-lg-10 mt-4 main">
					...
					<div class="card card-block p-4 mb-5">
						<div class="step-links">
							<ul class="only-steps">
								<li><a href="./circulateLabourViewAgendaNote" class="active pr-3">LOC</a></li>
								<li><a href="./circulateLabourViewAgendaNoteDis" class="pr-3">Disbursement </a></li>
							</ul>
						</div>
						<div id="accordion"
