...
$(document).on('click', '#printMethodAnx1', function(e) {
	e.preventDefault();

	var $this = $(this);
	var originalContent = $('body').html();
	var printArea = document.getElementById('Annexure-I').innerHTML;
...
$(document).on('click', '#printMethodAnx3', function(e) {
	e.preventDefault();

	var $this = $(this);
	var originalContent = $('body').html();
	var printArea = document.getElementById('Annexure-III').innerHTML;
...
$(document).on('click', '#printMethodddd', function(e) {
	e.preventDefault();
	...
	sidebartab.style.visibility = 'hidden';
	...
	var Lowerbpe = document.getElementById("LowerBPE");
	Lowerbpe.style.visibility = 'hidden';
	var removeTopId = document.getElementById("GoToTopBtn");
...
$(document).ready(function() {
    ...
    $('#formId').click(function() {
	 ...
	 $('#printMethodAnx1').hide();
	 $('#printMethodAnx3').hide();
	 $('#printMethod').show();
});

</script>
<script type="text/javascript">
function changePrintBTN()
{
	var getSelectId = document.getElementById("SelectParameter").value;
	if(getSelectId == 'viewAllApplicationDetails')
		{
		 $('#printMethodAnx1').hide();
		 $('#printMethodAnx3').hide();
		 $('#printMethod').show();
		}
	if(getSelectId == 'Annexure-I')
	{
	
		 $('#printMethod').hide();
		 $('#printMethodAnx3').hide();
		 $('#printMethodAnx1').show();
	}
	if(getSelectId == 'Annexure-III')
	{
	
		$('#printMethodAnx1').hide();
		 $('#printMethod').hide();
		 $('#printMethodAnx3').show();
...
<body>
							...
							<div class="col-sm-12">
								<div class="mt-4">
									<div class="without-wizard-steps">
										<div class="row" id="BPA">
											<div class="col-sm-8">
												<a href="./applicationForLoc"
													...
													<a
													href="javascript:void(0);" id="printMethodAnx1"
													class="common-btn mt-0"><i class="fa fa-print"></i>
													Print</a>
													<a
													href="javascript:void(0);" id="printMethodAnx3"
													class="common-btn mt-0"><i class="fa fa-print"></i>
													Print</a>
													
													 <a href="./evaluateApplication"
													onclick="return confirm('Are you Sure want to Evaluate Application ?')"
											...
											<div class="col-sm-4 text-right">
												<div class="form-group">
													<select class="form-control" id="SelectParameter" onchange="changePrintBTN()" >
										...
										<div id="content2">
											...
											<div class="tab-content py-2" id="downloadAF">
												...
												<div class="row">
													<div class="col-md-6 col-lg-4 col-xl-4">
														<div class="form-group">
															...
															<form:input type="text" path="appPinCode" readonly="true"
																maxlength="6" class="form-control" id="appPinCode"
																name="appPinCode" />
												...
												<div class="row">
													<div class="col-sm-12 mt-4">
														<h3 class="common-heading">Authorised Signatory Photo</h3>
													</div>
												</div>
												<div class="row">
										...
										<h4
											...
											Entity Details</h4>
										<div class="isf-form mt-4" id="downloadBED">
											<div class="row">
												<div class="col-sm-12 mt-4">
											...
											<div class="row">
												...
												<div class="col-md-6 col-lg-4 col-xl-4">
													<div class="form-group">
														<label>Mobile No.<span>*</span></label> <input type="text"
															class="form-control" value="${mobileNumber}"
															disabled="disabled" id="mobileNumber" name="mobileNumber">
													</div>
												</div>
											</div>
											<div class="row">
												<div class="col-md-6 col-lg-4 col-xl-4">
													<div class="form-group">
														<label>Fax</label> <input type="text" class="form-control"
															value="${fax}" disabled="disabled" id="fax" name="fax">
													</div>
												</div>
												...
												<div class="col-md-6 col-lg-4 col-xl-4">
													<div class="form-group">
														<label>GSTIN<span>*</span></label> <input type="text"
															value="${gstin}" disabled="disabled" class="form-control"
															id="gstin" name="gstin">
													</div>
												</div>
												<div class="col-md-6 col-lg-4 col-xl-4">
												...
												<div class="col-md-6 col-lg-4 col-xl-4">
													<div class="form-group">
														<label>Company Pan No.<span>*</span></label> <input
															...
															disabled="disabled" id="companyPanNo" name="companyPanNo">
													</div>
												</div>
												<div class="col-sm-8">
													<div class="form-group">
										...
										<h4
											...
											Details</h4>
										<div class="isf-form" id="downloadPD">
											<div class="row">
												<div class="col-sm-12 mt-4">
												...
												<div class="col-md-6 col-lg-4 col-xl-4">
													<div class="form-group">
														<label>District</label> <input type="text"
															...
															disabled="disabled" id="districtName" name="districtName">
													</div>
												</div>
												<div class="col-md-6 col-lg-4 col-xl-4">
													<div class="form-group">
												...
												<div class="col-sm-6">
													<div class="form-group">
														<label>Select Nature of the project<span
															...
															id="natureOfProjectId" disabled="disabled">
										...
										<div class="isf-form">
											...
											<form:form modelAttribute="viewInvestDetails"
												...
												<div class="tab-content py-2" id="downloadID">
													<div class="row">
													...
													<div class="row">
														...
														<div class="col-md-6 col-lg-4 col-xl-4">
															<div class="form-group">
																...
																<form:input path="pwFci" class="form-control" id="pwFci"
																	readonly="true" placeholder="Enter Amount in INR"
																	name="pwFci" onkeypress="return validateNumberField()"
														...
														<div class="col-md-12">
															<div class="form-group">
																...
																<span id="pwcutoffprodamt" class="text-danger"></span> <small
																	class="mt-2 d-block text-info" id="words24"></small>
																<form:errors path="pwCutoffProdAmt" cssClass="error" />
															</div>
														</div>
														</form:form>
											...
											<div class="col-sm-12">
												<div class="table-responsive">
													<table class="table table-bordered">
														<tbody>
															<tr>
																<td>Break-Up of Project Cost & Means<br>
																...
																<td><a href="javascript:void();"><small>${viewInvestDetails.invFilename}</small></a>
																</td>
															</tr>
														</tbody>
													</table>
										...
										<div class="isf-form" id="downloadPED">
											<div class="row">
												<div class="col-sm-12 mt-4">
										...
										<div class="parameter-properties" id="Annexure-I">
																...
																<tr>
																	<td class="text-center">
																		<div
																			class="custom-control custom-checkbox custom-control-inline">
																			<input type="checkbox" class="custom-control-input"
																				id="Small-p" value="" name="Small_Checkbox">
																	...
																	<td class="text-center">
																		<div
																			class="custom-control custom-checkbox custom-control-inline">
																			<input type="checkbox" class="custom-control-input"
																				id="Medium-p" value="" name="Medium_Checkbox">
																	...
																	<td class="text-center">
																		<div
																			class="custom-control custom-checkbox custom-control-inline">
																			<input type="checkbox" class="custom-control-input"
																				id="25exceedRs" value="" name="Small_Checkbox">
																	...
																	<td class="text-center">
																		<div
																			class="custom-control custom-checkbox custom-control-inline">
																			<input type="checkbox" class="custom-control-input"
																				id="5exceedRs" value="" name="Medium_Checkbox">
											...
											<%
												if (request.getAttribute("categorytype").equals("Large")) {
											%>
											<div class="row mt-4">
												<div class="col-sm-12">
													<div class="table-responsive">
											...
											<div class="row mt-4">
												<div class="col-sm-12">
															...
															<tbody>
																<tr>
																	...
																	<td>Name, Address& Contact Details of the
																		Applicant</td>
																	<td>${authorisedSignatoryName},${appAddressLine1}
																		${appAddressLine2}, ${viewSignatoryDetail.appMobileNo}</td>
																...
																<tr>
																	<td>6.</td>
																	<td>Status of Industrial Undertakingfirst</td>
													...
													<div class="table-responsive">
														<table class="table table-bordered">
															<tbody>
																<tr class="existing-hide">
																	<td>9.</td>
																	<td colspan="3">Details of Existing/Proposed
																		products to be manufactured and its capacityyy</td>
																</tr>
																<tr class="existing-hide">
																	<td colspan="4">
																		<div class="table-responsive">
															...
															<c:if test="${not empty existProjList}">
																...
																<tr class="newproject-hide">
																	<td>9.</td>
																	<td colspan="3">Details of New products to be
															...
															<div class="table-responsive">
																<table class="table table-bordered">
																	<tbody>
																		...
																		<tr>
																			<td>Investment amount</td>
																			<td colspan="3" id="fciL"></td>
																		</tr>
																		<tr>
																			<td>District/ Area</td>
																			<td colspan="3"><span id="districtNameL"></span>
																				/ <span id="resionNameL"></span></td>
																		</tr>
																	</tbody>
																</table>
															</div>
													...
													<div class="row mt-4">
														<div class="col-sm-12">
															<div class="table-responsive">
																<table class="table table-bordered">
																	...
																	<tbody>
																		...
																		<tr>
																			<td>6.</td>
																			<td>Status of Industrial Undertaking1</td>
																			<td></td>
																			<td>New /Expansion/Diversification</td>
																		</tr>
																		<tr>
															...
															<p
																class="mb-4 animate__animated animate__fadeInDown mt-3">
																<strong>12. BENEFITS REQUESTED BY APPLICANT</strong>
															</p>
															<div class="table-responsive">
																<table class="table table-bordered">
															...
															<p>The above information are completely true and no
																...
																policy of the Govt of UP for purpose of availing
													...
													<div class="row mt-4 mb-5">
														...
														<div class="col-md-12">
															...
															<p>(c) Charted Accountant's Certificate for
												...
												<div class="parameter-properties" id="Annexure-III">
													...
													<p
														class="mb-2 text-center animate__animated animate__fadeInDown">
														<i>(all supporting documents must be authenticated by
															a Director/Partner/Officer duly authorized by the
																		...
																		<tr>
																			...
																			<td>
																				<div
																					class="custom-control custom-checkbox custom-control-inline">
																					<input type="checkbox" class="custom-control-input"
																						id="checkIII6" value="${categorytype}"
																						name="BP_MP"> <label
																		...
																		<tr>
																			...
																			<td>
																				<div
																					class="custom-control custom-checkbox custom-control-inline">
																					<input type="checkbox" class="custom-control-input"
																						id="checkIII8" value="${categorytype}"
																						name="MP_MP"> <label
																		...
																		<tr>
																			...
																			<td>
																				<div
																					class="custom-control custom-checkbox custom-control-inline">
																					<input type="checkbox" class="custom-control-input"
																						id="checkIII9" value="${categorytype}"
																						name="BP_SM"> <label
																		...
																		<tr>
																			...
																			<td>
																				<div
																					class="custom-control custom-checkbox custom-control-inline">
																					<input type="checkbox" class="custom-control-input"
																						id="checkIII10" value="${categorytype}"
																						name="GG_MP"> <label
																		...
																		<tr>
																			...
																			<td>
																				<div
																					class="custom-control custom-checkbox custom-control-inline">
																					<input type="checkbox" class="custom-control-input"
																						id="checkIII11" value="${categorytype}"
																						name="MP_SM"> <label
																		...
																		<tr>
																			...
																			<td>
																				<div
																					class="custom-control custom-checkbox custom-control-inline">
																					<input type="checkbox" class="custom-control-input"
																						id="checkIII12" value="${categorytype}"
																						name="GG_SM"> <label
															...
															<div class="table-responsive">
																<table class="table table-bordered">
																	...
																	<tbody>
																		...
																		<tr>
																			<td>6.</td>
																			<td>Status of Industrial Undertaking3</td>
																			<td></td>
																			<td>New /Expansion/Diversification</td>
																		</tr>
																		<tr>
																	...
																	<tbody>
																		<tr>
																			...
																			<td>${authorisedSignatoryName},
																				${appAddressLine1} ${appAddressLine2},
												...
												<div class="isf-form mt-4" id="LowerBPE">
													<!-- <hr class="mt-4 mb-4"> -->
													<form:form modelAttribute="downloadSupport" class="mt-4"
														name="downloadSupport" method="post">
														<!-- <div class="row mt-4">
													...
													<div class="row">
														...
														<div class="col-sm-7 text-right">
															<a href="javacript:void(0);" id="printMethod1"
																...
																Print</a> <a href="./evaluateApplication"
																onclick="return confirm('Are you Sure want to Evaluate Application ?')"
																class="common-btn mt-3">Evaluate Application </a>
														</div>
													</div>
	...
	<footer class="dashboard-footer">
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-12" id="footerid">
					<div class="row">
						<div class="col-sm-3">
				...
				<form:form modelAttribute="department" id="concernDept"
					...
					<div class="modal-content">
						...
						<div class="modal-footer">
							...
							onclick="return submitConcernDepartment()"
							class="common-btn mt-3">Submit</form:button>
						</div>
					</div>
				</form:form>
	...
	$( "#adddept" ).click(function() {
		...
		var xhttp = new XMLHttpRequest();
		  ...
		  xhttp.open("POST", "${pageContext.request.contextPath}/addDept", true);
		  xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
		  xhttp.send("name="+$('#depttName').val()+"&email="+ $('#depttEmail').val());
		});
	});
	</script>
	<script>
	...
	window.onload = function() {
		...
		alert("Concerned Department Submitted sucessfully");

	}
	}
</script>
<script type="text/javascript">
function submitConcernDepartment() {
	var r = confirm("Are You Sure! want to Submit to Concern Department.");

	if (r == true) {
		alert("Application send to Concern Department Sucessfully");
		// return false
