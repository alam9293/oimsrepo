...
<title>View All Applicant Details DIC</title>
...
<!-- <scrip src="https://ajax.googleapis.com/ajax/libs/jquery/2.1.1/jquery.min.js"></script> -->
							...
							<div class="col-sm-12">
								<div class="mt-4">
									<div class="without-wizard-steps">
										<div class="row">
											<div class="col-sm-8">
												<a href="./dicApplicationForLoc"
													class="common-default-btn mt-0">Back</a> <a
													href="javascript:void(0);" id="printMethod" class="common-btn mt-0"><i
													class="fa fa-print"></i> Print</a>
													<a
													href="./evaluateApplicationDIC" onclick="return confirm('Are you Sure want to Evaluate Application ?')" class="common-btn mt-3">Evaluate
													Application </a>
											</div>
										...
										<div class="row mt-4">
											<div class="col-sm-12 text-center">
												<button type="button"
													class="btn btn-outline-success btn-sm mb-3" id="formId1">
														...
														<tbody>
															...
															<tr>
																...
																<td>Date from which capital investment has 28
																	commenced, or is proposed to commence (Cut-off date, as
																	opted)</td>
																<td></td>
																<td></td>
															</tr>
												...
												<div class="table-responsive">
													<table class="table table-bordered">
														...
														<tbody>
															...
															<tr>
																<td>12.3.3</td>
																<td>10% SGST where 25% minimum BPL workers employed
																	subject to minimum of 400 total workers in industrial
																	undertakings located in Paschimanchal and minimum of
																	200 total workers in B-P-M</td>
																<td></td>
															...
															<tr>
																<td>12.5.1</td>
																<td>Addl. 10% EPF Reimbursement (200 direct skilled
																	and unskilled workers)</td>
																<td></td>
															</tr>
															<tr>
																<td>12.5.2</td>
																<td>Addl. 10% EPF Reimbursement upto maximum of 70%
																	in case of industrial undertakings having 75% equity
																	owned by Divyang/SC/CT/Female Promoters</td>
																<td></td>
															</tr>
															<tr>
																<td>12.6</td>
