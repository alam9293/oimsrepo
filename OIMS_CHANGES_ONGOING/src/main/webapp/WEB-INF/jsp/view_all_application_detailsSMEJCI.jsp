...
<title>View All Applicant Details JCI</title>
		...
		<div class="container-fluid" id="main">
			<div class="row row-offcanvas row-offcanvas-left">
				...
				<div class="col-md-9 col-lg-10 mt-4 main mb-4">
					<h4 id="heading" class="card-title mb-4 mt-4 text-center animate__animated animate__fadeInDown">Industrial
								...
								<div class="mt-4">
									<div class="without-wizard-steps">
										<div class="row" id="BPA">
											<div class="col-sm-8">
												<a href="./JCIApplicationForLoc"
													class="common-default-btn mt-0">Back</a>
												 <a href="javascript:void(0);" id="printMethod" class="common-btn mt-0"><i
													class="fa fa-print"></i> Print</a>
												 
												 <!-- <a	href="./evaluateApplicationJCI"
