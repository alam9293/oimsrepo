				...
				<div class="col-md-3 col-lg-2 sidebar-offcanvas pt-3" id="sidebar"
					...
					<ul class="nav flex-column pl-1">
						<li class="nav-item"><a class="nav-link"
							href="./labourDashboard"><i class="fa fa-tachometer"></i>
								Dashboard</a></li>
						<li class="nav-item"><a class="nav-link"
							href="./viewLabourDeptApplication"><i class="fa fa-eye"></i> View
								Applications</a></li>
						<li class="nav-item"><a class="nav-link"
							href="./circulateLabourViewAgendaNote"><i class="fa fa-eye"></i>
								View Circulated Agenda Note</a></li>
						<li class="nav-item"><a class="nav-link active" href="./viewLocLabour"><i
